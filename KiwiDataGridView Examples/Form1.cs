...
namespace KiwiDataGridView_Examples
{
    public partial class Form1 : Form
    {
        ...
        private void buttonRandomCellColors_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < kiwiDataGridView1.Rows.Count; i++)
            {
                for (int j = 0; j < kiwiDataGridView1.ColumnCount; j++)
                {
                    ...
                    kiwiDataGridView1.Rows[i].Cells[j].Style.BackColor = foreColor;
                    kiwiDataGridView1.Rows[i].Cells[j].Style.ForeColor = backColor;
                }
            }
        }
        ...
        private void buttonClearCellColors_Click(object sender, EventArgs e)
        {
            for (int i = 0; i < kiwiDataGridView1.Rows.Count; i++)
            {
                for (int j = 0; j < kiwiDataGridView1.ColumnCount; j++)
                {
                    kiwiDataGridView1.Rows[i].Cells[j].Style.BackColor = Color.Empty;
                    kiwiDataGridView1.Rows[i].Cells[j].Style.ForeColor = Color.Empty;
                }
            }
        }
        ...
        {
            var old = new Form1().kiwiDataGridView1;
            var changes = GetChangedProperties<DataGridView>(old, kiwiDataGridView1);
    ...
    public class KiwiDataGridViewProxy
    {
        private KiwiDataGridView _grid;

        public KiwiDataGridViewProxy(KiwiDataGridView grid)
        {
            _grid = grid;
        }
