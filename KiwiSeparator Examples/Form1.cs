...
namespace KiwiSeparator_Examples
{
    public partial class Form1 : Form
    {
        ...
        {
            propertyGrid.SelectedObject = new KiwiSeparatorProxy(kiwiSeparator1);
        }

        private void separator_MouseDown(object sender, MouseEventArgs e)
        {
            propertyGrid.SelectedObject = new KiwiSeparatorProxy(sender as KiwiSeparator);
        }
    ...
    public class KiwiSeparatorProxy
    {
        private KiwiSeparator _separator;

        public KiwiSeparatorProxy(KiwiSeparator separator)
        {
