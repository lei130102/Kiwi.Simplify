...
namespace KiwiTextBox_Examples
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            propertyGrid.SelectedObject = new KiwiTextBoxProxy(kiwiTextBox1Blue);
        }

        private void kiwiTextBox1Blue_Enter(object sender, EventArgs e)
        {
            // Setup the property grid to edit this text box
            propertyGrid.SelectedObject = new KiwiTextBoxProxy(sender as KiwiTextBox);
        }

        private void buttonSpecAny1_Click(object sender, EventArgs e)
        {
            kiwiTextBox2Blue.Text = string.Empty;
        }

        private void buttonSpecAny3_Click(object sender, EventArgs e)
        {
            kiwiTextBox5System.Text = string.Empty;
        }

        private void fixedText1_Click(object sender, EventArgs e)
        {
            kiwiTextBox9Custom.Text = "Fixed Text 1";
            kiwiTextBox9Custom.TextBox.Focus();
        }

        private void fixedText2_Click(object sender, EventArgs e)
        {
            kiwiTextBox9Custom.Text = "Fixed Text 2";
            kiwiTextBox9Custom.TextBox.Focus();
        }

        private void clear_Click(object sender, EventArgs e)
        {
            kiwiTextBox9Custom.Text = string.Empty;
            kiwiTextBox9Custom.TextBox.Focus();
        }
    ...
    public class KiwiTextBoxProxy
    {
        private KiwiTextBox _textBox;

        public KiwiTextBoxProxy(KiwiTextBox textBox)
        {
            _textBox = textBox;
        }
