...
namespace KiwiHeaderGroup_Examples
{
    public partial class Form1 : Form
    {
        ...
        private void headerGroup_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            propertyGrid.SelectedObject = new KiwiHeaderGroupProxy(sender as KiwiHeaderGroup);
        }
        ...
        private void panel_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            propertyGrid.SelectedObject = new KiwiHeaderGroupProxy(c.Parent as KiwiHeaderGroup);
        }

        private void Form1_Load(object sender, EventArgs e)
        {
            // Setup the property grid to edit this header group
            propertyGrid.SelectedObject = new KiwiHeaderGroupProxy(headerGroup1Office);
        }
    }
    public class KiwiHeaderGroupProxy
    {
        private KiwiHeaderGroup _headerGroup;

        public KiwiHeaderGroupProxy(KiwiHeaderGroup headerGroup)
        {
        ...
        public KiwiHeaderGroup.HeaderGroupButtonSpecCollection ButtonSpecs
        {
