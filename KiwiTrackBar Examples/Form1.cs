...
namespace KiwiTrackBar_Examples
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            propertyGrid.SelectedObject = new KiwiTrackBarProxy(kiwiTrackBar1);
        }

        private void trackBar_Enter(object sender, EventArgs e)
        {
            // Setup the property grid to edit this track bar control
            propertyGrid.SelectedObject = new KiwiTrackBarProxy(sender as KiwiTrackBar);
        }
    ...
    public class KiwiTrackBarProxy
    {
        private KiwiTrackBar _trackBar;

        public KiwiTrackBarProxy(KiwiTrackBar trackBar)
        {
            _trackBar = trackBar;
        }
