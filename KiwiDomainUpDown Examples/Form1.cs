...
namespace KiwiDomainUpDown_Examples
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            propertyGrid.SelectedObject = new KiwiDomainUpDownProxy(dud1);
        }

        private void dud_Enter(object sender, EventArgs e)
        {
            // Setup the property grid to edit this domain upo-down control
            propertyGrid.SelectedObject = new KiwiDomainUpDownProxy(sender as KiwiDomainUpDown);
        }
        ...
        {
            KiwiContextMenuItem item = (KiwiContextMenuItem)sender;
            dud6.Text = item.Text;
    ...
    public class KiwiDomainUpDownProxy
    {
        private KiwiDomainUpDown _domainUpDown;

        public KiwiDomainUpDownProxy(KiwiDomainUpDown domainUpDown)
        {
