...
namespace KiwiRadioButton_Examples
{
    public partial class Form1 : Form
    {
        ...
        {
            propertyGrid.SelectedObject = new KiwiRadioButtonProxy(kiwiRadioButton12);
        }

        private void RadioButtonEnter(object sender, EventArgs e)
        {
            propertyGrid.SelectedObject = new KiwiRadioButtonProxy(sender as KiwiRadioButton);
        }
    ...
    public class KiwiRadioButtonProxy
    {
        private KiwiRadioButton _radioButton;

        public KiwiRadioButtonProxy(KiwiRadioButton checkBox)
        {
