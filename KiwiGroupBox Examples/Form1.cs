...
namespace KiwiGroupBox_Examples
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            propertyGrid.SelectedObject = new KiwiGroupBoxProxy(kiwiGroupBox1);
        }

        private void groupBox_MouseDown(object sender, MouseEventArgs e)
        {
            // Setup the property grid to edit this header group
            propertyGrid.SelectedObject = new KiwiGroupBoxProxy(sender as KiwiGroupBox);
        }
        ...
        private void panel_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            propertyGrid.SelectedObject = new KiwiGroupBoxProxy(c.Parent as KiwiGroupBox);
        }
    ...
    public class KiwiGroupBoxProxy
    {
        private KiwiGroupBox _groupBox;

        public KiwiGroupBoxProxy(KiwiGroupBox groupBox)
        {
            _groupBox = groupBox;
        }
