...
namespace KiwiBorderEdge_Examples
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            propertyGrid.SelectedObject = new KiwiBorderEdgeProxy(borderEdgeH1);
        }
        ...
        {
            kiwiManager.GlobalPalette = kiwiPaletteSparkle;
            propertyGrid.SelectedObject = kiwiPaletteSparkle;
        }
        ...
        private void checkButton_Enter(object sender, EventArgs e)
        {
            ...
            propertyGrid.SelectedObject = new KiwiCheckButtonProxy(sender as KiwiCheckButton);
        }

        private void borderEdge_MouseDown(object sender, MouseEventArgs e)
        {
            // Setup the property grid to edit this border edge
            propertyGrid.SelectedObject = new KiwiBorderEdgeProxy(sender as KiwiBorderEdge);
        }
    ...
    public class KiwiCheckButtonProxy
    {
        private KiwiCheckButton _checkButton;

        public KiwiCheckButtonProxy(KiwiCheckButton checkButton)
        {
    ...
    public class KiwiBorderEdgeProxy
    {
        private KiwiBorderEdge _borderEdge;

        public KiwiBorderEdgeProxy(KiwiBorderEdge borderEdge)
        {
