...
namespace Kiwi.ComponentFactory.Ribbon
{
    ...
    //
    [ToolboxBitmap(typeof(KiwiRibbonQATButton), "ToolboxBitmaps.KiwiRibbonQATButton.bmp")]
    public class KiwiRibbonQATButton : Component,
                                          IQuickAccessToolbarButton
    {
        ...
        #region Identity
        /// <summary>
        /// Initialise a new instance of the KiwiRibbonQATButton class.
        /// </summary>
        public KiwiRibbonQATButton()
        {
            // Default fields
        ...
        public void SetRibbon(KiwiRibbon ribbon)
        {
            _ribbon = ribbon;
        }
