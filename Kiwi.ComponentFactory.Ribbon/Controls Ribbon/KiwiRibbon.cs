...
namespace Kiwi.ComponentFactory.Ribbon
{
    ...
    [Designer("Kiwi.ComponentFactory.Ribbon.KiwiRibbonDesigner, Kiwi.ComponentFactory.Ribbon, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [DesignerCategory("code")]
    [Description("Ribbon control presents a tabbed set of user options.")]
    //
    [Docking(DockingBehavior.Never)]
    //
    [ToolboxBitmap(typeof(KiwiRibbon), "ToolboxBitmaps.KiwiRibbon.bmp")]
    public class KiwiRibbon : VisualSimple,
                                 IMessageFilter
    {
        ...
        public class RibbonButtonSpecAnyCollection : ButtonSpecCollection<ButtonSpecAny>
        {
            ...
            public RibbonButtonSpecAnyCollection(KiwiRibbon owner)
                : base(owner)
            {
            }
            #endregion
        ...
        private KiwiRibbonTab _minSelectedTab;
        private KiwiRibbonTab _selectedTab;
        private KiwiRibbonTabCollection _ribbonTabs;
        private KiwiRibbonContextCollection _ribbonContexts;
        private KiwiRibbonQATButtonCollection _qatButtons;
        ...
        /// <summary>
        /// Initialize a new instance of the KiwiRibbon class.
        /// </summary>
        public KiwiRibbon()
        {
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
            {
                ...
                // Dispose of the cached kiwi context menu
                if (_kcm != null)
                {
                    _kcm.Close();
                    _kcm.Dispose();
                ...
                foreach (KiwiRibbonTab tab in RibbonTabs)
                    tab.Dispose();
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiRibbonTabCollection RibbonTabs
        {
        ...
        public KiwiRibbonTab SelectedTab
        {
        ...
        [MergableProperty(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiRibbonContextCollection RibbonContexts
        {
        ...
        [MergableProperty(false)]
        [Editor("Kiwi.ComponentFactory.Ribbon.KiwiRibbonQATButtonCollectionEditor, Kiwi.ComponentFactory.Ribbon, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704", typeof(UITypeEditor))]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiRibbonQATButtonCollection QATButtons
        {
        ...
        protected override void OnLayout(LayoutEventArgs levent)
        {
            ...
            if (_captionArea.KiwiForm != null)
                _captionArea.KiwiForm.RecalculateComposition();
        ...
        internal void UpdateBackStyle()
        {
            ...
            if (f != null)
            {
                KiwiForm kiwiForm = f as KiwiForm;
                if (kiwiForm != null)
                {
                    if (!kiwiForm.WindowActive)
        ...
        internal KiwiForm FindKiwiForm()
        {
            Control c = this;
            while (c != null)
            {
            ...
            // Caller is only interested in the KiwiForm parent
            if ((c != null) && (c is KiwiForm))
                return c as KiwiForm;
            else
                return null;
        }
        ...
        {
            // Ensure cached kiwi context menu is ready for use
            ResetCachedKiwiContextMenu();

            // Add heading at top of the context menu
            KiwiContextMenuHeading heading = new KiwiContextMenuHeading();
            ...
            KiwiContextMenuItems menuItems = new KiwiContextMenuItems();
            ...
            if (QATUserChange)
            {
                ...
                foreach (IQuickAccessToolbarButton qatButton in QATButtons)
                {
                    KiwiContextMenuItem menuItem = new KiwiContextMenuItem();
            ...
            {
                KiwiContextMenuItem showQAT = new KiwiContextMenuItem();
                ...
                if (menuItems.Items.Count > 0)
                    menuItems.Items.Add(new KiwiContextMenuSeparator());
            ...
            if (AllowMinimizedChange)
            {
                ...
                KiwiContextMenuItem minimize = new KiwiContextMenuItem();
            ...
            if (!args.Cancel && (args.KiwiContextMenu != null) && CommonHelper.ValidKiwiContextMenu(_kcm))
            {
        ...
        {
            _ribbonContexts = new KiwiRibbonContextCollection();
            ...
            _ribbonContexts.Inserted += new TypedHandler<KiwiRibbonContext>(OnRibbonContextsInserted);
            _ribbonContexts.Removed += new TypedHandler<KiwiRibbonContext>(OnRibbonContextsRemoved);

            _ribbonTabs = new KiwiRibbonTabCollection();
            _ribbonTabs.Clearing += new EventHandler(OnRibbonTabsClearing);
            _ribbonTabs.Cleared += new EventHandler(OnRibbonTabsCleared);
            _ribbonTabs.Inserted += new TypedHandler<KiwiRibbonTab>(OnRibbonTabsInserted);
            _ribbonTabs.Removed += new TypedHandler<KiwiRibbonTab>(OnRibbonTabsRemoved);

            _qatButtons = new KiwiRibbonQATButtonCollection();
        ...
        private bool TabIsContextValid(KiwiRibbonTab tab)
        {
        ...
        {
            KiwiRibbonTab newSelection = null;
        ...
        private void OnRibbonContextsClearing(object sender, EventArgs e)
        {
            ...
            foreach (KiwiRibbonContext context in RibbonContexts)
        ...
        private void OnRibbonContextsInserted(object sender, TypedCollectionEventArgs<KiwiRibbonContext> e)
        {
        ...
        private void OnRibbonContextsRemoved(object sender, TypedCollectionEventArgs<KiwiRibbonContext> e)
        {
        ...
        private void OnRibbonTabsInserted(object sender, TypedCollectionEventArgs<KiwiRibbonTab> e)
        {
        ...
        private void OnRibbonTabsRemoved(object sender, TypedCollectionEventArgs<KiwiRibbonTab> e)
        {
            // Unhook from tab property change event
            e.Item.PropertyChanged -= new PropertyChangedEventHandler(OnTabPropertyChanged);
        ...
        private void ResetCachedKiwiContextMenu()
        {
            ...
            if (_kcm == null)
            {
                ...
                _kcm.Closed += new ToolStripDropDownClosedEventHandler(OnKiwiContextMenuClosed);
            }
