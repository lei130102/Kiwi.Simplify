...
namespace Kiwi.ComponentFactory.Ribbon
{
    ...
    //
    [ToolboxItem(false)]
    [Designer("Kiwi.ComponentFactory.Ribbon.KiwiRibbonGroupDesigner, Kiwi.ComponentFactory.Ribbon, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [DefaultEvent("DialogBoxLauncherClick")]
    [DefaultProperty("TextLine1")]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    //
    [ToolboxBitmap(typeof(KiwiRibbonGroup), "ToolboxBitmaps.KiwiRibbonGroup.bmp")]
    public class KiwiRibbonGroup : Component
    {
        ...
        private KiwiRibbonGroupContainerCollection _ribbonGroupItems;
        ...
        public KiwiRibbonGroup()
        {
            ...
            _ribbonGroupItems = new KiwiRibbonGroupContainerCollection();
            ...
            _ribbonGroupItems.Inserted += new TypedHandler<KiwiRibbonGroupContainer>(OnRibbonGroupItemsInserted);
            _ribbonGroupItems.Removed += new TypedHandler<KiwiRibbonGroupContainer>(OnRibbonGroupItemsRemoved);
        }
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
            {
                ...
                foreach (KiwiRibbonGroupContainer container in Items)
                    container.Dispose();
            }
        ...
        public KiwiRibbon Ribbon
        {
            ...
            internal set
            {
                ...
                foreach (KiwiRibbonGroupItem item in _ribbonGroupItems)
                    item.Ribbon = value;
            }
        }
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public KiwiRibbonTab RibbonTab
        {
        ...
        [Editor("Kiwi.ComponentFactory.Ribbon.KiwiRibbonGroupContainerCollectionEditor, Kiwi.ComponentFactory.Ribbon, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704", typeof(UITypeEditor))]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiRibbonGroupContainerCollection Items
        {
        ...
        private void OnRibbonGroupItemsClearing(object sender, EventArgs e)
        {
            ...
            foreach (KiwiRibbonGroupContainer container in _ribbonGroupItems)
            {
        ...
        private void OnRibbonGroupItemsInserted(object sender, TypedCollectionEventArgs<KiwiRibbonGroupContainer> e)
        {
        ...
        private void OnRibbonGroupItemsRemoved(object sender, TypedCollectionEventArgs<KiwiRibbonGroupContainer> e)
        {
            // Remove the back references
            e.Item.Ribbon = null;
