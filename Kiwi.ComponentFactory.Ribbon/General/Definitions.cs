...
namespace Kiwi.ComponentFactory.Ribbon
{
    ...
    public interface IQuickAccessToolbarButton
    {
        ...
        void SetRibbon(KiwiRibbon ribbon);
    ...
    public interface IRibbonGroupItem
    {
        ...
        /// </summary>
        KiwiRibbon Ribbon { get; set; }

        /// <summary>
        /// Gets and sets the owning ribbon tab instance.
        /// </summary>
        KiwiRibbonTab RibbonTab { get; set; }

        /// <summary>
        /// Gets and sets the owning ribbon container instance.
        /// </summary>
        KiwiRibbonGroupContainer RibbonContainer { get; set; }
        ...
        ViewBase CreateView(KiwiRibbon ribbon, NeedPaintHandler needPaint);
    }
    #endregion
    ...
    internal interface IRibbonKeyTipTarget
    {
        ...
        void KeyTipSelect(KiwiRibbon ribbon);
    }
    #endregion
