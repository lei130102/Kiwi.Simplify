...
namespace Kiwi.ComponentFactory.Ribbon
{
    ...
    /// </summary>
    [ToolboxItem(false)]
    [Designer("Kiwi.ComponentFactory.Ribbon.KiwiRibbonGroupClusterColorButtonDesigner, Kiwi.ComponentFactory.Ribbon, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    [DefaultEvent("SelectedColorChanged")]
    [DefaultProperty("SelectedColor")]
    //
    [ToolboxBitmap(typeof(KiwiRibbonGroupClusterColorButton), "ToolboxBitmaps.KiwiRibbonGroupClusterColorButton.bmp")]
    public class KiwiRibbonGroupClusterColorButton : KiwiRibbonGroupItem
    {
        ...
        #region Identity
        /// <summary>
        /// Initialise a new instance of the KiwiRibbonGroupClusterColorButton class.
        /// </summary>
        public KiwiRibbonGroupClusterColorButton()
        {
            // Default fields
            _enabled = true;
            _visible = true;
                ...
                if (Enabled)
                {
                        ...
                        (ButtonType == GroupButtonType.Split))
                    {
                        if (_kiwiContextMenu != null)
                        {
                            ...
                            ContextMenuArgs contextArgs = new ContextMenuArgs(_kiwiContextMenu);
        ...
        internal override bool ProcessCmdKey(ref Message msg, Keys keyData)
        {
            ...
            if (Enabled && ChainVisible)
            {
                ...
                {
                    if (_kiwiContextMenu != null)
                        if (_kiwiContextMenu.ProcessShortcut(keyData))
                            return true;
                }
            }
