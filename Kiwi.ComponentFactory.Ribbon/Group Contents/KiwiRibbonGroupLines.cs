...
namespace Kiwi.ComponentFactory.Ribbon
{
    ...
    //
    [ToolboxItem(false)]
    [Designer("Kiwi.ComponentFactory.Ribbon.KiwiRibbonGroupLinesDesigner, Kiwi.ComponentFactory.Ribbon, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    [DefaultProperty("Visible")]
    //
    [ToolboxBitmap(typeof(KiwiRibbonGroupLines), "ToolboxBitmaps.KiwiRibbonGroupLines.bmp")]
    public class KiwiRibbonGroupLines : KiwiRibbonGroupContainer
    {
        #region Instance Fields
        private KiwiRibbonGroupLinesCollection _ribbonLineItems;
        ...
        #region Identity
        /// <summary>
        /// Initialise a new instance of the KiwiRibbonGroupLines class.
        /// </summary>
        public KiwiRibbonGroupLines()
        {
            // Default fields
            _visible = true;
            ...
            _ribbonLineItems = new KiwiRibbonGroupLinesCollection();
            ...
            _ribbonLineItems.Inserted += new TypedHandler<KiwiRibbonGroupItem>(OnRibbonGroupLineInserted);
            _ribbonLineItems.Removed += new TypedHandler<KiwiRibbonGroupItem>(OnRibbonGroupLineRemoved);
        }
        ...
        public override KiwiRibbon Ribbon
        {
            ...
            set
            {
                ...
                foreach (KiwiRibbonGroupItem item in _ribbonLineItems)
                    item.Ribbon = value;
            }
        }
        ...
        [Editor("Kiwi.ComponentFactory.Ribbon.KiwiRibbonGroupLinesCollectionEditor, Kiwi.ComponentFactory.Ribbon, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704", typeof(UITypeEditor))]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiRibbonGroupLinesCollection Items
        {
        ...
        private void OnRibbonGroupLineInserted(object sender, TypedCollectionEventArgs<KiwiRibbonGroupItem> e)
        {
        ...
        private void OnRibbonGroupLineRemoved(object sender, TypedCollectionEventArgs<KiwiRibbonGroupItem> e)
        {
            // Remove the back references
            e.Item.Ribbon = null;
