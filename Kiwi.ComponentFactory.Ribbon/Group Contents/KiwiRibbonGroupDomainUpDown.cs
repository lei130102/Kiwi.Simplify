...
namespace Kiwi.ComponentFactory.Ribbon
{
    ...
    //
    [ToolboxItem(false)]
    [Designer("Kiwi.ComponentFactory.Ribbon.KiwiRibbonGroupDomainUpDownDesigner, Kiwi.ComponentFactory.Ribbon, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    [DefaultEvent("SelectedItemChanged")]
    [DefaultProperty("Items")]
    //
    [ToolboxBitmap(typeof(KiwiRibbonGroupDomainUpDown), "ToolboxBitmaps.KiwiRibbonGroupDomainUpDown.bmp")]
    public class KiwiRibbonGroupDomainUpDown : KiwiRibbonGroupItem
    {
        ...
        private KiwiDomainUpDown _lastDomainUpDown;
        ...
        #region Identity
        /// <summary>
        /// Initialise a new instance of the KiwiRibbonGroupDomainUpDown class.
        /// </summary>
        public KiwiRibbonGroupDomainUpDown()
        {
            // Default fields
            _visible = true;
            _enabled = true;
            ...
            _domainUpDown = new KiwiDomainUpDown();
        ...
        /// <summary>
        /// Access to the actual embedded KiwiDomainUpDown instance.
        /// </summary>
        [Description("Access to the actual embedded KiwiDomainUpDown instance.")]
        [Browsable(false)]
        [EditorBrowsable(EditorBrowsableState.Always)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public KiwiDomainUpDown DomainUpDown
        {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiDomainUpDown.DomainUpDownButtonSpecCollection ButtonSpecs
        {
        ...
        /// <summary>
        /// Gets and sets the KiwiContextMenu for showing when the domain up down is right clicked.
        /// </summary>
        [Category("Behavior")]
        [Description("KiwiContextMenu to be shown when the domain up down is right clicked.")]
        [DefaultValue(null)]
        public KiwiContextMenu KiwiContextMenu
        {
            get { return _domainUpDown.KiwiContextMenu; }
            set { _domainUpDown.KiwiContextMenu = value; }
        }
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        [Browsable(false)]
        public IKiwiDesignObject DomainUpDownDesigner
        {
        ...
        internal KiwiDomainUpDown LastDomainUpDown
        {
        ...
        private void MonitorControl(KiwiDomainUpDown c)
        {
        ...
        private void UnmonitorControl(KiwiDomainUpDown c)
        {
            c.MouseEnter -= new EventHandler(OnControlEnter);
            c.MouseLeave -= new EventHandler(OnControlLeave);
            c.TrackMouseEnter -= new EventHandler(OnControlEnter);
