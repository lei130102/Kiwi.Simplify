...
namespace Kiwi.ComponentFactory.Ribbon
{
    ...
    //
    [ToolboxItem(false)]
    [Designer("Kiwi.ComponentFactory.Ribbon.KiwiRibbonGroupRadioButtonDesigner, Kiwi.ComponentFactory.Ribbon, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    [DefaultEvent("CheckedChanged")]
    [DefaultProperty("Checked")]
    //
    [ToolboxBitmap(typeof(KiwiRibbonGroupRadioButton), "ToolboxBitmaps.KiwiRibbonGroupRadioButton.bmp")]
    public class KiwiRibbonGroupRadioButton : KiwiRibbonGroupItem
    {
        ...
        #region Identity
        /// <summary>
        /// Initialise a new instance of the KiwiRibbonGroupRadioButton class.
        /// </summary>
        public KiwiRibbonGroupRadioButton()
        {
            // Default fields
            _enabled = true;
            _visible = true;
        ...
        private void AutoUpdateContainer(IRibbonGroupContainer Container)
        {
            ...
            foreach (Component component in Container.GetChildComponents())
            {
                ...
                else
                {
                    ...
                    if (component is KiwiRibbonGroupRadioButton)
                    {
                        KiwiRibbonGroupRadioButton radioButton = (KiwiRibbonGroupRadioButton)component;
