...
namespace Kiwi.ComponentFactory.Ribbon
{
    ...
    //
    [ToolboxItem(false)]
    [Designer("Kiwi.ComponentFactory.Ribbon.KiwiRibbonGroupTextBoxDesigner, Kiwi.ComponentFactory.Ribbon, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    [DefaultEvent("TextChanged")]
    [DefaultProperty("Text")]
    //
    [ToolboxBitmap(typeof(KiwiRibbonGroupTextBox), "ToolboxBitmaps.KiwiRibbonGroupTextBox.bmp")]
    public class KiwiRibbonGroupTextBox : KiwiRibbonGroupItem
    {
        ...
        private KiwiTextBox _textBox;
        private KiwiTextBox _lastTextBox;
        ...
        #region Identity
        /// <summary>
        /// Initialise a new instance of the KiwiRibbonGroupTextBox class.
        /// </summary>
        public KiwiRibbonGroupTextBox()
        {
            // Default fields
            _visible = true;
            _enabled = true;
        ...
        /// <summary>
        /// Access to the actual embedded KiwiTextBox instance.
        /// </summary>
        [Description("Access to the actual embedded KiwiTextBox instance.")]
        [Browsable(false)]
        [EditorBrowsable(EditorBrowsableState.Always)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public KiwiTextBox TextBox
        {
            get { return _textBox; }
        }
        ...
        {
            get { return _textBox.KiwiContextMenu; }
            set { _textBox.KiwiContextMenu = value; }
        }
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiTextBox.TextBoxButtonSpecCollection ButtonSpecs
        {
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        [Browsable(false)]
        public IKiwiDesignObject TextBoxDesigner
        {
        ...
        internal KiwiTextBox LastTextBox
        {
        ...
        private void MonitorControl(KiwiTextBox c)
        {
        ...
        private void UnmonitorControl(KiwiTextBox c)
        {
            c.MouseEnter -= new EventHandler(OnControlEnter);
            c.MouseLeave -= new EventHandler(OnControlLeave);
            c.TrackMouseEnter -= new EventHandler(OnControlEnter);
