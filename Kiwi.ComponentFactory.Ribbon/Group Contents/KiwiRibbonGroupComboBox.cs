...
namespace Kiwi.ComponentFactory.Ribbon
{
    ...
    //
    [ToolboxItem(false)]
    [Designer("Kiwi.ComponentFactory.Ribbon.KiwiRibbonGroupComboBoxDesigner, Kiwi.ComponentFactory.Ribbon, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    [DefaultEvent("SelectedTextChanged")]
    [DefaultProperty("Text")]
    //
    [ToolboxBitmap(typeof(KiwiRibbonGroupComboBox), "ToolboxBitmaps.KiwiRibbonGroupComboBox.bmp")]
    public class KiwiRibbonGroupComboBox : KiwiRibbonGroupItem
    {
        ...
        private KiwiComboBox _lastComboBox;
        ...
        #region Identity
        /// <summary>
        /// Initialise a new instance of the KiwiRibbonGroupComboBox class.
        /// </summary>
        public KiwiRibbonGroupComboBox()
        {
            // Default fields
            _visible = true;
            _enabled = true;
        ...
        /// <summary>
        /// Access to the actual embedded KiwiComboBox instance.
        /// </summary>
        [Description("Access to the actual embedded KiwiComboBox instance.")]
        [Browsable(false)]
        [EditorBrowsable(EditorBrowsableState.Always)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public KiwiComboBox ComboBox
        {
        ...
        /// <summary>
        /// Gets and sets the KiwiContextMenu for showing when the combobox is right clicked.
        /// </summary>
        [Category("Behavior")]
        [Description("KiwiContextMenu to be shown when the combobox is right clicked.")]
        [DefaultValue(null)]
        public KiwiContextMenu KiwiContextMenu
        {
            get { return _comboBox.KiwiContextMenu; }
            set { _comboBox.KiwiContextMenu = value; }
        }
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        [Browsable(false)]
        public IKiwiDesignObject ComboBoxDesigner
        {
        ...
        internal KiwiComboBox LastComboBox
        {
        ...
        private void MonitorControl(KiwiComboBox c)
        {
        ...
        private void UnmonitorControl(KiwiComboBox c)
        {
            c.MouseEnter -= new EventHandler(OnControlEnter);
            c.MouseLeave -= new EventHandler(OnControlLeave);
            c.TrackMouseEnter -= new EventHandler(OnControlEnter);
