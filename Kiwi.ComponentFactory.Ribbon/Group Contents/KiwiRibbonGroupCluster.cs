...
namespace Kiwi.ComponentFactory.Ribbon
{
    ...
    //
    [ToolboxItem(false)]
    [Designer("Kiwi.ComponentFactory.Ribbon.KiwiRibbonGroupClusterDesigner, Kiwi.ComponentFactory.Ribbon, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    [DefaultProperty("Visible")]
    //
    [ToolboxBitmap(typeof(KiwiRibbonGroupCluster), "ToolboxBitmaps.KiwiRibbonGroupCluster.bmp")]
    public class KiwiRibbonGroupCluster : KiwiRibbonGroupContainer
    {
        #region Instance Fields
        private KiwiRibbonGroupClusterCollection _ribbonClusterItems;
        ...
        #region Identity
        /// <summary>
        /// Initialise a new instance of the KiwiRibbonGroupCluster class.
        /// </summary>
        public KiwiRibbonGroupCluster()
        {
            // Default fields
            ...
            _ribbonClusterItems = new KiwiRibbonGroupClusterCollection();
            ...
            _ribbonClusterItems.Inserted += new TypedHandler<KiwiRibbonGroupItem>(OnRibbonGroupClusterInserted);
            _ribbonClusterItems.Removed += new TypedHandler<KiwiRibbonGroupItem>(OnRibbonGroupClusterRemoved);
        }
        #endregion
        ...
        public override KiwiRibbon Ribbon
        {
            ...
            set
            {
                ...
                foreach (KiwiRibbonGroupItem item in _ribbonClusterItems)
                    item.Ribbon = value;
            }
        }
        ...
        [Editor("Kiwi.ComponentFactory.Ribbon.KiwiRibbonGroupClusterCollectionEditor, Kiwi.ComponentFactory.Ribbon, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704", typeof(UITypeEditor))]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiRibbonGroupClusterCollection Items
        {
        ...
        private void OnRibbonGroupClusterInserted(object sender, TypedCollectionEventArgs<KiwiRibbonGroupItem> e)
        {
        ...
        private void OnRibbonGroupClusterRemoved(object sender, TypedCollectionEventArgs<KiwiRibbonGroupItem> e)
        {
            // Remove the back references
            e.Item.Ribbon = null;
