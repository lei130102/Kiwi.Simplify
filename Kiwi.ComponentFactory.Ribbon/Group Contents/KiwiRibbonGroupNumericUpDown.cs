...
namespace Kiwi.ComponentFactory.Ribbon
{
    ...
    //
    [ToolboxItem(false)]
    [Designer("Kiwi.ComponentFactory.Ribbon.KiwiRibbonGroupNumericUpDownDesigner, Kiwi.ComponentFactory.Ribbon, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    [DefaultEvent("ValueChanged")]
    [DefaultProperty("Value")]
    //
    [ToolboxBitmap(typeof(KiwiRibbonGroupNumericUpDown), "ToolboxBitmaps.KiwiRibbonGroupNumericUpDown.bmp")]
    public class KiwiRibbonGroupNumericUpDown : KiwiRibbonGroupItem
    {
        ...
        private KiwiNumericUpDown _lastNumericUpDown;
        ...
        #region Identity
        /// <summary>
        /// Initialise a new instance of the KiwiRibbonGroupNumericUpDown class.
        /// </summary>
        public KiwiRibbonGroupNumericUpDown()
        {
            // Default fields
            _visible = true;
            _enabled = true;
            ...
            _numericUpDown = new KiwiNumericUpDown();
        ...
        /// <summary>
        /// Access to the actual embedded KiwiNumericUpDown instance.
        /// </summary>
        [Description("Access to the actual embedded KiwiNumericUpDown instance.")]
        [Browsable(false)]
        [EditorBrowsable(EditorBrowsableState.Always)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public KiwiNumericUpDown NumericUpDown
        {
        ...
        /// <summary>
        /// Gets and sets the KiwiContextMenu for showing when the numeric up down is right clicked.
        /// </summary>
        [Category("Behavior")]
        [Description("KiwiContextMenu to be shown when the numeric up down is right clicked.")]
        [DefaultValue(null)]
        public KiwiContextMenu KiwiContextMenu
        {
            get { return _numericUpDown.KiwiContextMenu; }
            set { _numericUpDown.KiwiContextMenu = value; }
        }
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        [Browsable(false)]
        public IKiwiDesignObject NumericUpDownDesigner
        {
        ...
        internal KiwiNumericUpDown LastNumericUpDown
        {
        ...
        private void MonitorControl(KiwiNumericUpDown c)
        {
        ...
        private void UnmonitorControl(KiwiNumericUpDown c)
        {
            c.MouseEnter -= new EventHandler(OnControlEnter);
            c.MouseLeave -= new EventHandler(OnControlLeave);
            c.TrackMouseEnter -= new EventHandler(OnControlEnter);
