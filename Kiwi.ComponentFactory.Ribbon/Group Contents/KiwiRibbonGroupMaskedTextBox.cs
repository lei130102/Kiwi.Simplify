...
namespace Kiwi.ComponentFactory.Ribbon
{
    ...
    //
    [ToolboxItem(false)]
    [Designer("Kiwi.ComponentFactory.Ribbon.KiwiRibbonGroupMaskedTextBoxDesigner, Kiwi.ComponentFactory.Ribbon, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    [DefaultEvent("TextChanged")]
    [DefaultProperty("Mask")]
    //
    [ToolboxBitmap(typeof(KiwiRibbonGroupMaskedTextBox), "ToolboxBitmaps.KiwiRibbonGroupMaskedTextBox.bmp")]
    public class KiwiRibbonGroupMaskedTextBox : KiwiRibbonGroupItem
    {
        ...
        private KiwiMaskedTextBox _lastMaskedTextBox;
        ...
        #region Identity
        /// <summary>
        /// Initialise a new instance of the KiwiRibbonGroupMaskedTextBox class.
        /// </summary>
        public KiwiRibbonGroupMaskedTextBox()
        {
            // Default fields
            _visible = true;
            _enabled = true;
            ...
            _maskedTextBox = new KiwiMaskedTextBox();
        ...
        /// <summary>
        /// Access to the actual embedded KiwiMaskedTextBox instance.
        /// </summary>
        [Description("Access to the actual embedded KiwiMaskedTextBox instance.")]
        [Browsable(false)]
        [EditorBrowsable(EditorBrowsableState.Always)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public KiwiMaskedTextBox MaskedTextBox
        {
        ...
        /// <summary>
        /// Gets and sets the KiwiContextMenu for showing when the masked textbox is right clicked.
        /// </summary>
        [Category("Behavior")]
        [Description("KiwiContextMenu to be shown when the masked textbox is right clicked.")]
        [DefaultValue(null)]
        public KiwiContextMenu KiwiContextMenu
        {
            get { return _maskedTextBox.KiwiContextMenu; }
            set { _maskedTextBox.KiwiContextMenu = value; }
        }
        ...
        public KiwiMaskedTextBox.MaskedTextBoxButtonSpecCollection ButtonSpecs
        {
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        [Browsable(false)]
        public IKiwiDesignObject MaskedTextBoxDesigner
        {
        ...
        internal KiwiMaskedTextBox LastMaskedTextBox
        {
        ...
        private void MonitorControl(KiwiMaskedTextBox c)
        {
        ...
        private void UnmonitorControl(KiwiMaskedTextBox c)
        {
            c.MouseEnter -= new EventHandler(OnControlEnter);
            c.MouseLeave -= new EventHandler(OnControlLeave);
            c.TrackMouseEnter -= new EventHandler(OnControlEnter);
