...
namespace Kiwi.ComponentFactory.Ribbon
{
    ...
    //
    [ToolboxItem(false)]
    [Designer("Kiwi.ComponentFactory.Ribbon.KiwiRibbonGroupRichTextBoxDesigner, Kiwi.ComponentFactory.Ribbon, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    [DefaultEvent("TextChanged")]
    [DefaultProperty("Text")]
    //
    [ToolboxBitmap(typeof(KiwiRibbonGroupRichTextBox), "ToolboxBitmaps.KiwiRibbonGroupRichTextBox.bmp")]
    public class KiwiRibbonGroupRichTextBox : KiwiRibbonGroupItem
    {
        ...
        private KiwiRichTextBox _richTextBox;
        private KiwiRichTextBox _lastRichTextBox;
        ...
        #region Identity
        /// <summary>
        /// Initialise a new instance of the KiwiRibbonGroupRichTextBox class.
        /// </summary>
        public KiwiRibbonGroupRichTextBox()
        {
            // Default fields
            _visible = true;
            _enabled = true;
            ...
            _richTextBox = new KiwiRichTextBox();
        ...
        /// <summary>
        /// Access to the actual embedded KiwiRichTextBox instance.
        /// </summary>
        [Description("Access to the actual embedded KiwiRichTextBox instance.")]
        [Browsable(false)]
        [EditorBrowsable(EditorBrowsableState.Always)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public KiwiRichTextBox RichTextBox
        {
        ...
        /// <summary>
        /// Gets and sets the KiwiContextMenu for showing when the rich text box is right clicked.
        /// </summary>
        [Category("Behavior")]
        [Description("KiwiContextMenu to be shown when the rich text box is right clicked.")]
        [DefaultValue(null)]
        public KiwiContextMenu KiwiContextMenu
        {
            get { return _richTextBox.KiwiContextMenu; }
            set { _richTextBox.KiwiContextMenu = value; }
        }
        ...
        /// <summary>
        /// Defines the current scaling factor of the KiwiRichTextBox display; 1.0 is normal viewing.
        /// </summary>
        [Category("Behavior")]
        [Description("Defines the current scaling factor of the KiwiRichTextBox display; 1.0 is normal viewing.")]
        [DefaultValue(1.0f)]
        [Localizable(true)]
        ...
        public KiwiRichTextBox.RichTextBoxButtonSpecCollection ButtonSpecs
        {
        ...
        /// <summary>
        /// Saves the contents of the KiwiRichTextBox to a specific type of file.
        /// </summary>
        /// <param name="path">The name and location of the file to save.</param>
        /// <param name="fileType">One of the RichTextBoxStreamType values.</param>
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        [Browsable(false)]
        public IKiwiDesignObject RichTextBoxDesigner
        {
        ...
        internal KiwiRichTextBox LastRichTextBox
        {
        ...
        private void MonitorControl(KiwiRichTextBox c)
        {
        ...
        private void UnmonitorControl(KiwiRichTextBox c)
        {
            c.MouseEnter -= new EventHandler(OnControlEnter);
            c.MouseLeave -= new EventHandler(OnControlLeave);
            c.TrackMouseEnter -= new EventHandler(OnControlEnter);
