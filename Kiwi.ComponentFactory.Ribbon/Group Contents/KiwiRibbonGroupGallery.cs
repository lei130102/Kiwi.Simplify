...
namespace Kiwi.ComponentFactory.Ribbon
{
    ...
    //
    [ToolboxItem(false)]
    [Designer("Kiwi.ComponentFactory.Ribbon.KiwiRibbonGroupGalleryDesigner, Kiwi.ComponentFactory.Ribbon, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    [DefaultProperty("Visible")]
    //
    [ToolboxBitmap(typeof(KiwiRibbonGroupGallery), "ToolboxBitmaps.KiwiGallery.bmp")]
    public class KiwiRibbonGroupGallery : KiwiRibbonGroupContainer
    {
        ...
        private KiwiGallery _lastGallery;
        ...
        #region Identity
        /// <summary>
        /// Initialise a new instance of the KiwiRibbonGroupGallery class.
        /// </summary>
        public KiwiRibbonGroupGallery()
        {
            // Default fields
            _visible = true;
            _enabled = true;
        ...
        #region Public
        /// <summary>
        /// Access to the actual embedded KiwiGallery instance.
        /// </summary>
        [Description("Access to the actual embedded KiwiGallery instance.")]
        [Browsable(false)]
        [EditorBrowsable(EditorBrowsableState.Always)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public KiwiGallery Gallery
        {
            get { return _gallery; }
        }
        ...
        /// <summary>
        /// Gets and sets the KiwiContextMenu for showing when the gallery is right clicked.
        /// </summary>
        [Category("Behavior")]
        [Description("KiwiContextMenu to be shown when the gallery is right clicked.")]
        [DefaultValue(null)]
        public KiwiContextMenu KiwiContextMenu
        {
            get { return _gallery.KiwiContextMenu; }
            set { _gallery.KiwiContextMenu = value; }
        }
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        [Browsable(false)]
        public IKiwiDesignObject GalleryDesigner
        {
        ...
        internal KiwiGallery LastGallery
        {
