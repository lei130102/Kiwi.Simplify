...
namespace Kiwi.ComponentFactory.Ribbon
{
    ...
    //
    [ToolboxItem(false)]
    [Designer("Kiwi.ComponentFactory.Ribbon.KiwiRibbonGroupDateTimePickerDesigner, Kiwi.ComponentFactory.Ribbon, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    ...
    //
    [ToolboxBitmap(typeof(KiwiRibbonGroupDateTimePicker), "ToolboxBitmaps.KiwiRibbonGroupDateTimePicker.bmp")]
    public class KiwiRibbonGroupDateTimePicker : KiwiRibbonGroupItem
    {
        ...
        private KiwiDateTimePicker _lastDateTimePicker;
        ...
        #region Identity
        /// <summary>
        /// Initialise a new instance of the KiwiRibbonGroupDateTimePicker class.
        /// </summary>
        public KiwiRibbonGroupDateTimePicker()
        {
            // Default fields
            _visible = true;
            ...
            _dateTimePicker = new KiwiDateTimePicker();
        ...
        /// <summary>
        /// Access to the actual embedded KiwinDateTimePicker instance.
        /// </summary>
        [Description("Access to the actual embedded KiwiDateTimePicker instance.")]
        [Browsable(false)]
        [EditorBrowsable(EditorBrowsableState.Always)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public KiwiDateTimePicker DateTimePicker
        {
        ...
        /// <summary>
        /// Gets and sets the KiwiContextMenu for showing when the date time picker is right clicked.
        /// </summary>
        [Category("Behavior")]
        [Description("KiwiContextMenu to be shown when the date time picker is right clicked.")]
        [DefaultValue(null)]
        public KiwiContextMenu KiwiContextMenu
        {
            get { return _dateTimePicker.KiwiContextMenu; }
            set { _dateTimePicker.KiwiContextMenu = value; }
        }
        ...
        public KiwiDateTimePicker.DateTimePickerButtonSpecCollection ButtonSpecs
        {
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        [Browsable(false)]
        public IKiwiDesignObject DateTimePickerDesigner
        {
        ...
        internal KiwiDateTimePicker LastDateTimePicker
        {
        ...
        private void MonitorControl(KiwiDateTimePicker c)
        {
            c.MouseEnter += new EventHandler(OnControlEnter);
            c.MouseLeave += new EventHandler(OnControlLeave);
        }

        private void UnmonitorControl(KiwiDateTimePicker c)
        {
            c.MouseEnter -= new EventHandler(OnControlEnter);
            c.MouseLeave -= new EventHandler(OnControlLeave);
        }
