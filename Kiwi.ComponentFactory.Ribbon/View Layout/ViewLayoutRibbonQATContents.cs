...
namespace Kiwi.ComponentFactory.Ribbon
{
    ...
    internal abstract class ViewLayoutRibbonQATContents : ViewComposite
    {
        ...
        public ViewLayoutRibbonQATContents(KiwiRibbon ribbon,
        ...
        /// </summary>
        /// <param name="ownerForm">KiwiForm instance that owns this view.</param>
        /// <returns>Array of KeyTipInfo instances.</returns>
        public KeyTipInfo[] GetQATKeyTips(KiwiForm ownerForm)
        {
