...
namespace Kiwi.ComponentFactory.Ribbon
{
    ...
    internal class ViewLayoutRibbonTabsArea : ViewLayoutDocker
    {
        ...
        public class RibbonButtonSpecFixedCollection : ButtonSpecCollection<ButtonSpec>
        {
            ...
            public RibbonButtonSpecFixedCollection(KiwiRibbon owner)
                : base(owner)
            {
            }
            #endregion
        ...
        public ViewLayoutRibbonTabsArea(KiwiRibbon ribbon,
                    ...
                    if (!CommonHelper.IsFormMinimized(topForm))
                    {
                        ...
                        else
                        {
                                ...
                                (_setVisible != show))
                            {
                                ...
                                {
                                    _paintCount = _captionArea.KiwiForm.PaintCount;
        ...
        public override void Layout(ViewLayoutContext context)
        {
            ...
            if (_captionArea.UsingCustomChrome && !_captionArea.KiwiForm.ApplyComposition)
            {
                _paintCount = _captionArea.KiwiForm.PaintCount;
                _invalidateTimer.Start();
            }
        ...
        private void OnRedrawTick(object sender, EventArgs e)
        {
            ...
            if ((_captionArea != null) &&
                (_captionArea.KiwiForm != null) &&
                _captionArea.UsingCustomChrome)
            {
                if (_captionArea.KiwiForm.PaintCount == _paintCount)
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if ((e.Target.Parent != null) && (e.Target.Parent is ViewDrawRibbonGroupLabel))
                            {
                                ...
                                // Create a content that recovers values from a KiwiRibbonGroupItem
