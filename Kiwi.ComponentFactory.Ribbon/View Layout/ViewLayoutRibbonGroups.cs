...
namespace Kiwi.ComponentFactory.Ribbon
{
    ...
    {
        #region Classes
        private class GroupToView : Dictionary<KiwiRibbonGroup, ViewDrawRibbonGroup> { };
        ...
        public ViewLayoutRibbonGroups(KiwiRibbon ribbon,
                                      KiwiRibbonTab ribbonTab,
        ...
        private void SyncChildrenToRibbonGroups()
        {
            ...
            foreach (KiwiRibbonGroup group in _ribbonTab.Groups)
            {
            ...
            {
                KiwiRibbonGroup ribbonGroup = _ribbonTab.Groups[i];
