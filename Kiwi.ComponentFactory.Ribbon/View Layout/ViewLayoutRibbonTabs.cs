...
namespace Kiwi.ComponentFactory.Ribbon
{
    ...
    internal class ViewLayoutRibbonTabs : ViewComposite
    {
        ...
        public ViewLayoutRibbonTabs(KiwiRibbon ribbon,
        ...
        public ViewDrawRibbonTab GetViewForRibbonTab(KiwiRibbonTab ribbonTab)
        {
        ...
        /// <returns>View element for a tab; otherwise null.</returns>
        public ViewDrawRibbonTab GetViewForNextRibbonTab(KiwiRibbonTab ribbonTab)
        {
            bool found = false;
            foreach (ViewBase child in this)
            {
        ...
        /// <param name="ribbonTab">Current ribbon tab to use when searching.</param>
        /// <returns>View element for a tab; otherwise null.</returns>
        public ViewDrawRibbonTab GetViewForPreviousRibbonTab(KiwiRibbonTab ribbonTab)
        {
            bool found = false;
        ...
        {
            KiwiRibbonTab selectTab = _ribbon.SelectedTab;

            // Scan to find the prev and next tabs
            bool prevSelected = false;
            KiwiRibbonTab prev = null;
            foreach (ViewBase child in this)
            {
        ...
        public override void Layout(ViewLayoutContext context)
        {
            ...
            if (_ribbon.CaptionArea.KiwiForm != null)
            {
                if (!customCaptionRect.IsEmpty)
                {
                    ...
                    customCaptionRect = _ribbon.CaptionArea.KiwiForm.RectangleToClient(customCaptionRect);
                }

                _ribbon.CaptionArea.KiwiForm.CustomCaptionArea = customCaptionRect;
            }
        ...
        private void AddTabsWithContextName(string contextName)
        {
            ...
            {
                KiwiRibbonTab ribbonTab = _ribbon.RibbonTabs[i];
        ...
        private void UpdateContextNameCache()
        {
            ...
            if (_ribbon.InDesignHelperMode)
            {
                ...
                foreach (KiwiRibbonContext context in _ribbon.RibbonContexts)
        ...
        private bool IsRibbonVisible(KiwiRibbonTab tab, string contextName)
        {
