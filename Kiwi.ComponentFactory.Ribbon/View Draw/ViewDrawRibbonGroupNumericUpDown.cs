...
namespace Kiwi.ComponentFactory.Ribbon
{
                                                      ...
                                                      IRibbonViewGroupItemView
    {
        ...
        public ViewDrawRibbonGroupNumericUpDown(KiwiRibbon ribbon,
                                                KiwiRibbonGroupNumericUpDown ribbonNumericUpDown,
        ...
        /// </summary>
        public KiwiRibbonGroupNumericUpDown GroupNumericUpDown
        {
        ...
        private KiwiNumericUpDown LastNumericUpDown
        {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if ((_ribbonNumericUpDown.RibbonContainer.RibbonGroup.IsCollapsed) &&
                                ((_ribbon.GetControllerControl(_ribbonNumericUpDown.NumericUpDown) is KiwiRibbon) ||
                            ...
                            else
                            {
                                ...
                                KiwiRibbonGroupContainer container = _ribbonNumericUpDown.RibbonContainer;
