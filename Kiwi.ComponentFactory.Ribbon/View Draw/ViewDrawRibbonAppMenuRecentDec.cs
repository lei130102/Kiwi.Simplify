...
namespace Kiwi.ComponentFactory.Ribbon
{
    ...
    internal class ViewDrawRibbonAppMenuRecentDec : ViewDrawCanvas
    {
        ...
        private KiwiRibbonRecentDoc _recentDoc;
        #endregion
        ...
        public ViewDrawRibbonAppMenuRecentDec(KiwiRibbon ribbon,
                                              IContextMenuProvider provider,
                                              KiwiRibbonRecentDoc recentDoc,
                                              int maxWidth,
        ...
        /// </summary>
        public KiwiRibbonRecentDoc RecentDoc
        {
