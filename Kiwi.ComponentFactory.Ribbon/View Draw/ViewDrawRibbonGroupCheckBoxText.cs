...
namespace Kiwi.ComponentFactory.Ribbon
{
                                                     ...
                                                     IContentValues
    {
        ...
        public ViewDrawRibbonGroupCheckBoxText(KiwiRibbon ribbon,
                                               KiwiRibbonGroupCheckBox ribbonCheckBox,
                                               bool firstText)
        {
        ...
        {
            if (_ribbonCheckBox.KiwiCommand != null)
            {
                if (_firstText)
                    return _ribbonCheckBox.KiwiCommand.TextLine1;
                else if (!string.IsNullOrEmpty(_ribbonCheckBox.KiwiCommand.TextLine2))
                    return _ribbonCheckBox.KiwiCommand.TextLine2;
                else
                    return " ";
            }
            else if (_firstText)
