...
namespace Kiwi.ComponentFactory.Ribbon
{
                                                      ...
                                                      IRibbonViewGroupItemView
    {
        ...
        public ViewDrawRibbonGroupMaskedTextBox(KiwiRibbon ribbon,
                                                KiwiRibbonGroupMaskedTextBox ribbonMaskedTextBox,
        ...
        /// </summary>
        public KiwiRibbonGroupMaskedTextBox GroupMaskedTextBox
        {
        ...
        private KiwiMaskedTextBox LastMaskedTextBox
        {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if ((_ribbonMaskedTextBox.RibbonContainer.RibbonGroup.IsCollapsed) &&
                                ((_ribbon.GetControllerControl(_ribbonMaskedTextBox.MaskedTextBox) is KiwiRibbon) ||
                            ...
                            else
                            {
                                ...
                                KiwiRibbonGroupContainer container = _ribbonMaskedTextBox.RibbonContainer;
