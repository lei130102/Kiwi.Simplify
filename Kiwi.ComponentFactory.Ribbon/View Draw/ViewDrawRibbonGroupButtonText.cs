...
namespace Kiwi.ComponentFactory.Ribbon
{
                                                   ...
                                                   IContentValues
    {
        ...
        public ViewDrawRibbonGroupButtonText(KiwiRibbon ribbon,
        ...
        public string GetShortText()
        {
            ...
            {
                if (_firstText)
                    return _ribbonButton.KiwiCommand.TextLine1;
                else if (!string.IsNullOrEmpty(_ribbonButton.KiwiCommand.TextLine2))
                    return _ribbonButton.KiwiCommand.TextLine2;
                else
                    return " ";
            }
            else if (_firstText)
