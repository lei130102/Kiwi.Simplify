...
namespace Kiwi.ComponentFactory.Ribbon
{
                                                        ...
                                                        IContentValues
    {
        ...
        public ViewDrawRibbonGroupColorButtonText(KiwiRibbon ribbon,
                                                  KiwiRibbonGroupColorButton ribbonColorButton,
                                                  bool firstText)
        {
        ...
        public string GetShortText()
        {
            ...
            {
                if (_firstText)
                    return _ribbonColorButton.KiwiCommand.TextLine1;
                else if (!string.IsNullOrEmpty(_ribbonColorButton.KiwiCommand.TextLine2))
                    return _ribbonColorButton.KiwiCommand.TextLine2;
                else
                    return " ";
            }
            else if (_firstText)
