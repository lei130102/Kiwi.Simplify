...
namespace Kiwi.ComponentFactory.Ribbon
{
                                                 ...
                                                 IRibbonViewGroupItemView
    {
        ...
        public ViewDrawRibbonGroupTrackBar(KiwiRibbon ribbon,
                                           KiwiRibbonGroupTrackBar ribbonTrackBar,
        ...
        /// </summary>
        public KiwiRibbonGroupTrackBar GroupTrackBar
        {
        ...
        private KiwiTrackBar LastTrackBar
        {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if ((_ribbonTrackBar.RibbonContainer.RibbonGroup.IsCollapsed) &&
                                ((_ribbon.GetControllerControl(_ribbonTrackBar.TrackBar) is KiwiRibbon) ||
                            ...
                            else
                            {
                                ...
                                KiwiRibbonGroupContainer container = _ribbonTrackBar.RibbonContainer;
