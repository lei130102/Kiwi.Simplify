...
namespace Kiwi.ComponentFactory.Ribbon
{
                                                 ...
                                                 IContentValues
    {
        ...
        public ViewDrawRibbonGroupCheckBox(KiwiRibbon ribbon,
        ...
        /// </summary>
        public KiwiRibbonGroupCheckBox GroupCheckBox
        {
        ...
        private void UpdateEnabledState()
        {
            ...
            if (_ribbonCheckBox.KiwiCommand != null)
                buttonEnabled = _ribbonCheckBox.KiwiCommand.Enabled;
        ...
        private void UpdateCheckState()
        {
            ...
            if (_ribbonCheckBox.KiwiCommand != null)
                newCheckState = _ribbonCheckBox.KiwiCommand.CheckState;
            else
