...
namespace Kiwi.ComponentFactory.Ribbon
{
                                                    ...
                                                    IRibbonViewGroupItemView
    {
        ...
        public ViewDrawRibbonGroupRichTextBox(KiwiRibbon ribbon,
                                              KiwiRibbonGroupRichTextBox ribbonRichTextBox,
        ...
        /// </summary>
        public KiwiRibbonGroupRichTextBox GroupRichTextBox
        {
        ...
        private KiwiRichTextBox LastRichTextBox
        {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if ((_ribbonRichTextBox.RibbonContainer.RibbonGroup.IsCollapsed) &&
                                ((_ribbon.GetControllerControl(_ribbonRichTextBox.RichTextBox) is KiwiRibbon) ||
                            ...
                            else
                            {
                                ...
                                KiwiRibbonGroupContainer container = _ribbonRichTextBox.RibbonContainer;
