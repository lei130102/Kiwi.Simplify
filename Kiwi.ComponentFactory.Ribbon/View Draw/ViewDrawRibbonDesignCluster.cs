...
namespace Kiwi.ComponentFactory.Ribbon
{
    ...
    internal class ViewDrawRibbonDesignCluster : ViewDrawRibbonDesignBase
    {
        ...
        static ViewDrawRibbonDesignCluster()
        {
            ...
            _imageList.Images.AddRange(new Image[]{Properties.Resources.KiwiRibbonGroupClusterButton,
                                                   Properties.Resources.KiwiRibbonGroupClusterColorButton});
        }
        ...
        public ViewDrawRibbonDesignCluster(KiwiRibbon ribbon,
                                           KiwiRibbonGroupCluster ribbonCluster,
