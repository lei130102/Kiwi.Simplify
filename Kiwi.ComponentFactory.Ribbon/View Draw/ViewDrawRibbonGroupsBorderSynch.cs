...
namespace Kiwi.ComponentFactory.Ribbon
{
    ...
    {
        #region Classes
        private class TabToView : Dictionary<KiwiRibbonTab, ViewLayoutRibbonScrollPort> { };
        #endregion
        ...
        public ViewDrawRibbonGroupsBorderSynch(KiwiRibbon ribbon,
        ...
        public KeyTipInfo[] GetGroupKeyTips(KiwiRibbonTab tab)
        {
        ...
        private void SyncChildrenToRibbonTabs()
        {
            ...
            foreach (KiwiRibbonTab tab in Ribbon.RibbonTabs)
            {
