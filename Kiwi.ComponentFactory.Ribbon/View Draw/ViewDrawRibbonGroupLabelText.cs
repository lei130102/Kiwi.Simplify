...
namespace Kiwi.ComponentFactory.Ribbon
{
                                                  ...
                                                  IContentValues
    {
        ...
        public ViewDrawRibbonGroupLabelText(KiwiRibbon ribbon,
        ...
        {
            if (_ribbonLabel.KiwiCommand != null)
            {
                if (_firstText)
                    return _ribbonLabel.KiwiCommand.TextLine1;
                else if (!string.IsNullOrEmpty(_ribbonLabel.KiwiCommand.TextLine2))
                    return _ribbonLabel.KiwiCommand.TextLine2;
                else
                    return " ";
            }
            else if (_firstText)
