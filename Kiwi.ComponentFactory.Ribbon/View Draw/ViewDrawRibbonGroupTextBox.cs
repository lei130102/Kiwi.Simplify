...
namespace Kiwi.ComponentFactory.Ribbon
{
                                                ...
                                                IRibbonViewGroupItemView
    {
        ...
        public ViewDrawRibbonGroupTextBox(KiwiRibbon ribbon,
                                          KiwiRibbonGroupTextBox ribbonTextBox,
        ...
        /// </summary>
        public KiwiRibbonGroupTextBox GroupTextBox
        {
        ...
        private KiwiTextBox LastTextBox
        {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if ((_ribbonTextBox.RibbonContainer.RibbonGroup.IsCollapsed) &&
                                ((_ribbon.GetControllerControl(_ribbonTextBox.TextBox) is KiwiRibbon) ||
                            ...
                            else
                            {
                                ...
                                KiwiRibbonGroupContainer container = _ribbonTextBox.RibbonContainer;
