...
namespace Kiwi.ComponentFactory.Ribbon
{
                                                           ...
                                                           IRibbonViewGroupItemView
    {
        ...
        public ViewDrawRibbonGroupClusterColorButton(KiwiRibbon ribbon,
                                                     KiwiRibbonGroupClusterColorButton ribbonButton,
        ...
        public override string ToString()
        {
            ...
            return "KiwiRibbonGroupClusterColorButton:" + Id;
        }
        ...
        /// </summary>
        public KiwiRibbonGroupClusterColorButton GroupClusterColorButton
        {
        ...
        private void UpdateEnabledState()
        {
            ...
            if (_ribbonColorButton.KiwiCommand != null)
                buttonEnabled = _ribbonColorButton.KiwiCommand.Enabled;
        ...
        private void UpdateCheckedState()
        {
            ...
            {
                if (_ribbonColorButton.KiwiCommand != null)
                    checkedState = _ribbonColorButton.KiwiCommand.Checked;
                else
