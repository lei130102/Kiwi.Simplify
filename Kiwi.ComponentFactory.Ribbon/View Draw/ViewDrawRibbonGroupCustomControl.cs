...
namespace Kiwi.ComponentFactory.Ribbon
{
                                                      ...
                                                      IRibbonViewGroupItemView
    {
        ...
        public ViewDrawRibbonGroupCustomControl(KiwiRibbon ribbon,
                                                KiwiRibbonGroupCustomControl ribbonCustom,
        ...
        /// </summary>
        public KiwiRibbonGroupCustomControl GroupCustomControl
        {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if ((_ribbonCustomControl.RibbonContainer.RibbonGroup.IsCollapsed) &&
                                ((_ribbon.GetControllerControl(_ribbonCustomControl.LastCustomControl) is KiwiRibbon) ||
                            ...
                            else
                            {
                                ...
                                KiwiRibbonGroupContainer container = _ribbonCustomControl.RibbonContainer;
