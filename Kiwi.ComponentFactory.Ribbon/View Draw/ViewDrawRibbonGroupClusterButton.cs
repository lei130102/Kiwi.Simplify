...
namespace Kiwi.ComponentFactory.Ribbon
{
                                                      ...
                                                      IRibbonViewGroupItemView
    {
        ...
        public ViewDrawRibbonGroupClusterButton(KiwiRibbon ribbon,
        ...
        /// </summary>
        public KiwiRibbonGroupClusterButton GroupClusterButton
        {
        ...
        private void UpdateEnabledState()
        {
            ...
            if (_ribbonButton.KiwiCommand != null)
                buttonEnabled = _ribbonButton.KiwiCommand.Enabled;
        ...
        private void UpdateCheckedState()
        {
            ...
            {
                if (_ribbonButton.KiwiCommand != null)
                    checkedState = _ribbonButton.KiwiCommand.Checked;
                else
