...
namespace Kiwi.ComponentFactory.Ribbon
{
...

    {
        ...
        public ViewDrawRibbonGroupColorButtonImage(KiwiRibbon ribbon,
        ...
        protected override Image DrawImage
        {
            get
            {
                ...
                {
                    if (_large)
                        newImage = _ribbonColorButton.KiwiCommand.ImageLarge;
                    else
                        newImage = _ribbonColorButton.KiwiCommand.ImageSmall;
                }
                else
                {
                    if (_large)
