...
namespace Kiwi.ComponentFactory.Ribbon
{
                                                ...
                                                IRibbonViewGroupContainerView
    {
        ...
        public ViewDrawRibbonGroupGallery(KiwiRibbon ribbon,
        ...
        /// </summary>
        public KiwiRibbonGroupGallery GroupGallery
        {
        ...
        private KiwiGallery LastGallery
        {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if ((_ribbonGallery.RibbonGroup.IsCollapsed) &&
                                ((_ribbon.GetControllerControl(_ribbonGallery.Gallery) is KiwiRibbon) ||
