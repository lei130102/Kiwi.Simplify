...
namespace Kiwi.ComponentFactory.Ribbon
{
    ...
    public class RibbonAppButton : Storage
    {
        ...
        public class AppMenuButtonSpecCollection : ButtonSpecCollection<ButtonSpecAppMenu>
        {
            ...
            public AppMenuButtonSpecCollection(KiwiRibbon owner)
                : base(owner)
            {
            }
            #endregion
        ...
        private KiwiContextMenuItems _appButtonMenuItems;
        private KiwiRibbonRecentDocCollection _appButtonRecentDocs;
        ...
        public RibbonAppButton(KiwiRibbon ribbon)
        {
            Debug.Assert(ribbon != null);
            _ribbon = ribbon;

            // Default values
            _appButtonMenuItems = new KiwiContextMenuItems();
            ...
            _appButtonRecentDocs = new KiwiRibbonRecentDocCollection();
        ...
        [Editor("Kiwi.ComponentFactory.Toolkit.KiwiContextMenuItemCollectionEditor, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704", typeof(UITypeEditor))]
        public virtual KiwiContextMenuItemCollection AppButtonMenuItems
        {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        [Editor("Kiwi.ComponentFactory.Ribbon.KiwiRibbonRecentDocCollectionEditor, Kiwi.ComponentFactory.Ribbon, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704", typeof(UITypeEditor))]
        public virtual KiwiRibbonRecentDocCollection AppButtonRecentDocs
        {
