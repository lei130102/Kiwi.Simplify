...
{
    internal class KiwiRibbonGroupLabelDesigner : ComponentDesigner
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiRibbonGroupLabelDesigner class.
        /// </summary>
        public KiwiRibbonGroupLabelDesigner()
        {
        }
        #endregion
        ...
        public override void Initialize(IComponent component)
        {
            ...
            _ribbonLabel = (KiwiRibbonGroupLabel)component;
        ...
        private void OnMoveFirst(object sender, EventArgs e)
        {
            if ((_ribbonLabel != null) && (_ribbonLabel.Ribbon != null))
            {
                ...
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupLabel MoveFirst");
        ...
        private void OnMovePrevious(object sender, EventArgs e)
        {
            if ((_ribbonLabel != null) && (_ribbonLabel.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupLabel MovePrevious");
        ...
        private void OnMoveNext(object sender, EventArgs e)
        {
            if ((_ribbonLabel != null) && (_ribbonLabel.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupLabel MoveNext");
        ...
        private void OnMoveLast(object sender, EventArgs e)
        {
            if ((_ribbonLabel != null) && (_ribbonLabel.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupLabel MoveLast");
        ...
        private void OnDeleteLabel(object sender, EventArgs e)
        {
            if ((_ribbonLabel != null) && (_ribbonLabel.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupLabel DeleteLabel");
        ...
        private TypedRestrictCollection<KiwiRibbonGroupItem> ParentItems
        {
            get
            {
                if (_ribbonLabel.RibbonContainer is KiwiRibbonGroupTriple)
                {
                    KiwiRibbonGroupTriple triple = (KiwiRibbonGroupTriple)_ribbonLabel.RibbonContainer;
                    return triple.Items;
                }
                else if (_ribbonLabel.RibbonContainer is KiwiRibbonGroupLines)
                {
                    KiwiRibbonGroupLines lines = (KiwiRibbonGroupLines)_ribbonLabel.RibbonContainer;
                    return lines.Items;
                }
                else
                {
