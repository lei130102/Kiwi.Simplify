...
{
    internal class KiwiRibbonGroupCheckBoxDesigner : ComponentDesigner
    {
        #region Instance Fields
        private IDesignerHost _designerHost;
        private IComponentChangeService _changeService;
        private KiwiRibbonGroupCheckBox _ribbonCheckBox;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiRibbonGroupCheckBoxDesigner class.
        /// </summary>
        public KiwiRibbonGroupCheckBoxDesigner()
        {
        }
        #endregion
        ...
        public override void Initialize(IComponent component)
        {
            ...
            _ribbonCheckBox = (KiwiRibbonGroupCheckBox)component;
        ...
        private void OnMoveFirst(object sender, EventArgs e)
        {
            if ((_ribbonCheckBox != null) && (_ribbonCheckBox.Ribbon != null))
            {
                ...
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupCheckBox MoveFirst");
        ...
        private void OnMovePrevious(object sender, EventArgs e)
        {
            if ((_ribbonCheckBox != null) && (_ribbonCheckBox.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupCheckBox MovePrevious");
        ...
        private void OnMoveNext(object sender, EventArgs e)
        {
            if ((_ribbonCheckBox != null) && (_ribbonCheckBox.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupCheckBox MoveNext");
        ...
        private void OnMoveLast(object sender, EventArgs e)
        {
            if ((_ribbonCheckBox != null) && (_ribbonCheckBox.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupCheckBox MoveLast");
        ...
        private void OnDeleteCheckBox(object sender, EventArgs e)
        {
            if ((_ribbonCheckBox != null) && (_ribbonCheckBox.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupCheckBox DeleteCheckBox");
        ...
        private TypedRestrictCollection<KiwiRibbonGroupItem> ParentItems
        {
            get
            {
                if (_ribbonCheckBox.RibbonContainer is KiwiRibbonGroupTriple)
                {
                    KiwiRibbonGroupTriple triple = (KiwiRibbonGroupTriple)_ribbonCheckBox.RibbonContainer;
                    return triple.Items;
                }
                else if (_ribbonCheckBox.RibbonContainer is KiwiRibbonGroupLines)
                {
                    KiwiRibbonGroupLines lines = (KiwiRibbonGroupLines)_ribbonCheckBox.RibbonContainer;
                    return lines.Items;
                }
                else
                {
