...
{
    internal class KiwiRibbonGroupNumericUpDownDesigner : ComponentDesigner, IKiwiDesignObject
    {
        #region Instance Fields
        private IDesignerHost _designerHost;
        private IComponentChangeService _changeService;
        private KiwiRibbonGroupNumericUpDown _ribbonNumericUpDown;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiRibbonGroupNumericUpDownDesigner class.
        /// </summary>
        public KiwiRibbonGroupNumericUpDownDesigner()
        {
        }
        #endregion
        ...
        public override void Initialize(IComponent component)
        {
            ...
            _ribbonNumericUpDown = (KiwiRibbonGroupNumericUpDown)component;
        ...
        protected override void PreFilterProperties(IDictionary properties)
        {
            ...
            for (int i = 0; i < strArray.Length; i++)
            {
                ...
                if (descrip != null)
                    properties[strArray[i]] = TypeDescriptor.CreateProperty(typeof(KiwiRibbonGroupNumericUpDownDesigner), descrip, attributes);
            }
        }
        #endregion
        ...
        private void OnMoveFirst(object sender, EventArgs e)
        {
            if ((_ribbonNumericUpDown != null) && (_ribbonNumericUpDown.Ribbon != null))
            {
                ...
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupNumericUpDown MoveFirst");
        ...
        private void OnMovePrevious(object sender, EventArgs e)
        {
            if ((_ribbonNumericUpDown != null) && (_ribbonNumericUpDown.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupNumericUpDown MovePrevious");
        ...
        private void OnMoveNext(object sender, EventArgs e)
        {
            if ((_ribbonNumericUpDown != null) && (_ribbonNumericUpDown.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupNumericUpDown MoveNext");
        ...
        private void OnMoveLast(object sender, EventArgs e)
        {
            if ((_ribbonNumericUpDown != null) && (_ribbonNumericUpDown.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupNumericUpDown MoveLast");
        ...
        private void OnDeleteNumericUpDown(object sender, EventArgs e)
        {
            if ((_ribbonNumericUpDown != null) && (_ribbonNumericUpDown.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupNumericUpDown DeleteNumericUpDown");
        ...
        private TypedRestrictCollection<KiwiRibbonGroupItem> ParentItems
        {
            get
            {
                if (_ribbonNumericUpDown.RibbonContainer is KiwiRibbonGroupTriple)
                {
                    KiwiRibbonGroupTriple triple = (KiwiRibbonGroupTriple)_ribbonNumericUpDown.RibbonContainer;
                    return triple.Items;
                }
                else if (_ribbonNumericUpDown.RibbonContainer is KiwiRibbonGroupLines)
                {
                    KiwiRibbonGroupLines lines = (KiwiRibbonGroupLines)_ribbonNumericUpDown.RibbonContainer;
                    return lines.Items;
                }
                else
                {
