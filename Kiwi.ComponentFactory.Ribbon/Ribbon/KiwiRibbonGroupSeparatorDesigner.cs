...
{
    internal class KiwiRibbonGroupSeparatorDesigner : ComponentDesigner
    {
        #region Instance Fields
        private IDesignerHost _designerHost;
        private IComponentChangeService _changeService;
        private KiwiRibbonGroupSeparator _ribbonSeparator;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiRibbonGroupSeparatorDesigner class.
        /// </summary>
        public KiwiRibbonGroupSeparatorDesigner()
        {
        }
        #endregion
        ...
        public override void Initialize(IComponent component)
        {
            ...
            _ribbonSeparator = (KiwiRibbonGroupSeparator)component;
        ...
        private void OnMoveFirst(object sender, EventArgs e)
        {
                 ...
                 _ribbonSeparator.RibbonGroup.Items.Contains(_ribbonSeparator))
            {
                ...
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupSeparator MoveFirst");
                ...
                try
                {
                    ...
                    KiwiRibbonGroup ribbonGroup = _ribbonSeparator.RibbonGroup;
        ...
        private void OnMovePrevious(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupSeparator MovePrevious");
        ...
        private void OnMoveNext(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupSeparator MoveNext");
        ...
        private void OnMoveLast(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupSeparator MoveLast");
        ...
        private void OnDeleteSeparator(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupSeparator DeleteSeparator");
        ...
        private void UpdateMoveToGroup()
        {
            ...
            if (_ribbonSeparator.Ribbon != null)
            {
                ...
                foreach (KiwiRibbonGroup group in _ribbonSeparator.RibbonTab.Groups)
                {
        ...
        private void OnMoveToGroup(object sender, EventArgs e)
        {
                 ...
                 _ribbonSeparator.RibbonGroup.Items.Contains(_ribbonSeparator))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupSeparator MoveSeparatorToGroup");
