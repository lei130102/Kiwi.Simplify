...
{
    internal class KiwiRibbonGroupMaskedTextBoxDesigner : ComponentDesigner, IKiwiDesignObject
    {
        #region Instance Fields
        private IDesignerHost _designerHost;
        private IComponentChangeService _changeService;
        private KiwiRibbonGroupMaskedTextBox _ribbonMaskedTextBox;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiRibbonGroupMaskedTextBoxDesigner class.
        /// </summary>
        public KiwiRibbonGroupMaskedTextBoxDesigner()
        {
        }
        #endregion
        ...
        public override void Initialize(IComponent component)
        {
            ...
            _ribbonMaskedTextBox = (KiwiRibbonGroupMaskedTextBox)component;
        ...
        protected override void PreFilterProperties(IDictionary properties)
        {
            ...
            for (int i = 0; i < strArray.Length; i++)
            {
                ...
                if (descrip != null)
                    properties[strArray[i]] = TypeDescriptor.CreateProperty(typeof(KiwiRibbonGroupMaskedTextBoxDesigner), descrip, attributes);
            }
        }
        #endregion
        ...
        private void OnMoveFirst(object sender, EventArgs e)
        {
            if ((_ribbonMaskedTextBox != null) && (_ribbonMaskedTextBox.Ribbon != null))
            {
                ...
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupMaskedTextBox MoveFirst");
        ...
        private void OnMovePrevious(object sender, EventArgs e)
        {
            if ((_ribbonMaskedTextBox != null) && (_ribbonMaskedTextBox.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupMaskedTextBox MovePrevious");
        ...
        private void OnMoveNext(object sender, EventArgs e)
        {
            if ((_ribbonMaskedTextBox != null) && (_ribbonMaskedTextBox.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupMaskedTextBox MoveNext");
        ...
        private void OnMoveLast(object sender, EventArgs e)
        {
            if ((_ribbonMaskedTextBox != null) && (_ribbonMaskedTextBox.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupMaskedTextBox MoveLast");
        ...
        private void OnDeleteTextBox(object sender, EventArgs e)
        {
            if ((_ribbonMaskedTextBox != null) && (_ribbonMaskedTextBox.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupMaskedTextBox DeleteTextBox");
        ...
        private TypedRestrictCollection<KiwiRibbonGroupItem> ParentItems
        {
            get
            {
                if (_ribbonMaskedTextBox.RibbonContainer is KiwiRibbonGroupTriple)
                {
                    KiwiRibbonGroupTriple triple = (KiwiRibbonGroupTriple)_ribbonMaskedTextBox.RibbonContainer;
                    return triple.Items;
                }
                else if (_ribbonMaskedTextBox.RibbonContainer is KiwiRibbonGroupLines)
                {
                    KiwiRibbonGroupLines lines = (KiwiRibbonGroupLines)_ribbonMaskedTextBox.RibbonContainer;
                    return lines.Items;
                }
                else
                {
