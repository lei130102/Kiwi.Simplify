...
{
    internal class KiwiRibbonGroupTripleDesigner : ComponentDesigner
    {
        #region Instance Fields
        private IDesignerHost _designerHost;
        private IComponentChangeService _changeService;
        private KiwiRibbonGroupTriple _ribbonTriple;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiRibbonGroupTripleDesigner class.
        /// </summary>
        public KiwiRibbonGroupTripleDesigner()
        {
        }
        #endregion
        ...
        public override void Initialize(IComponent component)
        {
            ...
            _ribbonTriple = (KiwiRibbonGroupTriple)component;
        ...
        private void OnMoveFirst(object sender, EventArgs e)
        {
                 ...
                 _ribbonTriple.RibbonGroup.Items.Contains(_ribbonTriple))
            {
                ...
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupTriple MoveFirst");
                ...
                try
                {
                    ...
                    KiwiRibbonGroup ribbonGroup = _ribbonTriple.RibbonGroup;
        ...
        private void OnMovePrevious(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupTriple MovePrevious");
        ...
        private void OnMoveNext(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupTriple MoveNext");
        ...
        private void OnMoveLast(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupTriple MoveLast");
        ...
        private void OnAddButton(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupTriple AddButton");
        ...
        private void OnAddColorButton(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupTriple AddColorButton");
        ...
        private void OnAddCheckBox(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupTriple AddCheckBox");
        ...
        private void OnAddRadioButton(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupTriple AddRadioButton");
        ...
        private void OnAddLabel(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupTriple AddLabel");
        ...
        private void OnAddCustomControl(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupTriple AddCustomControl");
        ...
        private void OnAddTextBox(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupTriple AddTextBox");
        ...
        private void OnAddTrackBar(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupTriple AddTrackBar");
        ...
        private void OnAddMaskedTextBox(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupTriple AddMaskedTextBox");
        ...
        private void OnAddRichTextBox(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupTriple AddRichTextBox");
        ...
        private void OnAddComboBox(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupTriple AddComboBox");
                ...
                try
                {
                    ...
                    KiwiRibbonGroupComboBox cc = (KiwiRibbonGroupComboBox)_designerHost.CreateComponent(typeof(KiwiRibbonGroupComboBox));
                    _ribbonTriple.Items.Add(cc);
        ...
        private void OnAddNumericUpDown(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupTriple AddNumericUpDown");
                ...
                try
                {
                    ...
                    KiwiRibbonGroupNumericUpDown cc = (KiwiRibbonGroupNumericUpDown)_designerHost.CreateComponent(typeof(KiwiRibbonGroupNumericUpDown));
                    _ribbonTriple.Items.Add(cc);
        ...
        private void OnAddDomainUpDown(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupTriple AddDomainUpDown");
                ...
                try
                {
                    ...
                    KiwiRibbonGroupDomainUpDown cc = (KiwiRibbonGroupDomainUpDown)_designerHost.CreateComponent(typeof(KiwiRibbonGroupDomainUpDown));
                    _ribbonTriple.Items.Add(cc);
        ...
        private void OnAddDateTimePicker(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupTriple AddDateTimePicker");
                ...
                try
                {
                    ...
                    // Get designer to create a domain up-down item
                    KiwiRibbonGroupDateTimePicker cc = (KiwiRibbonGroupDateTimePicker)_designerHost.CreateComponent(typeof(KiwiRibbonGroupDateTimePicker));
                    _ribbonTriple.Items.Add(cc);
        ...
        private void OnClearItems(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupTriple ClearItems");
                ...
                try
                {
                    ...
                    {
                        KiwiRibbonGroupItem item = _ribbonTriple.Items[i];
        ...
        private void OnDeleteTriple(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupTriple DeleteTriple");
        ...
        private void OnComponentRemoving(object sender, ComponentEventArgs e)
        {
            ...
            if (e.Component == _ribbonTriple)
            {
                ...
                {
                    KiwiRibbonGroupItem item = _ribbonTriple.Items[j] as KiwiRibbonGroupItem;
                    _ribbonTriple.Items.Remove(item);
                    host.DestroyComponent(item);
                }
            }
        ...
        private void UpdateMoveToGroup()
        {
            ...
            if (_ribbonTriple.Ribbon != null)
            {
                ...
                foreach (KiwiRibbonGroup group in _ribbonTriple.RibbonTab.Groups)
                {
        ...
        private void OnMoveToGroup(object sender, EventArgs e)
        {
                 ...
                 _ribbonTriple.RibbonGroup.Items.Contains(_ribbonTriple))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupTriple MoveTripleToGroup");
