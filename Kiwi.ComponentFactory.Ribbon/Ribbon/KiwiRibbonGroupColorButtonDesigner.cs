...
{
    internal class KiwiRibbonGroupColorButtonDesigner : ComponentDesigner
    {
        #region Instance Fields
        private IDesignerHost _designerHost;
        private IComponentChangeService _changeService;
        private KiwiRibbonGroupColorButton _ribbonColorButton;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiRibbonGroupColorButtonDesigner class.
        /// </summary>
        public KiwiRibbonGroupColorButtonDesigner()
        {
        }
        #endregion
        ...
        public override void Initialize(IComponent component)
        {
            ...
            _ribbonColorButton = (KiwiRibbonGroupColorButton)component;
        ...
        private void OnMoveFirst(object sender, EventArgs e)
        {
            if ((_ribbonColorButton != null) && (_ribbonColorButton.Ribbon != null))
            {
                ...
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupColorButton MoveFirst");
        ...
        private void OnMovePrevious(object sender, EventArgs e)
        {
            if ((_ribbonColorButton != null) && (_ribbonColorButton.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupColorButton MovePrevious");
        ...
        private void OnMoveNext(object sender, EventArgs e)
        {
            if ((_ribbonColorButton != null) && (_ribbonColorButton.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupColorButton MoveNext");
        ...
        private void OnMoveLast(object sender, EventArgs e)
        {
            if ((_ribbonColorButton != null) && (_ribbonColorButton.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupColorButton MoveLast");
        ...
        private void OnDeleteButton(object sender, EventArgs e)
        {
            if ((_ribbonColorButton != null) && (_ribbonColorButton.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupColorButton DeleteButton");
        ...
        private TypedRestrictCollection<KiwiRibbonGroupItem> ParentItems
        {
            get
            {
                if (_ribbonColorButton.RibbonContainer is KiwiRibbonGroupTriple)
                {
                    KiwiRibbonGroupTriple triple = (KiwiRibbonGroupTriple)_ribbonColorButton.RibbonContainer;
                    return triple.Items;
                }
                else if (_ribbonColorButton.RibbonContainer is KiwiRibbonGroupLines)
                {
                    KiwiRibbonGroupLines lines = (KiwiRibbonGroupLines)_ribbonColorButton.RibbonContainer;
                    return lines.Items;
                }
                else
                {
