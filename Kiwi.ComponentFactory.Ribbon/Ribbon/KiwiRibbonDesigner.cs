...
{
    internal class KiwiRibbonDesigner : ParentControlDesigner
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiRibbonDesigner class.
		/// </summary>
        public KiwiRibbonDesigner()
        {
        ...
        public override ICollection AssociatedComponents
        {
            get
            {
                ...
                foreach (KiwiRibbonTab ribbonTab in _ribbon.RibbonTabs)
        ...
        public override DesignerActionListCollection ActionLists
        {
            get
            {
                ...
                actionLists.Add(new KiwiRibbonActionList(this));
        ...
        private void OnAddTab(object sender, EventArgs e)
        {
            ...
            DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbon AddTab");
            ...
            try
            {
                ...
                KiwiRibbonTab page = (KiwiRibbonTab)_designerHost.CreateComponent(typeof(KiwiRibbonTab));
        ...
        {
            // Use a transaction to support undo/redo actions
            DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbon ClearTabs");
            ...
            try
            {
                ...
                {
                    KiwiRibbonTab tab = _ribbon.RibbonTabs[i];
        ...
        private void OnComponentRemoving(object sender, ComponentEventArgs e)
        {
            ...
            if (e.Component == _ribbon)
            {
                ...
                {
                    KiwiRibbonContext context = _ribbon.RibbonContexts[i];
