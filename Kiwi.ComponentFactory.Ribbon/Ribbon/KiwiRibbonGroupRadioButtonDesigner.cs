...
{
    internal class KiwiRibbonGroupRadioButtonDesigner : ComponentDesigner
    {
        #region Instance Fields
        private IDesignerHost _designerHost;
        private IComponentChangeService _changeService;
        private KiwiRibbonGroupRadioButton _ribbonRadioButton;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiRibbonGroupRadioButtonDesigner class.
        /// </summary>
        public KiwiRibbonGroupRadioButtonDesigner()
        {
        }
        #endregion
        ...
        public override void Initialize(IComponent component)
        {
            ...
            _ribbonRadioButton = (KiwiRibbonGroupRadioButton)component;
        ...
        private void OnMoveFirst(object sender, EventArgs e)
        {
            if ((_ribbonRadioButton != null) && (_ribbonRadioButton.Ribbon != null))
            {
                ...
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupRadioButton MoveFirst");
        ...
        private void OnMovePrevious(object sender, EventArgs e)
        {
            if ((_ribbonRadioButton != null) && (_ribbonRadioButton.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupRadioButton MovePrevious");
        ...
        private void OnMoveNext(object sender, EventArgs e)
        {
            if ((_ribbonRadioButton != null) && (_ribbonRadioButton.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupRadioButton MoveNext");
        ...
        private void OnMoveLast(object sender, EventArgs e)
        {
            if ((_ribbonRadioButton != null) && (_ribbonRadioButton.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupRadioButton MoveLast");
        ...
        private void OnDeleteRadioButton(object sender, EventArgs e)
        {
            if ((_ribbonRadioButton != null) && (_ribbonRadioButton.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupRadioButton DeleteRadioButton");
        ...
        private TypedRestrictCollection<KiwiRibbonGroupItem> ParentItems
        {
            get
            {
                if (_ribbonRadioButton.RibbonContainer is KiwiRibbonGroupTriple)
                {
                    KiwiRibbonGroupTriple triple = (KiwiRibbonGroupTriple)_ribbonRadioButton.RibbonContainer;
                    return triple.Items;
                }
                else if (_ribbonRadioButton.RibbonContainer is KiwiRibbonGroupLines)
                {
                    KiwiRibbonGroupLines lines = (KiwiRibbonGroupLines)_ribbonRadioButton.RibbonContainer;
                    return lines.Items;
                }
                else
                {
