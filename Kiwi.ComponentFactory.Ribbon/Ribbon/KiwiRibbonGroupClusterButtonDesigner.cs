...
{
    internal class KiwiRibbonGroupClusterButtonDesigner : ComponentDesigner
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiRibbonGroupClusterButtonDesigner class.
        /// </summary>
        public KiwiRibbonGroupClusterButtonDesigner()
        {
        }
        #endregion
        ...
        public override void Initialize(IComponent component)
        {
            ...
            _ribbonButton = (KiwiRibbonGroupClusterButton)component;
        ...
        private void UpdateVerbStatus()
        {
            ...
            if ((_ribbonButton != null) && (_ribbonButton.Ribbon != null))
            {
                ...
                KiwiRibbonGroupCluster cluster = (KiwiRibbonGroupCluster)_ribbonButton.RibbonContainer;
        ...
        private void OnMoveFirst(object sender, EventArgs e)
        {
            if ((_ribbonButton != null) && (_ribbonButton.Ribbon != null))
            {
                ...
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupClusterButton MoveFirst");
        ...
        private void OnMovePrevious(object sender, EventArgs e)
        {
            if ((_ribbonButton != null) && (_ribbonButton.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupClusterButton MovePrevious");
        ...
        private void OnMoveNext(object sender, EventArgs e)
        {
            if ((_ribbonButton != null) && (_ribbonButton.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupClusterButton MoveNext");
        ...
        private void OnMoveLast(object sender, EventArgs e)
        {
            if ((_ribbonButton != null) && (_ribbonButton.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupClusterButton MoveLast");
        ...
        private void OnDeleteButton(object sender, EventArgs e)
        {
            if ((_ribbonButton != null) && (_ribbonButton.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwikRibbonGroupClusterButton DeleteButton");
