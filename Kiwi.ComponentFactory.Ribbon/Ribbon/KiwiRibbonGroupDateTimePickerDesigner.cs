...
{
    internal class KiwiRibbonGroupDateTimePickerDesigner : ComponentDesigner, IKiwiDesignObject
    {
        #region Instance Fields
        private IDesignerHost _designerHost;
        private IComponentChangeService _changeService;
        private KiwiRibbonGroupDateTimePicker _ribbonDateTimePicker;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiRibbonGroupDateTimePickerDesigner class.
        /// </summary>
        public KiwiRibbonGroupDateTimePickerDesigner()
        {
        }
        #endregion
        ...
        public override void Initialize(IComponent component)
        {
            ...
            _ribbonDateTimePicker = (KiwiRibbonGroupDateTimePicker)component;
        ...
        protected override void PreFilterProperties(IDictionary properties)
        {
            ...
            for (int i = 0; i < strArray.Length; i++)
            {
                ...
                if (descrip != null)
                    properties[strArray[i]] = TypeDescriptor.CreateProperty(typeof(KiwiRibbonGroupDateTimePickerDesigner), descrip, attributes);
            }
        }
        #endregion
        ...
        private void OnMoveFirst(object sender, EventArgs e)
        {
            if ((_ribbonDateTimePicker != null) && (_ribbonDateTimePicker.Ribbon != null))
            {
                ...
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupDateTimePicker MoveFirst");
        ...
        private void OnMovePrevious(object sender, EventArgs e)
        {
            if ((_ribbonDateTimePicker != null) && (_ribbonDateTimePicker.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupDateTimePicker MovePrevious");
        ...
        private void OnMoveNext(object sender, EventArgs e)
        {
            if ((_ribbonDateTimePicker != null) && (_ribbonDateTimePicker.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupDateTimePicker MoveNext");
        ...
        private void OnMoveLast(object sender, EventArgs e)
        {
            if ((_ribbonDateTimePicker != null) && (_ribbonDateTimePicker.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupDateTimePicker MoveLast");
        ...
        private void OnDeleteDateTimePicker(object sender, EventArgs e)
        {
            if ((_ribbonDateTimePicker != null) && (_ribbonDateTimePicker.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupDateTimePicker DeleteDateTimePicker");
        ...
        private TypedRestrictCollection<KiwiRibbonGroupItem> ParentItems
        {
            get
            {
                if (_ribbonDateTimePicker.RibbonContainer is KiwiRibbonGroupTriple)
                {
                    KiwiRibbonGroupTriple triple = (KiwiRibbonGroupTriple)_ribbonDateTimePicker.RibbonContainer;
                    return triple.Items;
                }
                else if (_ribbonDateTimePicker.RibbonContainer is KiwiRibbonGroupLines)
                {
                    KiwiRibbonGroupLines lines = (KiwiRibbonGroupLines)_ribbonDateTimePicker.RibbonContainer;
                    return lines.Items;
                }
                else
                {
