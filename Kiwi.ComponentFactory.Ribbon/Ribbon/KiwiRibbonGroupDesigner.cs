...
{
    internal class KiwiRibbonGroupDesigner : ComponentDesigner
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiRibbonGroupDesigner class.
		/// </summary>
        public KiwiRibbonGroupDesigner()
        {
        }
        #endregion
        ...
        public override void Initialize(IComponent component)
        {
            ...
            _ribbonGroup = (KiwiRibbonGroup)component;
        ...
        private void OnMoveFirst(object sender, EventArgs e)
        {
                 ...
                 _ribbonGroup.RibbonTab.Groups.Contains(_ribbonGroup))
            {
                ...
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroup MoveFirst");
                ...
                try
                {
                    ...
                    KiwiRibbonTab ribbonTab = _ribbonGroup.RibbonTab;
        ...
        private void OnMovePrevious(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroup MovePrevious");
        ...
        private void OnMoveNext(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroup MoveNext");
        ...
        private void OnMoveLast(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroup MoveLast");
        ...
        private void OnAddTriple(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroup AddTriple");
                ...
                try
                {
                    ...
                    KiwiRibbonGroupTriple triple = (KiwiRibbonGroupTriple)_designerHost.CreateComponent(typeof(KiwiRibbonGroupTriple));
                    ...
                    KiwiRibbonGroupButton button1 = (KiwiRibbonGroupButton)_designerHost.CreateComponent(typeof(KiwiRibbonGroupButton));
                    KiwiRibbonGroupButton button2 = (KiwiRibbonGroupButton)_designerHost.CreateComponent(typeof(KiwiRibbonGroupButton));
                    KiwiRibbonGroupButton button3 = (KiwiRibbonGroupButton)_designerHost.CreateComponent(typeof(KiwiRibbonGroupButton));
        ...
        private void OnAddLines(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroup AddLines");
                ...
                try
                {
                    ...
                    KiwiRibbonGroupLines lines = (KiwiRibbonGroupLines)_designerHost.CreateComponent(typeof(KiwiRibbonGroupLines));
        ...
        private void OnAddSep(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroup AddSep");
                ...
                try
                {
                    ...
                    KiwiRibbonGroupSeparator sep = (KiwiRibbonGroupSeparator)_designerHost.CreateComponent(typeof(KiwiRibbonGroupSeparator));
        ...
        private void OnAddGallery(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroup AddGallery");
                ...
                try
                {
                    ...
                    KiwiRibbonGroupGallery gallery = (KiwiRibbonGroupGallery)_designerHost.CreateComponent(typeof(KiwiRibbonGroupGallery));
        ...
        private void OnClearItems(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroup ClearItems");
                ...
                try
                {
                    ...
                    {
                        KiwiRibbonGroupContainer item = _ribbonGroup.Items[i];
        ...
        private void OnDeleteGroup(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroup DeleteGroup");
        ...
        private void OnComponentRemoving(object sender, ComponentEventArgs e)
        {
            ...
            if (e.Component == _ribbonGroup)
            {
                ...
                {
                    KiwiRibbonGroupContainer item = _ribbonGroup.Items[j] as KiwiRibbonGroupContainer;
                    _ribbonGroup.Items.Remove(item);
                    host.DestroyComponent(item);
                }
            }
        ...
        private void OnContextMenu(object sender, MouseEventArgs e)
        {
                 ...
                 _ribbonGroup.RibbonTab.Groups.Contains(_ribbonGroup))
            {
                ...
                if (_cms == null)
                {
                    ...
                    _addTripleMenu = new ToolStripMenuItem("Add Triple", Properties.Resources.KiwiRibbonGroupTriple, new EventHandler(OnAddTriple));
                    _addLinesMenu = new ToolStripMenuItem("Add Lines", Properties.Resources.KiwiRibbonGroupLines, new EventHandler(OnAddLines));
                    _addSeparatorMenu = new ToolStripMenuItem("Add Separator", Properties.Resources.KiwiRibbonGroupSeparator, new EventHandler(OnAddSep));
                    _addGalleryMenu = new ToolStripMenuItem("Add Gallery", Properties.Resources.KiwiGallery, new EventHandler(OnAddGallery));
        ...
        private void UpdateMoveToTab()
        {
            ...
            if (_ribbonGroup.Ribbon != null)
            {
                ...
                foreach (KiwiRibbonTab tab in _ribbonGroup.Ribbon.RibbonTabs)
                {
        ...
        private void OnMoveToTab(object sender, EventArgs e)
        {
                 ...
                 _ribbonGroup.RibbonTab.Groups.Contains(_ribbonGroup))
            {
                ...
                KiwiRibbonTab destination = (KiwiRibbonTab)tabMenuItem.Tag;

                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroup MoveTabTo");
