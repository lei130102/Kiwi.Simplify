...
{
    internal class KiwiRibbonGroupGalleryDesigner : ComponentDesigner, IKiwiDesignObject
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiRibbonGroupGalleryDesigner class.
        /// </summary>
        public KiwiRibbonGroupGalleryDesigner()
        {
        }
        #endregion
        ...
        public override void Initialize(IComponent component)
        {
            ...
            _ribbonGallery = (KiwiRibbonGroupGallery)component;
        ...
        protected override void PreFilterProperties(IDictionary properties)
        {
            ...
            for (int i = 0; i < strArray.Length; i++)
            {
                ...
                if (descrip != null)
                    properties[strArray[i]] = TypeDescriptor.CreateProperty(typeof(KiwiRibbonGroupGalleryDesigner), descrip, attributes);
            }
        }
        #endregion
        ...
        private void OnMoveFirst(object sender, EventArgs e)
        {
                 ...
                 _ribbonGallery.RibbonGroup.Items.Contains(_ribbonGallery))
            {
                ...
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupGallery MoveFirst");
                ...
                try
                {
                    ...
                    KiwiRibbonGroup ribbonGroup = _ribbonGallery.RibbonGroup;
        ...
        private void OnMovePrevious(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupGallery MovePrevious");
        ...
        private void OnMoveNext(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupGallery MoveNext");
        ...
        private void OnMoveLast(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupGallery MoveLast");
        ...
        private void OnDeleteGallery(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupGallery DeleteGallery");
