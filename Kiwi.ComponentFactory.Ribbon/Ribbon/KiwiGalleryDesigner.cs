...
{
    internal class KiwiGalleryDesigner : ParentControlDesigner
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiGalleryDesigner class.
		/// </summary>
        public KiwiGalleryDesigner()
        {
        ...
        public override void Initialize(IComponent component)
        {
            ...
            _gallery = (KiwiGallery)component;
        ...
        public override ICollection AssociatedComponents
        {
            get
            {
                ...
                foreach (KiwiGalleryRange dropRange in _gallery.DropButtonRanges)
        ...
        public override DesignerActionListCollection ActionLists
        {
            get
            {
                ...
                actionLists.Add(new KiwiGalleryActionList(this));
        ...
        private void OnComponentRemoving(object sender, ComponentEventArgs e)
        {
            ...
            if (e.Component == _gallery)
            {
                ...
                {
                    KiwiGalleryRange dropRange = _gallery.DropButtonRanges[i];
