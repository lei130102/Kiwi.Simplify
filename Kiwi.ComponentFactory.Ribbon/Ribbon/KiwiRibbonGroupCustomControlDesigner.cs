...
{
    internal class KiwiRibbonGroupCustomControlDesigner : ComponentDesigner, IKiwiDesignObject
    {
        #region Instance Fields
        private IDesignerHost _designerHost;
        private IComponentChangeService _changeService;
        private KiwiRibbonGroupCustomControl _ribbonCustomControl;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiRibbonGroupCustomControlDesigner class.
        /// </summary>
        public KiwiRibbonGroupCustomControlDesigner()
        {
        }
        #endregion
        ...
        public override void Initialize(IComponent component)
        {
            ...
            _ribbonCustomControl = (KiwiRibbonGroupCustomControl)component;
        ...
        protected override void PreFilterProperties(IDictionary properties)
        {
            ...
            for (int i = 0; i < strArray.Length; i++)
            {
                ...
                if (descrip != null)
                    properties[strArray[i]] = TypeDescriptor.CreateProperty(typeof(KiwiRibbonGroupCustomControlDesigner), descrip, attributes);
            }
        }
        #endregion
        ...
        private void OnMoveFirst(object sender, EventArgs e)
        {
            if ((_ribbonCustomControl != null) && (_ribbonCustomControl.Ribbon != null))
            {
                ...
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupCustomControl MoveFirst");
        ...
        private void OnMovePrevious(object sender, EventArgs e)
        {
            if ((_ribbonCustomControl != null) && (_ribbonCustomControl.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupCustomControl MovePrevious");
        ...
        private void OnMoveNext(object sender, EventArgs e)
        {
            if ((_ribbonCustomControl != null) && (_ribbonCustomControl.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupCustomControl MoveNext");
        ...
        private void OnMoveLast(object sender, EventArgs e)
        {
            if ((_ribbonCustomControl != null) && (_ribbonCustomControl.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupCustomControl MoveLast");
        ...
        private void OnDeleteCustomControl(object sender, EventArgs e)
        {
            if ((_ribbonCustomControl != null) && (_ribbonCustomControl.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupCustomControl DeleteCustomControl");
        ...
        private TypedRestrictCollection<KiwiRibbonGroupItem> ParentItems
        {
            get
            {
                if (_ribbonCustomControl.RibbonContainer is KiwiRibbonGroupTriple)
                {
                    KiwiRibbonGroupTriple triple = (KiwiRibbonGroupTriple)_ribbonCustomControl.RibbonContainer;
                    return triple.Items;
                }
                else if (_ribbonCustomControl.RibbonContainer is KiwiRibbonGroupLines)
                {
                    KiwiRibbonGroupLines lines = (KiwiRibbonGroupLines)_ribbonCustomControl.RibbonContainer;
                    return lines.Items;
                }
                else
                {
