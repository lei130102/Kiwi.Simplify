...
{
    internal class KiwiRibbonGroupClusterDesigner : ComponentDesigner
    {
        #region Instance Fields
        private IDesignerHost _designerHost;
        private IComponentChangeService _changeService;
        private KiwiRibbonGroupCluster _ribbonCluster;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiRibbonGroupClusterDesigner class.
		/// </summary>
        public KiwiRibbonGroupClusterDesigner()
        {
        }
        #endregion
        ...
        public override void Initialize(IComponent component)
        {
            ...
            _ribbonCluster = (KiwiRibbonGroupCluster)component;
        ...
        private void UpdateVerbStatus()
        {
            ...
            if ((_ribbonCluster != null) && (_ribbonCluster.Ribbon != null))
            {
                ...
                KiwiRibbonGroupLines lines = (KiwiRibbonGroupLines)_ribbonCluster.RibbonContainer;
        ...
        private void OnMoveFirst(object sender, EventArgs e)
        {
            if ((_ribbonCluster != null) && (_ribbonCluster.Ribbon != null))
            {
                ...
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupCluster MoveFirst");
        ...
        private void OnMovePrevious(object sender, EventArgs e)
        {
            if ((_ribbonCluster != null) && (_ribbonCluster.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupCluster MovePrevious");
        ...
        private void OnMoveNext(object sender, EventArgs e)
        {
            if ((_ribbonCluster != null) && (_ribbonCluster.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupCluster MoveNext");
        ...
        private void OnMoveLast(object sender, EventArgs e)
        {
            if ((_ribbonCluster != null) && (_ribbonCluster.Ribbon != null))
            {
                ...
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupCluster MoveLast");
        ...
        private void OnAddButton(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupCluster AddButton");
                ...
                try
                {
                    ...
                    KiwiRibbonGroupClusterButton button = (KiwiRibbonGroupClusterButton)_designerHost.CreateComponent(typeof(KiwiRibbonGroupClusterButton));
        ...
        private void OnAddColorButton(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupCluster AddColorButton");
                ...
                try
                {
                    ...
                    KiwiRibbonGroupClusterColorButton button = (KiwiRibbonGroupClusterColorButton)_designerHost.CreateComponent(typeof(KiwiRibbonGroupClusterColorButton));
                    _ribbonCluster.Items.Add(button);
        ...
        private void OnClearItems(object sender, EventArgs e)
        {
            ...
            {
                // Use a transaction to support undo/redo actions
                DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiRibbonGroupCluster ClearItems");
                ...
                try
                {
                    ...
                    {
                        KiwiRibbonGroupItem item = _ribbonCluster.Items[i];
        ...
        private void OnContextMenu(object sender, MouseEventArgs e)
        {
            if ((_ribbonCluster != null) && (_ribbonCluster.Ribbon != null))
            {
                ...
                if (_cms == null)
                {
                    ...
                    _addButtonMenu = new ToolStripMenuItem("Add Button", Properties.Resources.KiwiRibbonGroupClusterButton, new EventHandler(OnAddButton));
                    _addColorButtonMenu = new ToolStripMenuItem("Add Color Button", Properties.Resources.KiwiRibbonGroupClusterColorButton, new EventHandler(OnAddColorButton));
