...
namespace Kiwi.ComponentFactory.Ribbon
{
    internal class VisualPopupAppMenu : VisualPopup
    {
        ...
        public VisualPopupAppMenu(KiwiRibbon ribbon,
        ...
        private void CreateContextMenuView(RibbonAppButton appButton)
        {
            ...
            KiwiContextMenuCollection topCollection = new KiwiContextMenuCollection();
            KiwiContextMenuItems topItems = new KiwiContextMenuItems();
            topItems.ImageColumn = false;
            topCollection.Add(topItems);
            foreach (KiwiContextMenuItemBase item in appButton.AppButtonMenuItems)
        ...
        private void CreateRecentDocumentsView()
        {
            ...
            if (_ribbon.RibbonAppButton.AppButtonShowRecentDocs)
            {
                ...
                KiwiContextMenuSeparator dummySep1 = new KiwiContextMenuSeparator();
                ...
                KiwiContextMenuSeparator dummySep2 = new KiwiContextMenuSeparator();
                ...
                int index = 1;
                foreach (KiwiRibbonRecentDoc recentDoc in _ribbon.RibbonAppButton.AppButtonRecentDocs)
