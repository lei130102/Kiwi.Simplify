...
namespace KiwiCheckBox_Examples
{
    public partial class Form1 : Form
    {
        ...
        {
            propertyGrid.SelectedObject = new KiwiCheckBoxProxy(kiwiCheckBox13);
        }

        private void CheckButtonEnter(object sender, EventArgs e)
        {
            propertyGrid.SelectedObject = new KiwiCheckBoxProxy(sender as KiwiCheckBox);
        }
    ...
    public class KiwiCheckBoxProxy
    {
        private KiwiCheckBox _checkBox;

        public KiwiCheckBoxProxy(KiwiCheckBox button)
        {
            _checkBox = button;
        }
