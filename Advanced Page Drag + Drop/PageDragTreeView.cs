...
{
    /// <summary>
    /// TreeView customized to work with KiwiPage drag and drop.
    /// </summary>
                                    ...
                                    IDragTargetProvider
    {
        ...
        public class DragTargetTreeViewTransfer : DragTarget
        {
            ...
            public DragTargetTreeViewTransfer(Rectangle rect,
                ...
                : base(rect, rect, rect, DragTargetHint.Transfer, KiwiPageFlags.All)
            {
                _treeView = treeView;
            }
        ...
        private void PageDragStart(Point pt)
        {
            if (DragPageNotify != null)
            {
                ...
                PageDragCancelEventArgs de = new PageDragCancelEventArgs(PointToScreen(pt), Point.Empty, this, new KiwiPage[] { _dragPage });
