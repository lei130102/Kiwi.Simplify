...
{
    internal class KiwiWorkspaceDesigner : ParentControlDesigner
    {
        ...
        public override void Initialize(IComponent component)
        {
            ...
            _workspace = (KiwiWorkspace)component;
        ...
        public override DesignerActionListCollection ActionLists
        {
            get
            {
                ...
                actionLists.Add(new KiwiWorkspaceActionList(this));
            ...
            if (e.Component == _workspace)
            {
                ...
                for (int i = _workspace.Root.Children.Count - 1; i >= 0; i--)
                {
                    ...
                    if (comp is Control)
                    {
                        ...
                        KiwiReadOnlyControls readOnlyControls = (KiwiReadOnlyControls)_workspace.Controls;
