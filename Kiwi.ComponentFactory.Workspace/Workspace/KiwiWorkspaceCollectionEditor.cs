...
{
    internal class KiwiWorkspaceCollectionEditor : CollectionEditor
    {
        #region Classes
        /// <summary>
        /// Form used for editing the KiwiWorkspaceCollection.
        /// </summary>
        protected partial class KiwiWorkspaceCollectionForm : CollectionEditor.CollectionForm
        {
            #region Types
            /// <summary>
            ...
            /// <summary>
            /// Act as proxy for kiwi page item to control the exposed properties to the property grid.
            /// </summary>
            protected class PageProxy
            {
                #region Instance Fields
                private KiwiPage _item;
                #endregion
                ...
                public PageProxy(KiwiPage item)
                {
                    _item = item;
                }
                #endregion
                ...
                {
                    get { return _item.KiwiContextMenu; }
                    set { _item.KiwiContextMenu = value; }
                }
            ...
            {
                #region Instance Fields
                private KiwiWorkspaceCell _item;
                #endregion
                ...
                /// </summary>
                /// <param name="item">Item to act as proxy for.</param>
                public CellProxy(KiwiWorkspaceCell item)
                {
                    _item = item;
                }
                #endregion
            ...
            {
                #region Instance Fields
                private KiwiWorkspaceSequence _item;
                #endregion
                ...
                /// </summary>
                /// <param name="item">Item to act as proxy for.</param>
                public SequenceProxy(KiwiWorkspaceSequence item)
                {
                    _item = item;
                }
                #endregion
            ...
            protected class MenuTreeNode : TreeNode
            {
                ...
                public MenuTreeNode(Component item)
                {
                    ...
                    _cell = item as KiwiWorkspaceCell;
                    if (_cell != null)
                    {
                    ...
                    _sequence = item as KiwiWorkspaceSequence;
                    if (_sequence != null)
                    {
                ...
                /// Gets access to the associated workspace cell item.
                /// </summary>
                public KiwiWorkspaceCell CellItem
                {
                    get { return _cell; }
                }
                ...
                /// </summary>
                public KiwiWorkspaceSequence SequenceItem
                {
            ...
            #region Instance Fields
            private KiwiWorkspaceCollectionEditor _editor;
            ...
            #region Identity
            /// <summary>
            /// Initialize a new instance of the KiwiWorkspaceCollectionForm class.
            /// </summary>
            public KiwiWorkspaceCollectionForm(KiwiWorkspaceCollectionEditor editor)
                : base(editor)
            {
                _editor = editor;
                ...
                this.Name = "KiwiWorkspaceCollectionForm";
            ...
            private void buttonAddPage_Click(object sender, EventArgs e)
            {
                ...
                KiwiPage page = (KiwiPage)CreateInstance(typeof(KiwiPage));
            ...
            private void buttonAddCell_Click(object sender, EventArgs e)
            {
                ...
                KiwiWorkspaceCell cell = (KiwiWorkspaceCell)CreateInstance(typeof(KiwiWorkspaceCell));
            ...
            private void buttonAddSequence_Click(object sender, EventArgs e)
            {
                ...
                KiwiWorkspaceSequence sequence = (KiwiWorkspaceSequence)CreateInstance(typeof(KiwiWorkspaceSequence));
            ...
            private void AddItemsToDictionary(DictItemBase dictItems, Component baseItem)
            {
                ...
                if (baseItem is KiwiWorkspaceCell)
                {
                    KiwiWorkspaceCell cell = (KiwiWorkspaceCell)baseItem;
                    foreach (Component item in cell.Pages)
                        AddItemsToDictionary(dictItems, item);
                }

                // Add children from a sequence
                if (baseItem is KiwiWorkspaceSequence)
                {
                    KiwiWorkspaceSequence sequence = (KiwiWorkspaceSequence)baseItem;
            ...
            private void AddMenuTreeNode(Component item, MenuTreeNode parent)
            {
                ...
                // Add pages from a cell
                if (item is KiwiWorkspaceCell)
                {
                    KiwiWorkspaceCell cell = (KiwiWorkspaceCell)item;
                    foreach (Component page in cell.Pages)
                        AddMenuTreeNode(page, node);
                }

                // Add children from a sequence
                if (item is KiwiWorkspaceSequence)
                {
                    KiwiWorkspaceSequence sequence = (KiwiWorkspaceSequence)item;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiWorkspaceCollectionEditor class.
		/// </summary>
        public KiwiWorkspaceCollectionEditor()
            : base(typeof(KiwiWorkspaceCollection))
        {
        }
        #endregion
        ...
        public KiwiWorkspace Workspace
        {
            get
            {
                KiwiWorkspaceSequence sequence = (KiwiWorkspaceSequence)Context.Instance;
        ...
        {
            return new KiwiWorkspaceCollectionForm(this);
        }
        #endregion
    }
}
