...
{
    internal class KiwiWorkspaceActionList : DesignerActionList
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiWorkspaceActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public KiwiWorkspaceActionList(KiwiWorkspaceDesigner owner)
            : base(owner.Component)
        {
            // Remember designer and actual component instance being designed
            _workspace = (KiwiWorkspace)owner.Component;
