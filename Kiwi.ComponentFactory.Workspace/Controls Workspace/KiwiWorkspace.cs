...
{
    /// <summary>
    /// Layout a hierarchy of KiwiNavigator instances.
	/// </summary>
    //
    ...
    [Designer("Kiwi.ComponentFactory.Workspace.KiwiWorkspaceDesigner, Kiwi.ComponentFactory.Workspace, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [DesignerCategory("code")]
    [Description("Layout a hierarchy of KiwiNavigator instances.")]
    //
    [Docking(DockingBehavior.Ask)]
    //
    [ToolboxBitmap(typeof(KiwiWorkspace), "ToolboxBitmaps.KiwiWorkspace.bmp")]
    public class KiwiWorkspace : VisualContainerControl,
                                    IDragTargetProvider
    {
        #region Classes
        /// <summary>
        ...
        internal class CellList : List<KiwiWorkspaceCell> { };
        internal class PageList : List<KiwiPage> { };
        ...
        // Exposed fields
        private KiwiWorkspaceSequence _root;
        ...
        private KiwiWorkspaceCell _maximizedCell;
        private KiwiWorkspaceCell _activeCell;
        private KiwiPage _activePage;
        ...
        private KiwiContextMenuItems _menuItems;
        private KiwiContextMenuSeparator _menuSeparator1;
        private KiwiContextMenuItem _menuClose;
        private KiwiContextMenuItem _menuCloseAllButThis;
        private KiwiContextMenuSeparator _menuSeparator2;
        private KiwiContextMenuItem _menuMoveNext;
        private KiwiContextMenuItem _menuMovePrevious;
        private KiwiContextMenuSeparator _menuSeparator3;
        private KiwiContextMenuItem _menuSplitVert;
        private KiwiContextMenuItem _menuSplitHorz;
        private KiwiContextMenuSeparator _menuSeparator4;
        private KiwiContextMenuItem _menuMaximizeRestore;
        private KiwiContextMenuSeparator _menuSeparator5;
        private KiwiContextMenuItem _menuRebalance;
        private KiwiWorkspaceCell _menuCell;
        private KiwiPage _menuPage;
        #endregion
        ...
        /// <summary>
        /// Occurs when a new KiwiWorkspaceCell instance is about to be added to the workspace.
        /// </summary>
        [Category("Workspace")]
        [Description("Occurs when a new KiwiWorkspaceCell instance is about to be added to the workspace.")]
        public event EventHandler<WorkspaceCellEventArgs> WorkspaceCellAdding;

        /// <summary>
        /// Occurs when an existing KiwiWorkspaceCell instance has been removed from the workspace.
        /// </summary>
        [Category("Workspace")]
        [Description("Occurs when an existing KiwiWorkspaceCell instance has been removed from the workspace.")]
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiWorkspace class.
		/// </summary>
        public KiwiWorkspace()
        {
            _root = new KiwiWorkspaceSequence();
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
            {
                ...
                ((KiwiReadOnlyControls)Controls).AllowRemoveInternal = true;
        ...
        {
            get { return base.KiwiContextMenu; }
            set { base.KiwiContextMenu = value; }
        }
        ...
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public KiwiWorkspaceCell ActiveCell
        {
        ...
        [DefaultValue(null)]
        public KiwiWorkspaceCell MaximizedCell
        {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiWorkspaceSequence Root
        {
            get { return _root; }
        }
        ...
        public int PageVisibleCount
        {
            get
            {
                ...
                // Iterate over the workspace hierarchy looking for cells
                KiwiWorkspaceCell cell = FirstVisibleCell();
                while (cell != null)
                {
        ...
        public KiwiPage[] AllVisiblePages()
        {
            List<KiwiPage> pages = new List<KiwiPage>();
        ...
        public KiwiWorkspaceCell FirstCell()
        {
        ...
        public KiwiWorkspaceCell LastCell()
        {
        ...
        public KiwiWorkspaceCell NextCell(KiwiWorkspaceCell current)
        {
            // Get parent of the provided cell
            KiwiWorkspaceSequence sequence = current.WorkspaceParent as KiwiWorkspaceSequence;
        ...
        public KiwiWorkspaceCell PreviousCell(KiwiWorkspaceCell current)
        {
            // Get parent of the provided cell
            KiwiWorkspaceSequence sequence = current.WorkspaceParent as KiwiWorkspaceSequence;
        ...
        public bool IsCellPresent(KiwiWorkspaceCell cell)
        {
        ...
        /// </summary>
        /// <returns>First cell;otherwise null.</returns>
        public KiwiWorkspaceCell FirstVisibleCell()
        {
        ...
        /// </summary>
        /// <returns>Last cell;otherwise null.</returns>
        public KiwiWorkspaceCell LastVisibleCell()
        {
        ...
        /// <param name="current">Starting cell.</param>
        /// <returns>Next cell;otherwise null.</returns>
        public KiwiWorkspaceCell NextVisibleCell(KiwiWorkspaceCell current)
        {
            // Get parent of the provided cell
            KiwiWorkspaceSequence sequence = current.WorkspaceParent as KiwiWorkspaceSequence;
        ...
        /// <param name="current">Starting cell.</param>
        /// <returns>Previous cell;otherwise null.</returns>
        public KiwiWorkspaceCell PreviousVisibleCell(KiwiWorkspaceCell current)
        {
            // Get parent of the provided cell
            KiwiWorkspaceSequence sequence = current.WorkspaceParent as KiwiWorkspaceSequence;
        ...
        public KiwiWorkspaceCell CellForPage(KiwiPage page)
        {
            // Default to having not found the page
            KiwiWorkspaceCell ret = null;

            // Do we have a valid page to look for?
            if (page != null)
            {
                // Start search from first cell
                KiwiWorkspaceCell examine = FirstCell();
        ...
        public KiwiWorkspaceCell CellForUniqueName(string uniqueName)
        {
        ...
        public bool CanClosePage(KiwiPage page)
        {
            // If we can find a cell in our workspace that contains the page...
            KiwiWorkspaceCell cellForPage = CellForPage(page);
            if (cellForPage != null)
            {
        ...
        public bool CanMovePageNext(KiwiPage page)
        {
            // If we can find a cell in our workspace that contains the page...
            KiwiWorkspaceCell cellForPage = CellForPage(page);
            if (cellForPage != null)
        ...
        public bool CanMovePagePrevious(KiwiPage page)
        {
            // If we can find a cell in our workspace that contains the page...
            KiwiWorkspaceCell cellForPage = CellForPage(page);
            if (cellForPage != null)
        ...
        public void ClosePage(KiwiPage page)
        {
        ...
        /// </summary>
        /// <param name="page">Page to close.</param>
        public void CloseAllButThisPage(KiwiPage page)
        {
            // Create a list of all pages in the workspace
            KiwiPageCollection pages = CopyToPageCollection();

            // Attempt a close of all pages except the provided one
            foreach (KiwiPage closePage in pages)
                if ((closePage != page) && CanClosePage(closePage))
                {
                    KiwiWorkspaceCell cellForPage = CellForPage(closePage);
        ...
        public void MovePageNext(KiwiPage page, bool selectPage)
        {
            if (CanMovePageNext(page))
            {
                ...
                KiwiWorkspaceCell cellForPage = CellForPage(page);
                KiwiWorkspaceCell nextCell = NextCell(cellForPage);
        ...
        /// <param name="page">Page to move.</param>
        /// <param name="selectPage">Should page be selected once moved.</param>
        public void MovePagePrevious(KiwiPage page, bool selectPage)
        {
            if (CanMovePagePrevious(page))
            {
                ...
                // Grab the cells involved in page movement
                KiwiWorkspaceCell cellForPage = CellForPage(page);
                KiwiWorkspaceCell previousCell = PreviousCell(cellForPage);
        ...
        public void ApplyResizing(KiwiWorkspaceSequence sequence,
                                  string newWidth,
                                  string newHeight,
                                  bool applyStar,
                                  bool applyFixed)
        {
            ...
            foreach (Component c in sequence.Children)
            {
                ...
                if (c is KiwiWorkspaceSequence)
                {
                    ...
                    ApplyResizing(c as KiwiWorkspaceSequence,
                                  newWidth, newHeight,
        ...
        public void ApplySingleCell(bool createCellIfNoPages)
        {
            ...
            KiwiPage activePage = ActivePage;
                                   ...
                                   int sequenceItems)
        {
            ...
            KiwiWorkspaceCell activeCell = ActiveCell;
            ...
            if (createCellIfEmpty || cells.Count > 0)
            {
                ...
                if (cells.Count == 0)
                {
                    ...
                    if (createCellIfEmpty)
                        Root.Children.Add(new KiwiWorkspaceCell());
                }
                else
                {
                    ...
                    while (cells.Count > 0)
                    {
                        ...
                        KiwiWorkspaceSequence sequence = new KiwiWorkspaceSequence(sequenceDirection);
                        for (int j = 0; j < sequenceItems; j++)
                        {
                            ...
                            if (createCellIfEmpty || cells.Count > 0)
                            {
                                ...
                                if (cells.Count == 0)
                                    sequence.Children.Add(new KiwiWorkspaceCell());
                                else
                                {
                                    cell = cells[0];
                                    cells.RemoveAt(0);
                                  ...
                                  int sequenceItems)
        {
            ...
            // Remember the active page before we rearrange
            KiwiPage activePage = ActivePage;
            KiwiWorkspaceCell newActiveCell = null;
        ...
        {
            return GenerateDragTargets(dragEndData, KiwiPageFlags.All);
        }
        ...
        /// <returns>List of drag targets.</returns>
        public virtual DragTargetList GenerateDragTargets(PageDragEndData dragEndData, KiwiPageFlags allowFlags)
        {
        ...
        public void LoadLayoutFromXml(XmlReader xmlReader, KiwiPageCollection availablePages)
        {
            // Remember the current culture setting
            CultureInfo culture = Thread.CurrentThread.CurrentCulture;
            ...
            try
            {
                ...
                if (formatVersion < 1)
                    throw new ArgumentException("Can only load Version 1 and upwards of KiwiWorkspace persisted data.");
                ...
                try
                {
                    ...
                    if (existingPages.Count > 0)
                    {
                        ...
                        List<KiwiPage> unmatched = new List<KiwiPage>();
                        foreach (KiwiPage page in existingPages.Values)
                            unmatched.Add(page);
                ...
                finally
                {
                    ...
                    // Restore active cell
                    KiwiWorkspaceCell activeCell = CellForUniqueName(activePageUniqueName);
                    if (activeCell != null)
                        ActiveCell = activeCell;
        ...
        public virtual void WriteCellElement(XmlWriter xmlWriter, KiwiWorkspaceCell cell)
        {
        ...
        public virtual string ReadCellElement(XmlReader xmlReader, KiwiWorkspaceCell cell)
        {
        ...
        public virtual void WriteSequenceElement(XmlWriter xmlWriter, KiwiWorkspaceSequence sequence)
        {
        ...
        /// <param name="xmlReader">XmlReader to use for loading.</param>
        /// <param name="sequence">Reference to sequence.</param>
        public virtual void ReadSequenceElement(XmlReader xmlReader, KiwiWorkspaceSequence sequence)
        {
        ...
        public virtual void WritePageElement(XmlWriter xmlWriter, KiwiPage page)
        {
        ...
        public virtual KiwiPage ReadPageElement(XmlReader xmlReader,
                                                   string uniqueName,
        ...
        {
            KiwiWorkspaceCell cell = sender as KiwiWorkspaceCell;
            if (cell != null)
            {
        ...
        /// </summary>
        /// <returns>A new instance of KiwiNavigatorControlCollection assigned to the control.</returns>
        protected override ControlCollection CreateControlsInstance()
        {
            // User should never adds controls directly to collection, only via the workspace hierarchy
            return new KiwiReadOnlyControls(this);
        }
            ...
            if (_suspendWorkspace == 0)
            {
                ...
                for (int i = Controls.Count - 1; i >= 0; i--)
                    if (!controls.Contains(Controls[i]))
                    {
                        ...
                        ((KiwiReadOnlyControls)Controls).RemoveInternal(c);
                ...
                KiwiWorkspaceCell order = FirstCell();
                while (order != null)
                {
        ...
        protected override void WndProc(ref Message m)
        {
            ...
            {
                // We never allow our ContextMenuStrip/KiwiContextMenu to show if there are cells 
        ...
        protected virtual void NewCellInitialize(KiwiWorkspaceCell cell)
        {
        ...
        protected virtual void ExistingCellDetach(KiwiWorkspaceCell cell)
        {
            cell.CtrlTabWrap -= new EventHandler<CtrlTabCancelEventArgs>(OnCellCtrlTabWrap);
            cell.ShowContextMenu -= new EventHandler<ShowContextMenuArgs>(OnCellShowContextMenu);
            cell.SelectedPageChanged -= new EventHandler(OnCellSelectedPageChanged);
                                     ...
                                     Point splitter)
        {
            ...
            KiwiWorkspaceSequence parentSequence = (KiwiWorkspaceSequence)separator.WorkspaceItem.WorkspaceParent;
        ...
        internal void InternalPageDragStart(object sender, KiwiNavigator navigator, PageDragCancelEventArgs e)
        {
            ...
            if (!e.Cancel)
            {
                ...
                List<KiwiPage> list = new List<KiwiPage>();
                foreach (KiwiPage p in e.Pages)
                    list.Add(p);
                ...
                else
                {
                    ...
                    e.Cancel = !_dragManager.DragStart(e.ScreenPoint, new PageDragEndData(sender as KiwiNavigator, e.Pages));
                }
            }
        }

        internal void InternalPageDragMove(KiwiNavigator sender, PointEventArgs e)
        {
            if (DragPageNotify != null)
        ...
        internal bool InternalPageDragEnd(KiwiNavigator sender, PointEventArgs e)
        {
        ...
        internal void InternalPageDragQuit(KiwiNavigator sender)
        {
            if (DragPageNotify != null)
        ...
        private void LayoutSequenceMaximized(KiwiWorkspaceSequence seq,
                                             Rectangle client,
                                             ...
                                             ViewLayoutContext layoutContext)
        {
            ...
            while (cell != null)
            {
                ...
                if (!Controls.Contains(cell))
                {
                    ...
                    ((KiwiReadOnlyControls)Controls).AddInternal(cell);
                }
        ...
        private void LayoutSequenceNonMaximized(KiwiWorkspaceSequence seq,
                                                Rectangle client,
                                                ControlList controls,
                                                ...
                                                ViewLayoutContext layoutContext)
        {
            ...
            for (int i = 0; i < seq.Children.Count; i++)
            {
                ...
                // Update the maximize/restore button spec per-cell
                KiwiWorkspaceCell cell = seq.Children[i] as KiwiWorkspaceCell;
                if (cell != null)
                {
                ...
                if (info[i].WorkspaceItem != null)
                {
                    ...
                    if (control != null)
                    {
                        ...
                        if (!Controls.Contains(control))
                        {
                            ...
                            if (control is KiwiWorkspaceCell)
                            {
                                KiwiWorkspaceCell cell = control as KiwiWorkspaceCell;
                                cell.DragPageNotify = _cellPageNotify;
                                OnWorkspaceCellAdding(new WorkspaceCellEventArgs(cell));
                            }

                            ((KiwiReadOnlyControls)Controls).AddInternal(control);
                        }
                    ...
                    else
                    {
                        ...
                        if (info[i].WorkspaceVisible)
                        {
                            ...
                            if (seq.Children[i] is KiwiWorkspaceSequence)
                                LayoutSequenceNonMaximized(seq.Children[i] as KiwiWorkspaceSequence,
                                                           info[i].DisplayRect,
                                                           controls,
                                                           separators,
                                                           layoutContext);
                        ...
                        else
                        {
                            ...
                            LayoutSequenceIsHidden(seq.Children[i] as KiwiWorkspaceSequence, controls);
                        }
                    }
                }
            }
        ...
        private void LayoutSequenceIsHidden(KiwiWorkspaceSequence sequence, ControlList controls)
        {
            ...
            for (int i = 0; i < sequence.Children.Count; i++)
            {
                ...
                else
                {
                    ...
                    if (sequence.Children[i] is KiwiWorkspaceSequence)
                    {
                        // Ensure we mark all the controls contained in the sequence as still needed
                        LayoutSequenceIsHidden(sequence.Children[i] as KiwiWorkspaceSequence, controls);
                    }
                }
            }
        }

        private bool RecursiveSearchCellInSequence(KiwiWorkspaceSequence sequence,
                                                   KiwiWorkspaceCell target)
        {
            ...
            for (int i = 0; i < sequence.Children.Count; i++)
            {
                ...
                KiwiWorkspaceSequence child = sequence.Children[i] as KiwiWorkspaceSequence;
        ...
        private KiwiWorkspaceCell RecursiveFindCellInSequence(KiwiWorkspaceSequence sequence,
                                                                 Component target,
                                                                 bool forwards,
                                                                 bool onlyVisible)
        {
            ...
            if (forwards)
            {
                ...
                {
                    if (sequence.Children[i] is KiwiWorkspaceCell)
                    {
                        // Check that the visible state of the cell matches the find requirements
                        KiwiWorkspaceCell cell = sequence.Children[i] as KiwiWorkspaceCell;
                        if (!onlyVisible || cell.WorkspaceVisible)
                            return cell;
                    }
                    else if (sequence.Children[i] is KiwiWorkspaceSequence)
                    {
                        // Search inside the sequence for the first leaf in the specified direction
                        KiwiWorkspaceCell ret = RecursiveFindCellInSequence(sequence.Children[i] as KiwiWorkspaceSequence, forwards, onlyVisible);
                        if (ret != null)
                            return ret;
                    }
                }
            ...
            if (sequence.WorkspaceParent != null)
                return RecursiveFindCellInSequence(sequence.WorkspaceParent as KiwiWorkspaceSequence, sequence, forwards, onlyVisible);
            else
                return null;
        }
                                                                 ...
                                                                 bool onlyVisible)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                if (sequence.Children[index] is KiwiWorkspaceCell)
                {
                    // Check that the visible state of the cell matches the find requirements
                    KiwiWorkspaceCell cell = sequence.Children[index] as KiwiWorkspaceCell;
                    if (!onlyVisible || cell.WorkspaceVisible)
                        return cell;
                }
                else if (sequence.Children[index] is KiwiWorkspaceSequence)
                {
                    // Search inside the sequence 
                    KiwiWorkspaceCell ret = RecursiveFindCellInSequence(sequence.Children[index] as KiwiWorkspaceSequence, forwards, onlyVisible);
                    if (ret != null)
                        return ret;
                }
            }
                                      ...
                                      out IWorkspaceItem before)
        {
            ...
            KiwiWorkspaceSequence beforeSequence = (KiwiWorkspaceSequence)after.WorkspaceParent;
        ...
        private KiwiPageCollection CopyToPageCollection()
        {
            // Make list of all pages inside all cells
        ...
        private void GenerateCellDragTargets(KiwiWorkspaceCell cell,
        ...
        private void SetActiveCell(KiwiWorkspaceCell newCell)
        {
        ...
        private void SetActiveCellRaw(KiwiWorkspaceCell newCell)
        {
        ...
        private void OnCellShowContextMenu(object sender, ShowContextMenuArgs e)
        {
            ...
            if (ContextMenus.ShowContextMenu && !e.Cancel)
            {
                ...
                if (_menuItems == null)
                {
                    ...
                    _menuSeparator1 = new KiwiContextMenuSeparator();
                    _menuClose = new KiwiContextMenuItem(ContextMenus.TextClose, new EventHandler(OnPageClose), ContextMenus.ShortcutClose);
                    _menuCloseAllButThis = new KiwiContextMenuItem(ContextMenus.TextCloseAllButThis, new EventHandler(OnPageCloseAllButThis), ContextMenus.ShortcutCloseAllButThis);
                    _menuSeparator2 = new KiwiContextMenuSeparator();
                    _menuMoveNext = new KiwiContextMenuItem(ContextMenus.TextMoveNext, new EventHandler(OnPageMoveNext), ContextMenus.ShortcutMoveNext);
                    _menuMovePrevious = new KiwiContextMenuItem(ContextMenus.TextMovePrevious, new EventHandler(OnPageMovePrevious), ContextMenus.ShortcutMovePrevious);
                    _menuSeparator3 = new KiwiContextMenuSeparator();
                    _menuSplitVert = new KiwiContextMenuItem(ContextMenus.TextSplitVertical, new EventHandler(OnPageSplitVert), ContextMenus.ShortcutSplitVertical);
                    _menuSplitHorz = new KiwiContextMenuItem(ContextMenus.TextSplitHorizontal, new EventHandler(OnPageSplitHorz), ContextMenus.ShortcutSplitHorizontal);
                    _menuSeparator4 = new KiwiContextMenuSeparator();
                    _menuMaximizeRestore = new KiwiContextMenuItem(ContextMenus.TextMaximize, new EventHandler(OnPageMaximizeRestore), ContextMenus.ShortcutMaximizeRestore);
                    _menuSeparator5 = new KiwiContextMenuSeparator();
                    _menuRebalance = new KiwiContextMenuItem(ContextMenus.TextRebalance, new EventHandler(OnPageRebalance), ContextMenus.ShortcutRebalance);

                    // Add items inside an items collection (apart from separator1 which is only added if required)
                    _menuItems = new KiwiContextMenuItems(new KiwiContextMenuItemBase[] { _menuClose,
                ...
                // Ensure we have a kiwi context menu if not already present
                ...
                _menuSeparator1.Visible = (e.KiwiContextMenu.Items.Count > 0) &&
                ...
                if (!e.KiwiContextMenu.Items.Contains(_menuItems))
                    e.KiwiContextMenu.Items.AddRange(new KiwiContextMenuItemBase[] { _menuSeparator1, _menuItems });

                // Need to know when menu is removed so we can undo our actions
                e.KiwiContextMenu.Closed += new ToolStripDropDownClosedEventHandler(OnCellClosedContextMenu);
        ...
        private void OnCellClosedContextMenu(object sender, ToolStripDropDownClosedEventArgs e)
        {
            ...
            KiwiContextMenu contextMenu = (KiwiContextMenu)sender;
        ...
        private void PageSplitDirection(KiwiWorkspaceCell cell,
                                        KiwiPage page,
                                        Orientation orientation)
        {
            ...
            KiwiWorkspaceSequence parentSequence = cell.WorkspaceParent as KiwiWorkspaceSequence;
            if (parentSequence != null)
            {
                ...
                KiwiWorkspaceCell newCell = new KiwiWorkspaceCell();
                ...
                else
                {
                    ...
                    KiwiWorkspaceSequence newSequence = new KiwiWorkspaceSequence(orientation);
        ...
        private UniqueNameToPage BuildUniqueNameDictionary(KiwiPageCollection pages)
        {
