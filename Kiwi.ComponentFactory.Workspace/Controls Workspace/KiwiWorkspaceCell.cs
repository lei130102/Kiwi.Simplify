...
namespace Kiwi.ComponentFactory.Workspace
{
    ...
    /// </summary>
    [ToolboxItem(false)]
    [Designer("Kiwi.ComponentFactory.Workspace.KiwiWorkspaceCellDesigner, Kiwi.ComponentFactory.Workspace, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    [DefaultProperty("Pages")]
    //
    [ToolboxBitmap(typeof(KiwiWorkspaceCell), "ToolboxBitmaps.KiwiWorkspaceCell.bmp")]
    public class KiwiWorkspaceCell : KiwiNavigator,
                                        IWorkspaceItem
    {
        ...
        #region Identity
        /// <summary>
        /// Initialise a new instance of the KiwiWorkspaceCell class.
        /// </summary>
        public KiwiWorkspaceCell()
            : this("50*,50*")
        {
        }
        ...
        public KiwiWorkspaceCell(string starSize)
        {
            ...
            Pages.Removed += new TypedHandler<KiwiPage>(OnPagesChanged);
            Pages.Inserted += new TypedHandler<KiwiPage>(OnPagesChanged);
            _events = true;
        ...
        protected override void Dispose(bool disposing)
        {
            try
            {
                ...
                if (Parent != null)
                {
                    KiwiReadOnlyControls controls = (KiwiReadOnlyControls)Parent.Controls;
        ...
        /// <summary>
        /// Gets or sets the coordinates of the upper-left corner of the workspace item relative to the upper-left corner of its KiwiWorkspace. 
        /// </summary>
        [Browsable(false)]
        [Bindable(false)]
        [EditorBrowsable(EditorBrowsableState.Never)]
        ...
        /// <summary>
        /// Gets or sets the tab order of the workspace item within its KiwiWorkspace.
        /// </summary>
        [Browsable(false)]
        [EditorBrowsable(EditorBrowsableState.Never)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        /// </summary>
        [Category("Workspace")]
        [Description("Should the KiwiNavigator be Disposed when removed from KiwiWorkspace.")]
        [DefaultValue(true)]
            ...
            if (!xmlReader.IsEmptyElement)
            {
                do
                {
                    ...
                    if (xmlReader.Name == "KP")
                    {
                        ...
                        KiwiPage page = workspace.ReadPageElement(xmlReader, uniqueName, existingPages);
        ...
        /// </summary>
        protected internal KiwiGroupPanel CellChildPanel
        {
    ...
    /// <summary>
    /// Manages a list of KiwiWorkspaceCell instances.
    /// </summary>
    public class KiwiWorkspaceCellList : List<KiwiWorkspaceCell> { }
}
