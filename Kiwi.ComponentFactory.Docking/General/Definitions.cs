...
namespace Kiwi.ComponentFactory.Docking
{
    ...
    public interface IDockingElement : IEnumerable<IDockingElement>
    {
        ...
        void PropogateAction(DockingPropogateAction action, KiwiPage[] pages);
        ...
        void PropogateDragTargets(KiwiFloatingWindow floatingWindow,
        ...
        KiwiPage PropogatePageState(DockingPropogatePageState state, string uniqueName);
        ...
        void PropogatePageList(DockingPropogatePageList state, KiwiPageCollection pages);
        ...
        void PropogateCellList(DockingPropogateCellList state, KiwiWorkspaceCellList cells);
        ...
        KiwiDockingFloating FindDockingFloating(string uniqueName);
        ...
        KiwiDockingEdgeDocked FindDockingEdgeDocked(string uniqueName);
        ...
        KiwiDockingEdgeAutoHidden FindDockingEdgeAutoHidden(string uniqueName);
        ...
        KiwiDockingWorkspace FindDockingWorkspace(string uniqueName);
        ...
        KiwiDockingNavigator FindDockingNavigator(string uniqueName);
        ...
        void LoadElementFromXml(XmlReader xmlReader, KiwiPageCollection pages);
