...
namespace Kiwi.ComponentFactory.Docking
{
    ...
    public class KiwiDockingFloating : DockingElementClosedCollection
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiDockingFloating class.
        /// </summary>
        /// <param name="name">Initial name of the element.</param>
        /// <param name="ownerForm">Reference to form that will own all the floating windows.</param>
        public KiwiDockingFloating(string name, Form ownerForm)
            : base(name)
        {
            if (ownerForm == null)
        ...
        public KiwiDockingFloatingWindow AddFloatingWindow()
        {
        ...
        /// <returns>Reference to docking element that handles the new workspace.</returns>
        public KiwiDockingFloatingWindow AddFloatingWindow(string name)
        {
        ...
        /// <returns>Reference to KiwiDockingFloatingWindow if placeholder found; otherwise null.</returns>
        public KiwiDockingFloatingWindow FloatingWindowForStorePage(string uniqueName)
        {
            // Search all the child docking elements
            foreach (IDockingElement child in this)
            {
                // Only interested in floating window elements
                KiwiDockingFloatingWindow floatingWindow = child as KiwiDockingFloatingWindow;
                                                        ...
                                                        IDockingElement child)
        {
            ...
            else
            {
                ...
                KiwiDockingFloatingWindow floatingWindow = AddFloatingWindow(xmlReader.GetAttribute("N"));
        ...
        private KiwiDockingFloatingWindow CreateFloatingWindow(string name)
        {
            // Create a floatspace and floating window for hosting the floatspace
            KiwiDockingFloatspace floatSpaceElement = new KiwiDockingFloatspace("Floatspace");
            KiwiDockingFloatingWindow floatingWindowElement = new KiwiDockingFloatingWindow(name, OwnerForm, floatSpaceElement);
        ...
        private void OnDockingFloatingWindowDisposed(object sender, EventArgs e)
        {
            ...
            KiwiDockingFloatingWindow floatingWindowElement = (KiwiDockingFloatingWindow)sender;
            floatingWindowElement.Disposed -= new EventHandler(OnDockingFloatingWindowDisposed);
