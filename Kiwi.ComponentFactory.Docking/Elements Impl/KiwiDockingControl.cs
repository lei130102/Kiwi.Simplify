...
namespace Kiwi.ComponentFactory.Docking
{
    ...
    public class KiwiDockingControl : DockingElementOpenCollection
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiDockingControl class.
        /// </summary>
        /// <param name="name">Initial name of the element.</param>
        /// <param name="control">Reference to control derived instance.</param>
        public KiwiDockingControl(string name, Control control)
            : base(name)
        {
            if (control == null)
        ...
        /// <param name="name">Initial name of the element.</param>
        /// <param name="control">Reference to control derived instance.</param>
        /// <param name="navigator">Inner space occupied by a KiwiDockingNavigator.</param>
        public KiwiDockingControl(string name, Control control, KiwiDockingNavigator navigator)
            : base(name)
        {
            if (control == null)
                throw new ArgumentNullException("control");
        ...
        /// <param name="name">Initial name of the element.</param>
        /// <param name="control">Reference to control derived instance.</param>
        /// <param name="workspace">Inner space occupied by a KiwiDockingNavigator.</param>
        public KiwiDockingControl(string name, Control control, KiwiDockingWorkspace workspace)
            : base(name)
        {
            if (control == null)
                throw new ArgumentNullException("control");
                                                  ...
                                                  DragTargetList targets)
        {
            ...
            if (transferPages.Count > 0)
            {
                ...
                targets.Add(new DragTargetControlEdge(screenRect, rectsHot[0], rectsDraw[0], DragTargetHint.EdgeLeft | DragTargetHint.ExcludeCluster, this, KiwiPageFlags.DockingAllowDocked, true));
                targets.Add(new DragTargetControlEdge(screenRect, rectsHot[1], rectsDraw[1], DragTargetHint.EdgeRight | DragTargetHint.ExcludeCluster, this, KiwiPageFlags.DockingAllowDocked, true));
                targets.Add(new DragTargetControlEdge(screenRect, rectsHot[2], rectsDraw[2], DragTargetHint.EdgeTop | DragTargetHint.ExcludeCluster, this, KiwiPageFlags.DockingAllowDocked, true));
                targets.Add(new DragTargetControlEdge(screenRect, rectsHot[3], rectsDraw[3], DragTargetHint.EdgeBottom | DragTargetHint.ExcludeCluster, this, KiwiPageFlags.DockingAllowDocked, true));
                ...
                if (_innerElement == null)
                {
                    ...
                    if ((innerRect.Width > 0) && (innerRect.Height > 0))
                    {
                        ...
                        targets.Add(new DragTargetControlEdge(innerScreenRect, innerRectsHot[0], innerRectsDraw[0], DragTargetHint.EdgeLeft, this, KiwiPageFlags.DockingAllowDocked, false));
                        targets.Add(new DragTargetControlEdge(innerScreenRect, innerRectsHot[1], innerRectsDraw[1], DragTargetHint.EdgeRight, this, KiwiPageFlags.DockingAllowDocked, false));
                        targets.Add(new DragTargetControlEdge(innerScreenRect, innerRectsHot[2], innerRectsDraw[2], DragTargetHint.EdgeTop, this, KiwiPageFlags.DockingAllowDocked, false));
                        targets.Add(new DragTargetControlEdge(innerScreenRect, innerRectsHot[3], innerRectsDraw[3], DragTargetHint.EdgeBottom, this, KiwiPageFlags.DockingAllowDocked, false));
                    }
                }
                else if (_innerElement is KiwiDockingNavigator)
                {
                    KiwiDockingNavigator dockingNavigator = (KiwiDockingNavigator)_innerElement;
        ...
        private void Construct(Control control, IDockingElement innerElement)
        {
            ...
            Add(new KiwiDockingEdge("Top", control, DockingEdge.Top));
            Add(new KiwiDockingEdge("Bottom", control, DockingEdge.Bottom));
            Add(new KiwiDockingEdge("Left", control, DockingEdge.Left));
            Add(new KiwiDockingEdge("Right", control, DockingEdge.Right));
        }
        ...
        private void EnforceInnerMinimum(int remove, Orientation orientation)
        {
            ...
            List<KiwiDockspace> controls = new List<KiwiDockspace>();
            foreach (Control c in Control.Controls)
            {
                KiwiDockspace dockspace = c as KiwiDockspace;
            ...
            while ((remove > 0) && (controls.Count > 0))
            {
                ...
                {
                    KiwiDockspace dockspace = controls[i];
