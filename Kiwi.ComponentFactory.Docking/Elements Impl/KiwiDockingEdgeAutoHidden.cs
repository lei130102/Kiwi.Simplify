...
namespace Kiwi.ComponentFactory.Docking
{
    ...
    public class KiwiDockingEdgeAutoHidden : DockingElementClosedCollection
    {
        ...
        private KiwiAutoHiddenPanel _panel;
        private KiwiAutoHiddenSlidePanel _slidePanel;
        private bool _panelEventFired;
        #endregion

        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiDockingEdgeAutoHidden class.
        /// </summary>
        ...
        public KiwiDockingEdgeAutoHidden(string name, Control control, DockingEdge edge)
            : base(name)
        {
            if (control == null)
            ...
            _panel = new KiwiAutoHiddenPanel(edge);
            ...
            _slidePanel = new KiwiAutoHiddenSlidePanel(control, edge, _panel);
        ...
        public KiwiDockingAutoHiddenGroup AppendAutoHiddenGroup()
        {
        ...
        /// <returns>Reference to docking element that handles the new auto hidden group.</returns>
        public KiwiDockingAutoHiddenGroup AppendAutoHiddenGroup(string name)
        {
        ...
        /// <returns>Reference to docking element that handles the new auto hidden group.</returns>
        public KiwiDockingAutoHiddenGroup InsertAutoHiddenGroup(int index)
        {
            // Generate a unique string by creating a GUID
        ...
        /// <param name="name">Initial name of the group element.</param>
        /// <returns>Reference to docking element that handles the new auto hidden group.</returns>
        public KiwiDockingAutoHiddenGroup InsertAutoHiddenGroup(int index, string name)
        {
        ...
        public void SlidePageOut(KiwiPage page, bool select)
        {
        ...
        public void SlidePageOut(string uniqueName, bool select)
        {
            ...
            {
                KiwiDockingAutoHiddenGroup ahg = this[i] as KiwiDockingAutoHiddenGroup;
                if (ahg != null)
                {
                    // If the target page is inside this group
                    KiwiPage page = ahg.AutoHiddenGroupControl.Pages[uniqueName];
                    if (page != null)
                    {
                                                        ...
                                                        IDockingElement child)
        {
            ...
            else
            {
                ...
                KiwiDockingAutoHiddenGroup autoHiddenGroup = AppendAutoHiddenGroup(xmlReader.GetAttribute("N"));
        ...
        private KiwiDockingAutoHiddenGroup CreateAndInsertAutoHiddenGroup(int index, string name)
        {
            // Create the new auto hidden group instance and add into our collection
            KiwiDockingAutoHiddenGroup groupElement = new KiwiDockingAutoHiddenGroup(name, Edge);
            groupElement.PageClicked += new EventHandler<KiwiPageEventArgs>(OnDockingAutoHiddenGroupClicked);
            groupElement.PageHoverStart += new EventHandler<KiwiPageEventArgs>(OnDockingAutoHiddenGroupHoverStart);
        ...
        private void OnDockingAutoHiddenGroupDisposed(object sender, EventArgs e)
        {
            ...
            KiwiDockingAutoHiddenGroup groupElement = (KiwiDockingAutoHiddenGroup)sender;
            groupElement.PageClicked -= new EventHandler<KiwiPageEventArgs>(OnDockingAutoHiddenGroupClicked);
            groupElement.PageHoverStart -= new EventHandler<KiwiPageEventArgs>(OnDockingAutoHiddenGroupHoverStart);
            groupElement.PageHoverEnd -= new EventHandler<EventArgs>(OnDockingAutoHiddenGroupHoverEnd);
            groupElement.Disposed -= new EventHandler(OnDockingAutoHiddenGroupDisposed);
        ...
        private void OnDockingAutoHiddenGroupClicked(object sender, KiwiPageEventArgs e)
        {
            // Request the sliding panel slide itself into view with the provided page
            KiwiDockingAutoHiddenGroup dockingGroup = (KiwiDockingAutoHiddenGroup)sender;
            _slidePanel.SlideOut(e.Item, dockingGroup.AutoHiddenGroupControl, true);
        }

        private void OnDockingAutoHiddenGroupHoverStart(object sender, KiwiPageEventArgs e)
        {
            // Request the sliding panel slide itself into view with the provided page
            KiwiDockingAutoHiddenGroup dockingGroup = (KiwiDockingAutoHiddenGroup)sender;
        ...
        private void OnSlidePanelSeparatorMoveRect(object sender, SplitterMoveRectMenuArgs e)
        {
            ...
            KiwiDockspace dockspaceControl = _slidePanel.DockspaceControl;
            KiwiPage page = _slidePanel.Page;
        ...
        private Rectangle FindMovementRect(Rectangle moveRect)
        {
            ...
            {
                if (child.Visible && child is KiwiAutoHiddenPanel)
                {
                    switch (child.Dock)
                    {
                        case DockStyle.Left:
