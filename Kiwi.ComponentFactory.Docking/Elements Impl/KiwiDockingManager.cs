...
namespace Kiwi.ComponentFactory.Docking
{
    ...
    //
    [ToolboxBitmap(typeof(KiwiDockingManager), "ToolboxBitmaps.KiwiDockingManager.bmp")]
    public class KiwiDockingManager : DockingElementOpenCollection
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiDockingManager class.
        /// </summary>
        public KiwiDockingManager()
            : this("DockingManager")
        {
        }
        ...
        public KiwiDockingManager(string name)
            : base(name)
        {
            InitializeManager();
        }
        ...
        /// <returns>KiwiDockingControl instance created.</returns>
        public KiwiDockingControl ManageControl(Control c)
        {
        ...
        /// <returns>KiwiDockingControl instance created.</returns>
        public KiwiDockingControl ManageControl(Control c, KiwiDockingNavigator navigator)
        {
        ...
        /// <returns>KiwiDockingControl instance created.</returns>
        public KiwiDockingControl ManageControl(Control c, KiwiDockingWorkspace workspace)
        {
        ...
        /// <param name="c">Reference to control instance.</param>
        /// <returns>KiwiDockingControl instance created.</returns>
        public KiwiDockingControl ManageControl(string name, Control c)
        {
            KiwiDockingControl dockingControl = new KiwiDockingControl(name, c);
            Add(dockingControl);
        ...
        /// <param name="navigator">Reference to docking navigator that is inside the control.</param>
        /// <returns>KiwiDockingControl instance created.</returns>
        public KiwiDockingControl ManageControl(string name, Control c, KiwiDockingNavigator navigator)
        {
            KiwiDockingControl dockingControl = new KiwiDockingControl(name, c, navigator);
            Add(dockingControl);
            return dockingControl;
        }
        ...
        /// <param name="workspace">Reference to docking workspace that is inside the control.</param>
        /// <returns>KiwiDockingControl instance created.</returns>
        public KiwiDockingControl ManageControl(string name, Control c, KiwiDockingWorkspace workspace)
        {
            KiwiDockingControl dockingControl = new KiwiDockingControl(name, c, workspace);
            Add(dockingControl);
            return dockingControl;
        }
        ...
        /// <returns>KiwiDockingFloating instance created.</returns>
        public KiwiDockingFloating ManageFloating(Form f)
        {
        ...
        /// <param name="f">Reference to form.</param>
        /// <returns>KiwiDockingFloating instance created.</returns>
        public KiwiDockingFloating ManageFloating(string name, Form f)
        {
            KiwiDockingFloating dockingFloating = new KiwiDockingFloating(name, f);
            Add(dockingFloating);
        ...
        /// <returns>KiwiDockingWorkspace instance created.</returns>
        public KiwiDockingWorkspace ManageWorkspace(KiwiDockableWorkspace w)
        {
        ...
        /// <param name="w">Reference to dockable workspace.</param>
        /// <returns>KiwiDockingWorkspace instance created.</returns>
        public KiwiDockingWorkspace ManageWorkspace(string name, KiwiDockableWorkspace w)
        {
        ...
        /// <param name="w">Reference to dockable workspace.</param>
        /// <returns>KiwiDockingWorkspace instance created.</returns>
        public KiwiDockingWorkspace ManageWorkspace(string name, string storeName, KiwiDockableWorkspace w)
        {
            KiwiDockingWorkspace dockingWorkspace = new KiwiDockingWorkspace(name, storeName, w);
        ...
        /// <returns>KiwiDockingNavigator instance created.</returns>
        public KiwiDockingNavigator ManageNavigator(KiwiDockableNavigator n)
        {
        ...
        /// <param name="n">Reference to dockable navigator.</param>
        /// <returns>KiwiDockingNavigator instance created.</returns>
        public KiwiDockingNavigator ManageNavigator(string name, KiwiDockableNavigator n)
        {
        ...
        /// <param name="n">Reference to dockable navigator.</param>
        /// <returns>KiwiDockingNavigator instance created.</returns>
        public KiwiDockingNavigator ManageNavigator(string name, string storeName, KiwiDockableNavigator n)
        {
            KiwiDockingNavigator dockingNavigator = new KiwiDockingNavigator(name, storeName, n);
        ...
        public bool IsPageShowing(KiwiPage page)
        {
        ...
        public void RemovePage(KiwiPage page, bool disposePage)
        {
        ...
        public bool ContainsPage(KiwiPage page)
        {
        ...
        public KiwiPage PageForUniqueName(string uniqueName)
        {
            // Cannot find a null reference
            if (uniqueName == null)
                throw new ArgumentNullException("uniqueName");
        ...
        public void StorePage(KiwiPage page)
        {
        ...
        public void StorePages(KiwiPage[] pages)
        {
            // Cannot replace a null reference
            if (pages == null)
                throw new ArgumentNullException("pages");
        ...
        /// </summary>
        /// <param name="pages">Array of references to pages that should be shown.</param>
        public void ClearStoredPages(KiwiPage[] pages)
        {
            // Cannot show a null reference
            if (pages == null)
                throw new ArgumentNullException("pages");
        ...
        public DockingLocation FindPageLocation(KiwiPage page)
        {
            // Cannot find a null reference
            if (page == null)
                throw new ArgumentNullException("page");
        ...
        public IDockingElement FindPageElement(KiwiPage page)
        {
            // Cannot find a null reference
            if (page == null)
                throw new ArgumentNullException("page");
        ...
        public IDockingElement FindStorePageElement(DockingLocation location, KiwiPage page)
        {
            // Cannot find a null reference
            if (page == null)
                throw new ArgumentNullException("page");
        ...
        /// <returns>KiwiDockingFloating reference if found; otherwise false.</returns>
        public override KiwiDockingFloating FindDockingFloating(string uniqueName)
        {
            // First preference is to find an existing store page inside a floating element
            KiwiDockingFloating floating = FindStorePageElement(DockingLocation.Floating, uniqueName) as KiwiDockingFloating;
            if (floating != null)
                return floating;
        ...
        public override KiwiDockingEdgeDocked FindDockingEdgeDocked(string uniqueName)
        {
            ...
            if (element is KiwiDockingDockspace)
            {
                // Find the edge the dockspace is against and return the matching docked edge
                KiwiDockingEdgeDocked edge = element.GetParentType(typeof(KiwiDockingEdgeDocked)) as KiwiDockingEdgeDocked;
                if (edge != null)
                    return edge;
            }

            // If exists as a auto hidden group page...
            if (element is KiwiDockingAutoHiddenGroup)
            {
                KiwiDockingEdgeAutoHidden edge = element.GetParentType(typeof(KiwiDockingEdgeAutoHidden)) as KiwiDockingEdgeAutoHidden;
                if (edge != null)
                {
                    // Finally we grab the auto hidden edge that is expected to be a sibling of the docked edge
                    KiwiDockingEdgeDocked edgeDocked = edge["Docked"] as KiwiDockingEdgeDocked;
                    if (edgeDocked != null)
                        return edgeDocked;
                }
            }
            ...
            KiwiDockingDockspace dockspace = FindStorePageElement(DockingLocation.Docked, uniqueName) as KiwiDockingDockspace;
            if (dockspace != null)
            {
                // Find the docked edge that the dockspace is inside
                KiwiDockingEdgeDocked edgeDocked = dockspace.GetParentType(typeof(KiwiDockingEdgeDocked)) as KiwiDockingEdgeDocked;
                if (edgeDocked != null)
                    return edgeDocked;
            }

            // Second preference is to find an existing store page inside a auto hidden group element
            KiwiDockingAutoHiddenGroup group = FindStorePageElement(DockingLocation.AutoHidden, uniqueName) as KiwiDockingAutoHiddenGroup;
            if (group != null)
            {
                // Navigate upwards to find the edge that this group is inside
                KiwiDockingEdge edge = group.GetParentType(typeof(KiwiDockingEdge)) as KiwiDockingEdge;
                if (edge != null)
                {
        ...
        /// <returns>KiwiDockingEdgeAutoHidden reference if found; otherwise false.</returns>
        public override KiwiDockingEdgeAutoHidden FindDockingEdgeAutoHidden(string uniqueName)
        {
            // Try and find as an existing page inside the hierarchy
            DockingElement element = FindPageElement(uniqueName) as DockingElement;
            ...
            if (element is KiwiDockingDockspace)
            {
                KiwiDockingEdge edge = element.GetParentType(typeof(KiwiDockingEdge)) as KiwiDockingEdge;
                if (edge != null)
                {
                    // Finally we grab the auto hidden edge that is expected to be a sibling of the docked edge
                    KiwiDockingEdgeAutoHidden edgeAutoHidden = edge["AutoHidden"] as KiwiDockingEdgeAutoHidden;
            ...
            if (group != null)
            {
                ...
                KiwiDockingEdgeAutoHidden edgeAutoHidden = group.GetParentType(typeof(KiwiDockingEdgeAutoHidden)) as KiwiDockingEdgeAutoHidden;
                if (edgeAutoHidden != null)
                    return edgeAutoHidden;
            }
            ...
            if (dockspace != null)
            {
                ...
                KiwiDockingEdge edge = dockspace.GetParentType(typeof(KiwiDockingEdge)) as KiwiDockingEdge;
                if (edge != null)
                {
                    // Finally we grab the auto hidden edge that is expected to be a sibling of the docked edge
                    KiwiDockingEdgeAutoHidden edgeAutoHidden = edge["AutoHidden"] as KiwiDockingEdgeAutoHidden;
        ...
        /// <returns>KiwiDockingWorkspace reference if found; otherwise false.</returns>
        public override KiwiDockingWorkspace FindDockingWorkspace(string uniqueName)
        {
            // First preference is to find an existing store page inside a workspace element
            KiwiDockingWorkspace workspace = FindStorePageElement(DockingLocation.Workspace, uniqueName) as KiwiDockingWorkspace;
            if (workspace != null)
                return workspace;
        ...
        public virtual void MakeAutoHiddenRequest(string uniqueName)
        {
            ...
            if (ContainsPage(uniqueName) && (FindPageLocation(uniqueName) != DockingLocation.AutoHidden))
            {
                ...
                KiwiDockingEdgeAutoHidden autoHidden = FindDockingEdgeAutoHidden(uniqueName);
                if (autoHidden != null)
                {
                    KiwiPage page = PageForUniqueName(uniqueName);
                    if (page != null)
                    {
                        // Ensure all docking controls have been layed out before the change is processed
                        Application.DoEvents();

                        CancelUniqueNameEventArgs args = new CancelUniqueNameEventArgs(uniqueName, !page.AreFlagsSet(KiwiPageFlags.DockingAllowAutoHidden));
                        ...
                        using (DockingMultiUpdate update = new DockingMultiUpdate(this))
                        {
                            ...
                            KiwiDockingAutoHiddenGroup restoreElement = autoHidden.FindStorePageElement(DockingLocation.AutoHidden, uniqueName) as KiwiDockingAutoHiddenGroup;
                            if (restoreElement != null)
                            {
                                // Find the target index of the restore page
                                KiwiAutoHiddenGroup control = restoreElement.AutoHiddenGroupControl;
                                int pageIndex = control.Pages.IndexOf(control.Pages[uniqueName]);

                                // Insert the page at the same index as the restore page
                                control.Pages.Insert(pageIndex, new KiwiAutoHiddenProxyPage(page));
                            }
                            else
                            {
                                // No existing store page so add as a new group
                                restoreElement = autoHidden.AppendAutoHiddenGroup();
                                restoreElement.Append(new KiwiPage[] { page });
                            }
                        }
                    }
                }
        ...
        public virtual void MakeDockedRequest(string uniqueName)
        {
            ...
            if (ContainsPage(uniqueName) && (FindPageLocation(uniqueName) != DockingLocation.Docked))
            {
                ...
                KiwiDockingEdgeDocked docked = FindDockingEdgeDocked(uniqueName);
                if (docked != null)
                {
                    KiwiPage page = PageForUniqueName(uniqueName);
                    if (page != null)
                    {
                        ...
                        CancelUniqueNameEventArgs args = new CancelUniqueNameEventArgs(uniqueName, !page.AreFlagsSet(KiwiPageFlags.DockingAllowDocked));
                        ...
                        using (DockingMultiUpdate update = new DockingMultiUpdate(this))
                        {
                            ...
                            KiwiDockingDockspace restoreElement = docked.FindStorePageElement(DockingLocation.Docked, uniqueName) as KiwiDockingDockspace;
                            if (restoreElement != null)
                            {
                                // Find the target cell and the index of the restore page
                                KiwiWorkspaceCell cell = restoreElement.CellForPage(uniqueName);
                                int pageIndex = cell.Pages.IndexOf(cell.Pages[uniqueName]);

                                // Insert the page at the same index as the restore page
                                restoreElement.CellInsert(cell, pageIndex, new KiwiPage[] { page });
                            ...
                            else
                            {
                                ...
                                KiwiDockingDockspace dockspaceElement = docked.AppendDockspace();
                                dockspaceElement.Append(new KiwiPage[] { page });
        ...
        public virtual void MakeFloatingRequest(string uniqueName)
        {
            ...
            if (ContainsPage(uniqueName) && (FindPageLocation(uniqueName) != DockingLocation.Floating))
            {
                ...
                KiwiDockingFloating floating = FindDockingFloating(uniqueName);
                if (floating != null)
                {
                    KiwiPage page = PageForUniqueName(uniqueName);
                    if (page != null)
                    {
                        ...
                        CancelUniqueNameEventArgs args = new CancelUniqueNameEventArgs(uniqueName, !page.AreFlagsSet(KiwiPageFlags.DockingAllowFloating));
                        ...
                        using (DockingMultiUpdate update = new DockingMultiUpdate(this))
                        {
                            ...
                            KiwiDockingFloatingWindow restoreElement = floating.FloatingWindowForStorePage(uniqueName);
                            if (restoreElement != null)
                            {
                                // Find the target cell and the index of the restore page
                                KiwiWorkspaceCell cell = restoreElement.CellForPage(uniqueName);
                                ...
                                // Insert the page at the same index as the restore page
                                restoreElement.FloatspaceElement.CellInsert(cell, pageIndex, new KiwiPage[] { page });
                                restoreElement.SelectPage(uniqueName);
                            ...
                            else
                            {
                                ...
                                KiwiDockingFloatingWindow floatingElement = floating.AddFloatingWindow();
                                floatingElement.FloatspaceElement.Append(new KiwiPage[] { page });
        ...
        public virtual void MakeWorkspaceRequest(string uniqueName)
        {
            ...
            if (ContainsPage(uniqueName) && (FindPageLocation(uniqueName) != DockingLocation.Workspace))
            {
                ...
                KiwiDockingWorkspace workspaceElement = FindDockingWorkspace(uniqueName);
                if (workspaceElement != null)
                {
                    ...
                    if (page != null)
                    {
                        ...
                        CancelUniqueNameEventArgs args = new CancelUniqueNameEventArgs(uniqueName, !page.AreFlagsSet(KiwiPageFlags.DockingAllowWorkspace));
                        ...
                        using (DockingMultiUpdate update = new DockingMultiUpdate(this))
                        {
                            ...
                            KiwiWorkspaceCell cell = workspaceElement.CellForPage(uniqueName);

                            if (cell != null)
                            {
                                // Insert the page at the same index as the restore page
                                int pageIndex = cell.Pages.IndexOf(cell.Pages[uniqueName]);
                                workspaceElement.CellInsert(cell, pageIndex, new KiwiPage[] { page });
                            ...
                            else
                            {
                                ...
                                workspaceElement.Append(new KiwiPage[] { page });
                                workspaceElement.SelectPage(uniqueName);
                                workspaceElement.DockableWorkspaceControl.Select();
                            }
                        }
        ...
        public virtual void MakeNavigatorRequest(string uniqueName)
        {
            ...
            if (ContainsPage(uniqueName) && (FindPageLocation(uniqueName) != DockingLocation.Navigator))
            {
                ...
                KiwiDockingNavigator navigatorElement = FindDockingNavigator(uniqueName);
                if (navigatorElement != null)
                {
                    ...
                    if (page != null)
                    {
                        ...
                        CancelUniqueNameEventArgs args = new CancelUniqueNameEventArgs(uniqueName, !page.AreFlagsSet(KiwiPageFlags.DockingAllowNavigator));
                        ...
                        using (DockingMultiUpdate update = new DockingMultiUpdate(this))
                        {
                            ...
                            KiwiDockableNavigator navigatorControl = navigatorElement.DockableNavigatorControl;
                            KiwiPage insertPage = navigatorControl.Pages[uniqueName];
                            if (insertPage != null)
                            {
        ...
        public virtual bool ShowPageContextMenuRequest(KiwiPage page, KiwiContextMenu kcm)
        {
            // Cannot action a null reference
            ...
            if (location != DockingLocation.None)
            {
                ...
                KiwiContextMenuItems options = new KiwiContextMenuItems();
                kcm.Items.Clear();
                ...
                if (FindDockingFloating(page.UniqueName) != null)
                {
                    ...
                    KiwiContextMenuItem floatingItem = new KiwiContextMenuItem(Strings.TextFloat);
                    floatingItem.Tag = page.UniqueName;
                    floatingItem.Click += new EventHandler(OnDropDownFloatingClicked);
                    floatingItem.Enabled = ((location != DockingLocation.Floating) && (page.AreFlagsSet(KiwiPageFlags.DockingAllowFloating)));
                ...
                if (FindDockingEdgeDocked(page.UniqueName) != null)
                {
                    ...
                    KiwiContextMenuItem dockedItem = new KiwiContextMenuItem(Strings.TextDock);
                    dockedItem.Tag = page.UniqueName;
                    dockedItem.Click += new EventHandler(OnDropDownDockedClicked);
                    dockedItem.Enabled = ((location != DockingLocation.Docked) && (page.AreFlagsSet(KiwiPageFlags.DockingAllowDocked)));
                ...
                {
                    // Add an option for docked the page
                    KiwiContextMenuItem workspaceItem = new KiwiContextMenuItem(Strings.TextTabbedDocument);
                    workspaceItem.Tag = page.UniqueName;
                    workspaceItem.Click += new EventHandler(OnDropDownWorkspaceClicked);
                    workspaceItem.Enabled = ((location != DockingLocation.Workspace) && (page.AreFlagsSet(KiwiPageFlags.DockingAllowWorkspace)));
                ...
                else
                {
                    ...
                    if (FindDockingNavigator(page.UniqueName) != null)
                    {
                        ...
                        workspaceItem.Enabled = ((location != DockingLocation.Navigator) && (page.AreFlagsSet(KiwiPageFlags.DockingAllowNavigator)));
                        options.Items.Add(workspaceItem);
                        retDisplay = true;
                    }
                }
                ...
                {
                    // Add an option for docked the page
                    KiwiContextMenuItem autoHiddenItem = new KiwiContextMenuItem(Strings.TextAutoHide);
                    autoHiddenItem.Tag = page.UniqueName;
                    autoHiddenItem.Click += new EventHandler(OnDropDownAutoHiddenClicked);
                    autoHiddenItem.Enabled = ((location != DockingLocation.AutoHidden) && (page.AreFlagsSet(KiwiPageFlags.DockingAllowAutoHidden)));
                    options.Items.Add(autoHiddenItem);
                    retDisplay = true;
                }

                // Can only add the close menu option if we are allowed to close the page
                if (page.AreFlagsSet(KiwiPageFlags.DockingAllowClose))
                {
                    // Add an option for closing the page
                    KiwiContextMenuItem closeItem = new KiwiContextMenuItem(Strings.TextClose);
        ...
        /// <returns>KiwiDockingAutoHiddenGroup reference on success; otherwise null.</returns>
        public virtual KiwiDockingAutoHiddenGroup SwitchDockedCellToAutoHiddenGroupRequest(string uniqueName)
        {
            ...
            if (FindPageLocation(uniqueName) == DockingLocation.Docked)
            {
                ...
                KiwiDockingDockspace dockspace = (KiwiDockingDockspace)ExpectPageElement(uniqueName, typeof(KiwiDockingDockspace));
                if (dockspace != null)
                {
                    ...
                    KiwiDockingEdgeAutoHidden edgeAutoHidden = dockspace.EdgeAutoHiddenElement;
                    if (edgeAutoHidden != null)
                    {
                        // Grab the set of visible pages in the same cell as the target unique name
                        KiwiPage[] visiblePages = dockspace.CellVisiblePages(uniqueName);
                        if (visiblePages.Length > 0)
                        {
                            // Use events to determine which pages in the cell should be switched
                            List<string> switchUniqueNames = new List<string>();
                            List<KiwiPage> switchPages = new List<KiwiPage>();
                            foreach (KiwiPage page in visiblePages)
                            {
                                CancelUniqueNameEventArgs args = new CancelUniqueNameEventArgs(page.UniqueName, !page.AreFlagsSet(KiwiPageFlags.DockingAllowAutoHidden));
                                OnPageAutoHiddenRequest(args);
                            ...
                            if (switchPages.Count > 0)
                            {
                                using (DockingMultiUpdate update = new DockingMultiUpdate(this))
                                {
                                    ...
                                    KiwiDockingAutoHiddenGroup group = edgeAutoHidden.AppendAutoHiddenGroup();
                                    ...
                                    if (hadFocus && !dockspace.DockspaceControl.ContainsFocus)
                                    {
                                        ...
                                        if ((topForm != null) && !topForm.ContainsFocus)
                                        {
                                            ...
                                            KiwiDockingEdgeAutoHidden edge = group.GetParentType(typeof(KiwiDockingEdgeAutoHidden)) as KiwiDockingEdgeAutoHidden;
                                            if (edge != null)
                                                topForm.Focus();
                                        }
                                    }
        ...
        /// <returns>KiwiDockingFloatingWindow reference on success; otherwise null.</returns>
        public virtual KiwiDockingFloatingWindow SwitchDockedToFloatingWindowRequest(string[] uniqueNames)
        {
            // Cannot action a null reference
            if (uniqueNames == null)
                throw new ArgumentNullException("uniqueNames");
            ...
            foreach (string uniqueName in uniqueNames)
            {
                ...
                if (FindPageLocation(uniqueName) == DockingLocation.Docked)
                {
                    ...
                    if (page != null)
                    {
                        CancelUniqueNameEventArgs args = new CancelUniqueNameEventArgs(page.UniqueName, !page.AreFlagsSet(KiwiPageFlags.DockingAllowFloating));
                        OnPageFloatingRequest(args);
                        ...
                        if (!args.Cancel)
                        {
                            ...
                            KiwiDockingDockspace dockspace = FindPageElement(page) as KiwiDockingDockspace;
                            if (dockspace != null)
                            {
                                KiwiWorkspaceCell cell = dockspace.CellForPage(uniqueName);
                                if (cell != null)
                                {
            ...
            if (switchUniqueNames.Count > 0)
            {
                ...
                KiwiDockingFloating floating = FindDockingFloating(selectedPage != null ? selectedPage : switchUniqueNames[0]);
                if (floating != null)
                {
                    using (DockingMultiUpdate update = new DockingMultiUpdate(this))
                    {
                        ...
                        KiwiWorkspaceCell cell = null;
                        foreach (string switchUniqueName in switchUniqueNames)
                        {
                            // Is there a floating window with a restore page for this unique name?
                            KiwiDockingFloatingWindow restoreElement = floating.FloatingWindowForStorePage(switchUniqueName);
                            if (restoreElement != null)
                            {
                                // Find the target cell and the index of the restore page
        ...
        /// <returns>KiwiDockingDockspace reference if a new dockspace needed to be created; otherwise false.</returns>
        public virtual KiwiDockingDockspace SwitchFloatingToDockedRequest(string[] uniqueNames)
        {
            // Cannot action a null reference
            if (uniqueNames == null)
                throw new ArgumentNullException("uniqueNames");
            ...
            foreach (string uniqueName in uniqueNames)
            {
                ...
                if (FindPageLocation(uniqueName) == DockingLocation.Floating)
                {
                    ...
                    if (page != null)
                    {
                        CancelUniqueNameEventArgs args = new CancelUniqueNameEventArgs(page.UniqueName, !page.AreFlagsSet(KiwiPageFlags.DockingAllowDocked));
                        OnPageDockedRequest(args);
                        ...
                        if (!args.Cancel)
                        {
                            ...
                            // Navigate to the cell that holds the page
                            KiwiDockingFloatspace floatspace = FindPageElement(page) as KiwiDockingFloatspace;
                            if (floatspace != null)
                            {
                                KiwiWorkspaceCell cell = floatspace.CellForPage(uniqueName);
                                if (cell != null)
                                {
                                    // Remember the page that is active
                                    if (cell.SelectedPage == page)
            ...
            if (switchUniqueNames.Count > 0)
            {
                using (DockingMultiUpdate update = new DockingMultiUpdate(this))
                {
                    ...
                    List<KiwiPage> defaultPages = new List<KiwiPage>();
                    KiwiPage defaultSelectedPage = null;
                    for (int i = 0; i < switchUniqueNames.Count; i++)
                    {
                        ...
                        KiwiDockingDockspace restoreElement = DockingManager.FindStorePageElement(DockingLocation.Docked, switchUniqueName) as KiwiDockingDockspace;
                        if (restoreElement != null)
                        {
                            // Find the target cell and the index of the restore page
                            KiwiWorkspaceCell cell = restoreElement.CellForPage(switchUniqueName);
                            int pageIndex = cell.Pages.IndexOf(cell.Pages[switchUniqueName]);
                    ...
                    if (defaultPages.Count > 0)
                    {
                        ...
                        KiwiDockingEdgeDocked edgeDocked = FindDockingEdgeDocked(defaultSelectedPage != null ? defaultSelectedPage.UniqueName : defaultPages[0].UniqueName);
                        if (edgeDocked != null)
                        {
                            KiwiDockingDockspace dockspace = edgeDocked.AppendDockspace();
        ...
        /// </summary>
        /// <param name="uniqueNames">Unique name of floating pages that need switching.</param>
        /// <returns>KiwiDockingFloatingWindow reference on success; otherwise false.</returns>
        public virtual KiwiDockingFloatingWindow SwitchFloatingToFloatingWindowRequest(string[] uniqueNames)
        {
            // Cannot action a null reference
            if (uniqueNames == null)
                throw new ArgumentNullException("uniqueNames");
            ...
            if (switchUniqueNames.Count > 0)
            {
                ...
                if (floating != null)
                {
                    using (DockingMultiUpdate update = new DockingMultiUpdate(this))
                    {
                        ...
                        KiwiDockingFloatspace currentElement = FindPageElement(switchPages[0]) as KiwiDockingFloatspace;
        ...
        /// <returns>KiwiDockingDockspace reference if a new dockspace needed to be created; otherwise false.</returns>
        public virtual KiwiDockingDockspace SwitchAutoHiddenGroupToDockedCellRequest(string uniqueName)
        {
            // Cannot switch a null reference
            if (uniqueName == null)
                throw new ArgumentNullException("uniqueName");
            ...
            if (FindPageLocation(uniqueName) == DockingLocation.AutoHidden)
            {
                ...
                KiwiDockingAutoHiddenGroup autoHiddenGroup = (KiwiDockingAutoHiddenGroup)ExpectPageElement(uniqueName, typeof(KiwiDockingAutoHiddenGroup));
                if (autoHiddenGroup != null)
                {
                    // Find the sibling docked edge so we can add/restore pages
                    KiwiDockingEdgeDocked edgeDocked = autoHiddenGroup.EdgeDockedElement;
                    if (edgeDocked != null)
                    {
                        // Grab the set of visible pages in the auto hidden group
                        KiwiPage[] visiblePages = autoHiddenGroup.VisiblePages();
                        if (visiblePages.Length > 0)
                        {
                            // Use events to determine which pages in the cell should be switched
                            List<string> switchUniqueNames = new List<string>();
                                ...
                                using (DockingMultiUpdate update = new DockingMultiUpdate(this))
                                {
                                    ...
                                    for (int i = 0; i < switchPages.Count; i++)
                                    {
                                        ...
                                        if (canRestore.HasValue && canRestore.Value)
                                        {
                                            ...
                                            edgeDocked.PropogateAction(DockingPropogateAction.RestorePages, new KiwiPage[] { switchPages[i] });
                                            ...
                                            if (uniqueName == uniqueNames[i])
                                            {
                                                ...
                                                KiwiDockingDockspace restoreElement = edgeDocked.FindPageElement(uniqueNames[i]) as KiwiDockingDockspace;
                                                if (restoreElement != null)
                                                {
                                    ...
                                    if (defaultPages.Count > 0)
                                    {
                                        ...
                                        KiwiDockingDockspace newDockspace = edgeDocked.AppendDockspace();
        ...
        /// </summary>
        /// <param name="path">Path for finding the target KiwiDockingControl.</param>
        /// <param name="edge">Target edge within the KiwiDockingControl.</param>
        ...
        /// <returns>KiwiDockingDockspace reference.</returns>
        public virtual KiwiDockingDockspace AddDockspace(string path,
                                                            DockingEdge edge,
                                                            KiwiPage[] pages,
                                                            params KiwiPage[][] stackPages)
        {
            ...
            KiwiDockingControl control = ResolvePath(path) as KiwiDockingControl;
            if (control == null)
                throw new ArgumentException("Path does not resolve to a KiwiDockingControl");

            // Find the requested target edge
            KiwiDockingEdge edgeElement = control[edge.ToString()] as KiwiDockingEdge;
            if (edgeElement == null)
                throw new ArgumentException("KiwiDockingControl does not have the requested edge.");

            // Find the docked edge
            KiwiDockingEdgeDocked edgeDocked = edgeElement["Docked"] as KiwiDockingEdgeDocked;
            if (edgeDocked == null)
                throw new ArgumentException("KiwiDockingControl edge does not have a docked element.");

            KiwiDockingDockspace dockspace = null;
            using (DockingMultiUpdate update = new DockingMultiUpdate(this))
            {
                ...
                if ((stackPages != null) && (stackPages.Length > 0))
                {
                    ...
                    foreach (KiwiPage[] pageArray in stackPages)
        ...
        /// <returns>KiwiDockingAutoHiddenGroup reference.</returns>
        public virtual KiwiDockingAutoHiddenGroup AddAutoHiddenGroup(string path,
                                                                        DockingEdge edge,
                                                                        KiwiPage[] pages,
                                                                        params KiwiPage[][] extraPages)
        {
            // Cannot add a null array
            if (pages == null)
                throw new ArgumentNullException("pages");
            ...
            KiwiDockingEdgeAutoHidden edgeAutoHidden = edgeElement["AutoHidden"] as KiwiDockingEdgeAutoHidden;
            if (edgeAutoHidden == null)
                throw new ArgumentException("KiwiDockingControl edge does not have an auto hidden element.");

            KiwiDockingAutoHiddenGroup autoHiddenGroup = null;
            using (DockingMultiUpdate update = new DockingMultiUpdate(this))
            {
                ...
                {
                    // For each array of pages...
                    foreach (KiwiPage[] pageArray in extraPages)
                        if ((pageArray != null) && (pageArray.Length > 0))
                        {
                            // Create a new auto hidden group and add the provided array of pages
                            KiwiDockingAutoHiddenGroup extraAutoHiddenGroup = edgeAutoHidden.AppendAutoHiddenGroup();
        ...
        /// </summary>
        /// <param name="path">Path for finding the target KiwiDockingFloating.</param>
        /// <param name="pages">Array of pages to be added as an auto hidden group.</param>
        /// <returns>KiwiDockingFloatingWindow reference.</returns>
        public virtual KiwiDockingFloatingWindow AddFloatingWindow(string path, KiwiPage[] pages)
        {
        ...
        /// <returns>KiwiDockingFloatingWindow reference.</returns>
        public virtual KiwiDockingFloatingWindow AddFloatingWindow(string path,
                                                                      KiwiPage[] pages,
                                                                      Size clientSize)
        {
                                                                      ...
                                                                      Size clientSize)
        {
            ...
            KiwiDockingFloating floating = ResolvePath(path) as KiwiDockingFloating;
            if (floating == null)
                throw new ArgumentException("Path does not resolve to a KiwiDockingFloating");

            // Create a new floating window and add the provided array of pages
            KiwiDockingFloatingWindow floatingWindow = floating.AddFloatingWindow();
        ...
        /// </summary>
        /// <param name="path">Path for finding the target KiwiDockingWorkspace.</param>
        /// <param name="pages">Array of pages to be added.</param>
        /// <returns>KiwiDockingWorkspace reference.</returns>
        public virtual KiwiDockingWorkspace AddToWorkspace(string path, KiwiPage[] pages)
        {
            // Cannot add a null array
            if (pages == null)
                throw new ArgumentNullException("pages");
            ...
            KiwiDockingWorkspace workspace = ResolvePath(path) as KiwiDockingWorkspace;
            if (workspace == null)
                throw new ArgumentException("Path does not resolve to a KiwiDockingWorkspace");
        ...
        /// </summary>
        /// <param name="path">Path for finding the target KiwiDockingNavigator.</param>
        /// <param name="pages">Array of pages to be added.</param>
        /// <returns>KiwiDockingNavigator reference.</returns>
        public virtual KiwiDockingNavigator AddToNavigator(string path, KiwiPage[] pages)
        {
            // Cannot add a null array
            if (pages == null)
                throw new ArgumentNullException("pages");
            ...
            KiwiDockingNavigator navigator = ResolvePath(path) as KiwiDockingNavigator;
            if (navigator == null)
                throw new ArgumentException("Path does not resolve to a KiwiDockingNavigator");
        ...
        /// <param name="stackPages">Extra arrays of pages to be added in a stacked manner.</param>
        /// <returns>KiwiDockingDockspace reference.</returns>
        public virtual KiwiDockingDockspace InsertDockspace(string path,
                                                               DockingEdge edge,
                                                               int index,
                                                               KiwiPage[] pages,
                                                               params KiwiPage[][] stackPages)
        ...
        /// <param name="extraPages">Extra arrays of pages to be added as extra groups.</param>
        /// <returns>KiwiDockingAutoHiddenGroup reference.</returns>
        public virtual KiwiDockingAutoHiddenGroup InsertAutoHiddenGroup(string path,
                                                                           DockingEdge edge,
                                                                           int index,
                                                                           KiwiPage[] pages,
                                                                           params KiwiPage[][] extraPages)
        ...
        public virtual void DoDragDrop(Point screenPoint, Point elementOffset, Control c, KiwiPageCollection pages)
        {
            ...
            KiwiPage firstFloatingPage = null;
            foreach (KiwiPage page in pages)
            {
                ...
                if (!(page is KiwiStorePage))
                {
                    ...
                    if (!atLeastOneFloating && page.AreFlagsSet(KiwiPageFlags.DockingAllowFloating))
                    {
            ...
            if (atLeastOneFloating)
            {
                ...
                KiwiDockingFloatspace floatspace = FindStorePageElement(DockingLocation.Floating, firstFloatingPage) as KiwiDockingFloatspace;
                if (floatspace != null)
                {
                    KiwiDockingFloatingWindow floatingWindow = floatspace.GetParentType(typeof(KiwiDockingFloatingWindow)) as KiwiDockingFloatingWindow;
                    if (floatingWindow != null)
                    {
                        ...
                        if (!floatingWindow.FloatingWindow.Visible)
                        {
                            using (DockingMultiUpdate update = new DockingMultiUpdate(this))
                            {
                                ...
                                KiwiPage[] firstFloatingPages = new KiwiPage[] { firstFloatingPage };
                                ...
                                List<KiwiPage> appendPages = new List<KiwiPage>();
                                foreach (KiwiPage page in pages)
                                    if (!(page is KiwiStorePage) && (page != firstFloatingPage) && page.AreFlagsSet(KiwiPageFlags.DockingAllowFloating))
                                    {
                                ...
                                KiwiWorkspaceCell cell = floatingWindow.CellForPage(firstFloatingPage.UniqueName);
                ...
                if (dragManager.FloatingWindow == null)
                {
                    ...
                    KiwiDockingFloating floating = FindDockingFloating(firstFloatingPage.UniqueName);
                    if (floating != null)
                    {
                        KiwiDockingFloatingWindow floatingWindow = floating.AddFloatingWindow();
                        if (floatingWindow != null)
                        {
                            using (DockingMultiUpdate update = new DockingMultiUpdate(this))
                            {
                                ...
                                List<KiwiPage> appendPages = new List<KiwiPage>();
                                foreach (KiwiPage page in pages)
                                    if (!(page is KiwiStorePage) && page.AreFlagsSet(KiwiPageFlags.DockingAllowFloating))
                                    {
                                        appendUniqueNames.Add(page.UniqueName);
                                        appendPages.Add(page);
                                    }
        ...
        public virtual void DoDragDrop(Point screenPoint, Point elementOffset, Control c, KiwiDockingFloatingWindow window)
        {
            // Cannot drag a null reference
            if (window == null)
            ...
            KiwiWorkspaceCell cell = window.FloatspaceElement.FloatspaceControl.FirstVisibleCell();
            while (cell != null)
            {
        ...
        public void LoadConfigFromXml(XmlReader xmlReader)
        {
            ...
            try
            {
                ...
                if (formatVersion < 1)
                    throw new ArgumentException("Can only load Version 1 and upwards of KiwiDockingManager persisted data.");

                using (DockingMultiUpdate update = new DockingMultiUpdate(this))
                {
                    // Create a list of all the existing pages
                    KiwiPageCollection currentPages = new KiwiPageCollection();
                        ...
                        if (currentPages.Count > 0)
                        {
                            ...
                            if (currentPages.Count > 0)
                            {
                                ...
                                if (args.Pages.Count > 0)
                                {
                                    ...
                                    foreach (KiwiPage page in args.Pages)
                                        page.Dispose();
                                }
                            }
                        }
        ...
        /// </summary>
        [Browsable(false)]
        public virtual KiwiPage[] PagesDocked
        {
            get
            {
                KiwiPageCollection pages = new KiwiPageCollection();
        ...
        /// </summary>
        [Browsable(false)]
        public virtual KiwiPage[] PagesAutoHidden
        {
            get
            {
                KiwiPageCollection pages = new KiwiPageCollection();
        ...
        /// </summary>
        [Browsable(false)]
        public virtual KiwiPage[] PagesFloating
        {
            get
            {
                KiwiPageCollection pages = new KiwiPageCollection();
        ...
        /// </summary>
        [Browsable(false)]
        public virtual KiwiPage[] PagesWorkspace
        {
            get
            {
                KiwiPageCollection pages = new KiwiPageCollection();
        ...
        /// </summary>
        [Browsable(false)]
        public virtual KiwiWorkspaceCell[] Cells
        {
            get
            {
                KiwiWorkspaceCellList cells = new KiwiWorkspaceCellList();
        ...
        /// </summary>
        [Browsable(false)]
        public virtual KiwiWorkspaceCell[] CellsDocked
        {
            get
            {
                KiwiWorkspaceCellList cells = new KiwiWorkspaceCellList();
        ...
        /// </summary>
        [Browsable(false)]
        public virtual KiwiWorkspaceCell[] CellsFloating
        {
            get
            {
                KiwiWorkspaceCellList cells = new KiwiWorkspaceCellList();
        ...
        /// </summary>
        [Browsable(false)]
        public virtual KiwiWorkspaceCell[] CellsWorkspace
        {
            get
            {
                KiwiWorkspaceCellList cells = new KiwiWorkspaceCellList();
        ...
        private void RemoveControlStorePages(DockingElement element, string[] uniqueNames, bool autoHidden, bool docked)
        {
            ...
            KiwiDockingControl control = element as KiwiDockingControl;
            if (control == null)
                control = element.GetParentType(typeof(KiwiDockingControl)) as KiwiDockingControl;
            ...
            if (control != null)
            {
                ...
                foreach (IDockingElement child in control)
                {
                    ...
                    KiwiDockingEdge edge = child as KiwiDockingEdge;
                    if (edge != null)
                    {
                        // Do we need to clear auto hidden elements?
                        if (autoHidden)
                        {
                            KiwiDockingEdgeAutoHidden autoHiddenEdge = edge["AutoHidden"] as KiwiDockingEdgeAutoHidden;
                        ...
                        if (docked)
                        {
                            KiwiDockingEdgeDocked dockedEdge = edge["Docked"] as KiwiDockingEdgeDocked;
                            if (dockedEdge != null)
        ...
        {
            KiwiContextMenuItem workspaceItem = (KiwiContextMenuItem)sender;
        ...
        {
            KiwiContextMenuItem autoHiddenItem = (KiwiContextMenuItem)sender;
        ...
        {
            KiwiContextMenuItem dockedItem = (KiwiContextMenuItem)sender;
        ...
        private void OnDropDownFloatingClicked(object sender, EventArgs e)
        {
            ...
            KiwiContextMenuItem floatingItem = (KiwiContextMenuItem)sender;
        ...
        {
            KiwiContextMenuItem closeItem = (KiwiContextMenuItem)sender;
            CloseRequest(new string[] { (string)closeItem.Tag });
        }

        private KiwiPage[] ArrayFromCollection(KiwiPageCollection pages)
        {
            // Convert collection to array
            KiwiPage[] array = new KiwiPage[pages.Count];
