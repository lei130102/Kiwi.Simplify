...
namespace Kiwi.ComponentFactory.Docking
{
    ...
    public class KiwiDockingFloatingWindow : DockingElementClosedCollection
    {
        #region Instance Fields
        private KiwiFloatingWindow _window;
        private KiwiDockingFloatspace _floatspace;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiDockingFloatingWindow class.
        /// </summary>
        ...
        public KiwiDockingFloatingWindow(string name, Form owner, KiwiDockingFloatspace floatspace)
            : base(name)
        {
            ...
            _window = new KiwiFloatingWindow(owner, floatspace.FloatspaceControl);
        ...
        private void OnDockingFloatspaceDisposed(object sender, EventArgs e)
        {
            ...
            KiwiDockingFloatspace floatspaceElement = (KiwiDockingFloatspace)sender;
