...
{
    /// <summary>
    /// Extends the KiwiForm to act as a floating window within the docking framework.
    /// </summary>
    [ToolboxItem(false)]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    public class KiwiFloatingWindow : KiwiForm
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiFloatingWindow class.
        /// </summary>
        ...
        public KiwiFloatingWindow(Form owner, KiwiFloatspace floatspace)
        {
        ...
        #region Public
        /// <summary>
        /// Gets access to the contained KiwiFloatspace control.
        /// </summary>
        ...
        private string[] VisibleCloseableUniqueNames()
        {
            ...
            while (cell != null)
            {
                ...
                foreach (KiwiPage page in cell.Pages)
                    if (page.LastVisibleSet && page.AreFlagsSet(KiwiPageFlags.DockingAllowClose))
