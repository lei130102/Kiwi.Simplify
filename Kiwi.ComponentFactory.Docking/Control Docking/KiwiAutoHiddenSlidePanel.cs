...
{
    /// <summary>
    /// Extends the KiwiPanel to work as a panel for hosting the display of a sliding in/out page.
    /// </summary>
    [ToolboxItem(false)]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    public class KiwiAutoHiddenSlidePanel : KiwiPanel,
                                               IMessageFilter
    {
        ...
        private KiwiAutoHiddenGroup _group;
        private KiwiDockspaceSlide _dockspaceSlide;
        private KiwiDockspaceSeparator _separator;
        private EventHandler _checkMakeHidden;
        private KiwiPanel _inner;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiAutoHiddenSlidePanel class.
        /// </summary>
        ...
        public KiwiAutoHiddenSlidePanel(Control control, DockingEdge edge, KiwiAutoHiddenPanel panel)
        {
            _control = control;
            _edge = edge;
            _panel = panel;
            ...
            _dockspaceSlide = new KiwiDockspaceSlide();
            ...
            _separator = new KiwiDockspaceSeparator(edge, true);
        ...
        #region Public
        /// <summary>
        /// Gets access to the KiwiDockspace control.
        /// </summary>
        ...
        /// <summary>
        /// Gets access to the KiwiSeparator control.
        /// </summary>
        public KiwiDockspaceSeparator SeparatorControl
        {
            get { return _separator; }
        }

        /// <summary>
        /// Gets access to the KiwiPage associated with the slide panel.
        /// </summary>
        ...
        public void SlideOut(KiwiPage page, KiwiAutoHiddenGroup group, bool select)
        {
            ...
            KiwiWorkspaceCell cell = DockspaceControl.FirstVisibleCell();
            if (cell == null)
            {
