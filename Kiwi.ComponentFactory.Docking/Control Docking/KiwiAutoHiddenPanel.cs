...
{
    /// <summary>
    /// Extends the KiwiPanel to work as a panel for hosting KiwiAutoHiddenGroup controls.
    /// </summary>
    [ToolboxItem(false)]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    public class KiwiAutoHiddenPanel : KiwiPanel
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiAutoHiddenPanel class.
        /// </summary>
        /// <param name="edge">Docking edge being managed.</param>
        public KiwiAutoHiddenPanel(DockingEdge edge)
        {
        ...
        public override Size GetPreferredSize(Size proposedSize)
        {
            int width = 0;
            int height = 0;
            foreach (KiwiAutoHiddenGroup group in Controls)
            {
