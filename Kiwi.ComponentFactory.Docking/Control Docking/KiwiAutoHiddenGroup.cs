...
{
    /// <summary>
    /// Extends the KiwiNavigator to work as a docking auto hidden group control.
    /// </summary>
    [ToolboxItem(false)]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    public class KiwiAutoHiddenGroup : KiwiNavigator
    {
        #region Events
        /// <summary>
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiAutoHiddenGroup class.
        /// </summary>
        public KiwiAutoHiddenGroup(DockingEdge edge)
        {
        ...
        public void StorePages(string[] uniqueNames)
        {
            foreach (string uniqueName in uniqueNames)
            {
                ...
                KiwiPage page = Pages[uniqueName];
                if ((page != null) && !(page is KiwiStorePage))
                {
                    ...
                    KiwiStorePage placeholder = new KiwiStorePage(uniqueName, "AutoHiddenGroup");
        ...
        public void RestorePages(KiwiPage[] pages)
        {
            foreach (KiwiPage page in pages)
            {
                // If a matching page exists and it is not a store placeholder already
                KiwiPage storePage = Pages[page.UniqueName];
