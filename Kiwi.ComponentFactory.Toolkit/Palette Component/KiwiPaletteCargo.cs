...
{
    /// <summary>
    /// Storage of user supplied values not used by Kiwi.
    /// </summary>
    public class KiwiPaletteCargo : Storage
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiPaletteCargo class.
		/// </summary>
        /// <param name="needPaint">Delegate for notifying paint requests.</param>
        public KiwiPaletteCargo(NeedPaintHandler needPaint)
        {
