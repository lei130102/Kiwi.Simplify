...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    /// </summary>
    public class KiwiPaletteImagesRadioButton : Storage
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiPaletteImagesRadioButton class.
		/// </summary>
        /// <param name="redirect">Redirector to inherit values from.</param>
        /// <param name="needPaint">Delegate for notifying paint requests.</param>
        public KiwiPaletteImagesRadioButton(PaletteRedirect redirect,
