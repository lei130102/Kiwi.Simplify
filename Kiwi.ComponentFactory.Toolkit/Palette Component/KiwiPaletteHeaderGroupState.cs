...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    /// </summary>
    public class KiwiPaletteHeaderGroupState : Storage,
                                                  IPaletteMetric
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiPaletteHeaderGroupState class.
		/// </summary>
        /// <param name="redirect">Redirection for inheriting values.</param>
        /// <param name="needPaint">Delegate for notifying paint requests.</param>
        public KiwiPaletteHeaderGroupState(PaletteRedirect redirect,
