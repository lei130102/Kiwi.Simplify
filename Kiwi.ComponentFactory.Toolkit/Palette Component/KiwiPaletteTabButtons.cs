...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    /// </summary>
    public class KiwiPaletteTabButtons : Storage
    {
        #region Instance Fields
        private KiwiPaletteTabButton _tabCommon;
        private KiwiPaletteTabButton _tabHighProfile;
        private KiwiPaletteTabButton _tabStandardProfile;
        private KiwiPaletteTabButton _tabLowProfile;
        private KiwiPaletteTabButton _tabDock;
        private KiwiPaletteTabButton _tabDockAutoHidden;
        private KiwiPaletteTabButton _tabOneNote;
        private KiwiPaletteTabButton _tabCustom1;
        private KiwiPaletteTabButton _tabCustom2;
        private KiwiPaletteTabButton _tabCustom3;
        #endregion

        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiPaletteTabButtons class.
        /// </summary>
        /// <param name="redirector">Palette redirector for sourcing inherited values.</param>
        /// <param name="needPaint">Delegate for notifying paint requests.</param>
        internal KiwiPaletteTabButtons(PaletteRedirect redirector,
                                       NeedPaintHandler needPaint)
        {
            Debug.Assert(redirector != null);

            // Create the button style specific and common palettes
            _tabCommon = new KiwiPaletteTabButton(redirector, PaletteBackStyle.TabHighProfile, PaletteBorderStyle.TabHighProfile, PaletteContentStyle.TabHighProfile, needPaint);
            _tabHighProfile = new KiwiPaletteTabButton(redirector, PaletteBackStyle.TabHighProfile, PaletteBorderStyle.TabHighProfile, PaletteContentStyle.TabHighProfile, needPaint);
            _tabStandardProfile = new KiwiPaletteTabButton(redirector, PaletteBackStyle.TabStandardProfile, PaletteBorderStyle.TabStandardProfile, PaletteContentStyle.TabStandardProfile, needPaint);
            _tabLowProfile = new KiwiPaletteTabButton(redirector, PaletteBackStyle.TabLowProfile, PaletteBorderStyle.TabLowProfile, PaletteContentStyle.TabLowProfile, needPaint);
            _tabDock = new KiwiPaletteTabButton(redirector, PaletteBackStyle.TabDock, PaletteBorderStyle.TabDock, PaletteContentStyle.TabDock, needPaint);
            _tabDockAutoHidden = new KiwiPaletteTabButton(redirector, PaletteBackStyle.TabDockAutoHidden, PaletteBorderStyle.TabDockAutoHidden, PaletteContentStyle.TabDockAutoHidden, needPaint);
            _tabOneNote = new KiwiPaletteTabButton(redirector, PaletteBackStyle.TabOneNote, PaletteBorderStyle.TabOneNote, PaletteContentStyle.TabOneNote, needPaint);
            _tabCustom1 = new KiwiPaletteTabButton(redirector, PaletteBackStyle.TabCustom1, PaletteBorderStyle.TabCustom1, PaletteContentStyle.TabCustom1, needPaint);
            _tabCustom2 = new KiwiPaletteTabButton(redirector, PaletteBackStyle.TabCustom2, PaletteBorderStyle.TabCustom2, PaletteContentStyle.TabCustom2, needPaint);
            _tabCustom3 = new KiwiPaletteTabButton(redirector, PaletteBackStyle.TabCustom3, PaletteBorderStyle.TabCustom3, PaletteContentStyle.TabCustom3, needPaint);
        ...
        public KiwiPaletteTabButton TabCommon
        {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiPaletteTabButton TabHighProfile
        {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiPaletteTabButton TabStandardProfile
        {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiPaletteTabButton TabLowProfile
        {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiPaletteTabButton TabDock
        {
            get { return _tabDock; }
        }
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiPaletteTabButton TabDockAutoHidden
        {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiPaletteTabButton TabOneNote
        {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiPaletteTabButton TabCustom1
        {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiPaletteTabButton TabCustom2
        {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiPaletteTabButton TabCustom3
        {
