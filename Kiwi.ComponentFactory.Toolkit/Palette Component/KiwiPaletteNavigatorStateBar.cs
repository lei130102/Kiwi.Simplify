...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    /// </summary>
    public class KiwiPaletteNavigatorStateBar : Storage,
                                                   IPaletteMetric
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiPaletteNavigatorStateBar class.
		/// </summary>
        /// <param name="redirect">Redirection for inheriting values.</param>
        /// <param name="needPaint">Delegate for notifying paint requests.</param>
        public KiwiPaletteNavigatorStateBar(PaletteRedirect redirect,
