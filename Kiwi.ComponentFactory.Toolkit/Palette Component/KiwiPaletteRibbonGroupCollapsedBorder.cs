...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    /// </summary>
    public class KiwiPaletteRibbonGroupCollapsedBorder : Storage
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiPaletteRibbonGroupCollapsedBorder class.
		/// </summary>
        /// <param name="redirect">Redirector to inherit values from.</param>
        /// <param name="needPaint">Delegate for notifying paint requests.</param>
        public KiwiPaletteRibbonGroupCollapsedBorder(PaletteRedirect redirect,
