...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    /// </summary>
    public class KiwiPaletteTMSButton : KiwiPaletteTMSBase
    {
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiPaletteTMSButton class.
		/// </summary>
        /// <param name="internalKCT">Reference to inherited values.</param>
        /// <param name="needPaint">Delegate for notifying paint requests.</param>
        internal KiwiPaletteTMSButton(KiwiInternalKCT internalKCT,
