...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    /// </summary>
    public class KiwiPaletteRibbonGroupCollapsedFrameBorder : Storage
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiPaletteRibbonGroupCollapsedFrameBorder class.
		/// </summary>
        /// <param name="redirect">Redirector to inherit values from.</param>
        /// <param name="needPaint">Delegate for notifying paint requests.</param>
        public KiwiPaletteRibbonGroupCollapsedFrameBorder(PaletteRedirect redirect,
