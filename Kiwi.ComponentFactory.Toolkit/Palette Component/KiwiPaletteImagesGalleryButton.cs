...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    /// </summary>
    public class KiwiPaletteImagesGalleryButton : Storage
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiPaletteImagesGalleryButton class.
		/// </summary>
        /// <param name="button">Which button this instance represents.</param>
        /// <param name="redirect">Redirector to inherit values from.</param>
        /// <param name="needPaint">Delegate for notifying paint requests.</param>
        public KiwiPaletteImagesGalleryButton(PaletteRibbonGalleryButton button,
