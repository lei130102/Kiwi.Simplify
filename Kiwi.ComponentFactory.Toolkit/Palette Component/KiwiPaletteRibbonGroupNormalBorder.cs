...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    /// </summary>
    public class KiwiPaletteRibbonGroupNormalBorder : Storage
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiPaletteRibbonGroupNormalBorder class.
		/// </summary>
        /// <param name="redirect">Redirector to inherit values from.</param>
        /// <param name="needPaint">Delegate for notifying paint requests.</param>
        public KiwiPaletteRibbonGroupNormalBorder(PaletteRedirect redirect,
