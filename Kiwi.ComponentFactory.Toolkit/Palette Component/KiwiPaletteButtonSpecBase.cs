...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    /// </summary>
    public class KiwiPaletteButtonSpecBase : Storage,
                                                IPaletteButtonSpec
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiPaletteButtonSpecBase class.
        /// </summary>
        /// <param name="redirector">Palette redirector for sourcing inherited values.</param>
        internal KiwiPaletteButtonSpecBase(PaletteRedirect redirector)
        {
