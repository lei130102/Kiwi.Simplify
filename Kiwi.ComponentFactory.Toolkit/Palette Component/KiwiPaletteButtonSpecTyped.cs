...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    /// </summary>
    public class KiwiPaletteButtonSpecTyped : KiwiPaletteButtonSpecBase
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiPaletteButtonSpecTyped class.
        /// </summary>
        /// <param name="redirector">Palette redirector for sourcing inherited values.</param>
        internal KiwiPaletteButtonSpecTyped(PaletteRedirect redirector)
            : base(redirector)
        {
            _image = null;
            _text = string.Empty;
