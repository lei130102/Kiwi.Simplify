...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    [ComVisible(true)]
    [ToolboxItem(false)]
    public class VisualTaskDialog : KiwiForm
    {
        #region Types
        /// <summary>
        ...
        /// </summary>
        [ToolboxItem(false)]
        public class MessageButton : KiwiButton
        {
        ...
        #region Instance Fields
        private KiwiTaskDialog _taskDialog;
        private string _windowTitle;
        private string _mainInstruction;
        private string _content;
        private MessageBoxIcon _mainIcon;
        private Image _customMainIcon;
        private KiwiTaskDialogCommandCollection _radioButtons;
        private KiwiTaskDialogCommandCollection _commandButtons;
        private KiwiTaskDialogCommand _defaultRadioButton;
        ...
        // User Interface
        private KiwiPanel _panelMain;
        private KiwiPanel _panelIcon;
        private PictureBox _messageIcon;
        private KiwiPanel _panelMainText;
        private KiwiWrapLabel _messageText;
        private KiwiWrapLabel _messageContent;
        private KiwiTextBox _messageContentMultiline;
        private KiwiPanel _panelButtons;
        ...
        private KiwiBorderEdge _panelButtonsBorderTop;
        private KiwiPanel _panelFooter;
        private KiwiLinkLabel _linkLabelFooter;
        private PictureBox _iconFooter;
        private KiwiWrapLabel _footerLabel;
        private KiwiBorderEdge _panelFooterBorderTop;
        private KiwiCheckBox _checkBox;
        private KiwiPanel _panelMainRadio;
        private KiwiPanel _panelMainCommands;
        private KiwiPanel _panelMainSpacer;
        ...
        public VisualTaskDialog(KiwiTaskDialog taskDialog)
        {
        ...
        private void UpdateRadioButtons()
        {
            ...
            else
            {
                ...
                foreach (KiwiTaskDialogCommand command in _radioButtons)
                {
                    // Create and add a new radio button instance
                    KiwiRadioButton button = new KiwiRadioButton();
                ...
                foreach (KiwiRadioButton button in _panelMainRadio.Controls)
                {
        ...
        private void UpdateCommandButtons()
        {
            ...
            else
            {
                ...
                Size maxButtonSize = Size.Empty;
                foreach (KiwiTaskDialogCommand command in _commandButtons)
                {
                    // Create and add a new button instance
                    KiwiButton button = new KiwiButton();
                ...
                Point offset = new Point(BUTTON_GAP - 1, 2);
                foreach (KiwiButton button in _panelMainCommands.Controls)
                {
                    button.Location = offset;
                    button.Size = maxButtonSize;
                    offset.Y += maxButtonSize.Height;
        ...
        private void UpdateButtons()
        {
            ...
            if ((_commonButtons & TaskDialogButtons.OK) == TaskDialogButtons.OK)
            {
                ...
                _buttonOK.Text = KiwiManager.Strings.OK;
            ...
            if ((_commonButtons & TaskDialogButtons.Yes) == TaskDialogButtons.Yes)
            {
                ...
                _buttonYes.Text = KiwiManager.Strings.Yes;
            ...
            if ((_commonButtons & TaskDialogButtons.No) == TaskDialogButtons.No)
            {
                ...
                _buttonNo.Text = KiwiManager.Strings.No;
            ...
            if ((_commonButtons & TaskDialogButtons.Cancel) == TaskDialogButtons.Cancel)
            {
                ...
                _buttonCancel.Text = KiwiManager.Strings.Cancel;
            ...
            if ((_commonButtons & TaskDialogButtons.Retry) == TaskDialogButtons.Retry)
            {
                ...
                _buttonRetry.Text = KiwiManager.Strings.Retry;
            ...
            if ((_commonButtons & TaskDialogButtons.Close) == TaskDialogButtons.Close)
            {
                ...
                _buttonClose.Text = KiwiManager.Strings.Close;
        ...
        {
            KiwiRadioButton button = (KiwiRadioButton)sender;
            _defaultRadioButton = (KiwiTaskDialogCommand)button.Tag;
        ...
        private void OnCommandClicked(object sender, EventArgs e)
        {
            ...
            KiwiButton button = (KiwiButton)sender;
            DialogResult = button.DialogResult;

            // Invoke any event handlers from the command button
            KiwiTaskDialogCommand command = (KiwiTaskDialogCommand)button.Tag;
        ...
        {
            this._panelMain = new Kiwi.ComponentFactory.Toolkit.KiwiPanel();
            this._panelMainSpacer = new Kiwi.ComponentFactory.Toolkit.KiwiPanel();
            this._panelMainCommands = new Kiwi.ComponentFactory.Toolkit.KiwiPanel();
            this._panelMainRadio = new Kiwi.ComponentFactory.Toolkit.KiwiPanel();
            this._panelMainText = new Kiwi.ComponentFactory.Toolkit.KiwiPanel();
            this._messageContent = new Kiwi.ComponentFactory.Toolkit.KiwiWrapLabel();
            this._messageContentMultiline = new Kiwi.ComponentFactory.Toolkit.KiwiTextBox();
            this._messageText = new Kiwi.ComponentFactory.Toolkit.KiwiWrapLabel();
            this._panelIcon = new Kiwi.ComponentFactory.Toolkit.KiwiPanel();
            this._messageIcon = new System.Windows.Forms.PictureBox();
            this._panelButtons = new Kiwi.ComponentFactory.Toolkit.KiwiPanel();
            this._checkBox = new Kiwi.ComponentFactory.Toolkit.KiwiCheckBox();
            this._panelButtonsBorderTop = new Kiwi.ComponentFactory.Toolkit.KiwiBorderEdge();
            this._buttonOK = new Kiwi.ComponentFactory.Toolkit.VisualTaskDialog.MessageButton();
            this._buttonYes = new Kiwi.ComponentFactory.Toolkit.VisualTaskDialog.MessageButton();
            this._buttonNo = new Kiwi.ComponentFactory.Toolkit.VisualTaskDialog.MessageButton();
            this._buttonRetry = new Kiwi.ComponentFactory.Toolkit.VisualTaskDialog.MessageButton();
            this._buttonCancel = new Kiwi.ComponentFactory.Toolkit.VisualTaskDialog.MessageButton();
            this._buttonClose = new Kiwi.ComponentFactory.Toolkit.VisualTaskDialog.MessageButton();
            this._panelFooter = new Kiwi.ComponentFactory.Toolkit.KiwiPanel();
            this._linkLabelFooter = new Kiwi.ComponentFactory.Toolkit.KiwiLinkLabel();
            this._iconFooter = new System.Windows.Forms.PictureBox();
            this._footerLabel = new Kiwi.ComponentFactory.Toolkit.KiwiWrapLabel();
            this._panelFooterBorderTop = new Kiwi.ComponentFactory.Toolkit.KiwiBorderEdge();
            ...
            this._messageContent.LabelStyle = Kiwi.ComponentFactory.Toolkit.LabelStyle.NormalPanel;
            ...
            this._messageText.LabelStyle = Kiwi.ComponentFactory.Toolkit.LabelStyle.TitlePanel;
            ...
            this._panelButtons.PanelBackStyle = Kiwi.ComponentFactory.Toolkit.PaletteBackStyle.PanelAlternate;
            this._panelButtons.Size = new System.Drawing.Size(544, 46);
            this._panelButtons.TabIndex = 1;
            // 
            // _checkBox
            // 
            this._checkBox.LabelStyle = Kiwi.ComponentFactory.Toolkit.LabelStyle.NormalPanel;
            ...
            // 
            this._panelButtonsBorderTop.BorderStyle = Kiwi.ComponentFactory.Toolkit.PaletteBorderStyle.HeaderPrimary;
            ...
            this._panelButtonsBorderTop.Text = "kiwiBorderEdge1";
            // 
            // _buttonOK
            // 
            ...
            this._panelFooter.PanelBackStyle = Kiwi.ComponentFactory.Toolkit.PaletteBackStyle.PanelAlternate;
            this._panelFooter.Size = new System.Drawing.Size(544, 49);
            this._panelFooter.TabIndex = 2;
            // 
            // _linkLabelFooter
            // 
            this._linkLabelFooter.LabelStyle = Kiwi.ComponentFactory.Toolkit.LabelStyle.NormalPanel;
            ...
            this._linkLabelFooter.Values.Text = "kiwiLinkLabel1";
            ...
            this._footerLabel.LabelStyle = Kiwi.ComponentFactory.Toolkit.LabelStyle.NormalPanel;
            ...
            // 
            this._panelFooterBorderTop.BorderStyle = Kiwi.ComponentFactory.Toolkit.PaletteBorderStyle.HeaderPrimary;
            ...
            this._panelFooterBorderTop.Text = "kiwiBorderEdge1";
            // 
            // VisualTaskDialog
            // 
