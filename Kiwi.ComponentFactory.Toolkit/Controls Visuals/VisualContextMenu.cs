...
{
    /// <summary>
    /// Base class for drawing a kiwi context menu as a popup control.
    /// </summary>
    public class VisualContextMenu : VisualPopup
    {
            ...
            : base(true)
        {
            ...
            if (provider.ProviderPalette != null)
                ...
                SetPalette(KiwiManager.GetPaletteForMode(provider.ProviderPaletteMode));
        ...
        /// <param name="keyboardActivated">Was the context menu activate by a keyboard action.</param>
        public VisualContextMenu(KiwiContextMenu contextMenu,
                                 IPalette palette,
            ...
            : base(true)
        {
            ...
            if (palette != null)
                ...
                SetPalette(KiwiManager.GetPaletteForMode(paletteMode));
        ...
        public new void Show(Rectangle screenRect)
        {
            ...
            Show(screenRect, KiwiContextMenuPositionH.Left, KiwiContextMenuPositionV.Below);
        }
        ...
        public void Show(Rectangle screenRect,
                         KiwiContextMenuPositionH horz,
                         KiwiContextMenuPositionV vert)
        {
                         ...
                         bool constrain)
        {
            ...
            switch (horz)
            {
                ...
                case KiwiContextMenuPositionH.Before:
                    ...
                    break;
                case KiwiContextMenuPositionH.Left:
                    screenPt.X = screenRect.Left;
                    break;
                case KiwiContextMenuPositionH.Right:
            ...
            switch (vert)
            {
                ...
                case KiwiContextMenuPositionV.Below:
                    ...
                    break;
                case KiwiContextMenuPositionV.Top:
                    screenPt.Y = screenRect.Top;
                    break;
                case KiwiContextMenuPositionV.Bottom:
            ...
            if (bounce)
            {
                ...
                if ((screenPt.X + preferredSize.Width) > workingArea.Right)
                {
                    ...
                    if ((horz == KiwiContextMenuPositionH.After) ||
                        (horz == KiwiContextMenuPositionH.Left))
                    {
                        // Then switch to positioning before
                        horz = KiwiContextMenuPositionH.Before;
                        screenPt.X = screenRect.Left - preferredSize.Width;
                    }
                }
                ...
                if (screenPt.X < workingArea.X)
                {
                    ...
                    if ((horz == KiwiContextMenuPositionH.Before) ||
                        (horz == KiwiContextMenuPositionH.Right))
                    {
                        // Then switch to positioning after
                        horz = KiwiContextMenuPositionH.After;
                        screenPt.X = screenRect.Right;
                    }
                }
                ...
                if ((screenPt.Y + preferredSize.Height) > workingArea.Bottom)
                {
                    ...
                    if ((vert == KiwiContextMenuPositionV.Below) ||
                        (vert == KiwiContextMenuPositionV.Top))
                    {
                        // Then switch to positoning upwards
                        vert = KiwiContextMenuPositionV.Bottom;
                        screenPt.Y = screenRect.Bottom - preferredSize.Height;
                    }
                }
                ...
                if (screenPt.Y < workingArea.Y)
                {
                    ...
                    if ((vert == KiwiContextMenuPositionV.Above) ||
                        (vert == KiwiContextMenuPositionV.Bottom))
                    {
        ...
        /// </summary>
        public KiwiContextMenuPositionH ShowHorz
        {
        ...
        /// </summary>
        public KiwiContextMenuPositionV ShowVert
        {
        ...
        private void Construct(KiwiContextMenuCollection items,
                               bool keyboardActivated)
        {
