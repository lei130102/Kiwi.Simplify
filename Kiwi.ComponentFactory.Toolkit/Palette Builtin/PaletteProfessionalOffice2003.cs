...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    public class PaletteProfessionalOffice2003 : PaletteProfessionalSystem
    {
        ...
        /// </summary>
        /// <returns>KiwiColorTable instance.</returns>
        internal override KiwiProfessionalKCT GenerateColorTable()
        {
                ...
                if (VisualStyleInformation.IsEnabledByUser)
                {
                    ...
                    switch (VisualStyleInformation.ColorScheme)
                    {
                        case "NormalColor":
                            ...
                            return new KiwiProfessionalKCT(_colorsB, false, this);
                        case "HomeStead":
                            _usingOffice2003 = true;
                            return new KiwiProfessionalKCT(_colorsG, false, this);
                        case "Metallic":
                            _usingOffice2003 = true;
                            return new KiwiProfessionalKCT(_colorsS, false, this);
                    }
                }
            }
