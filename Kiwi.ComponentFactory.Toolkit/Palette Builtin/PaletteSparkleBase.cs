...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    public class PaletteSparkleBase : PaletteBase
    {
        ...
        private KiwiColorTableSparkle _table;
        ...
        public override IRenderer GetRenderer()
        {
            ...
            return KiwiManager.RenderSparkle;
        }
        #endregion
        ...
        public override KiwiColorTable ColorTable
        {
            ...
            {
                if (_table == null)
                    _table = new KiwiColorTableSparkle(_ribbonColors, _sparkleColors, InheritBool.True, this);
