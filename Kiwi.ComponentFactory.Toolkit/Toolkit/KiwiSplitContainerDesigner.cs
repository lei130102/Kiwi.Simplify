...
{
    internal class KiwiSplitContainerDesigner : ParentControlDesigner
    {
        ...
        public override void Initialize(IComponent component)
        {
            ...
            _splitContainer = component as KiwiSplitContainer;

            // Create a new adorner and add our splitter glyph
            _adorner = new Adorner();
            _adorner.Glyphs.Add(new KiwiSplitContainerGlyph(_selectionService, _behaviorService, _adorner, this));
        ...
        public override DesignerActionListCollection ActionLists
        {
            get
            {
                ...
                actionLists.Add(new KiwiSplitContainerActionList(this));
