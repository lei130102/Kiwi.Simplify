...
{
    internal class KiwiListBoxActionList : DesignerActionList
    {
        #region Instance Fields
        private KiwiListBox _listBox;
        private IComponentChangeService _service;
        #endregion

        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiListBoxActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public KiwiListBoxActionList(KiwiListBoxDesigner owner)
            : base(owner.Component)
        {
            // Remember the list box instance
            _listBox = owner.Component as KiwiListBox;
