...
{
    internal class KiwiRichTextBoxActionList : DesignerActionList
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiRichTextBoxActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public KiwiRichTextBoxActionList(KiwiRichTextBoxDesigner owner)
            : base(owner.Component)
        {
            // Remember the text box instance
            _richTextBox = owner.Component as KiwiRichTextBox;
