...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    /// </summary>
    public class KiwiContextMenuCollectionEditor : CollectionEditor
    {
        #region Classes
        /// <summary>
        /// Form used for editing the KiwiContextMenuCollection.
        /// </summary>
        protected partial class KiwiContextMenuCollectionForm : CollectionEditor.CollectionForm
        {
            #region Types
            /// <summary>
            /// Simple class to reduce the length of declaractions!
            /// </summary>
            protected class DictItemBase : Dictionary<KiwiContextMenuItemBase, KiwiContextMenuItemBase> { };
            ...
            protected class MenuTreeNode : TreeNode
            {
                ...
                private KiwiContextMenuItemBase _item;
                ...
                public MenuTreeNode(KiwiContextMenuItemBase item)
                {
                ...
                /// </summary>
                public KiwiContextMenuItemBase Item
                {
                    get { return _item; }
                }
                ...
                {
                    if (_item is KiwiContextMenuCheckBox)
                        return 6;
                    else if (_item is KiwiContextMenuCheckButton)
                        return 7;
                    else if (_item is KiwiContextMenuColorColumns)
                        return 0;
                    else if (_item is KiwiContextMenuHeading)
                        return 1;
                    else if (_item is KiwiContextMenuItem)
                        return 2;
                    else if (_item is KiwiContextMenuItems)
                        return 3;
                    else if (_item is KiwiContextMenuLinkLabel)
                        return 8;
                    else if (_item is KiwiContextMenuRadioButton)
                        return 5;
                    else if (_item is KiwiContextMenuSeparator)
                        return 4;
                    else if (_item is KiwiContextMenuImageSelect)
                        return 13;
                    else if (_item is KiwiContextMenuMonthCalendar)
                        return 14;
            ...
            private KiwiContextMenuCollectionEditor _editor;
            ...
            #region Identity
            /// <summary>
            /// Initialize a new instance of the KiwiContextMenuCollectionForm class.
            /// </summary>
            public KiwiContextMenuCollectionForm(KiwiContextMenuCollectionEditor editor)
                : base(editor)
            {
                _editor = editor;
                ...
                this.imageList.Images.AddRange(new Image[]{
                    Properties.Resources.KiwiContextMenuColorColumns,
                    Properties.Resources.KiwiContextMenuHeading,
                    Properties.Resources.KiwiContextMenuItem,
                    Properties.Resources.KiwiContextMenuItems,
                    Properties.Resources.KiwiContextMenuSeparator,
                    Properties.Resources.KiwiRadioButton,
                    Properties.Resources.KiwiCheckBox,
                    Properties.Resources.KiwiCheckButton,
                    Properties.Resources.KiwiLinkLabel,
                    Properties.Resources.delete2,
                    Properties.Resources.arrow_up_blue,
                    Properties.Resources.arrow_down_blue,
                    Properties.Resources.KiwiContextMenuColorColumns,
                    Properties.Resources.KiwiContextMenuImageSelect,
                    Properties.Resources.KiwiMonthCalendar});
                this.imageList.Images.SetKeyName(0, "KiwiContextMenuColorColumns.bmp");
                this.imageList.Images.SetKeyName(1, "KiwiContextMenuHeading.bmp");
                this.imageList.Images.SetKeyName(2, "KiwiContextMenuItem.bmp");
                this.imageList.Images.SetKeyName(3, "KiwiContextMenuItems.bmp");
                this.imageList.Images.SetKeyName(4, "KiwiContextMenuSeparator.bmp");
                this.imageList.Images.SetKeyName(5, "KiwiRadioButton.bmp");
                this.imageList.Images.SetKeyName(6, "KiwiCheckBox.bmp");
                this.imageList.Images.SetKeyName(7, "KiwiCheckButton.bmp");
                this.imageList.Images.SetKeyName(8, "KiwiLinkLabel.bmp");
                ...
                this.imageList.Images.SetKeyName(12, "KiwiContextMenuColorColumns.bmp");
                this.imageList.Images.SetKeyName(13, "KiwiContextMenuImageSelect.bmp");
                // 
                // label1
                // 
                ...
                this.Name = "KiwiContextMenuEditorForm";
                this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
                this.Text = "KiwiContextMenu Items Editor";
                this.Load += new System.EventHandler(this.KiwiContextMenuEditorForm_Load);
            ...
            protected override void OnEditValueChanged()
            {
                if (EditValue != null)
                {
                    ...
                    foreach (KiwiContextMenuItemBase item in Items)
            ...
            #region Implementation
            private void KiwiContextMenuEditorForm_Load(object sender, EventArgs e)
            {
                // Set allowed categories into the property grid filter
                propertyGrid1.BrowsableAttributes = new AttributeCollection(new KiwiPersistAttribute());
            }
            ...
            private void buttonMoveUp_Click(object sender, EventArgs e)
            {
                ...
                if (node != null)
                {
                    ...
                    else
                    {
                        ...
                        if (treeParentNode.Item is KiwiContextMenuItems)
                        {
                            KiwiContextMenuItems items = treeParentNode.Item as KiwiContextMenuItems;
                            items.Items.Remove(treeNode.Item);
                            items.Items.Insert(index - 1, treeNode.Item);
                        }
                        else if (treeParentNode.Item is KiwiContextMenuItem)
                        {
                            KiwiContextMenuItem items = treeParentNode.Item as KiwiContextMenuItem;
                            items.Items.Remove(treeNode.Item);
                            items.Items.Insert(index - 1, treeNode.Item);
                        }
            ...
            {
                AddNewItem((KiwiContextMenuItemBase)CreateInstance(typeof(KiwiContextMenuItem)));
            }

            private void buttonAddItems_Click(object sender, EventArgs e)
            {
                AddNewItem((KiwiContextMenuItemBase)CreateInstance(typeof(KiwiContextMenuItems)));
            }

            private void buttonAddHeading_Click(object sender, EventArgs e)
            {
                AddNewItem((KiwiContextMenuItemBase)CreateInstance(typeof(KiwiContextMenuHeading)));
            }

            private void buttonAddMonthCalendar_Click(object sender, EventArgs e)
            {
                AddNewItem((KiwiContextMenuItemBase)CreateInstance(typeof(KiwiContextMenuMonthCalendar)));
            }

            private void buttonAddSeparator_Click(object sender, EventArgs e)
            {
                AddNewItem((KiwiContextMenuItemBase)CreateInstance(typeof(KiwiContextMenuSeparator)));
            }

            private void buttonAddCheckBox_Click(object sender, EventArgs e)
            {
                AddNewItem((KiwiContextMenuItemBase)CreateInstance(typeof(KiwiContextMenuCheckBox)));
            }

            private void buttonAddCheckButton_Click(object sender, EventArgs e)
            {
                AddNewItem((KiwiContextMenuItemBase)CreateInstance(typeof(KiwiContextMenuCheckButton)));
            }

            private void buttonAddRadioButton_Click(object sender, EventArgs e)
            {
                AddNewItem((KiwiContextMenuItemBase)CreateInstance(typeof(KiwiContextMenuRadioButton)));
            }

            private void buttonAddLinkLabel_Click(object sender, EventArgs e)
            {
                AddNewItem((KiwiContextMenuItemBase)CreateInstance(typeof(KiwiContextMenuLinkLabel)));
            }

            private void buttonAddColorColumns_Click(object sender, EventArgs e)
            {
                AddNewItem((KiwiContextMenuItemBase)CreateInstance(typeof(KiwiContextMenuColorColumns)));
            }

            private void buttonAddImageSelect_Click(object sender, EventArgs e)
            {
                AddNewItem((KiwiContextMenuItemBase)CreateInstance(typeof(KiwiContextMenuImageSelect)));
            }
            ...
            private void AddMenuTreeNode(KiwiContextMenuItemBase item, MenuTreeNode parent)
            {
                ...
                if (item is KiwiContextMenuItems)
                {
                    KiwiContextMenuItems itemsCollection = (KiwiContextMenuItems)item;
                    foreach (KiwiContextMenuItemBase child in itemsCollection.Items)
                        AddMenuTreeNode(child, node);
                }
                else if (item is KiwiContextMenuItem)
                {
                    KiwiContextMenuItem itemsCollection = (KiwiContextMenuItem)item;
                    foreach (KiwiContextMenuItemBase child in itemsCollection.Items)
                        AddMenuTreeNode(child, node);
                }
            }

            private void AddNewItem(KiwiContextMenuItemBase item)
            {
                ...
                else
                {
                    ...
                    if (selectedNode.Parent == null)
                    {
                        ...
                        if (item is KiwiContextMenuItem)
                        {
                            MenuTreeNode treeSelectedNode = selectedNode as MenuTreeNode;
                            KiwiContextMenuItems items = treeSelectedNode.Item as KiwiContextMenuItems;
                    ...
                    else
                    {
                        ...
                        if (treeParentNode.Item is KiwiContextMenuItems)
                        {
                            ...
                            {
                                MenuTreeNode treeSelectedNode = selectedNode as MenuTreeNode;
                                Debug.Assert(treeSelectedNode.Item is KiwiContextMenuItem);
                                KiwiContextMenuItem items = treeSelectedNode.Item as KiwiContextMenuItem;
                                items.Items.Add(item);
                                selectedNode.Nodes.Add(newNode);
                            }
                        }
                        else if (treeParentNode.Item is KiwiContextMenuItem)
                        {
                            ...
                            {
                                MenuTreeNode treeSelectedNode = selectedNode as MenuTreeNode;
                                Debug.Assert(treeSelectedNode.Item is KiwiContextMenuItems);
                                KiwiContextMenuItems items = treeSelectedNode.Item as KiwiContextMenuItems;
                                items.Items.Add(item);
                                selectedNode.Nodes.Add(newNode);
                            }
            ...
            {
                KiwiContextMenuItemBase item = null;
                KiwiContextMenuItemBase parent = null;
                ...
                buttonAddItem.Enabled = AllowAddItem(item, parent, typeof(KiwiContextMenuItem));
                buttonAddItems.Enabled = AllowAddItem(item, parent, typeof(KiwiContextMenuItems));
                buttonAddSeparator.Enabled = AllowAddItem(item, parent, typeof(KiwiContextMenuSeparator));
                buttonAddHeading.Enabled = AllowAddItem(item, parent, typeof(KiwiContextMenuHeading));
                buttonAddMonthCalendar.Enabled = AllowAddItem(item, parent, typeof(KiwiContextMenuMonthCalendar));
                buttonAddCheckBox.Enabled = AllowAddItem(item, parent, typeof(KiwiContextMenuCheckBox));
                buttonAddCheckButton.Enabled = AllowAddItem(item, parent, typeof(KiwiContextMenuCheckButton));
                buttonAddRadioButton.Enabled = AllowAddItem(item, parent, typeof(KiwiContextMenuRadioButton));
                buttonAddLinkLabel.Enabled = AllowAddItem(item, parent, typeof(KiwiContextMenuLinkLabel));
                buttonAddColorColumns.Enabled = AllowAddItem(item, parent, typeof(KiwiContextMenuColorColumns));
                buttonAddImageSelect.Enabled = AllowAddItem(item, parent, typeof(KiwiContextMenuImageSelect));
                buttonDelete.Enabled = (item != null);
            }

            private bool AllowAddItem(KiwiContextMenuItemBase item,
                                      KiwiContextMenuItemBase parent,
                                      Type addType)
            {
                // Special case the you can use add button on an Items collection so it adds an item inside it
                if ((item is KiwiContextMenuItems) && addType.Equals(typeof(KiwiContextMenuItem)))
                    return true;

                if (ItemInsideCollection(item, parent))
                {
                    KiwiContextMenuCollection temp = new KiwiContextMenuCollection();
                ...
                {
                    KiwiContextMenuItemCollection temp1 = new KiwiContextMenuItemCollection();
                    foreach (Type t in temp1.RestrictTypes)
                        if (t.Equals(addType))
                            return true;

                    if ((item != null) && (item is KiwiContextMenuItem))
                    {
                        KiwiContextMenuCollection temp2 = new KiwiContextMenuCollection();
            ...
            private bool ValidInCollection(KiwiContextMenuItemBase item)
            {
            ...
            private bool ValidInItemCollection(KiwiContextMenuItemBase item)
            {
                Type addType = item.GetType();
                KiwiContextMenuItemCollection temp = new KiwiContextMenuItemCollection();
                foreach (Type t in temp.RestrictTypes)
                    if (t.Equals(addType))
                        return true;
            ...
            private bool ItemInsideCollection(KiwiContextMenuItemBase item,
                                              KiwiContextMenuItemBase parent)
            {
                ...
                else
                {
                    ...
                    return !(parent is KiwiContextMenuItems);
                }
            }
            ...
            private void AddItemsToDictionary(DictItemBase dictItems, KiwiContextMenuItemBase baseItem)
            {
                // Add item to the dictionary
                dictItems.Add(baseItem, baseItem);

                // Add children of an items collection
                if (baseItem is KiwiContextMenuItems)
                {
                    KiwiContextMenuItems items = (KiwiContextMenuItems)baseItem;
                    foreach (KiwiContextMenuItemBase childItem in items.Items)
                        AddItemsToDictionary(dictItems, childItem);
                }

                // Add children of an item
                if (baseItem is KiwiContextMenuItem)
                {
                    KiwiContextMenuItem item = (KiwiContextMenuItem)baseItem;
                    foreach (KiwiContextMenuItemBase childItem in item.Items)
                        AddItemsToDictionary(dictItems, childItem);
                }
            }
                                                ...
                                                ITypeDescriptorContext context)
            {
                ...
                foreach (KiwiContextMenuItemBase item in after.Values)
                ...
                foreach (KiwiContextMenuItemBase item in before.Values)
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiContextMenuCollectionEditor class.
		/// </summary>
        public KiwiContextMenuCollectionEditor()
            : base(typeof(KiwiContextMenuCollection))
        {
        }
        #endregion
        ...
        {
            return new KiwiContextMenuCollectionForm(this);
        }
        ...
        {
            return new Type[] { typeof(KiwiContextMenuItems),
