...
{
    internal class KiwiLinkLabelActionList : DesignerActionList
    {
        #region Instance Fields
        private KiwiLinkLabel _linkLabel;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiLinkLabelActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public KiwiLinkLabelActionList(KiwiLinkLabelDesigner owner)
            : base(owner.Component)
        {
            // Remember the link label instance
            _linkLabel = owner.Component as KiwiLinkLabel;
        ...
        public override DesignerActionItemCollection GetSortedActionItems()
        {
            ...
            if (_linkLabel != null)
            {
                ...
                actions.Add(new KiwiDesignerActionItem(new DesignerVerb(_action, new EventHandler(OnLinkVisitedClick)), "Appearance"));
