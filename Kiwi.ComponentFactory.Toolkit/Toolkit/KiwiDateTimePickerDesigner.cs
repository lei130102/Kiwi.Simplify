...
{
    internal class KiwiDateTimePickerDesigner : ControlDesigner
    {
        ...
        public override void Initialize(IComponent component)
        {
            ...
            _dateTimePicker = component as KiwiDateTimePicker;
        ...
        public override DesignerActionListCollection ActionLists
        {
            get
            {
                ...
                actionLists.Add(new KiwiDateTimePickerActionList(this));
