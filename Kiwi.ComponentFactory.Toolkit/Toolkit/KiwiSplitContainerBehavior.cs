...
{
    internal class KiwiSplitContainerBehavior : Behavior
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiSplitContainerBehavior class.
        /// </summary>
        /// <param name="relatedDesigner">Reference to the containing designer.</param>
        public KiwiSplitContainerBehavior(IDesigner relatedDesigner)
        {
            _splitContainer = relatedDesigner.Component as KiwiSplitContainer;
        }
        #endregion
        ...
        private static Point PointToSplitContainer(Glyph g, Point pt)
        {
            ...
            KiwiSplitContainerGlyph splitGlyph = (KiwiSplitContainerGlyph)g;
