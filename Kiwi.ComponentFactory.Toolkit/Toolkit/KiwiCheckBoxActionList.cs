...
{
    internal class KiwiCheckBoxActionList : DesignerActionList
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiCheckBoxActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public KiwiCheckBoxActionList(KiwiCheckBoxDesigner owner)
            : base(owner.Component)
        {
            // Remember the checkbox instance
            _checkBox = owner.Component as KiwiCheckBox;
