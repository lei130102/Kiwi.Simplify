...
{
    internal class KiwiCheckButtonActionList : KiwiButtonActionList
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiCheckButtonActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public KiwiCheckButtonActionList(KiwiCheckButtonDesigner owner)
            : base(owner)
        {
            // Remember the button instance
            _checkButton = owner.Component as KiwiCheckButton;
        ...
        public override DesignerActionItemCollection GetSortedActionItems()
        {
            ...
            if (_checkButton != null)
            {
                ...
                actions.Add(new KiwiDesignerActionItem(new DesignerVerb(_action, new EventHandler(OnCheckedClick)), "Appearance"));
