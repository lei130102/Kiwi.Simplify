...
{
    internal class KiwiTreeViewActionList : DesignerActionList
    {
        #region Instance Fields
        private KiwiTreeView _treeView;
        private IComponentChangeService _service;
        #endregion

        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiTreeViewActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public KiwiTreeViewActionList(KiwiTreeViewDesigner owner)
            : base(owner.Component)
        {
            // Remember the tree view instance
            _treeView = owner.Component as KiwiTreeView;
