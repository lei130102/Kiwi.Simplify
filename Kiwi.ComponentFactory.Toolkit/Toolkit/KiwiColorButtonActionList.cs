...
{
    internal class KiwiColorButtonActionList : DesignerActionList
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiColorButtonActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public KiwiColorButtonActionList(KiwiColorButtonDesigner owner)
            : base(owner.Component)
        {
            // Remember the button instance
            _colorButton = owner.Component as KiwiColorButton;
