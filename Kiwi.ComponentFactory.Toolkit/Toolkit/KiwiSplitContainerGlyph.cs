...
{
    internal class KiwiSplitContainerGlyph : Glyph
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiSplitContainerGlyph class.
        /// </summary>
        ...
        public KiwiSplitContainerGlyph(ISelectionService selectionService,
                                          BehaviorService behaviorService,
                                          Adorner adorner,
                                          IDesigner relatedDesigner)
            : base(new KiwiSplitContainerBehavior(relatedDesigner))
        {
