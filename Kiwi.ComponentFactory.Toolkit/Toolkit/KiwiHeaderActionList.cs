...
{
    internal class KiwiHeaderActionList : DesignerActionList
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiHeaderActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public KiwiHeaderActionList(KiwiHeaderDesigner owner)
            : base(owner.Component)
        {
            // Remember the header instance
            _header = owner.Component as KiwiHeader;
