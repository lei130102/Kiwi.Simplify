...
{
    internal class KiwiBreadCrumbItemsEditor : CollectionEditor
    {
        #region Classes
        /// <summary>
        /// Form used for editing the KiwiBreadCrumbItems.
        /// </summary>
        protected partial class KiwiBreadCrumbItemsForm : CollectionEditor.CollectionForm
        {
            #region Types
            /// <summary>
            /// Simple class to reduce the length of declaractions!
            /// </summary>
            protected class DictItemBase : Dictionary<KiwiBreadCrumbItem, KiwiBreadCrumbItem> { };
            ...
            protected class CrumbProxy
            {
                ...
                private KiwiBreadCrumbItem _item;
                #endregion
                ...
                public CrumbProxy(KiwiBreadCrumbItem item)
                {
                    _item = item;
                }
                #endregion
            ...
            protected class MenuTreeNode : TreeNode
            {
                ...
                public MenuTreeNode(KiwiBreadCrumbItem item)
                {
                    _item = item;
                ...
                /// </summary>
                public KiwiBreadCrumbItem Item
                {
                    get { return _item; }
                }
            ...
            #region Instance Fields
            private KiwiBreadCrumbItemsEditor _editor;
            ...
            #region Identity
            /// <summary>
            /// Initialize a new instance of the KiwiBreadCrumbItemsForm class.
            /// </summary>
            public KiwiBreadCrumbItemsForm(KiwiBreadCrumbItemsEditor editor)
                : base(editor)
            {
                _editor = editor;
                ...
                this.Name = "KiwiBreadCrumbCollectionForm";
            ...
            protected override void OnEditValueChanged()
            {
                if (EditValue != null)
                {
                    ...
                    foreach (KiwiBreadCrumbItem item in Items)
            ...
            {
                KiwiBreadCrumbItem item = (KiwiBreadCrumbItem)CreateInstance(typeof(KiwiBreadCrumbItem));
            ...
            private void UpdatePropertyGrid()
            {
                ...
                if (node == null)
                    ...
                    propertyGrid1.SelectedObject = new CrumbProxy((KiwiBreadCrumbItem)((MenuTreeNode)node).PropertyObject);
            }
            ...
            private void AddItemsToDictionary(DictItemBase dictItems, KiwiBreadCrumbItem baseItem)
            {
                // Add item to the dictionary
                dictItems.Add(baseItem, baseItem);

                // Add children of an items collection
                foreach (KiwiBreadCrumbItem item in baseItem.Items)
                    AddItemsToDictionary(dictItems, item);
            }

            private void AddMenuTreeNode(KiwiBreadCrumbItem item, MenuTreeNode parent)
            {
                ...
                // Add children of an items collection
                foreach (KiwiBreadCrumbItem child in item.Items)
                                                ...
                                                ITypeDescriptorContext context)
            {
                ...
                foreach (KiwiBreadCrumbItem item in after.Values)
                ...
                foreach (KiwiBreadCrumbItem item in before.Values)
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiBreadCrumbItemsEditor class.
		/// </summary>
        public KiwiBreadCrumbItemsEditor()
            : base(typeof(KiwiBreadCrumbItem.BreadCrumbItems))
        {
        }
        #endregion
        ...
        {
            return new KiwiBreadCrumbItemsForm(this);
        }
        #endregion
    }
}
