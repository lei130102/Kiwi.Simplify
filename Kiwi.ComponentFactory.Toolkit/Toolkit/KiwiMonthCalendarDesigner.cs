...
{
    internal class KiwiMonthCalendarDesigner : ControlDesigner
    {
        ...
        public override void Initialize(IComponent component)
        {
            ...
            _monthCalendar = component as KiwiMonthCalendar;
        ...
        public override DesignerActionListCollection ActionLists
        {
            get
            {
                ...
                actionLists.Add(new KiwiMonthCalendarActionList(this));
