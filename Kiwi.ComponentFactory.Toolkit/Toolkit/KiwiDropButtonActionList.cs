...
{
    internal class KiwiDropButtonActionList : DesignerActionList
    {
        #region Instance Fields
        private KiwiDropButton _dropButton;
        private IComponentChangeService _service;
        #endregion

        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiDropButtonActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public KiwiDropButtonActionList(KiwiDropButtonDesigner owner)
            : base(owner.Component)
        {
            // Remember the button instance
            _dropButton = owner.Component as KiwiDropButton;
