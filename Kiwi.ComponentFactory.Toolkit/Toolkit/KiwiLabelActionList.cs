...
{
    internal class KiwiLabelActionList : DesignerActionList
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiLabelActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public KiwiLabelActionList(KiwiLabelDesigner owner)
            : base(owner.Component)
        {
            // Remember the label instance
            _label = owner.Component as KiwiLabel;
