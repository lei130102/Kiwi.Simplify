...
{
    internal class KiwiTrackBarActionList : DesignerActionList
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiTrackBarActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public KiwiTrackBarActionList(KiwiTrackBarDesigner owner)
            : base(owner.Component)
        {
            _trackBar = owner.Component as KiwiTrackBar;
