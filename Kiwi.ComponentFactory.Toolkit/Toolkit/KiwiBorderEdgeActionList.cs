...
{
    internal class KiwiBorderEdgeActionList : DesignerActionList
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiBorderEdgeActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public KiwiBorderEdgeActionList(KiwiBorderEdgeDesigner owner)
            : base(owner.Component)
        {
            _borderEdge = owner.Component as KiwiBorderEdge;
        ...
        public override DesignerActionItemCollection GetSortedActionItems()
        {
            ...
            if (_borderEdge != null)
            {
                ...
                actions.Add(new KiwiDesignerActionItem(new DesignerVerb(_action, new EventHandler(OnOrientationClick)), "Layout"));
