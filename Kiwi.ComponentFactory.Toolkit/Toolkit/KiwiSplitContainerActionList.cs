...
{
    internal class KiwiSplitContainerActionList : DesignerActionList
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiSplitContainerActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public KiwiSplitContainerActionList(KiwiSplitContainerDesigner owner)
            : base(owner.Component)
        {
            _splitContainer = owner.Component as KiwiSplitContainer;
        ...
        public override DesignerActionItemCollection GetSortedActionItems()
        {
            ...
            if (_splitContainer != null)
            {
                ...
                actions.Add(new KiwiDesignerActionItem(new DesignerVerb(_action, new EventHandler(OnOrientationClick)), "Splitter"));
