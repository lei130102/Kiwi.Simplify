...
{
    internal class KiwiHeaderGroupActionList : DesignerActionList
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiHeaderGroupActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public KiwiHeaderGroupActionList(KiwiHeaderGroupDesigner owner)
            : base(owner.Component)
        {
            // Remember the panel instance
            _headerGroup = owner.Component as KiwiHeaderGroup;
        ...
        public override DesignerActionItemCollection GetSortedActionItems()
        {
            ...
            if (_headerGroup != null)
            {
                ...
                actions.Add(new KiwiDesignerActionItem(_visible1, "Primary Header"));
                ...
                actions.Add(new KiwiDesignerActionItem(_visible2, "Secondary Header"));
