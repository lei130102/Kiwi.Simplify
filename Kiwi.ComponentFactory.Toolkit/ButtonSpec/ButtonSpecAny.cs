...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    public class ButtonSpecAny : ButtonSpec
    {
        ...
        [RefreshPropertiesAttribute(RefreshProperties.All)]
        [DefaultValue(null)]
        public override KiwiCommand KiwiCommand
        {
        ...
        protected override void OnButtonSpecPropertyChanged(string propertyName)
        {
            ...
            if (propertyName == "KiwiCommand")
            {
                if (KiwiCommand != null)
                {
                    if (Checked != ButtonCheckState.NotCheckButton)
                        Checked = (KiwiCommand.Checked ? ButtonCheckState.Checked : ButtonCheckState.Unchecked);

                    Enabled = (KiwiCommand.Enabled ? ButtonEnabled.True : ButtonEnabled.False);
                }
            }
            else if (propertyName == "Checked")
            {
                if (KiwiCommand != null)
                    KiwiCommand.Checked = (Checked == ButtonCheckState.Checked);
            }
        }
