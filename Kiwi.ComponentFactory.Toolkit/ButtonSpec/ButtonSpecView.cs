                                  ...
                                  IContentValues
    {
        ...
        private void OnClick(object sender, MouseEventArgs e)
        {
            ...
            if (!CommonHelper.DesignMode(_manager.Control))
            {
                ...
                // Does the button spec define a kiwi context menu?
                if ((_buttonSpec.KiwiContextMenu != null) && (ViewButton != null))
                {
                    ...
                    _buttonSpec.KiwiContextMenu.Closed += new ToolStripDropDownClosedEventHandler(OnKiwiContextMenuClosed);
                    if (!_buttonSpec.KiwiContextMenu.Show(_buttonSpec, pt))
                    {
        ...
        private void OnKiwiContextMenuClosed(object sender, ToolStripDropDownClosedEventArgs e)
        {
