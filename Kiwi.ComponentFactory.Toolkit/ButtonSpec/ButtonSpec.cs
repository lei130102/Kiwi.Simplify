...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    [ToolboxBitmap(typeof(ButtonSpec), "ToolboxBitmaps.KiwiButtonSpec.bmp")]
    [DefaultEvent("Click")]
                                       ...
                                       ICloneable
    {
        ...
        public virtual object Clone()
        {
            ...
            clone.KiwiContextMenu = KiwiContextMenu;
            clone.KiwiCommand = KiwiCommand;
            clone.Owner = Owner;
            clone.Tag = Tag;
            return clone;
        }
        ...
        /// <summary>
        /// Gets and sets the kiwi context menu for the button.
        /// </summary>
        [Localizable(true)]
        [Category("Behavior")]
        [Description("KiwiContextMenu to show when the button is pressed.")]
        [RefreshPropertiesAttribute(RefreshProperties.All)]
        [DefaultValue(null)]
        public KiwiContextMenu KiwiContextMenu
        {
            get { return _kiwiContextMenu; }
            set { _kiwiContextMenu = value; }
        }
        #endregion
        ...
        public virtual KiwiCommand KiwiCommand
        {
            ...
            set
            {
                if (_command != value)
                {
                    ...
                    _command = value;
                    OnButtonSpecPropertyChanged("KiwiCommand");
