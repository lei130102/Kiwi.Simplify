...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    internal class ViewLayoutMenuItemSelect : ViewComposite
    {
        ...
        private KiwiContextMenuImageSelect _itemSelect;
        ...
        public ViewLayoutMenuItemSelect(KiwiContextMenuImageSelect itemSelect,
                                        IContextMenuProvider provider)
        {
            ...
            if (palette == null)
                palette = KiwiManager.GetPaletteForMode(provider.ProviderPaletteMode);
