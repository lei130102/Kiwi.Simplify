...
namespace Kiwi.ComponentFactory.Toolkit
{
    #region IKiwiDebug
    /// <summary>
    /// Exposes access to the debugging helpers for kiwi controls.
    /// </summary>
    public interface IKiwiDebug
    {
        /// <summary>
        /// Reset the internal counters.
        /// </summary>
        void KiwiResetCounters();

        /// <summary>
        /// Gets the number of layout cycles performed since last reset.
        /// </summary>
        int KiwiLayoutCounter { get; }

        /// <summary>
        /// Gets the number of paint cycles performed since last reset.
        /// </summary>
        int KiwiPaintCounter { get; }
    }
    #endregion
    ...
    public interface IContextMenuProvider
    {
        ...
        bool ProviderShowSubMenuFixed(KiwiContextMenuItem menuItem);
        ...
        Rectangle ProviderShowSubMenuFixedRect(KiwiContextMenuItem menuItem);
        ...
        /// </summary>
        KiwiContextMenuPositionH ProviderShowHorz { get; set; }

        /// <summary>
        /// Gets and sets the vertical setting used to position the menu.
        /// </summary>
        KiwiContextMenuPositionV ProviderShowVert { get; set; }
    ...
    public interface IKiwiCommand
    {
        ...
        /// <summary>
        /// Gets and sets the command text line 1 for use in KiwiRibbon.
        /// </summary>
        string TextLine1 { get; set; }

        /// <summary>
        /// Gets and sets the command text line 2 for use in KiwiRibbon.
        /// </summary>
    ...
    #region Enum KiwiContextMenuPositionV
    /// <summary>
    /// Specifies the relative vertical position for showing a KiwiContextMenu.
    /// </summary>
    public enum KiwiContextMenuPositionV
    {
        /// <summary>
    ...
    #region Enum KiwiContextMenuPositionH
    /// <summary>
    /// Specifies the relative horizontal position for showing a KiwiContextMenu.
    /// </summary>
    public enum KiwiContextMenuPositionH
    {
        /// <summary>
    ...
    #region IKiwiMonthCalendar
    /// <summary>
    /// Provides month calendar information.
    /// </summary>
    public interface IKiwiMonthCalendar
    {
        /// <summary>
    ...
    #endregion
    #region Enum KiwiLinkBehavior
    /// <summary>
    /// Specifies the logic for underlining the link label short text.
    /// </summary>
    [TypeConverter(typeof(KiwiLinkBehaviorConverter))]
    public enum KiwiLinkBehavior
    {
        /// <summary>
    ...
    #endregion
    #region IKiwiDesignerSelect
    /// <summary>
    /// Exposes design time selection of parent control.
    /// </summary>
    public interface IKiwiDesignerSelect
    {
        /// <summary>
        /// Should painting be performed for the selection glyph.
        /// </summary>
