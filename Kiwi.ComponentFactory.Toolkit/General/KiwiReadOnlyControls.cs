...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    /// </summary>
    public class KiwiReadOnlyControls : KiwiControlCollection
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiReadOnlyControls class.
        /// </summary>
        /// <param name="owner">Owning control.</param>
        public KiwiReadOnlyControls(Control owner)
            : base(owner)
        {
            _allowRemove = false;
        }
