...
{
    internal class KiwiSparkleRenderer : KiwiProfessionalRenderer
    {
        ...
        /// <summary>
        /// Initialise a new instance of the KiwiSparkleRenderer class.
        /// </summary>
        /// <param name="kct">Source for text colors.</param>
        public KiwiSparkleRenderer(KiwiColorTable kct)
            : base(kct)
        {
        }
        #endregion
        ...
        protected override void OnRenderToolStripBackground(ToolStripRenderEventArgs e)
        {
            ...
            else if (e.ToolStrip is StatusStrip)
            {
                ...
                // Check if the status strip is inside a KiwiForm and using the Sparkle renderer, in 
                    ...
                    (ToolStripManager.Renderer is KiwiSparkleRenderer))
                {
                    ...
                    if (kiwiForm.ApplyCustomChrome)
                    {
                        ...
                        Padding borders = kiwiForm.RealWindowBorders;
