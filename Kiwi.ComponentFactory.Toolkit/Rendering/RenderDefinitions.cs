...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    public interface IRenderBorder
    {
        ...
        /// <summary>
        /// Generate a gaphics path that is in the middle of the border.
        /// </summary>
        ...
        /// <summary>
        /// Generate a graphics path that encloses the border and is used when rendering a background to ensure the background
        /// does not draw over the border area.
        /// </summary>
        /// <param name="context"></param>
        /// <param name="rect"></param>
        /// <param name="palette"></param>
    ...
    public interface IRenderTabBorder
    {
        ...
        /// <summary>
        /// Generate a graphics path that encloses the border and is used when rendering a background
        /// to ensure the background does not draw over the border area.
        /// </summary>
        /// <param name="context"></param>
        /// <param name="rect"></param>
        /// <param name="palette"></param>
        /// <param name="orientation"></param>
        /// <param name="state"></param>
        /// <param name="tabBorderStyle"></param>
        /// <returns></returns>
    ...
    public interface IRenderGlyph
    {
        ...
        /// <param name="displayRect">Display area available for drawing.</param>
        /// <param name="palette">palette for sourcing display values.</param>
        /// <param name="enabled">shoud check box be displayed as enabled.</param>
        /// <param name="checkState">The checked state of the check box.</param>
        /// <param name="tracking">Should check box be displayed as hot tracking.</param>
        /// <param name="pressed">Should check box be displayed as pressed.</param>
        ...
        /// <param name="pressed">Shoud radio button be displayed as pressed.</param>
        ...
        /// <param name="orientation">How to orientation the image.</param>
        ...
        /// <param name="context">Render context.</param>
        /// <param name="cellRect">Available drawing rectangle space.</param>
        /// <param name="paletteContent">Content palette for getting color.</param>
        /// <param name="state">State associated with rendering.</param>
        ...
        /// </summary>
        /// <param name="shape">Ribbon shape.</param>
        /// <param name="context">Render cnotext.</param>
        /// <param name="displayRect">Display area available for drawing.</param>
        /// <param name="paletteGeneral">General ribbon palette details.</param>
        /// <param name="state">State associated with rendering.</param>
        ...
        /// <param name="cellRect">Available drawing rectangle space.</param>
        /// <param name="state">State associated with rendering.</param>
        /// <param name="rthl">Shoud be drawn from right to left.</param>
        /// <returns>Remainder space left over for other drawing.</returns>
