...
{
    internal class KiwiOffice2010Renderer : KiwiProfessionalRenderer
    {
        ...
        /// <summary>
        /// Initialise a new instance of the KiwiOffice2010Renderer class.
        /// </summary>
        /// <param name="kct">Source for text colors.</param>
        public KiwiOffice2010Renderer(KiwiColorTable kct)
            : base(kct)
        {
        }
        #endregion
