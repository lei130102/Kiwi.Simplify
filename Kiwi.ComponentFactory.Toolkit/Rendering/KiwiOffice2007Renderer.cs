...
{
    internal class KiwiOffice2007Renderer : KiwiProfessionalRenderer
    {
        ...
        /// <summary>
        /// Initialise a new instance of the KiwiOffice2007Renderer class.
        /// </summary>
        /// <param name="kct">Source for text colors.</param>
        public KiwiOffice2007Renderer(KiwiColorTable kct)
            : base(kct)
        {
        }
        #endregion
        ...
        protected override void OnRenderToolStripBackground(ToolStripRenderEventArgs e)
        {
            ...
            else if (e.ToolStrip is StatusStrip)
            {
                ...
                // Check if the status strip is inside a KiwiForm and using the Office 2007 renderer, in 
                    ...
                    (ToolStripManager.Renderer is KiwiOffice2007Renderer))
                {
                    ...
                    KiwiForm kiwiForm = (KiwiForm)owner;

                    // Finally check that the actual form is using custom chrome
                    if (kiwiForm.ApplyCustomChrome)
                    {
                        // Extend down into the bottom border
                        backRect.Height += kiwiForm.RealWindowBorders.Bottom;
                    }
                }
