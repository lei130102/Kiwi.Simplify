...
{
    internal class KiwiProfessionalRenderer : ToolStripProfessionalRenderer
    {
        #region Instance Fields
        private KiwiColorTable _kct;
        #endregion

        #region Identity
        /// <summary>
        /// Initialise a new instance of the KiwiProfessionalRenderer class.
        /// </summary>
        /// <param name="kct">Source for text colors.</param>
        public KiwiProfessionalRenderer(KiwiColorTable kct)
            : base(kct)
        {
        ...
        #region KCT
        /// <summary>
        /// Gets access to the KiwiColorTable instance.
        /// </summary>
        public KiwiColorTable KCT
        {
            get { return _kct; }
        }
        #endregion
