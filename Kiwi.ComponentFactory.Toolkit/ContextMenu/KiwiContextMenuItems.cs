...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    [ToolboxItem(false)]
    //
    [ToolboxBitmap(typeof(KiwiContextMenuItems), "ToolboxBitmaps.KiwiContextMenuItems.bmp")]
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiContextMenuItemsDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [DefaultProperty("Items")]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    public class KiwiContextMenuItems : KiwiContextMenuItemBase
    {
        #region Instance Fields
        private bool _standardStyle;
        private bool _imageColumn;
        private KiwiContextMenuItemCollection _items;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiContextMenuItems class.
        /// </summary>
        public KiwiContextMenuItems()
            : this(null)
        {
        }
        ...
        public KiwiContextMenuItems(KiwiContextMenuItemBase[] children)
        {
            // Default fields
            _standardStyle = true;
            _imageColumn = true;
            _items = new KiwiContextMenuItemCollection();
        ...
        public KiwiContextMenuItemCollection Items
        {
            get { return _items; }
        }
