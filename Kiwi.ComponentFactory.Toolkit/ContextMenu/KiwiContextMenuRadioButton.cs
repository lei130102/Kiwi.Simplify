...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    [ToolboxItem(false)]
    //
    [ToolboxBitmap(typeof(KiwiContextMenuRadioButton), "ToolboxBitmaps.KiwiRadioButton.bmp")]
    [DefaultProperty("Text")]
    [DefaultEvent("CheckedChanged")]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    public class KiwiContextMenuRadioButton : KiwiContextMenuItemBase
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiContextMenuRadioButton class.
        /// </summary>
        public KiwiContextMenuRadioButton()
            : this("RadioButton")
        {
        }
        ...
        public KiwiContextMenuRadioButton(string initialText)
        {
            // Default fields
            _enabled = true;
            _autoClose = false;
