...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    [ToolboxItem(false)]
    //
    [ToolboxBitmap(typeof(KiwiContextMenuImageSelect), "ToolboxBitmaps.KiwiContextMenuImageSelect.bmp")]
    [DefaultProperty("ImageList")]
    [DefaultEvent("SelectedIndexChanged")]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    public class KiwiContextMenuImageSelect : KiwiContextMenuItemBase
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiContextMenuImageSelect class.
        /// </summary>
        public KiwiContextMenuImageSelect()
        {
            _autoClose = true;
            _selectedIndex = -1;
            _trackingIndex = -1;
