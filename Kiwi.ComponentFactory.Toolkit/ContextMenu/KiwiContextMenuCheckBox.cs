...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    [ToolboxItem(false)]
    //
    [ToolboxBitmap(typeof(KiwiContextMenuCheckBox), "ToolboxBitmaps.KiwiCheckBox.bmp")]
    [DefaultProperty("Text")]
    [DefaultEvent("CheckedChanged")]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    public class KiwiContextMenuCheckBox : KiwiContextMenuItemBase
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiContextMenuCheckBox class.
        /// </summary>
        public KiwiContextMenuCheckBox()
            : this("CheckBox")
        {
        }
        ...
        public KiwiContextMenuCheckBox(string initialText)
        {
            // Default fields
            _enabled = true;
            _autoClose = false;
