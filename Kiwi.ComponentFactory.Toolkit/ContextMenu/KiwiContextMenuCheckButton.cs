...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    [ToolboxItem(false)]
    //
    [ToolboxBitmap(typeof(KiwiContextMenuCheckButton), "ToolboxBitmaps.KiwiCheckButton.bmp")]
    [DefaultProperty("Text")]
    [DefaultEvent("CheckedChanged")]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    public class KiwiContextMenuCheckButton : KiwiContextMenuItemBase
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiContextMenuCheckButton class.
        /// </summary>
        public KiwiContextMenuCheckButton()
            : this("CheckButton")
        {
        }
        ...
        public KiwiContextMenuCheckButton(string initialText)
        {
            // Default fields
            _enabled = true;
            _autoClose = false;
