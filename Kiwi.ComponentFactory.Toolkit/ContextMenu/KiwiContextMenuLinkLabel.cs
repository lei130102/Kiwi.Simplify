...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    [ToolboxItem(false)]
    //
    [ToolboxBitmap(typeof(KiwiContextMenuLinkLabel), "ToolboxBitmaps.KiwiLinkLabel.bmp")]
    [DefaultProperty("Text")]
    [DefaultEvent("Click")]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    public class KiwiContextMenuLinkLabel : KiwiContextMenuItemBase
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiContextMenuLinkLabel class.
        /// </summary>
        public KiwiContextMenuLinkLabel()
            : this("LinkLabel")
        {
        }
        ...
        public KiwiContextMenuLinkLabel(string initialText)
        {
            // Default fields
            _text = initialText;
            ...
            _inheritBehavior = new LinkLabelBehaviorInherit(_stateNormal, KiwiLinkBehavior.AlwaysUnderline);
        ...
        [DefaultValue(typeof(KiwiLinkBehavior), "Always Underline")]
        public KiwiLinkBehavior LinkBehavior
        {
