...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    [ToolboxItem(false)]
    //
    [ToolboxBitmap(typeof(KiwiContextMenuMonthCalendar), "ToolboxBitmaps.KiwiMonthCalendar.bmp")]
    [DefaultEvent("DateChanged")]
    [DefaultProperty("SelectionRange")]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    public class KiwiContextMenuMonthCalendar : KiwiContextMenuItemBase
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiContextMenuMonthCalendar class.
        /// </summary>
        public KiwiContextMenuMonthCalendar()
        {
            // Default fields
            _autoClose = true;
            _enabled = true;
