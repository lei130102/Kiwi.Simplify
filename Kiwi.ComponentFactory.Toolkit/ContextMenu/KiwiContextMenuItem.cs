...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiContextMenuItemDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [ToolboxItem(false)]
    //
    [ToolboxBitmap(typeof(KiwiContextMenuItem), "ToolboxBitmaps.KiwiContextMenuItem.bmp")]
    [DefaultEvent("Click")]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    public class KiwiContextMenuItem : KiwiContextMenuItemBase
    {
        ...
        private bool _largeKiwiCommandImage;
        ...
        private KiwiContextMenuCollection _items;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiContextMenuItem class.
        /// </summary>
        public KiwiContextMenuItem()
        ...
        public KiwiContextMenuItem(string initialText)
        ...
        /// <summary>
        /// Gets and sets if the large image is used from the attached KiwiCommand.
        /// </summary>
        [KiwiPersist]
        [Category("Behavior")]
        [Description("Determines if the large image is used from the attached KiwiCommand.")]
        [DefaultValue(false)]
        public bool LargeKiwiCommandImage
        {
            get { return _largeKiwiCommandImage; }

            set
            {
                if (_largeKiwiCommandImage != value)
                {
                    _largeKiwiCommandImage = value;
                    OnPropertyChanged(new PropertyChangedEventArgs("LargeKiwiCommandImage"));
                }
            }
        }
        ...
        public KiwiContextMenuCollection Items
        {
            get { return _items; }
        }
        ...
        public virtual KiwiCommand KiwiCommand
        {
            ...
            set
            {
                ...
                {
                    _command = value;
                    OnPropertyChanged(new PropertyChangedEventArgs("KiwiCommand"));
                }
            }
        }
        ...
        public void PerformClick()
        {
            ...
            if (CheckOnClick)
            {
                ...
                CheckState state = (KiwiCommand == null ? CheckState : KiwiCommand.CheckState);
