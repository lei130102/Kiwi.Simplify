...
namespace Kiwi.ComponentFactory.Toolkit
{
    internal class LinkLabelBehaviorInherit : PaletteContentInherit
    {
        ...
        private KiwiLinkBehavior _linkBehavior;
        #endregion
        ...
        private Font GetContentFont(PaletteState state, Font font)
        {
            ...
            if (!CommonHelper.IsOverrideState(state))
            {
                ...
                {
                    case KiwiLinkBehavior.AlwaysUnderline:
                        underline = true;
                        break;
                    case KiwiLinkBehavior.HoverUnderline:
                        underline = ((state == PaletteState.Tracking) ||
                                     (state == PaletteState.Pressed));
                        break;
                    case KiwiLinkBehavior.NeverUnderline:
                        // Nothing to do
                        break;
                }
