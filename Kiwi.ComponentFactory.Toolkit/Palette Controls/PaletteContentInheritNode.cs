...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    public class PaletteContentInheritNode : PaletteContentInherit
    {
        ...
        {
            KiwiTreeNode kiwiNode = TreeNode as KiwiTreeNode;

            if ((kiwiNode != null) && (kiwiNode.LongNodeFont != null))
                return kiwiNode.LongNodeFont;
            else
        ...
        public override Color GetContentLongTextColor1(PaletteState state)
        {
            ...
            if ((kiwiNode != null) && (kiwiNode.LongForeColor != Color.Empty))
                return kiwiNode.LongForeColor;
            else
