...
namespace Kiwi.ComponentFactory.Toolkit
{
                                              ...
                                              IContextMenuTarget
    {
        ...
        private void PressColorBlock()
        {
            ...
            if (_menuColorBlock.KiwiContextMenuColorColumns.AutoClose)
            {
        ...
        {
            _highlight = true;
            _menuColorBlock.KiwiContextMenuColorColumns.OnTrackingColor(new ColorEventArgs(_menuColorBlock.Color));
            UpdateTarget();
        }
        ...
        {
            _highlight = false;
            _menuColorBlock.KiwiContextMenuColorColumns.OnTrackingColor(new ColorEventArgs(Color.Empty));
            UpdateTarget();
        }
