...
namespace Kiwi.ComponentFactory.Toolkit
{
                                               ...
                                               IContextMenuTarget
    {
        ...
        private void PressMenuCheckButton(bool keyboard)
        {
            ...
            if (_menuCheckButton.KiwiContextMenuCheckButton.AutoClose)
            {
            ...
            if (_menuCheckButton.KiwiContextMenuCheckButton.AutoCheck)
            {
                // Get the current checked state
                bool checkState = (_menuCheckButton.KiwiContextMenuCheckButton.KiwiCommand == null ?
                                   _menuCheckButton.KiwiContextMenuCheckButton.Checked :
                                   _menuCheckButton.KiwiContextMenuCheckButton.KiwiCommand.Checked);

                // Invert state
                checkState = !checkState;

                // Set the state back again
                if (_menuCheckButton.KiwiContextMenuCheckButton.KiwiCommand == null)
                    _menuCheckButton.KiwiContextMenuCheckButton.Checked = checkState;
                else
                    _menuCheckButton.KiwiContextMenuCheckButton.KiwiCommand.Checked = checkState;
            }
        ...
        private void UpdateTarget()
        {
            ...
            _menuCheckButton.KiwiContextMenuCheckButton.OverrideDisabled.Apply = applyFocus;
            _menuCheckButton.KiwiContextMenuCheckButton.OverrideNormal.Apply = applyFocus;
            _menuCheckButton.KiwiContextMenuCheckButton.OverrideTracking.Apply = applyFocus;
            _menuCheckButton.KiwiContextMenuCheckButton.OverridePressed.Apply = applyFocus;
            _menuCheckButton.KiwiContextMenuCheckButton.OverrideCheckedNormal.Apply = applyFocus;
            _menuCheckButton.KiwiContextMenuCheckButton.OverrideCheckedTracking.Apply = applyFocus;
            _menuCheckButton.KiwiContextMenuCheckButton.OverrideCheckedPressed.Apply = applyFocus;
