...
namespace Kiwi.ComponentFactory.Toolkit
{
                                           ...
                                           IContextMenuTarget
    {
        ...
        private KiwiContextMenuMonthCalendar _monthCalendar;
        ...
        public MonthCalendarController(KiwiContextMenuMonthCalendar monthCalendar,
        ...
        public virtual bool MouseDown(Control c, Point pt, MouseButtons button)
        {
            ...
            if (button == MouseButtons.Left)
            {
                ...
                if ((c != null) && (c is KiwiMonthCalendar) && !c.ContainsFocus)
                    c.Focus();
