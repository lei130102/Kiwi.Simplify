...
namespace Kiwi.ComponentFactory.Toolkit
{
                                            ...
                                            IContextMenuTarget
    {
        ...
        private void PressMenuCheckBox(bool keyboard)
        {
            ...
            if (_menuCheckBox.KiwiContextMenuCheckBox.AutoClose)
            {
            ...
            if (_menuCheckBox.KiwiContextMenuCheckBox.AutoCheck)
            {
                // Grab current state from command or ourself
                CheckState state = (_menuCheckBox.KiwiContextMenuCheckBox.KiwiCommand == null ?
                                    _menuCheckBox.KiwiContextMenuCheckBox.CheckState :
                                    _menuCheckBox.KiwiContextMenuCheckBox.KiwiCommand.CheckState);
                ...
                switch (state)
                {
                    ...
                    case CheckState.Checked:
                        state = (_menuCheckBox.KiwiContextMenuCheckBox.ThreeState ? CheckState.Indeterminate : CheckState.Unchecked);
                        break;
                ...
                if (_menuCheckBox.KiwiContextMenuCheckBox.KiwiCommand != null)
                    _menuCheckBox.KiwiContextMenuCheckBox.KiwiCommand.CheckState = state;
                else
                    _menuCheckBox.KiwiContextMenuCheckBox.CheckState = state;
        ...
        private void UpdateTarget()
        {
            ...
            _menuCheckBox.KiwiContextMenuCheckBox.OverrideNormal.Apply = applyFocus;
            _menuCheckBox.KiwiContextMenuCheckBox.OverrideDisabled.Apply = applyFocus;
