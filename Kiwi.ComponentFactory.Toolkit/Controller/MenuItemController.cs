...
namespace Kiwi.ComponentFactory.Toolkit
{
                                        ...
                                        IContextMenuTarget
    {
        ...
        private void PressMenuItem()
        {
            ...
            if (_menuItem.KiwiContextMenuItem.AutoClose)
            {
            ...
            _menuItem.KiwiContextMenuItem.PerformClick();
        ...
        private void HighlightState()
        {
            if (_menuItem.ItemEnabled)
            {
                ...
                _menuItem.SplitSeparator.SetPalettes(_menuItem.KiwiContextMenuItem.StateHighlight.ItemSplit.Back,
                                                     _menuItem.KiwiContextMenuItem.StateHighlight.ItemSplit.Border);
                _menuItem.SetPalettes(_menuItem.KiwiContextMenuItem.StateHighlight.ItemHighlight.Back,
                                      _menuItem.KiwiContextMenuItem.StateHighlight.ItemHighlight.Border);
            }
            else
            {
                _menuItem.ElementState = PaletteState.Disabled;
                _menuItem.SplitSeparator.ElementState = PaletteState.Disabled;
                _menuItem.SplitSeparator.SetPalettes(_menuItem.KiwiContextMenuItem.StateDisabled.ItemSplit.Back,
                                                     _menuItem.KiwiContextMenuItem.StateDisabled.ItemSplit.Border);
                _menuItem.SetPalettes(_menuItem.KiwiContextMenuItem.StateDisabled.ItemHighlight.Back,
                                      _menuItem.KiwiContextMenuItem.StateDisabled.ItemHighlight.Border);
            }
        ...
        private void NormalState()
        {
            ...
            _menuItem.SplitSeparator.SetPalettes(_menuItem.KiwiContextMenuItem.StateNormal.ItemSplit.Back,
                                                 _menuItem.KiwiContextMenuItem.StateNormal.ItemSplit.Border);
            _menuItem.SetPalettes(_menuItem.KiwiContextMenuItem.StateNormal.ItemHighlight.Back,
                                  _menuItem.KiwiContextMenuItem.StateNormal.ItemHighlight.Border);
