...
namespace Kiwi.ComponentFactory.Toolkit
{
                                               ...
                                               IContextMenuTarget
    {
        ...
        private void PressMenuRadioButton(bool keyboard)
        {
            ...
            if (_menuRadioButton.KiwiContextMenuRadioButton.AutoClose)
            {
            ...
            if (_menuRadioButton.KiwiContextMenuRadioButton.AutoCheck)
            {
                // We only alter state if it is currently not checked
                if (!_menuRadioButton.KiwiContextMenuRadioButton.Checked)
                    _menuRadioButton.KiwiContextMenuRadioButton.Checked = true;
            }
        ...
        private void UpdateTarget()
        {
            ...
            _menuRadioButton.KiwiContextMenuRadioButton.OverrideNormal.Apply = applyFocus;
            _menuRadioButton.KiwiContextMenuRadioButton.OverrideDisabled.Apply = applyFocus;
