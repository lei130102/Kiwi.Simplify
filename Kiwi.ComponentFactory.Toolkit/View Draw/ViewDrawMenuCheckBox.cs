...
namespace Kiwi.ComponentFactory.Toolkit
{
    internal class ViewDrawMenuCheckBox : ViewComposite
    {
        ...
        private KiwiContextMenuCheckBox _checkBox;
        ...
        public ViewDrawMenuCheckBox(IContextMenuProvider provider,
                                    KiwiContextMenuCheckBox checkBox)
        {
            _provider = provider;
            _checkBox = checkBox;
            ...
            if (_checkBox.KiwiCommand != null)
            {
                _cachedCommand = _checkBox.KiwiCommand;
                _checkBox.KiwiCommand.PropertyChanged += new PropertyChangedEventHandler(OnCommandPropertyChanged);
            }
        }
        ...
        #region KiwiContextMenuCheckBox
        /// <summary>
        /// Gets access to the actual check box definiton.
        /// </summary>
        public KiwiContextMenuCheckBox KiwiContextMenuCheckBox
        {
