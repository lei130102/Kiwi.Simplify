...
namespace Kiwi.ComponentFactory.Toolkit
{
    internal class ViewDrawMenuCheckButton : ViewComposite
    {
        ...
        private KiwiContextMenuCheckButton _checkButton;
        ...
        public ViewDrawMenuCheckButton(IContextMenuProvider provider,
                                       KiwiContextMenuCheckButton checkButton)
        {
            _provider = provider;
            ...
            if (_checkButton.KiwiCommand != null)
            {
                _cachedCommand = _checkButton.KiwiCommand;
                _checkButton.KiwiCommand.PropertyChanged += new PropertyChangedEventHandler(OnCommandPropertyChanged);
            }
        }
        ...
        #region KiwiContextMenuCheckButton
        /// <summary>
        /// Gets access to the actual check button definiton.
        /// </summary>
        public KiwiContextMenuCheckButton KiwiContextMenuCheckButton
        {
