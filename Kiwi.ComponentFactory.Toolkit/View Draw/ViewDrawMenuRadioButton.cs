...
namespace Kiwi.ComponentFactory.Toolkit
{
    internal class ViewDrawMenuRadioButton : ViewComposite
    {
        ...
        private KiwiContextMenuRadioButton _radioButton;
        ...
        public ViewDrawMenuRadioButton(IContextMenuProvider provider,
                                       KiwiContextMenuRadioButton radioButton)
        {
            _provider = provider;
        ...
        #region KiwiContextMenuRadioButton
        /// <summary>
        /// Gets access to the actual radio button definiton.
        /// </summary>
        public KiwiContextMenuRadioButton KiwiContextMenuRadioButton
        {
