...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    public class ViewDrawMenuColorBlock : ViewLeaf
    {
        ...
        private KiwiContextMenuColorColumns _colorColumns;
        ...
        public ViewDrawMenuColorBlock(IContextMenuProvider provider,
                                      KiwiContextMenuColorColumns colorColumns,
                                      Color color,
                                      bool first,
                                      bool last,
                                      bool enabled)
        ...
        #region KiwiContextMenuColorColumns
        /// <summary>
        /// Gets access to the actual color columns definiton.
        /// </summary>
        public KiwiContextMenuColorColumns KiwiContextMenuColorColumns
        {
