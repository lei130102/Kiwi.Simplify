...
namespace Kiwi.ComponentFactory.Toolkit
{
    internal class ViewDrawMenuLinkLabel : ViewComposite
    {
        ...
        private KiwiContextMenuLinkLabel _linkLabel;
        ...
        public ViewDrawMenuLinkLabel(IContextMenuProvider provider,
                                     KiwiContextMenuLinkLabel linkLabel)
        {
            _provider = provider;
            ...
            if (_linkLabel.KiwiCommand != null)
            {
                _cachedCommand = _linkLabel.KiwiCommand;
                _linkLabel.KiwiCommand.PropertyChanged += new PropertyChangedEventHandler(OnCommandPropertyChanged);
            }
        }
        ...
        #region KiwiContextMenuLinkLabel
        /// <summary>
        /// Gets access to the actual link label definiton.
        /// </summary>
        public KiwiContextMenuLinkLabel KiwiContextMenuLinkLabel
        {
