...
namespace Kiwi.ComponentFactory.Toolkit
{
    internal class ViewDrawMenuItem : ViewDrawCanvas
    {
        ...
        private KiwiContextMenuItem _menuItem;
        ...
        private KiwiCommand _cachedCommand;
                   ...
                   VisualOrientation.Top)
        {
            ...
            if (_menuItem.KiwiCommand != null)
            {
                _cachedCommand = _menuItem.KiwiCommand;
                _menuItem.KiwiCommand.PropertyChanged += new PropertyChangedEventHandler(OnCommandPropertyChanged);
            }
        }
        ...
        #region KiwiContextMenuItem
        /// <summary>
        /// Gets access to the context menu item we represent.
        /// </summary>
        public KiwiContextMenuItem KiwiContextMenuItem
        {
        ...
        public Image ResolveImage
        {
            get
            {
                if (_cachedCommand != null)
                {
                    if (_menuItem.LargeKiwiCommandImage)
