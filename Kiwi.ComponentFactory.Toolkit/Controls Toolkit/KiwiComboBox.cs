...
{
    /// <summary>
    /// Provide a ComboBox with Kiwi styling applied.
	/// </summary>
    ...
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiComboBoxDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
	[ToolboxItem(true)]
    [DesignerCategory("code")]
    [Description("Displays an editable textbox with a drop-down list of permitted values.")]
    //
    [ToolboxBitmap(typeof(KiwiComboBox), "ToolboxBitmaps.KiwiComboBox.bmp")]
    public class KiwiComboBox : VisualControlBase,
...

    {
        ...
        private class InternalPanel : Panel
        {
            ...
            private KiwiComboBox _kiwiComboBox;
            #endregion
            ...
            /// </summary>
            /// <param name="KiwiComboBox">Reference to owning control.</param>
            public InternalPanel(KiwiComboBox kiwiComboBox)
            {
                _kiwiComboBox = kiwiComboBox;
            }
            #endregion
            ...
            public override Size GetPreferredSize(Size proposedSize)
            {
                ...
                return new Size(maxSize.Width - 3, _kiwiComboBox._comboBox.ItemHeight + 4);
            }
            #endregion
            ...
            protected override void WndProc(ref Message m)
            {
                switch (m.Msg)
                {
                    case PI.WM_NCHITTEST:
                        if (_kiwiComboBox.InTransparentDesignMode)
        ...
        private class InternalComboBox : ComboBox, IContentValues
        {
            ...
            /// </summary>
            /// <param name="kiwiComboBox">Reference to owning control.</param>
            public InternalComboBox(KiwiComboBox kiwiComboBox)
            {
                // Remember incoming reference
                _kiwiComboBox = kiwiComboBox;

                // Remove from view until size for the first time by the Kiwi control
                ItemHeight = 15;
                DropDownHeight = 200;
            ...
            protected override void WndProc(ref Message m)
            {
                switch (m.Msg)
                {
                    ...
                    case PI.WM_MOUSELEAVE:
                        {
                            ...
                            _kiwiComboBox.PerformNeedPaint(false);
                            Invalidate();
                        }
                        break;
                    ...
                    case PI.WM_PAINT:
                        {
                            ...
                            using (Graphics g = Graphics.FromHdc(hdc))
                            {
                                ...
                                if (_kiwiComboBox.RightToLeft == RightToLeft.Yes)
                                {
                                ...
                                else
                                {
                                    ...
                                    g.TextRenderingHint = CommonHelper.PaletteTextHintToRenderingHint(_kiwiComboBox.StateDisabled.Item.PaletteContent.GetContentShortTextHint(PaletteState.Disabled));
                                    ...
                                    {
                                        using (SolidBrush foreBrush = new SolidBrush(ForeColor))
                                            g.DrawString(Text, _kiwiComboBox.GetComboBoxTripleState().PaletteContent.GetContentShortTextFont(PaletteState.Disabled), foreBrush,
                                                         new RectangleF(rect.left, rect.top, rect.right - rect.left, rect.bottom - rect.top),
                                                         stringFormat);
                                    }
                                }
                    ...
                    case PI.WM_CONTEXTMENU:
                        // Only interested in overriding the behavior when we have a kiwi context menu...
                        if (_kiwiComboBox.KiwiContextMenu != null)
                        {
                            ...
                            _kiwiComboBox.KiwiContextMenu.Show(_kiwiComboBox, mousePt);
            ...
            private void DrawDropButton(Graphics g, Rectangle drawRect)
            {
                ...
                if (_viewButton == null)
                {
                    // Create helper object to get all values from the KiwiComboBox redirector
                    _palette = new PaletteTripleToPalette(_kiwiComboBox.Redirector,
                    ...
                    _viewButton = new ViewDrawButton(_palette, _palette, _palette,
                                                     ...
                                                     new PaletteMetricRedirect(_kiwiComboBox.Redirector),
                                                     this, VisualOrientation.Top, false);
                }

                // Update with the latest button style for the drop down
                _palette.SetStyles(_kiwiComboBox.DropButtonStyle);
                ...
                if (_kiwiComboBox.Enabled)
                {
                    ...
                    else if (_kiwiComboBox.IsActive || (_kiwiComboBox.IsFixedActive && (_kiwiComboBox.InputControlStyle == InputControlStyle.Standalone)))
                    {
                        if (_kiwiComboBox.InputControlStyle == InputControlStyle.Standalone)
                ...
                using (ViewLayoutContext layoutContext = new ViewLayoutContext(_kiwiComboBox, _kiwiComboBox.Renderer))
                {
                ...
                using (RenderContext renderContext = new RenderContext(_kiwiComboBox, g, drawRect, _kiwiComboBox.Renderer))
                {
        ...
        private class SubclassEdit : NativeWindow
        {
            ...
            /// <param name="kiwiComboBox">Reference to top level control.</param>
            public SubclassEdit(IntPtr editControl,
                                KiwiComboBox kiwiComboBox)
            {
                _kiwiComboBox = kiwiComboBox;
            ...
            protected override void WndProc(ref Message m)
            {
                switch (m.Msg)
                {
                    ...
                    case PI.WM_DESTROY:
                        ...
                        // _kiwiComboBox.DetachEditControl();
                        base.WndProc(ref m);
                        break;
                    default:
                        base.WndProc(ref m);
        ...
        public class ComboBoxButtonSpecCollection : ButtonSpecCollection<ButtonSpecAny>
        {
            ...
            public ComboBoxButtonSpecCollection(KiwiComboBox owner)
                : base(owner)
            {
            }
            #endregion
        ...
        /// <summary>
        /// Occurs when the drop-down portion of the KiwiComboBox is shown.
        /// </summary>
        [Description("Occurs when the drop-down portion of the KiwiComboBox is shown.")]
        [Category("Behavior")]
        public event EventHandler DropDown;

        /// <summary>
        /// Indicates that the drop-down portion of the KiwiComboBox has closed.
        /// </summary>
        [Description("Indicates that the drop-down portion of the KiwiComboBox has closed.")]
        [Category("Behavior")]
        ...
        /// <summary>
        /// Occurs when the KiwiComboBox text has changed.
        /// </summary>
        [Description("Occurs when the KiwiComboBox text has changed.")]
        [Category("Behavior")]
        ...
        /// <summary>
        /// Initialize a new instance of the KiwiComboBox class.
		/// </summary>
        public KiwiComboBox()
        {
            ...
            ((KiwiReadOnlyControls)Controls).AddInternal(_comboHolder);
            ...
            set
            {
                if (_comboBox.DropDownStyle != value)
                {
                    if (value == ComboBoxStyle.Simple)
                        throw new ArgumentOutOfRangeException("KiwiComboBox does not support the DropDownStyle.Simple style.");
        ...
        /// <summary>
        /// Gets or sets whether the items in the list portion of the KiwiComboBox are sorted.
        /// </summary>
        [Category("Behavior")]
        ...
        /// <summary>
        /// Gets or sets the items in the KiwiComboBox.
        /// </summary>
        [Category("Data")]
        ...
        /// <summary>
        /// Creates a new instance of the control collection for the KiwiComboBox.
        /// </summary>
