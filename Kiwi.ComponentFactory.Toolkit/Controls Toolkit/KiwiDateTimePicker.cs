...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiDateTimePickerDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [DesignerCategory("code")]
    [Description("Enables the user to select a date and time, and to display that date and time in a specified format.")]
    //
    [ToolboxBitmap(typeof(KiwiDateTimePicker), "ToolboxBitmaps.KiwiDateTimePicker.bmp")]
    public class KiwiDateTimePicker : VisualControlBase,
                                         IContentValues
    {
        ...
        public class DateTimePickerButtonSpecCollection : ButtonSpecCollection<ButtonSpecAny>
        {
            ...
            public DateTimePickerButtonSpecCollection(KiwiDateTimePicker owner)
                : base(owner)
            {
            }
            #endregion
        ...
        private static readonly string _defaultToday = "今日:";
        #endregion
        ...
        private KiwiContextMenuMonthCalendar _kmc;
        ...
        /// </summary>
        [Category("Action")]
        [Description("Event raised when the value of the Value property is changed on KiwiDateTimePicker.")]
        ...
        /// </summary>
        [Category("Action")]
        [Description("Event raised when the value of the ValueNullable property is changed on KiwiDateTimePicker.")]
        ...
        /// </summary>
        [Category("Action")]
        [Description("Event raised when the value of the ActiveFragment property is changed on KiwiDateTimePicker.")]
        ...
        [Description("Event raised when the value of the Checked property is changed on KiwiDateTimePicker.")]
        ...
        /// </summary>
        [Category("Property Changed")]
        [Description("Event raised when the value of the Format property is changed on KiwiDateTimePicker.")]
        ...
        /// </summary>
        [Category("Property Changed")]
        [Description("Event raised when the value of the RightToLeftLayout property is changed on KiwiDateTimePicker.")]
        public event EventHandler RightToLeftLayoutChanged;
        #endregion

        #region Identity
        /// <summary>
		/// Initialize a new instance of the KiwiHeader class.
		/// </summary>
		public KiwiDateTimePicker()
        {
        ...
        /// </summary>
        [Category("Appearance")]
        [Description("Alignment of the drop-down calendar on the KiwiDateTimePicker control.")]
        ...
        private void OnDropDownClick(object sender, EventArgs e)
        {
            ...
            if (!_inRibbonDesignMode)
            {
                ...
                // Create a new kiwi context menu each time we drop the menu
                ...
                _kmc = new KiwiContextMenuMonthCalendar();
                ...
                DateTimePickerDropArgs dtpda = new DateTimePickerDropArgs(kcm,
                                                                          (DropDownAlign == LeftRightAlignment.Left ? KiwiContextMenuPositionH.Left : KiwiContextMenuPositionH.Right),
                                                                          KiwiContextMenuPositionV.Below);
                ...
                if (!dtpda.Cancel)
                {
                    if (dtpda.KiwiContextMenu != null)
                    {
                        ...
                        if (CommonHelper.ValidKiwiContextMenu(dtpda.KiwiContextMenu))
                        {
                            ...
                            dtpda.KiwiContextMenu.Closed += new ToolStripDropDownClosedEventHandler(OnKiwiContextMenuClosed);
                            dtpda.KiwiContextMenu.Show(this, screenRect, dtpda.PositionH, dtpda.PositionV);
                            return;
                        }
                    }
                }
    ...
    /// <summary>
    /// Specialized implementation of the KiwiContextMenu for use with the KiwiDateTimePicker.
    /// </summary>
    [ToolboxItem(false)]
    [DesignerCategory("code")]
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    public class DTPContextMenu : KiwiContextMenu
    {
        #region Instance Fields
        ...
        /// </summary>
        /// <param name="dropScreenRect">Screen rectangle of the drop down button on the KiwiDateTimePicker.</param>
        ...
        /// </summary>
        /// <param name="kcm">Owning KiwiContextMenu instance.</param>
        ...
        protected override VisualContextMenu CreateContextMenu(KiwiContextMenu kcm,
                                                               IPalette palette,
