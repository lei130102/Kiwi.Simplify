...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiCheckButtonDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [ToolboxItem(true)]
    //其他
    [ToolboxBitmap(typeof(KiwiCheckButton), "ToolboxBitmaps.KiwiCheckButton.bmp")]
    [DefaultEvent("Click")]
    [DesignerCategory("code")]
    [Description("Toggles checked state when user clicks button.")]
    public class KiwiCheckButton : KiwiButton
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiCheckButton class.
        /// </summary>
        public KiwiCheckButton()
        {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the KiwiCheckButton is in the checked state. 
        /// </summary>
        [Category("Appearance")]
        ...
        [DefaultValue(null)]
        public override IKiwiCommand KiwiCommand
        {
            get { return base.KiwiCommand; }

            set
            {
                if (base.KiwiCommand != value)
                {
                    if (base.KiwiCommand == null)
                        _wasChecked = Checked;

                    base.KiwiCommand = value;
        ...
        protected override void OnKiwiCommandChanged(EventArgs e)
        {
            // Let base class update with base button properties
            base.OnKiwiCommandChanged(e);

            // Update the check button specific properties from the command
            if (KiwiCommand != null)
                Checked = KiwiCommand.Checked;
        }
