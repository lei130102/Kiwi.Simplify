...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiHeaderDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [DesignerCategory("code")]
    [Description("Display a descriptive caption.")]
    //
    [ToolboxBitmap(typeof(KiwiHeader), "ToolboxBitmaps.KiwiHeader.bmp")]
    public class KiwiHeader : VisualSimpleBase
    {
        ...
        public class HeaderButtonSpecCollection : ButtonSpecCollection<ButtonSpecAny>
        {
            ...
            public HeaderButtonSpecCollection(KiwiHeader owner)
                : base(owner)
            {
            }
            #endregion
