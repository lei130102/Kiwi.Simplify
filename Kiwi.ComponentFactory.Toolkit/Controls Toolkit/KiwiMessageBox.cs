...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    //
    [ToolboxBitmap(typeof(KiwiMessageBox), "ToolboxBitmaps.KiwiMessageBox.bmp")]
    public class KiwiMessageBox : KiwiForm
    {
        #region Types
        ...
        [ToolboxItem(false)]
        internal class MessageButton : KiwiButton
        {
            #region Instance Fields
        ...
        private KiwiPanel _panelMessage;
        private KiwiPanel _panelMessageText;
        private KiwiWrapLabel _messageText;
        private KiwiPanel _panelMessageIcon;
        ...
        private KiwiBorderEdge borderEdge;
        private HelpInfo _helpInfo;
        #endregion

        #region Identity
        static KiwiMessageBox()
        {
            _osMajorVersion = Environment.OSVersion.Version.Major;
        }

        private KiwiMessageBox(string text, string caption,
                                                 ...
                                                 HelpInfo helpInfo)
        {
            ...
            using (KiwiMessageBox kmb = new KiwiMessageBox(text, caption, buttons, icon, defaultButton, options, helpInfo))
            {
                if (showOwner == null)
        ...
        private void UpdateButtons()
        {
            switch (_buttons)
            {
                ...
                case MessageBoxButtons.YesNoCancel:
                    _button1.Text = KiwiManager.Strings.Yes;
                    _button2.Text = KiwiManager.Strings.No;
                    _button3.Text = KiwiManager.Strings.Cancel;
                    _button1.DialogResult = DialogResult.Yes;
                    _button2.DialogResult = DialogResult.No;
                    _button3.DialogResult = DialogResult.Cancel;
                    break;
                case MessageBoxButtons.RetryCancel:
                    _button1.Text = KiwiManager.Strings.Retry;
                    _button2.Text = KiwiManager.Strings.Cancel;
                ...
                case MessageBoxButtons.AbortRetryIgnore:
                    _button1.Text = KiwiManager.Strings.Abort;
                    _button2.Text = KiwiManager.Strings.Retry;
                    _button3.Text = KiwiManager.Strings.Ignore;
        ...
        {
            this._panelMessage = new Kiwi.ComponentFactory.Toolkit.KiwiPanel();
            this._panelMessageText = new Kiwi.ComponentFactory.Toolkit.KiwiPanel();
            this._messageText = new Kiwi.ComponentFactory.Toolkit.KiwiWrapLabel();
            this._panelMessageIcon = new Kiwi.ComponentFactory.Toolkit.KiwiPanel();
            this._messageIcon = new System.Windows.Forms.PictureBox();
            this._panelButtons = new Kiwi.ComponentFactory.Toolkit.KiwiPanel();
            this.borderEdge = new Kiwi.ComponentFactory.Toolkit.KiwiBorderEdge();
            this._button3 = new Kiwi.ComponentFactory.Toolkit.KiwiMessageBox.MessageButton();
            this._button1 = new Kiwi.ComponentFactory.Toolkit.KiwiMessageBox.MessageButton();
            this._button2 = new Kiwi.ComponentFactory.Toolkit.KiwiMessageBox.MessageButton();
            ...
            this._messageText.LabelStyle = Kiwi.ComponentFactory.Toolkit.LabelStyle.NormalPanel;
            ...
            // borderEdge
            // 
            this.borderEdge.BorderStyle = Kiwi.ComponentFactory.Toolkit.PaletteBorderStyle.HeaderPrimary;
            ...
            this.borderEdge.Text = "kiwiBorderEdge1";
            // 
            // _button3
            // 
