...
{
    /// <summary>
    /// Provide a MaskedTextBox with Kiwi styling applied.
	/// </summary>
    ...
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiMaskedTextBoxDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [DesignerCategory("code")]
    [Description("Uses a mask to distinguish between proper and improper user input.")]
    //
    [ToolboxBitmap(typeof(KiwiMaskedTextBox), "ToolboxBitmaps.KiwiMaskedTextBox.bmp")]
    public class KiwiMaskedTextBox : VisualControlBase,
                                        IContainedInputControl
    {
        ...
        private class InternalMaskedTextBox : MaskedTextBox
        {
            ...
            private KiwiMaskedTextBox _kiwiMaskedTextBox;
            ...
            /// </summary>
            /// <param name="kiwiMaskedTextBox">Reference to owning control.</param>
            public InternalMaskedTextBox(KiwiMaskedTextBox kiwiMaskedTextBox)
            {
                _kiwiMaskedTextBox = kiwiMaskedTextBox;
            ...
            protected override void WndProc(ref Message m)
            {
                switch (m.Msg)
                {
                    case PI.WM_NCHITTEST:
                        if (_kiwiMaskedTextBox.InTransparentDesignMode)
                    ...
                    case PI.WM_MOUSELEAVE:
                        ...
                        MouseOver = false;
                        _kiwiMaskedTextBox.PerformNeedPaint(true);
                        Invalidate();
                        base.WndProc(ref m);
                        break;
                    ...
                    case PI.WM_PAINT:
                        {
                            ...
                            using (Graphics g = Graphics.FromHdc(hdc))
                            {
                                ...
                                else
                                {
                                    ...
                                    g.TextRenderingHint = CommonHelper.PaletteTextHintToRenderingHint(_kiwiMaskedTextBox.StateDisabled.PaletteContent.GetContentShortTextHint(PaletteState.Disabled));
                                    ...
                                    switch (_kiwiMaskedTextBox.TextAlign)
                                    {
                                    ...
                                    {
                                        using (SolidBrush foreBrush = new SolidBrush(ForeColor))
                                            g.DrawString(drawText, _kiwiMaskedTextBox.GetTripleState().PaletteContent.GetContentShortTextFont(PaletteState.Disabled), foreBrush,
                                                         new RectangleF(rect.left, rect.top, rect.right - rect.left, rect.bottom - rect.top),
                                                         stringFormat);
                                    }
                                }
                    ...
                    case PI.WM_CONTEXTMENU:
                        ...
                        if (_kiwiMaskedTextBox.KiwiContextMenu != null)
                        {
                            ...
                            _kiwiMaskedTextBox.KiwiContextMenu.Show(_kiwiMaskedTextBox, mousePt);
        ...
        public class MaskedTextBoxButtonSpecCollection : ButtonSpecCollection<ButtonSpecAny>
        {
            ...
            public MaskedTextBoxButtonSpecCollection(KiwiMaskedTextBox owner)
                : base(owner)
            {
            }
            #endregion
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiMaskedTextBox class.
		/// </summary>
        public KiwiMaskedTextBox()
        {
            ...
            ((KiwiReadOnlyControls)Controls).AddInternal(_maskedTextBox);
        }
