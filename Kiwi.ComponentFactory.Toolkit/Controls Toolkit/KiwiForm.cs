...
{
    /// <summary>
    /// Draws the window chrome using a Kiwi palette.
    /// </summary>
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    [ToolboxItem(false)]
    //
    [ToolboxBitmap(typeof(KiwiForm), "ToolboxBitmaps.KiwiForm.bmp")]
    [Description("Draws the window chrome using a Kiwi palette.")]
    public class KiwiForm : VisualForm,
                               IContentValues
    {
        ...
        public class FormButtonSpecCollection : ButtonSpecCollection<ButtonSpecAny>
        {
            ...
            public FormButtonSpecCollection(KiwiForm owner)
                : base(owner)
            {
            }
            #endregion
        ...
        public class FormFixedButtonSpecCollection : ButtonSpecCollection<ButtonSpecFormFixed>
        {
            ...
            /// </summary>
            /// <param name="owner">Reference to owning object.</param>
            public FormFixedButtonSpecCollection(KiwiForm owner)
                : base(owner)
            {
            }
            #endregion
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiForm class.
        /// </summary>
        public KiwiForm()
        {
            // Default properties
            ...
            KiwiManager.GlobalAllowFormChromeChanged += new EventHandler(OnGlobalAllowFormChromeChanged);
        ...
        internal bool StatusStripMerging
        {
            get
            {
                ...
                // provide this ability for the Office 2007 palettes via KiwiOffice2007Renderer. 
                return (_allowStatusStripMerge &&
                        ...
                        ((ToolStripManager.Renderer is KiwiOffice2007Renderer) ||
                         (ToolStripManager.Renderer is KiwiSparkleRenderer)));
            }
        }
