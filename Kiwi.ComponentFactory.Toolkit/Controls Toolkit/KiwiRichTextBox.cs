...
{
    /// <summary>
    /// Provide a RichTextBox with Kiwi styling applied.
	/// </summary>
    ...
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiRichTextBoxDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [DesignerCategory("code")]
    [Description("Enables the user to enter text, and provides multiline editing and password character masking.")]
    //
    [ToolboxBitmap(typeof(KiwiRichTextBox), "ToolboxBitmaps.KiwiRichTextBox.bmp")]
    public class KiwiRichTextBox : VisualControlBase,
                                      IContainedInputControl
    {
        ...
        private class InternalRichTextBox : RichTextBox
        {
            ...
            private KiwiRichTextBox _kiwiRichTextBox;
            ...
            /// </summary>
            /// <param name="kiwiRichTextBox">Reference to owning control.</param>
            public InternalRichTextBox(KiwiRichTextBox kiwiRichTextBox)
            {
                _kiwiRichTextBox = kiwiRichTextBox;
            ...
            protected override void WndProc(ref Message m)
            {
                switch (m.Msg)
                {
                    case PI.WM_NCHITTEST:
                        if (_kiwiRichTextBox.InTransparentDesignMode)
                    ...
                    case PI.WM_MOUSELEAVE:
                        ...
                        MouseOver = false;
                        _kiwiRichTextBox.PerformNeedPaint(true);
                        Invalidate();
                        base.WndProc(ref m);
                        break;
                    ...
                    case PI.WM_CONTEXTMENU:
                        ...
                        if (_kiwiRichTextBox.KiwiContextMenu != null)
                        {
                            ...
                            _kiwiRichTextBox.KiwiContextMenu.Show(_kiwiRichTextBox, mousePt);
        ...
        public class RichTextBoxButtonSpecCollection : ButtonSpecCollection<ButtonSpecAny>
        {
            ...
            public RichTextBoxButtonSpecCollection(KiwiRichTextBox owner)
                : base(owner)
            {
            }
            #endregion
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiRichTextBox class.
		/// </summary>
        public KiwiRichTextBox()
        {
            ...
            ((KiwiReadOnlyControls)Controls).AddInternal(_richTextBox);
