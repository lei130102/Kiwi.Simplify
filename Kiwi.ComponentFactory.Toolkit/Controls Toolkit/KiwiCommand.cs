...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiCommandDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [ToolboxItem(true)]
    //
    [ToolboxBitmap(typeof(KiwiCommand), "ToolboxBitmaps.KiwiCommand.bmp")]
    [DesignerCategory("code")]
    [Description("Defines state and events for a single command.")]
    public class KiwiCommand : Component, IKiwiCommand, INotifyPropertyChanged
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiCommand class.
        /// </summary>
        public KiwiCommand()
        {
            _enabled = true;
        ...
        [Localizable(true)]
        [Category("Appearance")]
        [Description("Command text line 1 for use in KiwiRibbon.")]
        ...
        [Localizable(true)]
        [Category("Appearance")]
        [Description("Command text line 2 for use in KiwiRibbon.")]
    ...
    /// <summary>
    /// Manages a collection of KiwiCommand instances.
    /// </summary>
    public class KiwiCommandCollection : TypedCollection<KiwiCommand>
    {
        #region Public
        /// <summary>
        ...
        public override KiwiCommand this[string name]
        {
            get
            {
                if (!string.IsNullOrEmpty(name))
                {
                    foreach (KiwiCommand item in this)
                    {
