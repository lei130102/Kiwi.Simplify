...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    //
    [ToolboxBitmap(typeof(KiwiTaskDialogCommand), "ToolboxBitmaps.KiwiTaskDialogCommand.bmp")]
    public class KiwiTaskDialogCommand : Component, IKiwiCommand, INotifyPropertyChanged
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiTaskDialogCommand class.
        /// </summary>
        public KiwiTaskDialogCommand()
        {
            _enabled = true;
            _text = string.Empty;
        ...
        /// </summary>
        CheckState IKiwiCommand.CheckState
        {
    ...
    /// <summary>
    /// Manages a collection of KiwiTaskDialogCommand instances.
    /// </summary>
    public class KiwiTaskDialogCommandCollection : TypedCollection<KiwiTaskDialogCommand>
    {
        #region Public
        /// <summary>
        ...
        public override KiwiTaskDialogCommand this[string name]
        {
            get
            {
                if (!string.IsNullOrEmpty(name))
                {
                    foreach (KiwiTaskDialogCommand item in this)
                    {
