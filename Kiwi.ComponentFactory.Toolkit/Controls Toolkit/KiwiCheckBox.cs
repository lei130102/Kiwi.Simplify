...
{
    /// <summary>
    /// Display check box with text and images with the styling features of the Kiwi Toolkit
	/// </summary>
    ...
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiCheckBoxDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
	[ToolboxItem(true)]
    [DesignerCategory("code")]
    [Description("Allow user to set or clear the associated option.")]
    //
    [ToolboxBitmap(typeof(KiwiCheckBox), "ToolboxBitmaps.KiwiCheckBox.bmp")]
    public class KiwiCheckBox : VisualSimpleBase, IContentValues
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiCheckBox class.
        /// </summary>
        public KiwiCheckBox()
        {
        ...
        protected virtual void OnCheckStateChanged(EventArgs e)
        {
            ...
            if (KiwiCommand != null)
                KiwiCommand.CheckState = CheckState;
        }
        ...
        protected virtual void OnKiwiCommandChanged(EventArgs e)
        {
            ...
            if (KiwiCommand != null)
            {
                ...
                CheckState = KiwiCommand.CheckState;
            }
