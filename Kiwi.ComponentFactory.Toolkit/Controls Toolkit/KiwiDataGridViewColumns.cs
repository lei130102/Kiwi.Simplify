...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    /// <summary>
    /// Hosts a collection of KiwiDataGridViewTextBoxCell cells.
    /// </summary>
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiTextBoxColumnDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [ToolboxBitmap(typeof(KiwiDataGridViewTextBoxColumn), "ToolboxBitmaps.KiwiTextBox.bmp")]
    public class KiwiDataGridViewTextBoxColumn : DataGridViewColumn
    {
        #region Instance Fields
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiDataGridViewTextBoxColumn class.
        /// </summary>
        public KiwiDataGridViewTextBoxColumn()
            : base(new KiwiDataGridViewTextBoxCell())
        {
        ...
        public override string ToString()
        {
            ...
            builder.Append("KiwiDataGridViewTextBoxColumn { Name=");
        ...
        {
            KiwiDataGridViewTextBoxColumn cloned = base.Clone() as KiwiDataGridViewTextBoxColumn;
        ...
        public int MaxInputLength
        {
            get
            {
                if (TextBoxCellTemplate == null)
                    throw new InvalidOperationException("KiwiDataGridViewTextBoxColumn cell template required");
        ...
        public override DataGridViewCell CellTemplate
        {
            ...
            set
            {
                if ((value != null) && !(value is KiwiDataGridViewTextBoxCell))
                    throw new InvalidCastException("Can only assign a object of type KiwiDataGridViewTextBoxCell");
        ...
        #region Private
        private KiwiDataGridViewTextBoxCell TextBoxCellTemplate
        {
            get { return (KiwiDataGridViewTextBoxCell)CellTemplate; }
        }
        #endregion
    ...
    /// <summary>
    /// Displays editable text information in a KiwiDataGridView control.
    /// </summary>
    public class KiwiDataGridViewTextBoxCell : DataGridViewTextBoxCell
    {
        #region Static Fields
        [ThreadStatic]
        private static KiwiTextBox _paintingTextBox;
        private static readonly Type _defaultEditType = typeof(KiwiDataGridViewTextBoxEditingControl);
        ...
        #region Identity
        /// <summary>
        /// Constructor for the KiwiDataGridViewTextBoxCell cell type
        /// </summary>
        public KiwiDataGridViewTextBoxCell()
        {
            // Create a thread specific KiwiTextBox control used for the painting of the non-edited cells
            if (_paintingTextBox == null)
            {
                _paintingTextBox = new KiwiTextBox();
        ...
        public override string ToString()
        {
            return "KiwiDataGridViewTextBoxCell { ColumnIndex=" + ColumnIndex.ToString(CultureInfo.CurrentCulture) +
        ...
        public override void DetachEditingControl()
        {
            ...
            KiwiTextBox kiwiTextBox = dataGridView.EditingControl as KiwiTextBox;
            if (kiwiTextBox != null)
            {
                KiwiDataGridViewTextBoxColumn textBoxColumn = OwningColumn as KiwiDataGridViewTextBoxColumn;
                if (textBoxColumn != null)
                {
                    foreach (ButtonSpec bs in kiwiTextBox.ButtonSpecs)
                        bs.Click -= new EventHandler(OnButtonClick);

                    kiwiTextBox.ButtonSpecs.Clear();

                    TextBox textBox = kiwiTextBox.Controls[0] as TextBox;
                    if (textBox != null)
                        textBox.ClearUndo();
                }
            }
        ...
        /// at the beginning of an editing session. It makes sure that the properties of the KiwiNumericUpDown editing control are 
                                                      ...
                                                      DataGridViewCellStyle dataGridViewCellStyle)
        {
            ...
            KiwiTextBox textBox = DataGridView.EditingControl as KiwiTextBox;
            if (textBox != null)
            {
                KiwiDataGridViewTextBoxColumn textBoxColumn = OwningColumn as KiwiDataGridViewTextBoxColumn;
                if (textBoxColumn != null)
        ...
        {
            KiwiDataGridViewTextBoxColumn textColumn = OwningColumn as KiwiDataGridViewTextBoxColumn;
        ...
        private KiwiDataGridViewTextBoxEditingControl EditingTextBox
        {
            get { return DataGridView.EditingControl as KiwiDataGridViewTextBoxEditingControl; }
        }
        ...
        private bool OwnsEditingTextBox(int rowIndex)
        {
            ...
            KiwiDataGridViewTextBoxEditingControl control = DataGridView.EditingControl as KiwiDataGridViewTextBoxEditingControl;
    ...
    /// </summary>
    [ToolboxItem(false)]
    public class KiwiDataGridViewTextBoxEditingControl : KiwiTextBox,
                                                            IDataGridViewEditingControl
    {
        ...
        #region Identity
        /// <summary>
        /// Initalize a new instance of the KiwiDataGridViewTextBoxEditingControl class.
        /// </summary>
        public KiwiDataGridViewTextBoxEditingControl()
        {
            TabStop = false;
        ...
        public virtual void ApplyCellStyleToEditingControl(DataGridViewCellStyle dataGridViewCellStyle)
        {
            ...
            TextAlign = KiwiDataGridViewNumericUpDownCell.TranslateAlignment(dataGridViewCellStyle.Alignment);
        }
        ...
        /// KiwiNumericUpDown control so that the first character pressed appears in it.
        /// </summary>
    ...
    /// <summary>
    /// Hosts a collection of KiwiDataGridViewCheckBoxCell cells.
    /// </summary>
    [ToolboxBitmap(typeof(KiwiDataGridViewCheckBoxColumn), "ToolboxBitmaps.KiwiCheckBox.bmp")]
    public class KiwiDataGridViewCheckBoxColumn : DataGridViewColumn
    {
        #region Implementation
        /// <summary>
        /// Initialize a new instance of the KiwiDataGridViewCheckBoxColumn class.
        /// </summary>
        public KiwiDataGridViewCheckBoxColumn()
            : this(false)
        {
        }
        ...
        public KiwiDataGridViewCheckBoxColumn(bool threeState)
            : base(new KiwiDataGridViewCheckBoxCell(threeState))
        {
        ...
        {
            StringBuilder builder = new StringBuilder(0x40);
            builder.Append("KiwiDataGridViewCheckBoxColumn { Name=");
            builder.Append(base.Name);
            builder.Append(", Index=");
            builder.Append(base.Index.ToString(CultureInfo.CurrentCulture));
            builder.Append(" }");
        ...
        public override DataGridViewCell CellTemplate
        {
            ...
            set
            {
                if ((value != null) && !(value is KiwiDataGridViewCheckBoxCell))
                    throw new InvalidCastException("Can only assign a object of type KiwiDataGridViewCheckBoxCell");
        ...
        public object FalseValue
        {
            get
            {
                if (CheckBoxCellTemplate == null)
                    throw new InvalidOperationException("KiwiDataGridViewCheckBoxColumn cell template required");
            ...
            set
            {
                if (FalseValue != value)
                {
                    ...
                    if (DataGridView != null)
                    {
                        ...
                        for (int i = 0; i < count; i++)
                        {
                            DataGridViewCheckBoxCell cell = rows.SharedRow(i).Cells[Index] as KiwiDataGridViewCheckBoxCell;
                            if (cell != null)
        ...
        #region Private
        private KiwiDataGridViewCheckBoxCell CheckBoxCellTemplate
        {
            get { return (KiwiDataGridViewCheckBoxCell)CellTemplate; }
        }

        private bool ShouldSerializeDefaultCellStyle()
        {
            KiwiDataGridViewCheckBoxCell cellTemplate = CheckBoxCellTemplate;
    ...
    /// </summary>
    public class KiwiDataGridViewCheckBoxCell : DataGridViewCheckBoxCell
    {
        #region Static Fields
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiDataGridViewCheckBoxCell.
        /// </summary>
        public KiwiDataGridViewCheckBoxCell()
            : this(false)
        {
        }
        ...
        public KiwiDataGridViewCheckBoxCell(bool threeState)
            : base(threeState)
        {
        }
        #endregion
                                                 ...
                                                 Size constraintSize)
        {
            try
            {
                KiwiDataGridView kDGV = (KiwiDataGridView)DataGridView;
        ...
        {
            if ((DataGridView != null) && (DataGridView is KiwiDataGridView))
            {
                KiwiDataGridView kDGV = (KiwiDataGridView)DataGridView;
    ...
    /// <summary>
    /// Hosts a collection of KiwiDataGridViewButtonCell cells.
    /// </summary>
    [ToolboxBitmap(typeof(KiwiDataGridViewButtonColumn), "ToolboxBitmaps.KiwiButton.bmp")]
    public class KiwiDataGridViewButtonColumn : DataGridViewColumn
    {
        #region Static Fields
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiDataGridViewButtonColumn class.
        /// </summary>
        public KiwiDataGridViewButtonColumn()
            : base(new KiwiDataGridViewButtonCell())
        {
            DataGridViewCellStyle style = new DataGridViewCellStyle();
            style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            DefaultCellStyle = style;
        ...
        {
            StringBuilder builder = new StringBuilder(0x40);
            builder.Append("KiwiDataGridViewButtonColumn { Name=");
            builder.Append(base.Name);
            builder.Append(", Index=");
            builder.Append(base.Index.ToString(CultureInfo.CurrentCulture));
            builder.Append(" }");
        ...
        public override object Clone()
        {
            ...
            KiwiDataGridViewButtonColumn clone = base.Clone() as KiwiDataGridViewButtonColumn;
            clone.Text = Text;
            return clone;
        }
        #endregion
        ...
        public override DataGridViewCell CellTemplate
        {
            ...
            set
            {
                if ((value != null) && !(value is KiwiDataGridViewButtonCell))
                    throw new InvalidCastException("Can only assign a object of type KiwiDataGridViewButtonCell");
                ...
                if (!string.Equals(value, _text, StringComparison.Ordinal))
                {
                    ...
                    if (DataGridView != null)
                    {
                        ...
                        else
                        {
                            ...
                            for (int i = 0; i < count; i++)
                            {
                                KiwiDataGridViewButtonCell cell = rows.SharedRow(i).Cells[Index] as KiwiDataGridViewButtonCell;
        ...
        public bool UseColumnTextForButtonValue
        {
            ...
            {
                if (CellTemplate == null)
                    throw new InvalidOperationException("KiwiDataGridViewButtonColumn cell template required");

                return ((KiwiDataGridViewButtonCell)CellTemplate).UseColumnTextForButtonValue;
            }
            ...
            set
            {
                if (UseColumnTextForButtonValue != value)
                {
                    ...
                    if (DataGridView != null)
                    {
                        ...
                        for (int i = 0; i < count; i++)
                        {
                            DataGridViewButtonCell cell = rows.SharedRow(i).Cells[Index] as KiwiDataGridViewButtonCell;
                            if (cell != null)
        ...
        public ButtonStyle ButtonStyle
        {
            get
            {
                ...
                return ((KiwiDataGridViewButtonCell)CellTemplate).ButtonStyle;
            }
            ...
            set
            {
                ...
                {
                    ((KiwiDataGridViewButtonCell)CellTemplate).ButtonStyleInternal = value;
                    if (DataGridView != null)
                    {
                        DataGridViewRowCollection rows = DataGridView.Rows;
                        int count = rows.Count;
    ...
    /// </summary>
    public class KiwiDataGridViewButtonCell : DataGridViewButtonCell
    {
        #region Static Fields
        private static PropertyInfo _piButtonState;
        private static PropertyInfo _piMouseEnteredCellAddress;
        ...
        /// Initialize a new instance of the KiwiDataGridViewCheckBoxCell.
        /// </summary>
        public KiwiDataGridViewButtonCell()
        {
        ...
        #region Public
        /// <summary>
        /// This member overrides KiwiDataGridViewButtonCell.Clone.
        /// </summary>
        /// <returns>New object instance.</returns>
        public override object Clone()
        {
            KiwiDataGridViewButtonCell dataGridViewCell = base.Clone() as KiwiDataGridViewButtonCell;
                                                 ...
                                                 Size constraintSize)
        {
            try
            {
                ...
                KiwiDataGridViewButtonColumn col = kDGV.Columns[ColumnIndex] as KiwiDataGridViewButtonColumn;
        ...
        #region Private
        private void CreateViewAndPalettes(KiwiDataGridView kDGV)
        {
    ...
    /// <summary>
    /// Hosts a collection of KiwiDataGridViewLinkColumn cells.
    /// </summary>
    [ToolboxBitmap(typeof(KiwiDataGridViewLinkColumn), "ToolboxBitmaps.KiwiLinkLabel.bmp")]
    public class KiwiDataGridViewLinkColumn : DataGridViewColumn
    {
        #region Static Fields
        private MethodInfo _miColumnCommonChange;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiDataGridViewLinkColumn class.
        /// </summary>
        public KiwiDataGridViewLinkColumn()
            : base(new KiwiDataGridViewLinkCell())
        {
            // Define defaults
        ...
        {
            StringBuilder builder = new StringBuilder(0x40);
            builder.Append("KiwiDataGridViewLinkColumn { Name=");
            builder.Append(base.Name);
            builder.Append(", Index=");
            builder.Append(base.Index.ToString(CultureInfo.CurrentCulture));
            builder.Append(" }");
        ...
        {
            // Create a new instance
            KiwiDataGridViewLinkColumn clone = base.Clone() as KiwiDataGridViewLinkColumn;
            clone.Text = Text;
        ...
        public override DataGridViewCell CellTemplate
        {
            ...
            set
            {
                if ((value != null) && !(value is KiwiDataGridViewLinkCell))
                    throw new InvalidCastException("Can only assign a object of type KiwiDataGridViewLinkCell");
                ...
                if (!string.Equals(value, _text, StringComparison.Ordinal))
                {
                    ...
                    if (DataGridView != null)
                    {
                        ...
                        else
                        {
                            ...
                            for (int i = 0; i < count; i++)
                            {
                                KiwiDataGridViewLinkCell cell = rows.SharedRow(i).Cells[Index] as KiwiDataGridViewLinkCell;
        ...
        public LabelStyle LabelStyle
        {
            ...
            set
            {
                ...
                {
                    _labelStyle = value;
                    ((KiwiDataGridViewLinkCell)CellTemplate).LabelStyleInternal = value;
        ...
        public LinkBehavior LinkBehavior
        {
            ...
            {
                if (CellTemplate == null)
                    throw new InvalidOperationException("KiwiDataGridViewLinkCell cell template required");

                return ((KiwiDataGridViewLinkCell)CellTemplate).LinkBehavior;
            }
            set
            {
                if (!LinkBehavior.Equals(value))
                {
                    ((KiwiDataGridViewLinkCell)CellTemplate).LinkBehaviorInternal = value;
                    if (base.DataGridView != null)
                    {
                        DataGridViewRowCollection rows = DataGridView.Rows;
                        int count = rows.Count;
        ...
        public bool TrackVisitedState
        {
            get
            {
                ...
                return ((KiwiDataGridViewLinkCell)CellTemplate).TrackVisitedState;
            }
            set
            {
        ...
        public bool UseColumnTextForLinkValue
        {
            get
            {
                ...
                return ((KiwiDataGridViewLinkCell)CellTemplate).UseColumnTextForLinkValue;
            }
    ...
    /// </summary>
    public class KiwiDataGridViewLinkCell : DataGridViewLinkCell
    {
        #region Static Fields
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiDataGridViewLinkCell.
        /// </summary>
        public KiwiDataGridViewLinkCell()
        {
            _labelStyle = LabelStyle.NormalControl;
        ...
        private void CreateViewAndPalettes(KiwiDataGridView kDGV)
        {
            ...
            if (_viewLabel == null)
            {
                ...
                _inheritBehavior = new LinkLabelBehaviorInherit(_palette, KiwiLinkBehavior.AlwaysUnderline);
        ...
        private void SetElementStateAndPalette()
        {
            ...
            switch (base.LinkBehavior)
            {
                ...
                case LinkBehavior.AlwaysUnderline:
                    _inheritBehavior.LinkBehavior = KiwiLinkBehavior.AlwaysUnderline;
                    break;
                case LinkBehavior.HoverUnderline:
                    _inheritBehavior.LinkBehavior = KiwiLinkBehavior.HoverUnderline;
                    break;
                case LinkBehavior.NeverUnderline:
                    _inheritBehavior.LinkBehavior = KiwiLinkBehavior.NeverUnderline;
                    break;
            }
    ...
    /// <summary>
    /// Hosts a collection of KiwiDataGridViewNumericUpDownCell cells.
    /// </summary>
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiNumericUpDownColumnDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [ToolboxBitmap(typeof(KiwiDataGridViewNumericUpDownColumn), "ToolboxBitmaps.KiwiNumericUpDown.bmp")]
    public class KiwiDataGridViewNumericUpDownColumn : DataGridViewColumn
    {
        #region Instance Fields
        private DataGridViewColumnSpecCollection _buttonSpecs;
        #endregion
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiDataGridViewNumericUpDownColumn class.
        /// </summary>
        public KiwiDataGridViewNumericUpDownColumn()
            : base(new KiwiDataGridViewNumericUpDownCell())
        {
            _buttonSpecs = new DataGridViewColumnSpecCollection(this);
        }
        ...
        {
            StringBuilder builder = new StringBuilder(0x40);
            builder.Append("KiwiDataGridViewNumericUpDownColumn { Name=");
            builder.Append(base.Name);
            builder.Append(", Index=");
            builder.Append(base.Index.ToString(CultureInfo.CurrentCulture));
            builder.Append(" }");
        ...
        public override object Clone()
        {
            KiwiDataGridViewNumericUpDownColumn cloned = base.Clone() as KiwiDataGridViewNumericUpDownColumn;
        ...
        public override DataGridViewCell CellTemplate
        {
            ...
            set
            {
                KiwiDataGridViewNumericUpDownCell cell = value as KiwiDataGridViewNumericUpDownCell;
                if ((value != null) && (cell == null))
                    throw new InvalidCastException("Value provided for CellTemplate must be of type KiwiDataGridViewNumericUpDownCell or derive from it.");
        ...
        /// <summary>
        /// Replicates the DecimalPlaces property of the KiwiDataGridViewNumericUpDownCell cell type.
        /// </summary>
        [Category("Appearance")]
        [DefaultValue(0)]
        ...
        public int DecimalPlaces
        {
            ...
            set
            {
                ...
                if (DataGridView != null)
                {
                    // Update all the existing KiwiDataGridViewNumericUpDownCell cells in the column accordingly.
                    ...
                    for (int rowIndex = 0; rowIndex < rowCount; rowIndex++)
                    {
                        ...
                        KiwiDataGridViewNumericUpDownCell dataGridViewCell = dataGridViewRow.Cells[Index] as KiwiDataGridViewNumericUpDownCell;
                        if (dataGridViewCell != null)
        ...
        /// <summary>
        /// Replicates the Maximum property of the KiwiDataGridViewNumericUpDownCell cell type.
        /// </summary>
        [Category("Data")]
        ...
        /// <summary>
        /// Replicates the Minimum property of the KiwiDataGridViewNumericUpDownCell cell type.
        /// </summary>
        [Category("Data")]
        ...
        /// <summary>
        /// Replicates the ThousandsSeparator property of the KiwiDataGridViewNumericUpDownCell cell type.
        /// </summary>
        [Category("Data")]
        [DefaultValue(false)]
        ...
        #region Private
        /// <summary>
        /// Small utility function that returns the template cell as a KiwiDataGridViewNumericUpDownCell
        /// </summary>
        private KiwiDataGridViewNumericUpDownCell NumericUpDownCellTemplate
        {
            get { return (KiwiDataGridViewNumericUpDownCell)CellTemplate; }
        }
        #endregion
    ...
    /// <summary>
    /// Defines a KiwiNumericUpDown cell type for the KiwiDataGridView control
    /// </summary>
    public class KiwiDataGridViewNumericUpDownCell : DataGridViewTextBoxCell
    {
        #region Static Fields
        [ThreadStatic]
        private static KiwiNumericUpDown _paintingNumericUpDown;
        ...
        private static readonly Type _defaultEditType = typeof(KiwiDataGridViewNumericUpDownEditingControl);
        ...
        /// </summary>
        public KiwiDataGridViewNumericUpDownCell()
        {
            // Create a thread specific KiwiNumericUpDown control used for the painting of the non-edited cells
            if (_paintingNumericUpDown == null)
            {
                _paintingNumericUpDown = new KiwiNumericUpDown();
        ...
        /// <summary>
        /// The DecimalPlaces property replicates the one from the KiwiNumericUpDown control
        /// </summary>
        [DefaultValue(0)]
        public int DecimalPlaces
        {
        ...
        /// <summary>
        /// The Increment property replicates the one from the KiwiNumericUpDown control
        /// </summary>
        public Decimal Increment
        {
        ...
        /// <summary>
        /// The Maximum property replicates the one from the KiwiNumericUpDown control
        /// </summary>
        public Decimal Maximum
        {
            get { return _maximum; }
        ...
        /// <summary>
        /// The Minimum property replicates the one from the KiwiNumericUpDown control
        /// </summary>
        public Decimal Minimum
        {
            get { return _minimum; }
        ...
        /// <summary>
        /// The ThousandsSeparator property replicates the one from the KiwiNumericUpDown control
        /// </summary>
        [DefaultValue(false)]
        public bool ThousandsSeparator
        {
        ...
        public override object Clone()
        {
            KiwiDataGridViewNumericUpDownCell dataGridViewCell = base.Clone() as KiwiDataGridViewNumericUpDownCell;
            if (dataGridViewCell != null)
            {
        ...
        public override void DetachEditingControl()
        {
            ...
            KiwiNumericUpDown numericUpDown = dataGridView.EditingControl as KiwiNumericUpDown;
            if (numericUpDown != null)
            {
                KiwiDataGridViewNumericUpDownColumn numericColumn = OwningColumn as KiwiDataGridViewNumericUpDownColumn;
        ...
        private KiwiDataGridViewNumericUpDownEditingControl EditingNumericUpDown
        {
            get { return DataGridView.EditingControl as KiwiDataGridViewNumericUpDownEditingControl; }
        }
        ...
        private bool OwnsEditingNumericUpDown(int rowIndex)
        {
            ...
            KiwiDataGridViewNumericUpDownEditingControl control = DataGridView.EditingControl as KiwiDataGridViewNumericUpDownEditingControl;
            return (control != null) && (rowIndex == ((IDataGridViewEditingControl)control).EditingControlRowIndex);
        }
    ...
    /// </summary>
    [ToolboxItem(false)]
    public class KiwiDataGridViewNumericUpDownEditingControl : KiwiNumericUpDown,
                                                                  IDataGridViewEditingControl
    {
        #region Instance Fields
        private DataGridView _dataGridView;
        ...
        #region Identity
        /// <summary>
        /// Initalize a new instance of the KiwiDataGridViewNumericUpDownEditingControl class.
        /// </summary>
        public KiwiDataGridViewNumericUpDownEditingControl()
        {
            TabStop = false;
            StateCommon.Border.Width = 0;
            StateCommon.Border.Draw = InheritBool.False;
    ...
    /// <summary>
    /// Hosts a collection of KiwiDataGridViewDomainUpDownCell cells.
    /// </summary>
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiDomainUpDownColumnDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [ToolboxBitmap(typeof(KiwiDataGridViewDomainUpDownColumn), "ToolboxBitmaps.KiwiDomainUpDown.bmp")]
    public class KiwiDataGridViewDomainUpDownColumn : DataGridViewColumn
    {
        #region Instance Fields
        private DataGridViewColumnSpecCollection _buttonSpecs;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiDataGridViewDomainUpDownColumn class.
        /// </summary>
        public KiwiDataGridViewDomainUpDownColumn()
            : base(new KiwiDataGridViewDomainUpDownCell())
        {
            _buttonSpecs = new DataGridViewColumnSpecCollection(this);
        ...
        {
            StringBuilder builder = new StringBuilder(0x40);
            builder.Append("KiwiDataGridViewDomainUpDownColumn { Name=");
            builder.Append(base.Name);
            builder.Append(", Index=");
            builder.Append(base.Index.ToString(CultureInfo.CurrentCulture));
            builder.Append(" }");
        ...
        public override object Clone()
        {
            KiwiDataGridViewDomainUpDownColumn cloned = base.Clone() as KiwiDataGridViewDomainUpDownColumn;
        ...
        public override DataGridViewCell CellTemplate
        {
            ...
            set
            {
                KiwiDataGridViewDomainUpDownCell cell = value as KiwiDataGridViewDomainUpDownCell;
                if ((value != null) && (cell == null))
                    throw new InvalidCastException("Value provided for CellTemplate must be of type KiwiDataGridViewDomainUpDownCell or derive from it.");
        ...
        #region Private
        /// <summary>
        /// Small utility function that returns the template cell as a KiwiDataGridViewDomainUpDownCell
        /// </summary>
        private KiwiDataGridViewDomainUpDownCell DomainUpDownCellTemplate
        {
            get { return (KiwiDataGridViewDomainUpDownCell)CellTemplate; }
        }
        #endregion
    ...
    /// <summary>
    /// Defines a KiwiDomainUpDown cell type for the KiwiDataGridView control
    /// </summary>
    public class KiwiDataGridViewDomainUpDownCell : DataGridViewTextBoxCell
    {
        #region Static Fields
        [ThreadStatic]
        private static KiwiDomainUpDown _paintingDomainUpDown;
        private static readonly DataGridViewContentAlignment _anyRight = DataGridViewContentAlignment.TopRight | DataGridViewContentAlignment.MiddleRight | DataGridViewContentAlignment.BottomRight;
        private static readonly DataGridViewContentAlignment _anyCenter = DataGridViewContentAlignment.TopCenter | DataGridViewContentAlignment.MiddleCenter | DataGridViewContentAlignment.BottomCenter;
        private static readonly Type _defaultEditType = typeof(KiwiDataGridViewDomainUpDownEditingControl);
        private static readonly Type _defaultValueType = typeof(System.String);
        private static readonly Size _sizeLarge = new Size(10000, 10000);
        #endregion
        ...
        #region Identity
        /// <summary>
        /// Constructor for the KiwiDataGridViewDomainUpDownCell cell type
        /// </summary>
        public KiwiDataGridViewDomainUpDownCell()
        {
            // Create a thread specific KiwiNumericUpDown control used for the painting of the non-edited cells
            if (_paintingDomainUpDown == null)
            {
                _paintingDomainUpDown = new KiwiDomainUpDown();
        ...
        public override void DetachEditingControl()
        {
            ...
            KiwiDomainUpDown domainUpDown = dataGridView.EditingControl as KiwiDomainUpDown;
            if (domainUpDown != null)
            {
                KiwiDataGridViewDomainUpDownColumn domainColumn = OwningColumn as KiwiDataGridViewDomainUpDownColumn;
        ...
        private KiwiDataGridViewDomainUpDownEditingControl EditingDomainUpDown
        {
            get { return DataGridView.EditingControl as KiwiDataGridViewDomainUpDownEditingControl; }
        }
        ...
        private bool OwnsEditingDomainUpDown(int rowIndex)
        {
            ...
            KiwiDataGridViewDomainUpDownEditingControl control = DataGridView.EditingControl as KiwiDataGridViewDomainUpDownEditingControl;
            return (control != null) && (rowIndex == ((IDataGridViewEditingControl)control).EditingControlRowIndex);
        }
    ...
    /// </summary>
    [ToolboxItem(false)]
    public class KiwiDataGridViewDomainUpDownEditingControl : KiwiDomainUpDown,
                                                                 IDataGridViewEditingControl
    {
        #region Instance Fields
        private DataGridView _dataGridView;
        ...
        #region Identity
        /// <summary>
        /// Initalize a new instance of the KiwiDataGridViewDomainUpDownEditingControl class.
        /// </summary>
        public KiwiDataGridViewDomainUpDownEditingControl()
        {
            TabStop = false;
            StateCommon.Border.Width = 0;
            StateCommon.Border.Draw = InheritBool.False;
    ...
    /// <summary>
    /// Hosts a collection of KiwiDataGridViewComboBoxCell cells.
    /// </summary>
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiComboBoxColumnDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [ToolboxBitmap(typeof(KiwiDataGridViewComboBoxColumn), "ToolboxBitmaps.KiwiComboBox.bmp")]
    public class KiwiDataGridViewComboBoxColumn : DataGridViewColumn
    {
        #region Instance Fields
        private StringCollection _items;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiDataGridViewComboBoxColumn class.
        /// </summary>
        public KiwiDataGridViewComboBoxColumn()
            : base(new KiwiDataGridViewComboBoxCell())
        {
            _buttonSpecs = new DataGridViewColumnSpecCollection(this);
            _items = new StringCollection();
        ...
        {
            StringBuilder builder = new StringBuilder(0x40);
            builder.Append("KiwiDataGridViewComboBoxColumn { Name=");
            builder.Append(base.Name);
            builder.Append(", Index=");
            builder.Append(base.Index.ToString(CultureInfo.CurrentCulture));
            builder.Append(" }");
        ...
        public override object Clone()
        {
            KiwiDataGridViewComboBoxColumn cloned = base.Clone() as KiwiDataGridViewComboBoxColumn;
        ...
        public override DataGridViewCell CellTemplate
        {
            ...
            set
            {
                KiwiDataGridViewComboBoxCell cell = value as KiwiDataGridViewComboBoxCell;
                if ((value != null) && (cell == null))
                    throw new InvalidCastException("Value provided for CellTemplate must be of type KiwiDataGridViewComboBoxCell or derive from it.");
        ...
        /// <summary>
        /// Gets and sets the appearance and functionality of the KiwiComboBox.
        /// </summary>
        [Category("Appearance")]
        ...
        public ComboBoxStyle DropDownStyle
        {
            ...
            set
            {
                ...
                if (DataGridView != null)
                {
                    // Update all the existing KiwiDataGridViewComboBoxCell cells in the column accordingly.
                    DataGridViewRowCollection dataGridViewRows = DataGridView.Rows;
                    int rowCount = dataGridViewRows.Count;
                    for (int rowIndex = 0; rowIndex < rowCount; rowIndex++)
                    {
                        ...
                        // This could have severe performance repercussions.
                        DataGridViewRow dataGridViewRow = dataGridViewRows.SharedRow(rowIndex);
                        KiwiDataGridViewComboBoxCell dataGridViewCell = dataGridViewRow.Cells[Index] as KiwiDataGridViewComboBoxCell;
                        if (dataGridViewCell != null)
        ...
        /// <summary>
        /// Gets and sets the height, in pixels, of the drop down box in a KiwiComboBox.
        /// </summary>
        [Category("Behavior")]
        ...
        /// <summary>
        /// Gets and sets the width, in pixels, of the drop down box in a KiwiComboBox.
        /// </summary>
        [Category("Behavior")]
        ...
        /// Small utility function that returns the template cell as a KiwiDataGridViewDomainUpDownCell
        /// </summary>
        private KiwiDataGridViewComboBoxCell ComboBoxCellTemplate
        {
            get { return (KiwiDataGridViewComboBoxCell)CellTemplate; }
        }
        #endregion
    ...
    /// <summary>
    /// Defines a KiwiComboBox cell type for the KiwiDataGridView control
    /// </summary>
    public class KiwiDataGridViewComboBoxCell : DataGridViewTextBoxCell
    {
        #region Static Fields
        [ThreadStatic]
        private static KiwiComboBox _paintingComboBox;
        private static readonly Type _defaultEditType = typeof(KiwiDataGridViewComboBoxEditingControl);
        private static readonly Type _defaultValueType = typeof(System.String);
        private static readonly Size _sizeLarge = new Size(10000, 10000);
        #endregion
        ...
        #region Identity
        /// <summary>
        /// Constructor for the KiwiDataGridViewComboBoxCell cell type
        /// </summary>
        public KiwiDataGridViewComboBoxCell()
        {
            // Create a thread specific KiwiComboBox control used for the painting of the non-edited cells
            if (_paintingComboBox == null)
            {
                _paintingComboBox = new KiwiComboBox();
        ...
        public override string ToString()
        {
            return "KiwiDataGridViewComboBoxCell { ColumnIndex=" + ColumnIndex.ToString(CultureInfo.CurrentCulture) +
                   ", RowIndex=" + RowIndex.ToString(CultureInfo.CurrentCulture) + " }";
        }
        #endregion
        ...
        public override object Clone()
        {
            KiwiDataGridViewComboBoxCell dataGridViewCell = base.Clone() as KiwiDataGridViewComboBoxCell;
            if (dataGridViewCell != null)
            {
        ...
        /// <summary>
        /// The DropDownStyle property replicates the one from the KiwiComboBox control
        /// </summary>
        [DefaultValue(0)]
        public ComboBoxStyle DropDownStyle
        {
        ...
        /// <summary>
        /// The MaxDropDownItems property replicates the one from the KiwiComboBox control
        /// </summary>
        [DefaultValue(8)]
        public int MaxDropDownItems
        {
        ...
        /// <summary>
        /// The DropDownHeight property replicates the one from the KiwiComboBox control
        /// </summary>
        [DefaultValue(200)]
        public int DropDownHeight
        {
        ...
        /// <summary>
        /// The DropDownWidth property replicates the one from the KiwiComboBox control
        /// </summary>
        [DefaultValue(121)]
        public int DropDownWidth
        {
        ...
        /// <summary>
        /// The AutoCompleteMode property replicates the one from the KiwiComboBox control
        /// </summary>
        [DefaultValue(121)]
        public AutoCompleteMode AutoCompleteMode
        {
        ...
        /// <summary>
        /// The AutoCompleteSource property replicates the one from the KiwiComboBox control
        /// </summary>
        [DefaultValue(121)]
        public AutoCompleteSource AutoCompleteSource
        {
        ...
        /// <summary>
        /// The DisplayMember property replicates the one from the KiwiComboBox control
        /// </summary>
        [DefaultValue("")]
        public string DisplayMember
        {
        ...
        /// <summary>
        /// The ValueMember property replicates the one from the KiwiComboBox control
        /// </summary>
        [DefaultValue("")]
        ...
        public override void DetachEditingControl()
        {
            ...
            KiwiComboBox comboBox = dataGridView.EditingControl as KiwiComboBox;
            if (comboBox != null)
            {
                KiwiDataGridViewComboBoxColumn comboColumn = OwningColumn as KiwiDataGridViewComboBoxColumn;
                if (comboColumn != null)
                {
        ...
        private KiwiDataGridViewComboBoxEditingControl EditingComboBox
        {
            get { return DataGridView.EditingControl as KiwiDataGridViewComboBoxEditingControl; }
        }
        ...
        private bool OwnsEditingComboBox(int rowIndex)
        {
            ...
            KiwiDataGridViewComboBoxEditingControl control = DataGridView.EditingControl as KiwiDataGridViewComboBoxEditingControl;
            return (control != null) && (rowIndex == ((IDataGridViewEditingControl)control).EditingControlRowIndex);
        }
    ...
    /// </summary>
    [ToolboxItem(false)]
    public class KiwiDataGridViewComboBoxEditingControl : KiwiComboBox,
                                                             IDataGridViewEditingControl
    {
        #region Instance Fields
        private DataGridView _dataGridView;
        ...
        #region Identity
        /// <summary>
        /// Initalize a new instance of the KiwiDataGridViewComboBoxEditingControl class.
        /// </summary>
        public KiwiDataGridViewComboBoxEditingControl()
        {
            TabStop = false;
        ...
        /// <summary>
        /// A few keyboard messages need to be forwarded to the inner textbox of the
        /// KiwiComboBox control so that the first character pressed appears in it.
        /// </summary>
        protected override bool ProcessKeyEventArgs(ref Message m)
        {
            return base.ProcessKeyEventArgs(ref m);
    ...
    /// <summary>
    /// Hosts a collection of KiwiDataGridViewDateTimePickerCell cells.
    /// </summary>
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiDateTimePickerColumnDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [ToolboxBitmap(typeof(KiwiDataGridViewDateTimePickerColumn), "ToolboxBitmaps.KiwiDateTimePicker.bmp")]
    public class KiwiDataGridViewDateTimePickerColumn : DataGridViewColumn
    {
        #region Instance Fields
        private DataGridViewColumnSpecCollection _buttonSpecs;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiDataGridViewDateTimePickerColumn class.
        /// </summary>
        public KiwiDataGridViewDateTimePickerColumn()
            : base(new KiwiDataGridViewDateTimePickerCell())
        {
            _buttonSpecs = new DataGridViewColumnSpecCollection(this);
        ...
        {
            StringBuilder builder = new StringBuilder(0x40);
            builder.Append("KiwiDataGridViewDateTimePickerColumn { Name=");
            builder.Append(base.Name);
            builder.Append(", Index=");
            builder.Append(base.Index.ToString(CultureInfo.CurrentCulture));
            builder.Append(" }");
        ...
        public override object Clone()
        {
            KiwiDataGridViewDateTimePickerColumn cloned = base.Clone() as KiwiDataGridViewDateTimePickerColumn;
        ...
        public override DataGridViewCell CellTemplate
        {
            ...
            set
            {
                KiwiDataGridViewDateTimePickerCell cell = value as KiwiDataGridViewDateTimePickerCell;
                if ((value != null) && (cell == null))
                    throw new InvalidCastException("Value provided for CellTemplate must be of type KiwiDataGridViewDateTimePickerCell or derive from it.");
        ...
        /// <summary>
        /// Replicates the ShowCheckBox property of the KiwiDataGridViewDateTimePickerCell cell type.
        /// </summary>
        [Category("Appearance")]
        ...
        public bool ShowCheckBox
        {
            ...
            set
            {
                ...
                if (DataGridView != null)
                {
                    // Update all the existing KiwiDataGridViewDateTimePickerCell cells in the column accordingly.
                    DataGridViewRowCollection dataGridViewRows = DataGridView.Rows;
                    int rowCount = dataGridViewRows.Count;
                    for (int rowIndex = 0; rowIndex < rowCount; rowIndex++)
                    {
                        ...
                        // This could have severe performance repercussions.
                        DataGridViewRow dataGridViewRow = dataGridViewRows.SharedRow(rowIndex);
                        KiwiDataGridViewDateTimePickerCell dataGridViewCell = dataGridViewRow.Cells[Index] as KiwiDataGridViewDateTimePickerCell;
                        if (dataGridViewCell != null)
        ...
        /// <summary>
        /// Replicates the ShowUpDown property of the KiwiDataGridViewDateTimePickerCell cell type.
        /// </summary>
        [Category("Appearance")]
        ...
        /// <summary>
        /// Replicates the Format property of the KiwiDataGridViewDateTimePickerCell cell type.
        /// </summary>
        [Category("Appearance")]
        ...
        /// <summary>
        /// Replicates the AutoShift property of the KiwiDataGridViewDateTimePickerCell cell type.
        /// </summary>
        [Category("Behavior")]
        ...
        #region Private
        /// <summary>
        /// Small utility function that returns the template cell as a KiwiDataGridViewDateTimePickerCell
        /// </summary>
        private KiwiDataGridViewDateTimePickerCell DateTimePickerCellTemplate
        {
            get { return (KiwiDataGridViewDateTimePickerCell)CellTemplate; }
        }
        #endregion
    ...
    /// <summary>
    /// Defines a KiwiDateTimePicker cell type for the KiwiDataGridView control
    /// </summary>
    public class KiwiDataGridViewDateTimePickerCell : DataGridViewTextBoxCell
    {
        #region Static Fields
        [ThreadStatic]
        private static KiwiDateTimePicker _paintingDateTime;
        private static DateTimeConverter _dtc = new DateTimeConverter();
        private static readonly Type _defaultEditType = typeof(KiwiDataGridViewDateTimePickerEditingControl);
        ...
        #region Identity
        /// <summary>
        /// Constructor for the KiwiDataGridViewDateTimePickerCell cell type
        /// </summary>
        public KiwiDataGridViewDateTimePickerCell()
        {
            // Create a thread specific KiwiDateTimePicker control used for the painting of the non-edited cells
            if (_paintingDateTime == null)
            {
                _paintingDateTime = new KiwiDateTimePicker();
        ...
        public override string ToString()
        {
            return "KiwiDataGridViewDateTimePickerCell { ColumnIndex=" + ColumnIndex.ToString(CultureInfo.CurrentCulture) +
                   ", RowIndex=" + RowIndex.ToString(CultureInfo.CurrentCulture) + " }";
        }
        #endregion
        ...
        public override object Clone()
        {
            KiwiDataGridViewDateTimePickerCell dateTimeCell = base.Clone() as KiwiDataGridViewDateTimePickerCell;
        ...
        /// <summary>
        /// The ShowCheckBox property replicates the one from the KiwiDateTimePicker control
        /// </summary>
        [DefaultValue(false)]
        public bool ShowCheckBox
        {
        ...
        /// <summary>
        /// The ShowUpDown property replicates the one from the KiwiDateTimePicker control
        /// </summary>
        [DefaultValue(false)]
        public bool ShowUpDown
        {
        ...
        /// <summary>
        /// The AutoShift property replicates the one from the KiwiDateTimePicker control
        /// </summary>
        [DefaultValue(false)]
        public bool AutoShift
        {
        ...
        /// <summary>
        /// The Checked property replicates the one from the KiwiDateTimePicker control
        /// </summary>
        [DefaultValue(false)]
        public bool Checked
        {
        ...
        /// <summary>
        /// The CustomFormat property replicates the one from the KiwiDateTimePicker control
        /// </summary>
        [DefaultValue("")]
        public string CustomFormat
        {
        ...
        /// <summary>
        /// The CustomNullText property replicates the one from the KiwiDateTimePicker control
        /// </summary>
        [DefaultValue(" ")]
        public string CustomNullText
        {
        ...
        /// <summary>
        /// The MaxDate property replicates the one from the KiwiDateTimePicker control
        /// </summary>
        public DateTime MaxDate
        {
            get { return _maxDate; }
        ...
        /// <summary>
        /// The Format property replicates the one from the KiwiDateTimePicker control
        /// </summary>
        [DefaultValue(typeof(DateTimePickerFormat), "Long")]
        public DateTimePickerFormat Format
        {
        ...
        /// <summary>
        /// The CalendarDimensions property replicates the one from the KiwiDateTimePicker control
        /// </summary>
        [DefaultValue(typeof(Size), "1,1")]
        public Size CalendarDimensions
        {
        ...
        /// <summary>
        /// The CalendarTodayText property replicates the one from the KiwiDateTimePicker control
        /// </summary>
        [DefaultValue("Today:")]
        public string CalendarTodayText
        {
        ...
        /// <summary>
        /// The CalendarFirstDayOfWeek property replicates the one from the KiwiDateTimePicker control
        /// </summary>
        [DefaultValue(typeof(Day), "Default")]
        public Day CalendarFirstDayOfWeek
        {
        ...
        /// <summary>
        /// The CalendarShowToday property replicates the one from the KiwiDateTimePicker control
        /// </summary>
        [DefaultValue(true)]
        public bool CalendarShowToday
        {
        ...
        /// <summary>
        /// The CalendarCloseOnTodayClick property replicates the one from the KiwiDateTimePicker control
        /// </summary>
        [DefaultValue(true)]
        public bool CalendarCloseOnTodayClick
        {
        ...
        /// <summary>
        /// The CalendarShowTodayCircle property replicates the one from the KiwiDateTimePicker control
        /// </summary>
        [DefaultValue(true)]
        public bool CalendarShowTodayCircle
        {
        ...
        /// <summary>
        /// The CalendarShowWeekNumbers property replicates the one from the KiwiDateTimePicker control
        /// </summary>
        [DefaultValue(true)]
        public bool CalendarShowWeekNumbers
        {
        ...
        /// <summary>
        /// The CalendarTodayDate property replicates the one from the KiwiDateTimePicker control
        /// </summary>
        [DefaultValue(true)]
        public DateTime CalendarTodayDate
        {
        ...
        public override void DetachEditingControl()
        {
            ...
            KiwiDateTimePicker dateTimePicker = dataGridView.EditingControl as KiwiDateTimePicker;
            if (dateTimePicker != null)
            {
                KiwiDataGridViewDateTimePickerColumn dateTimeColumn = OwningColumn as KiwiDataGridViewDateTimePickerColumn;
        ...
        /// <summary>
        /// Custom implementation of the InitializeEditingControl function. This function is called by the DataGridView control 
        /// at the beginning of an editing session. It makes sure that the properties of the KiwiDateTimePicker editing control are 
        /// set according to the cell properties.
        /// </summary>
        public override void InitializeEditingControl(int rowIndex,
                                                      object initialFormattedValue,
                                                      DataGridViewCellStyle dataGridViewCellStyle)
        {
            ...
            KiwiDateTimePicker dateTime = DataGridView.EditingControl as KiwiDateTimePicker;
            if (dateTime != null)
            {
                KiwiDataGridViewDateTimePickerColumn dateTimeColumn = OwningColumn as KiwiDataGridViewDateTimePickerColumn;
                if (dateTimeColumn != null)
        ...
        /// In this sample, the non-edited KiwiDateTimePicker control is painted by using a call to Control.DrawToBitmap. This is
        /// an easy solution for painting controls but it's not necessarily the most performant. An alternative would be to paint
        /// the KiwiDateTimePicker control piece by piece (text and up/down buttons).
        /// </summary>
        protected override void Paint(Graphics graphics,
                                      Rectangle clipBounds,
                                      Rectangle cellBounds,
        ...
        private KiwiDataGridViewDateTimePickerEditingControl EditingDateTimePicker
        {
            get { return DataGridView.EditingControl as KiwiDataGridViewDateTimePickerEditingControl; }
        }
        ...
        private bool OwnsEditingDateTimePicker(int rowIndex)
        {
            ...
            KiwiDataGridViewDateTimePickerEditingControl control = DataGridView.EditingControl as KiwiDataGridViewDateTimePickerEditingControl;
            return (control != null) && (rowIndex == ((IDataGridViewEditingControl)control).EditingControlRowIndex);
        }
    ...
    /// <summary>
    /// Defines the editing control for the DataGridViewKiwiDateTimePickerCell custom cell type.
    /// </summary>
    [ToolboxItem(false)]
    public class KiwiDataGridViewDateTimePickerEditingControl : KiwiDateTimePicker,
                                                                   IDataGridViewEditingControl
    {
        #region Static Fields
        private static DateTimeConverter _dtc = new DateTimeConverter();
        ...
        #region Identity
        /// <summary>
        /// Initalize a new instance of the KiwiDataGridViewDateTimePickerEditingControl class.
        /// </summary>
        public KiwiDataGridViewDateTimePickerEditingControl()
        {
            TabStop = false;
            StateCommon.Border.Width = 0;
            StateCommon.Border.Draw = InheritBool.False;
    ...
    /// <summary>
    /// Hosts a collection of KiwiDataGridViewMaskedTextBoxCell cells.
    /// </summary>
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiMaskedTextBoxColumnDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [ToolboxBitmap(typeof(KiwiDataGridViewMaskedTextBoxColumn), "ToolboxBitmaps.KiwiMaskedTextBox.bmp")]
    public class KiwiDataGridViewMaskedTextBoxColumn : DataGridViewColumn
    {
        #region Instance Fields
        private DataGridViewColumnSpecCollection _buttonSpecs;
        #endregion
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiDataGridViewMaskedTextBoxColumn class.
        /// </summary>
        public KiwiDataGridViewMaskedTextBoxColumn()
            : base(new KiwiDataGridViewMaskedTextBoxCell())
        {
            _buttonSpecs = new DataGridViewColumnSpecCollection(this);
        }
        ...
        {
            StringBuilder builder = new StringBuilder(0x40);
            builder.Append("KiwiDataGridViewMaskedTextBoxColumn { Name=");
            builder.Append(base.Name);
            builder.Append(", Index=");
            builder.Append(base.Index.ToString(CultureInfo.CurrentCulture));
            builder.Append(" }");
        ...
        public override object Clone()
        {
            KiwiDataGridViewMaskedTextBoxColumn cloned = base.Clone() as KiwiDataGridViewMaskedTextBoxColumn;
        ...
        public override DataGridViewCell CellTemplate
        {
            ...
            set
            {
                KiwiDataGridViewMaskedTextBoxCell cell = value as KiwiDataGridViewMaskedTextBoxCell;
                if ((value != null) && (cell == null))
                    throw new InvalidCastException("Value provided for CellTemplate must be of type KiwiDataGridViewMaskedTextBoxCell or derive from it.");
        ...
        /// <summary>
        /// Replicates the PromptChar property of the KiwiDataGridViewMaskedTextBoxCell cell type.
        /// </summary>
        [Category("Appearance")]
            ...
            set
            {
                ...
                if (DataGridView != null)
                {
                    ...
                    for (int rowIndex = 0; rowIndex < rowCount; rowIndex++)
                    {
                        ...
                        // This could have severe performance repercussions.
                        DataGridViewRow dataGridViewRow = dataGridViewRows.SharedRow(rowIndex);
                        KiwiDataGridViewMaskedTextBoxCell dataGridViewCell = dataGridViewRow.Cells[Index] as KiwiDataGridViewMaskedTextBoxCell;
                        if (dataGridViewCell != null)
        ...
        #region Private
        /// <summary>
        /// Small utility function that returns the template cell as a KiwiDataGridViewMaskedTextBoxCell
        /// </summary>
        private KiwiDataGridViewMaskedTextBoxCell MaskedTextBoxCellTemplate
        {
            get { return (KiwiDataGridViewMaskedTextBoxCell)CellTemplate; }
        }
        #endregion
    ...
    /// <summary>
    /// Defines a KiwiMaskedTextBox cell type for the KiwiDataGridView control
    /// </summary>
    public class KiwiDataGridViewMaskedTextBoxCell : DataGridViewTextBoxCell
    {
        #region Static Fields
        [ThreadStatic]
        private static KiwiMaskedTextBox _paintingMaskedTextBox;
        private static readonly DataGridViewContentAlignment _anyRight = DataGridViewContentAlignment.TopRight | DataGridViewContentAlignment.MiddleRight | DataGridViewContentAlignment.BottomRight;
        private static readonly DataGridViewContentAlignment _anyCenter = DataGridViewContentAlignment.TopCenter | DataGridViewContentAlignment.MiddleCenter | DataGridViewContentAlignment.BottomCenter;
        private static readonly Type _defaultEditType = typeof(KiwiDataGridViewMaskedTextBoxEditingControl);
        private static readonly Type _defaultValueType = typeof(System.String);
        private static readonly Size _sizeLarge = new Size(10000, 10000);
        #endregion
        ...
        #region Identity
        /// <summary>
        /// Constructor for the KiwiDataGridViewMaskedTextBoxCell cell type
        /// </summary>
        public KiwiDataGridViewMaskedTextBoxCell()
        {
            // Create a thread specific KiwiMaskedTextBox control used for the painting of the non-edited cells
            if (_paintingMaskedTextBox == null)
            {
                _paintingMaskedTextBox = new KiwiMaskedTextBox();
        ...
        /// <summary>
        /// The PromptChar property replicates the one from the KiwiMaskedTextBox control
        /// </summary>
        [DefaultValue('_')]
        public char PromptChar
        {
        ...
        /// <summary>
        /// The AllowPromptAsInput property replicates the one from the KiwiMaskedTextBox control
        /// </summary>
        [DefaultValue(true)]
        public bool AllowPromptAsInput
        {
        ...
        /// <summary>
        /// The AsciiOnly property replicates the one from the KiwiMaskedTextBox control
        /// </summary>
        [DefaultValue(false)]
        public bool AsciiOnly
        {
        ...
        /// <summary>
        /// The BeepOnError property replicates the one from the KiwiMaskedTextBox control
        /// </summary>
        [DefaultValue(true)]
        public bool BeepOnError
        {
        ...
        /// <summary>
        /// The CutCopyMaskFormat property replicates the one from the KiwiMaskedTextBox control
        /// </summary>
        [DefaultValue(typeof(MaskFormat), "IncludeLiterals")]
        public MaskFormat CutCopyMaskFormat
        {
        ...
        /// <summary>
        /// The HidePromptOnLeave property replicates the one from the KiwiMaskedTextBox control
        /// </summary>
        [DefaultValue(false)]
        public bool HidePromptOnLeave
        {
        ...
        /// <summary>
        /// The HideSelection property replicates the one from the KiwiMaskedTextBox control
        /// </summary>
        [DefaultValue(true)]
        public bool HideSelection
        {
        ...
        /// <summary>
        /// The InsertKeyMode property replicates the one from the KiwiMaskedTextBox control
        /// </summary>
        [DefaultValue(typeof(InsertKeyMode), "Default")]
        public InsertKeyMode InsertKeyMode
        {
        ...
        /// <summary>
        /// The Mask property replicates the one from the KiwiMaskedTextBox control
        /// </summary>
        [DefaultValue("")]
        public string Mask
        {
        ...
        /// <summary>
        /// The PasswordChar property replicates the one from the KiwiMaskedTextBox control
        /// </summary>
        [DefaultValue('\0')]
        public char PasswordChar
        {
        ...
        /// <summary>
        /// The RejectInputOnFirstFailure property replicates the one from the KiwiMaskedTextBox control
        /// </summary>
        [DefaultValue(false)]
        public bool RejectInputOnFirstFailure
        {
        ...
        /// <summary>
        /// The ResetOnPrompt property replicates the one from the KiwiMaskedTextBox control
        /// </summary>
        [DefaultValue(true)]
        public bool ResetOnPrompt
        {
        ...
        /// <summary>
        /// The ResetOnSpace property replicates the one from the KiwiMaskedTextBox control
        /// </summary>
        [DefaultValue(true)]
        public bool ResetOnSpace
        {
        ...
        /// <summary>
        /// The SkipLiterals property replicates the one from the KiwiMaskedTextBox control
        /// </summary>
        [DefaultValue(true)]
        public bool SkipLiterals
        {
        ...
        /// <summary>
        /// The TextMaskFormat property replicates the one from the KiwiMaskedTextBox control
        /// </summary>
        [DefaultValue(typeof(MaskFormat), "IncludeLiterals")]
        public MaskFormat TextMaskFormat
        {
        ...
        /// <summary>
        /// The UseSystemPasswordChar property replicates the one from the KiwiMaskedTextBox control
        /// </summary>
        [DefaultValue(false)]
        public bool UseSystemPasswordChar
        {
        ...
        public override object Clone()
        {
            KiwiDataGridViewMaskedTextBoxCell dataGridViewCell = base.Clone() as KiwiDataGridViewMaskedTextBoxCell;
            if (dataGridViewCell != null)
            {
        ...
        public override void DetachEditingControl()
        {
            ...
            KiwiMaskedTextBox maskedTextBox = dataGridView.EditingControl as KiwiMaskedTextBox;
            if (maskedTextBox != null)
            {
                KiwiDataGridViewMaskedTextBoxColumn maskedTextBoxColumn = OwningColumn as KiwiDataGridViewMaskedTextBoxColumn;
        ...
        private void OnButtonClick(object sender, EventArgs e)
        {
            KiwiDataGridViewMaskedTextBoxColumn maskedColumn = OwningColumn as KiwiDataGridViewMaskedTextBoxColumn;
        ...
        private KiwiDataGridViewMaskedTextBoxEditingControl EditingMaskedTextBox
        {
            get { return DataGridView.EditingControl as KiwiDataGridViewMaskedTextBoxEditingControl; }
        }
        ...
        private bool OwnsEditingMaskedTextBox(int rowIndex)
        {
            ...
            KiwiDataGridViewMaskedTextBoxEditingControl control = DataGridView.EditingControl as KiwiDataGridViewMaskedTextBoxEditingControl;
            return (control != null) && (rowIndex == ((IDataGridViewEditingControl)control).EditingControlRowIndex);
        }
    ...
    /// </summary>
    [ToolboxItem(false)]
    public class KiwiDataGridViewMaskedTextBoxEditingControl : KiwiMaskedTextBox,
                                                                  IDataGridViewEditingControl
    {
        #region Instance Fields
        private DataGridView _dataGridView;
        ...
        #region Identity
        /// <summary>
        /// Initalize a new instance of the KiwiDataGridViewMaskedTextBoxEditingControl class.
        /// </summary>
        public KiwiDataGridViewMaskedTextBoxEditingControl()
        {
            TabStop = false;
            StateCommon.Border.Width = 0;
            StateCommon.Border.Draw = InheritBool.False;
