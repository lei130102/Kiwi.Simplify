...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiTrackBarDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [DesignerCategory("code")]
    [Description("Allow user to scroll between a range of values.")]
    //
    [ToolboxBitmap(typeof(KiwiTrackBar), "ToolboxBitmaps.KiwiTrackBar.bmp")]
    public class KiwiTrackBar : VisualSimpleBase
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiTrackBar class.
		/// </summary>
		public KiwiTrackBar()
        {
            // Default values
