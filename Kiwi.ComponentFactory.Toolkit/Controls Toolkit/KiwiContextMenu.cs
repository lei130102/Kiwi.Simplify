...
{
    /// <summary>
    /// Represents a shortcut menu with Kiwi palette styling.
    /// </summary>
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    [DefaultProperty("PaletteMode")]
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiContextMenuDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [ToolboxItem(true)]
    //其他
    [ToolboxBitmap(typeof(KiwiContextMenu), "ToolboxBitmaps.KiwiContextMenu.bmp")]
    [DefaultEvent("Opening")]
    [DesignerCategory("code")]
    [Description("Displays a shortcut menu in popup window.")]
    public class KiwiContextMenu : Component
    {
        ...
        #region Identity
        /// <summary>
        ///  Initialize a new instance of the KiwiContextMenu class.
        /// </summary>
        public KiwiContextMenu()
        {
                         ...
                         Rectangle screenRect)
        {
            ...
            return Show(caller, screenRect, KiwiContextMenuPositionH.Left, KiwiContextMenuPositionV.Below);
        }
                         ...
                         bool constrain)
        {
            ...
            if (_contextMenu == null)
            {
                ...
                if (!cea.Cancel)
                {
                    ...
                    _contextMenu.ShowHorz = KiwiContextMenuPositionH.After;
                    _contextMenu.ShowVert = KiwiContextMenuPositionV.Top;
        ...
        protected virtual VisualContextMenu CreateContextMenu(KiwiContextMenu kcm,
                                                              IPalette palette,
