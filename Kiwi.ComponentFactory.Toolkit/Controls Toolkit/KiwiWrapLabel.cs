...
{
    /// <summary>
    /// Display a windows forms label but with Kiwi palette text and font settings.
	/// </summary>
    ...
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiWrapLabelDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [DesignerCategory("code")]
    [Description("Displays descriptive information.")]
    //
    [ToolboxBitmap(typeof(KiwiWrapLabel), "ToolboxBitmaps.KiwiWrapLabel.bmp")]
    public class KiwiWrapLabel : Label
    {
        #region Static Field
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiWrapLabel class.
        /// </summary>
        public KiwiWrapLabel()
        {
            ...
            _localPalette = null;
            SetPalette(KiwiManager.CurrentGlobalPalette);
                ...
                if (_paletteMode != value)
                {
                    ...
                    switch (value)
                    {
                        ...
                        default:
                            ...
                            _localPalette = null;
                            SetPalette(KiwiManager.GetPaletteForMode(_paletteMode));
        ...
        public virtual KiwiContextMenu KiwiContextMenu
        {
            ...
            set
            {
                if (_kiwiContextMenu != value)
                {
                    if (_kiwiContextMenu != null)
                    {
                        _kiwiContextMenu.Closed -= new ToolStripDropDownClosedEventHandler(OnContextMenuClosed);
                        _kiwiContextMenu.Disposed -= new EventHandler(OnKiwiContextMenuDisposed);
                    }
