...
{
    /// <summary>
    /// Provide a TreeView with Kiwi styling applied.
	/// </summary>
    ...
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiTreeViewDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [DesignerCategory("code")]
    [Description("Displays a hierarchical collection of labeled items, each represented by a TreeNode")]
    //
    [Docking(DockingBehavior.Ask)]
    //
    [ToolboxBitmap(typeof(KiwiTreeView), "ToolboxBitmaps.KiwiTreeView.bmp")]
    public class KiwiTreeView : VisualControlBase,
                                   IContainedInputControl
    {
        ...
        private class InternalTreeView : TreeView
        {
            ...
            private KiwiTreeView _kiwiTreeView;
            ...
            /// </summary>
            /// <param name="kiwiTreeView">Reference to owning control.</param>
            public InternalTreeView(KiwiTreeView kiwiTreeView)
            {
                SetStyle(ControlStyles.ResizeRedraw, true);

                _kiwiTreeView = kiwiTreeView;
            ...
            protected override void OnLayout(LayoutEventArgs levent)
            {
                ...
                using (ViewLayoutContext context = new ViewLayoutContext(_viewManager, this, _kiwiTreeView, _kiwiTreeView.Renderer))
            ...
            protected override void WndProc(ref Message m)
            {
                switch (m.Msg)
                {
                    ...
                    case PI.WM_MOUSELEAVE:
                        ...
                        {
                            MouseOver = false;
                            _kiwiTreeView.PerformNeedPaint(true);
                            Invalidate();
                        }
                        base.WndProc(ref m);
                        break;
                    ...
                    if (hBitmap != IntPtr.Zero)
                    {
                        try
                        {
                            ...
                            using (Graphics g = Graphics.FromHdc(_screenDC))
                            {
                                ...
                                using (ViewLayoutContext context = new ViewLayoutContext(this, _kiwiTreeView.Renderer))
                                {
                                    context.DisplayRectangle = realRect;
                                    _drawPanel.Layout(context);
                                }

                                using (RenderContext context = new RenderContext(this, _kiwiTreeView, g, realRect, _kiwiTreeView.Renderer))
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiTreeView class.
        /// </summary>
        public KiwiTreeView()
        {
            ...
            ((KiwiReadOnlyControls)Controls).AddInternal(_treeView);
        }
        ...
        /// 注意没有NoneExcludedImageIndexConverter的定义，以后补上
        /// </summary>
        [Category("Behavior")]
        [Description("The default image index for nodes.")]
        [Localizable(true)]
        [TypeConverter("Kiwi.ComponentFactory.Toolkit.NoneExcludedImageIndexConverter, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
        ...
        /// </summary>
        [Category("Behavior")]
        [Description("The root nodes in the KiwiTreeView control.")]
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the items in the KiwiTreeView are sorted alphabetically.
        /// </summary>
        [Category("Behavior")]
        ...
        /// <summary>
        /// Sorts the items in KiwiTreeView control.
        /// </summary>
        public void Sort()
        {
            _treeView.Sort();
        ...
        /// <summary>
        /// Creates a new instance of the control collection for the KiwiTreeView.
        /// </summary>
        ...
        private void UpdateContentFromNode(TreeNode node)
        {
            ...
            if (node != null)
            {
                ...
                KiwiTreeNode kiwiNode = node as KiwiTreeNode;
                if (kiwiNode != null)
                {
                    // Get long text from the Kiwi extension
                    _contentValues.LongText = kiwiNode.LongText;
                }
            }
            else
            {
