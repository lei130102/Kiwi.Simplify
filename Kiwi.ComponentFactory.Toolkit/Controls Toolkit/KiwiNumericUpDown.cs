...
{
    /// <summary>
    /// Provide a NumericUpDown with Kiwi styling applied.
	/// </summary>
    ...
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiNumericUpDownDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [DesignerCategory("code")]
    [Description("Represents a Windows spin box (also known as an up-down control) that displays numeric values.")]
    //
    [ToolboxBitmap(typeof(KiwiNumericUpDown), "ToolboxBitmaps.KiwiNumericUpDown.bmp")]
    public class KiwiNumericUpDown : VisualControlBase,
                                        IContainedInputControl
    {
        ...
        private class InternalNumericUpDown : NumericUpDown
        {
            ...
            private KiwiNumericUpDown _kiwiNumericUpDown;
            ...
            /// </summary>
            /// <param name="kiwiNumericUpDown">Reference to owning control.</param>
            public InternalNumericUpDown(KiwiNumericUpDown kiwiNumericUpDown)
            {
                _kiwiNumericUpDown = kiwiNumericUpDown;
            ...
            protected override void WndProc(ref Message m)
            {
                switch (m.Msg)
                {
                    case PI.WM_NCHITTEST:
                        if (_kiwiNumericUpDown.InTransparentDesignMode)
                    ...
                    case PI.WM_MOUSELEAVE:
                        ...
                        MouseOver = false;
                        _kiwiNumericUpDown.PerformNeedPaint(true);
                        Invalidate();
                        base.WndProc(ref m);
                        break;
                    ...
                    case PI.WM_CONTEXTMENU:
                        ...
                        if (_kiwiNumericUpDown.KiwiContextMenu != null)
                        {
                            ...
                            _kiwiNumericUpDown.KiwiContextMenu.Show(_kiwiNumericUpDown, mousePt);
        ...
        private class SubclassEdit : NativeWindow
        {
            ...
            /// </summary>
            protected KiwiNumericUpDown NumericUpDown
            {
                get { return _kiwiNumericUpDown; }
            }
            ...
            protected override void WndProc(ref Message m)
            {
                switch (m.Msg)
                {
                    ...
                    case PI.WM_PAINT:
                        {
                            ...
                            using (Graphics g = Graphics.FromHdc(hdc))
                            {
                                ...
                                else
                                {
                                    ...
                                    g.TextRenderingHint = CommonHelper.PaletteTextHintToRenderingHint(_kiwiNumericUpDown.StateDisabled.PaletteContent.GetContentShortTextHint(PaletteState.Disabled));
                                    ...
                                    switch (_kiwiNumericUpDown.TextAlign)
                                    {
                                        case HorizontalAlignment.Left:
                                            if (_kiwiNumericUpDown.RightToLeft == RightToLeft.Yes)
                                    ...
                                    {
                                        using (SolidBrush foreBrush = new SolidBrush(_internalNumericUpDown.ForeColor))
                                            g.DrawString(_internalNumericUpDown.Text, _kiwiNumericUpDown.GetTripleState().PaletteContent.GetContentShortTextFont(PaletteState.Disabled), foreBrush,
                                                         new RectangleF(rect.left, rect.top, rect.right - rect.left, rect.bottom - rect.top),
                                                         stringFormat);
                                    }
                                }
                    ...
                    case PI.WM_CONTEXTMENU:
                        // Only interested in overriding the behavior when we have a kiwi context menu...
                        if (NumericUpDown.KiwiContextMenu != null)
                        {
                            // Extract the screen mouse position (if might not actually be provided)
                            Point mousePt = new Point(PI.LOWORD(m.LParam), PI.HIWORD(m.LParam));
                            ...
                            // Show the context menu
                            NumericUpDown.KiwiContextMenu.Show(NumericUpDown, mousePt);
        ...
        private class SubclassButtons : SubclassEdit, IContentValues, IDisposable
        {
            ...
            public SubclassButtons(IntPtr buttonsPtr,
                                   KiwiNumericUpDown kiwiNumericUpDown,
                                   InternalNumericUpDown internalNumericUpDown)
                : base(buttonsPtr, kiwiNumericUpDown, internalNumericUpDown)
            {
            ...
            private void DrawUpDownButtons(Graphics g, Rectangle clientRect)
            {
                ...
                if (_viewButton == null)
                {
                    // Create helper object to get all values from the KiwiNumericUpDown redirector
        ...
        public class NumericUpDownButtonSpecCollection : ButtonSpecCollection<ButtonSpecAny>
        {
            ...
            public NumericUpDownButtonSpecCollection(KiwiNumericUpDown owner)
                : base(owner)
            {
            }
            #endregion
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiNumericUpDown class.
		/// </summary>
        public KiwiNumericUpDown()
        {
            ...
            ((KiwiReadOnlyControls)Controls).AddInternal(_numericUpDown);
        }
