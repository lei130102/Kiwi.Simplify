...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiBreadCrumbDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
	[ToolboxItem(true)]
    [DesignerCategory("code")]
    [Description("Flat navigation of hierarchical data.")]
    //System.Drawing
    [ToolboxBitmap(typeof(KiwiBreadCrumb), "ToolboxBitmaps.KiwiBreadCrumb.bmp")]
    public class KiwiBreadCrumb : VisualSimpleBase,
                                     ISupportInitializeNotification
    {
        ...
        public class BreadCrumbButtonSpecCollection : ButtonSpecCollection<ButtonSpecAny>
        {
            ...
            public BreadCrumbButtonSpecCollection(KiwiBreadCrumb owner)
                : base(owner)
            {
            }
            #endregion
        ...
        private KiwiBreadCrumbItem _rootItem;
        private KiwiBreadCrumbItem _selectedItem;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiBreadCrumb class.
		/// </summary>
        public KiwiBreadCrumb()
        {
            ...
            _rootItem = new KiwiBreadCrumbItem("Root");
        ...
        [DefaultValue(null)]
        public KiwiBreadCrumbItem SelectedItem
        {
        ...
        private void OnCrumbItemChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            if (e.PropertyName == "Items")
            {
                ...
                if (SelectedItem != null)
                {
                    ...
                    KiwiBreadCrumbItem temp = SelectedItem;
                    while ((temp != null) && (temp != RootItem))
                        temp = temp.Parent;
