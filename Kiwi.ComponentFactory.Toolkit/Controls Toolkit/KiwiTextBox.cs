...
{
    /// <summary>
    /// Provide a TextBox with Kiwi styling applied.
	/// </summary>
    ...
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiTextBoxDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [DesignerCategory("code")]
    [Description("Enables the user to enter text, and provides multiline editing and password character masking.")]
    //
    [ToolboxBitmap(typeof(KiwiTextBox), "ToolboxBitmaps.KiwiTextBox.bmp")]
    public class KiwiTextBox : VisualControlBase,
                                  IContainedInputControl
    {
        ...
        private class InternalTextBox : TextBox
        {
            ...
            private KiwiTextBox _kiwiTextBox;
            ...
            /// </summary>
            /// <param name="kiwiTextBox">Reference to owning control.</param>
            public InternalTextBox(KiwiTextBox kiwiTextBox)
            {
                _kiwiTextBox = kiwiTextBox;
            ...
            protected override void WndProc(ref Message m)
            {
                switch (m.Msg)
                {
                    case PI.WM_NCHITTEST:
                        if (_kiwiTextBox.InTransparentDesignMode)
                    ...
                    case PI.WM_MOUSELEAVE:
                        ...
                        MouseOver = false;
                        _kiwiTextBox.PerformNeedPaint(true);
                        Invalidate();
                        base.WndProc(ref m);
                        break;
                    ...
                    case PI.WM_PAINT:
                        {
                            ...
                            using (Graphics g = Graphics.FromHdc(hdc))
                            {
                                ...
                                else
                                {
                                    ...
                                    g.TextRenderingHint = CommonHelper.PaletteTextHintToRenderingHint(_kiwiTextBox.StateDisabled.PaletteContent.GetContentShortTextHint(PaletteState.Disabled));

                                    // Define the string formatting requirements
                                    StringFormat stringFormat = new StringFormat();
                                    stringFormat.Trimming = StringTrimming.None;
                                    stringFormat.LineAlignment = StringAlignment.Near;
                                    if (!_kiwiTextBox.Multiline)
                                        stringFormat.FormatFlags |= StringFormatFlags.NoWrap;

                                    switch (_kiwiTextBox.TextAlign)
                                    {
                                    ...
                                    {
                                        using (SolidBrush foreBrush = new SolidBrush(ForeColor))
                                            g.DrawString(drawString, _kiwiTextBox.GetTripleState().PaletteContent.GetContentShortTextFont(PaletteState.Disabled), foreBrush,
                                                         new RectangleF(rect.left, rect.top, rect.right - rect.left, rect.bottom - rect.top),
                                                         stringFormat);
                                    }
                                }
                    ...
                    case PI.WM_CONTEXTMENU:
                        ...
                        if (_kiwiTextBox.KiwiContextMenu != null)
                        {
                            ...
                            _kiwiTextBox.KiwiContextMenu.Show(_kiwiTextBox, mousePt);
        ...
        public class TextBoxButtonSpecCollection : ButtonSpecCollection<ButtonSpecAny>
        {
            ...
            public TextBoxButtonSpecCollection(KiwiTextBox owner)
                : base(owner)
            {
            }
            #endregion
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiTextBox class.
		/// </summary>
        public KiwiTextBox()
        {
            ...
            ((KiwiReadOnlyControls)Controls).AddInternal(_textBox);
        }
