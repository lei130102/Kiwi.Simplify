...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiMonthCalendarDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    //
    [DefaultBindingProperty("SelectionRange")]
    [ToolboxBitmap(typeof(KiwiMonthCalendar), "ToolboxBitmaps.KiwiMonthCalendar.bmp")]
    [DesignerCategory("code")]
    [Description("Select a date using a visual monthly calendar display.")]
    public class KiwiMonthCalendar : VisualSimpleBase,
                                        IKiwiMonthCalendar
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiMonthCalendar class.
		/// </summary>
        public KiwiMonthCalendar()
        {
