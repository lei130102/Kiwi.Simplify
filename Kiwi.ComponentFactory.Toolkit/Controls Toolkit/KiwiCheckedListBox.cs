...
{
    /// <summary>
    /// Provide a CheckedListBox with Kiwi styling applied.
	/// </summary>
    ...
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiCheckedListBoxDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
	[ToolboxItem(true)]
    [DesignerCategory("code")]
    [Description("Represents a checked list box control that allows single or multiple item selection.")]
    //
    [ToolboxBitmap(typeof(KiwiCheckedListBox), "ToolboxBitmaps.KiwiCheckedListBox.bmp")]
    public class KiwiCheckedListBox : VisualControlBase,
                                         IContainedInputControl
    {
        ...
        public class CheckedIndexCollection : IList
        {
            ...
            private KiwiCheckedListBox _owner;
            ...
            internal CheckedIndexCollection(KiwiCheckedListBox owner)
            {
                _owner = owner;
            ...
            public object this[int index]
            {
                get
                {
                    object entryObject = InnerArrayGetEntryObject(index, KiwiCheckedListBox.CheckedItemCollection._anyItemMask);
        ...
        /// <summary>
        /// Encapsulates the collection of checked items, including items in an indeterminate state, in a KiwiCheckedListBox control.
        /// </summary>
        public class CheckedItemCollection : IList
        {
            ...
            /// </summary>
            /// <param name="owner">Reference to owning control.</param>
            internal CheckedItemCollection(KiwiCheckedListBox owner)
            {
                _owner = owner;
                _internalListBox = (InternalCheckedListBox)owner.ListBox;
            }
        ...
        public class ObjectCollection : ListBox.ObjectCollection
        {
            ...
            /// </summary>
            /// <param name="owner">Reference to owning control.</param>
            public ObjectCollection(KiwiCheckedListBox owner)
                : base(owner.ListBox)
            {
                _owner = owner;
            }
        ...
        private class InternalCheckedListBox : ListBox
        {
            ...
            private KiwiCheckedListBox _kiwiCheckedListBox;
            ...
            /// </summary>
            /// <param name="kiwiCheckedListBox">Reference to owning control.</param>
            public InternalCheckedListBox(KiwiCheckedListBox kiwiCheckedListBox)
            {
                SetStyle(ControlStyles.ResizeRedraw, true);

                _kiwiCheckedListBox = kiwiCheckedListBox;
                _mouseIndex = -1;
                _lastSelected = -1;
            ...
            protected override void OnKeyPress(KeyPressEventArgs e)
            {
                ...
                if (_kiwiCheckedListBox.FormattingEnabled)
                    base.OnKeyPress(e);
            }
            ...
            protected override void OnLayout(LayoutEventArgs levent)
            {
                ...
                using (ViewLayoutContext context = new ViewLayoutContext(_viewManager, this, _kiwiCheckedListBox, _kiwiCheckedListBox.Renderer))
            ...
            protected override void WndProc(ref Message m)
            {
                if (m.Msg == LBC_GETCHECKSTATE)
                {
                    ...
                    if ((wParam < 0) || (wParam >= Items.Count))
                        ...
                        m.Result = _kiwiCheckedListBox.GetItemChecked(wParam) ? ((IntPtr)1) : IntPtr.Zero;
                }
                else if (m.Msg == LBC_SETCHECKSTATE)
                {
                    ...
                    {
                        _kiwiCheckedListBox.SetItemChecked(index, lParam == 1);
                        m.Result = (IntPtr)1;
                    }
                }
                ...
                switch (m.Msg)
                {
                    ...
                    case PI.WM_MOUSELEAVE:
                        ...
                        MouseOver = false;
                        _kiwiCheckedListBox.PerformNeedPaint(true);
                        Invalidate();
                        base.WndProc(ref m);
                        break;
                    ...
                    if (hBitmap != IntPtr.Zero)
                    {
                        try
                        {
                            ...
                            using (Graphics g = Graphics.FromHdc(_screenDC))
                            {
                                ...
                                using (ViewLayoutContext context = new ViewLayoutContext(this, _kiwiCheckedListBox.Renderer))
                                {
                                    context.DisplayRectangle = realRect;
                                    _drawPanel.Layout(context);
                                }

                                using (RenderContext context = new RenderContext(this, _kiwiCheckedListBox, g, realRect, _kiwiCheckedListBox.Renderer))
            ...
            private void LbnSelChange()
            {
                ...
                {
                    if (!_killNextSelect && ((selectedIndex == _lastSelected) || _kiwiCheckedListBox.CheckOnClick))
                    {
                        CheckState checkedState = _kiwiCheckedListBox.GetItemCheckState(selectedIndex);
                        ...
                        _kiwiCheckedListBox.SetItemCheckState(selectedIndex, ice.NewValue);
                    }
                    _lastSelected = selectedIndex;
                    Invalidate();
                }
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiCheckedListBox class.
        /// </summary>
        public KiwiCheckedListBox()
        {
            ...
            ((KiwiReadOnlyControls)Controls).AddInternal(_listBox);
        }
        ...
        /// <summary>
        /// Gets or sets the zero-based index of the currently selected item in a KiwiCheckedListBox.
        /// </summary>
        [Bindable(true)]
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        /// <summary>
        /// Gets a collection that contains the zero-based indexes of all currently selected items in the KiwiCheckedListBox.
        /// </summary>
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        /// <summary>
        /// Gets or sets the currently selected item in the KiwiCheckedListBox.
        /// </summary>
        [Bindable(true)]
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        /// <summary>
        /// Gets a collection containing the currently selected items in the KiwiCheckedListBox.
        /// </summary>
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        /// <summary>
        /// Gets or sets the index of the first visible item in the KiwiCheckedListBox.
        /// </summary>
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public int TopIndex
        ...
        /// <summary>
        /// Gets or sets the width by which the horizontal scroll bar of a KiwiCheckedListBox can scroll. 
        /// </summary>
        [Category("Behavior")]
        ...
        /// </summary>
        [Category("Behavior")]
        [Description("Indicates whether the KiwiCheckedListBox will display a horizontal scrollbar for items beyond the right edge of the KiwiCheckedListBox.")]
        [Localizable(true)]
        [DefaultValue(false)]
        ...
        /// <summary>
        /// Gets or sets the selection mode of the KiwiCheckedListBox control.
        /// </summary>
        [Category("Behavior")]
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the items in the KiwiCheckedListBox are sorted alphabetically.
        /// </summary>
        [Category("Behavior")]
        ...
        /// <summary>
        /// Gets the items of the KiwiCheckedListBox. 
        /// </summary>
        [Category("Data")]
        [Description("The items in the KiwiCheckedListBox.")]
        ...
        /// <summary>
        /// Collection of checked items in this KiwiCheckedListBox.
        /// </summary>
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public KiwiCheckedListBox.CheckedItemCollection CheckedItems
        {
            get { return _checkedItems; }
        }

        /// <summary>
        /// Collection of checked indexes in this KiwiCheckedListBox.
        /// </summary>
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public KiwiCheckedListBox.CheckedIndexCollection CheckedIndices
        {
        ...
        /// <summary>
        /// Unselects all items in the KiwiCheckedListBox.
        /// </summary>
        ...
        /// <summary>
        /// Returns the height of an item in the KiwiCheckedListBox.
        /// </summary>
        ...
        /// <summary>
        /// Returns the bounding rectangle for an item in the KiwiCheckedListBox.
        /// </summary>
        ...
        /// <returns>true if the specified item is currently selected in the KiwiCheckedListBox; otherwise, false.</returns>
        ...
        /// <summary>
        /// Selects or clears the selection for the specified item in a KiwiCheckedListBox. 
        /// </summary>
        /// <param name="index">The zero-based index of the item in a KiwiCheckedListBox to select or clear the selection for.</param>
        ...
        /// <summary>
        /// Creates a new instance of the control collection for the KiwiTextBox.
        /// </summary>
