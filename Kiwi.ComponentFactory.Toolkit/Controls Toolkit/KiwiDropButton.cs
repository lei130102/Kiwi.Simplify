...
{
    /// <summary>
    /// Combines drop down button functionality with the styling features of the Kiwi Toolkit.
	/// </summary>
    ...
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiDropButtonDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [DesignerCategory("code")]
    [Description("Raises an event when the user clicks it.")]
    //
    [ToolboxBitmap(typeof(KiwiDropButton), "ToolboxBitmaps.KiwiDropButton.bmp")]
    public class KiwiDropButton : VisualSimpleBase, IButtonControl, IContentValues
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiDropButton class.
		/// </summary>
        public KiwiDropButton()
        {
        ...
        private bool ShowDropDown()
        {
            ...
            if (KiwiContextMenu != null)
            {
                if (PaletteMode != PaletteMode.Custom)
                    KiwiContextMenu.PaletteMode = PaletteMode;
                else
                    KiwiContextMenu.Palette = Palette;
            }
