...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiSplitContainerDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [Description("Divide the container inside two resizable panels.")]
    [Docking(DockingBehavior.AutoDock)]
    //
    [ToolboxBitmap(typeof(KiwiSplitContainer), "ToolboxBitmaps.KiwiSplitContainer.bmp")]
    public class KiwiSplitContainer : VisualControlContainment,
                                         ISeparatorSource
    {
        ...
        private KiwiSplitterPanel _panel1;
        private KiwiSplitterPanel _panel2;
        ...
        #region Identity
        /// <summary>
		/// Initialize a new instance of the KiwiSplitContainer class.
		/// </summary>
		public KiwiSplitContainer()
        {
            ...
            _panel1 = new KiwiSplitterPanel(this);
            _panel2 = new KiwiSplitterPanel(this);

            // Add both panels to the controls collection
            ((KiwiReadOnlyControls)Controls).AddInternal(_panel1);
            ((KiwiReadOnlyControls)Controls).AddInternal(_panel2);
        }
        ...
        /// <summary>
        /// Gets access to the first kiwi splitter panel.
        /// </summary>
        [Localizable(false)]
        [Category("Appearance")]
        [Description("The Left or Top panel in the KiwiSplitContainer.")]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiSplitterPanel Panel1
        {
            get { return _panel1; }
        }
        ...
        /// <summary>
        /// Gets access to the second kiwi splitter panel.
        /// </summary>
        [Localizable(false)]
        [Category("Appearance")]
        [Description("The Right or Bottom panel in the KiwiSplitContainer.")]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiSplitterPanel Panel2
        {
            get { return _panel2; }
        }
        ...
        /// <summary>
        /// Gets or sets a value indicating the horizontal or vertical orientation of the KiwiSplitContainer panels.
        /// </summary>
        [Category("Behavior")]
        ...
        /// <summary>
        /// Creates a new instance of the control collection for the KiwiSplitContainer.
        /// </summary>
