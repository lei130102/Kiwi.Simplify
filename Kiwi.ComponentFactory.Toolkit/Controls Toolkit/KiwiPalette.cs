...
{
    /// <summary>
    /// Define and modify a palette for styling Kiwi controls.
    /// </summary>
    ...
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiPaletteDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    //
    [ToolboxBitmap(typeof(KiwiPalette), "ToolboxBitmaps.KiwiPalette.bmp")]
    [DesignerCategory("code")]
    [Description("Customisable palette component.")]
    public class KiwiPalette : Component, IPalette
    {
        ...
        private KiwiPaletteCheckButtons _buttons;
        private KiwiPaletteButtonSpecs _buttonSpecs;
        private KiwiPaletteCalendarDay _calendarDay;
        private KiwiPaletteCargo _cargo;
        private KiwiPaletteCommon _common;
        private KiwiPaletteContextMenu _contextMenu;
        private KiwiPaletteControls _controls;
        private PaletteDragDrop _dragDrop;
        private KiwiPaletteForms _forms;
        private KiwiPaletteGrids _grids;
        private KiwiPaletteHeaders _headers;
        private KiwiPaletteHeaderGroup _headerGroup;
        private KiwiPaletteImages _images;
        private KiwiPaletteInputControls _inputControls;
        private KiwiPaletteLabels _labels;
        private KiwiPaletteNavigator _navigator;
        private KiwiPalettePanels _panels;
        private KiwiPaletteRibbon _ribbon;
        private KiwiPaletteSeparators _separators;
        private KiwiPaletteTabButtons _tabs;
        private KiwiPaletteTrackBar _trackBar;
        private KiwiPaletteTMS _toolMenuStatus;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiPalette class.
        /// </summary>
        public KiwiPalette()
        {
            ...
            _basePalette = KiwiManager.GetPaletteForMode(PaletteMode.Office2010Blue);
            ...
            _common = new KiwiPaletteCommon(_redirector, _needPaintDelegate);
            ...
            _buttons = new KiwiPaletteCheckButtons(_redirectCommon, _needPaintDelegate);
            _buttonSpecs = new KiwiPaletteButtonSpecs(_redirector);
            _calendarDay = new KiwiPaletteCalendarDay(_redirector, _needPaintDelegate);
            _cargo = new KiwiPaletteCargo(_needPaintDelegate);
            _controls = new KiwiPaletteControls(_redirectCommon, _needPaintDelegate);
            _contextMenu = new KiwiPaletteContextMenu(_redirectCommon, _needPaintDelegate);
            _dragDrop = new PaletteDragDrop(_redirectCommon, _needPaintDelegate);
            _forms = new KiwiPaletteForms(_redirectCommon, _needPaintDelegate);
            _grids = new KiwiPaletteGrids(_redirectCommon, _needPaintDelegate);
            _headers = new KiwiPaletteHeaders(_redirectCommon, _needPaintDelegate);
            _headerGroup = new KiwiPaletteHeaderGroup(_redirector, _needPaintDelegate);
            _images = new KiwiPaletteImages(_redirectCommon, _needPaintDelegate);
            _inputControls = new KiwiPaletteInputControls(_redirectCommon, _needPaintDelegate);
            _labels = new KiwiPaletteLabels(_redirectCommon, _needPaintDelegate);
            _navigator = new KiwiPaletteNavigator(_redirectCommon, _needPaintDelegate);
            _panels = new KiwiPalettePanels(_redirectCommon, _needPaintDelegate);
            _ribbon = new KiwiPaletteRibbon(_redirectCommon, _needPaintDelegate);
            _separators = new KiwiPaletteSeparators(_redirectCommon, _needPaintDelegate);
            _tabs = new KiwiPaletteTabButtons(_redirectCommon, _needPaintDelegate);
            _trackBar = new KiwiPaletteTrackBar(_redirectCommon, _needPaintDelegate);
            _toolMenuStatus = new KiwiPaletteTMS(this, _basePalette.ColorTable, _needTMSPaintDelegate);
        ...
        public KiwiPalette(IContainer container)
            : this()
        {
        ...
        /// <summary>
        /// Gets or sets a value indicating if KiwiForm instances should show custom chrome.
        /// </summary>
        [KiwiPersist(false)]
        [Category("Visuals")]
        [Description("Should KiwiForm instances show custom chrome.")]
        ...
        public KiwiPaletteButtonSpecs ButtonSpecs
        {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiPaletteCheckButtons ButtonStyles
        {
            get { return _buttons; }
        }
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiPaletteCalendarDay CalendarDay
        {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiPaletteCommon Common
        {
            get { return _common; }
        }
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiPaletteControls ControlStyles
        {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiPaletteContextMenu ContextMenu
        {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiPaletteForms FormStyles
        {
            get { return _forms; }
        }
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiPaletteHeaderGroup HeaderGroup
        {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiPaletteHeaders HeaderStyles
        {
            get { return _headers; }
        }
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiPaletteGrids GridStyles
        {
            get { return _grids; }
        }
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiPaletteImages Images
        {
            get { return _images; }
        }
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiPaletteInputControls InputControlStyles
        {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiPaletteLabels LabelStyles
        {
            get { return _labels; }
        }
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiPaletteNavigator Navigator
        {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiPalettePanels PanelStyles
        {
            get { return _panels; }
        }
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiPaletteRibbon Ribbon
        {
            get { return _ribbon; }
        }
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiPaletteSeparators SeparatorStyles
        {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiPaletteTabButtons TabStyles
        {
            get { return _tabs; }
        }
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiPaletteTrackBar TrackBar
        {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public KiwiPaletteTMS ToolMenuStatus
        {
        ...
        public IRenderer GetRenderer()
        {
            switch (_baseRenderMode)
            {
                ...
                default:
                    ...
                    return KiwiManager.GetRendererForMode(_baseRenderMode);
            }
        }
        #endregion
        ...
        #region IPalette
        /// <summary>
        /// Gets a value indicating if KiwiForm instances should show custom chrome.
        /// </summary>
        ...
        public Image GetGalleryButtonImage(PaletteRibbonGalleryButton button, PaletteState state)
        {
            ...
            KiwiPaletteImagesGalleryButton images = null;
            switch (button)
            {
                ...
                if (_basePaletteMode != value)
                {
                    ...
                    switch (value)
                    {
                        ...
                        default:
                            ...
                            _basePalette = KiwiManager.GetPaletteForMode(_basePaletteMode);
                            ...
                            SetPalette(KiwiManager.GetPaletteForMode(_basePaletteMode));
        ...
        /// <summary>
        /// Gets and sets the KiwiPalette used to inherit from.
        /// </summary>
        [Category("Visuals")]
        [Description("KiwiPalette used to inherit from.")]
        [DefaultValue(null)]
                    ...
                    switch (value)
                    {
                        ...
                        default:
                            ...
                            if (value == RendererMode.Inherit)
                                ...
                                _baseRenderer = KiwiManager.GetRendererForMode(_baseRenderMode);
        ...
        /// </summary>
        [Browsable(false)]
        public KiwiColorTable ColorTable
        {
        ...
        internal bool HasCircularReference()
        {
            ...
            while (palette != null)
            {
                ...
                else
                {
                    ...
                    // If this is a KiwiPalette instance
                    if (palette is KiwiPalette)
                    {
                        // Cast to correct type
                        KiwiPalette owner = (KiwiPalette)palette;
                        ...
                        if (owner.BasePaletteMode == PaletteMode.Custom)
                            ...
                            palette = KiwiManager.InternalGlobalPalette;
                        else
                            palette = null;
                    }
                    else
        ...
        private void ImportFromXmlDocument(XmlDocument doc)
        {
            ...
            try
            {
                ...
                XmlElement root = (XmlElement)doc.SelectSingleNode("KiwiPalette");

                // We insist the root is always present
                if (root == null)
                    throw new ArgumentException("Root element must be called 'KiwiPalette'.");
                ...
                if (version < _paletteVersion)
                    throw new ArgumentException("Version '" + version + "' number is incompatible, only version " + _paletteVersion.ToString() +
                                                " or above can be imported.\nUse the PaletteUpgradeTool from the Application tab of the KiwiExplorer to upgrade.");
                ...
                if (props == null) throw new ArgumentException("Element 'Properties' missing from the 'KiwiPalette'.");
                if (images == null) throw new ArgumentException("Element 'Images' missing from the 'KiwiPalette'.");
        ...
        private XmlDocument ExportToXmlDocument(bool ignoreDefaults)
        {
            ...
            try
            {
                ...
                doc.AppendChild(doc.CreateComment("Created by exporting the settings of a KiwiPalette instance."));
                doc.AppendChild(doc.CreateComment("For more information about Kiwi visit www.ComponentFactory.com"));
                ...
                XmlElement root = doc.CreateElement("KiwiPalette");
            ...
            if (obj != null)
            {
                ...
                foreach (PropertyInfo prop in t.GetProperties())
                {
                    ...
                    foreach (object attrib in prop.GetCustomAttributes(false))
                    {
                        ...
                        if (attrib is KiwiPersistAttribute)
                        {
                            // Cast attribute to the correct type
                            KiwiPersistAttribute persist = (KiwiPersistAttribute)attrib;
        ...
        private IPaletteRibbonBack GetPaletteRibbonBack(KiwiPaletteRibbonTab ribbonTab,
                                                        PaletteState state)
        {
            switch (state)
            {
        ...
        private IPaletteRibbonBack GetPaletteRibbonBack(KiwiPaletteRibbonAppButton ribbonAppButton,
                                                        PaletteState state)
        {
            switch (state)
            {
        ...
        private IPaletteRibbonBack GetPaletteRibbonBack(KiwiPaletteRibbonGroupArea ribbonGroupArea,
                                                        PaletteState state)
        {
            switch (state)
            {
        ...
        private IPaletteRibbonBack GetPaletteRibbonBack(KiwiPaletteRibbonGroupNormalBorder ribbonGroupNormalBorder,
                                                        PaletteState state)
        {
            switch (state)
            {
        ...
        private IPaletteRibbonBack GetPaletteRibbonBack(KiwiPaletteRibbonGroupNormalTitle ribbonGroupNormalTitle,
                                                        PaletteState state)
        {
            switch (state)
            {
        ...
        private IPaletteRibbonBack GetPaletteRibbonBack(KiwiPaletteRibbonGroupCollapsedBorder ribbonGroupCollapsedBorder,
                                                        PaletteState state)
        {
            switch (state)
            {
        ...
        private IPaletteRibbonBack GetPaletteRibbonBack(KiwiPaletteRibbonGroupCollapsedBack ribbonGroupCollapsedBack,
                                                        PaletteState state)
        {
            switch (state)
            {
        ...
        private IPaletteRibbonBack GetPaletteRibbonBack(KiwiPaletteRibbonGroupCollapsedFrameBorder ribbonGroupCollapsedFrameBorder,
                                                        PaletteState state)
        {
            switch (state)
            {
        ...
        private IPaletteRibbonBack GetPaletteRibbonBack(KiwiPaletteRibbonGroupCollapsedFrameBack ribbonGroupCollapsedFrameBack,
                                                        PaletteState state)
        {
            switch (state)
            {
        ...
        private IPaletteRibbonBack GetPaletteRibbonBack(KiwiPaletteRibbonQATMinibar ribbonQATMinibar,
                                                        PaletteState state)
        {
            switch (state)
            {
        ...
        private IPaletteRibbonText GetPaletteRibbonText(KiwiPaletteRibbonTab ribbonTab,
                                                        PaletteState state)
        {
            switch (state)
            {
        ...
        private IPaletteRibbonText GetPaletteRibbonText(KiwiPaletteRibbonGroupNormalTitle ribbonGroupNormalTitle,
                                                        PaletteState state)
        {
            switch (state)
            {
        ...
        private IPaletteRibbonText GetPaletteRibbonText(KiwiPaletteRibbonGroupCollapsedText ribbonGroupCollapsedText,
                                                        PaletteState state)
        {
            switch (state)
            {
        ...
        private IPaletteRibbonText GetPaletteRibbonText(KiwiPaletteRibbonGroupBaseText ribbonGroupButtonText,
                                                        PaletteState state)
        {
            switch (state)
            {
        ...
        private IPaletteBack GetPaletteBackButton(KiwiPaletteCheckButton button, PaletteState state)
        {
        ...
        private PaletteBorder GetPaletteBorderButton(KiwiPaletteCheckButton button, PaletteState state)
        {
            // Have to special case states that do not derive from PaletteTriple
            switch (state)
            {
        ...
        private PaletteContent GetPaletteContentButton(KiwiPaletteCheckButton button, PaletteState state)
        {
            // Have to special case states that do not derive from PaletteTriple
            switch (state)
            {
        ...
        private PaletteTriple GetPaletteButton(KiwiPaletteCheckButton button, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private IPaletteBack GetPaletteBackCalendarDay(KiwiPaletteCalendarDay button, PaletteState state)
        {
            // Have to special case states that do not derive from PaletteTriple
            switch (state)
            {
        ...
        private PaletteBorder GetPaletteBorderCalendarDay(KiwiPaletteCalendarDay button, PaletteState state)
        {
            // Have to special case states that do not derive from PaletteTriple
            switch (state)
            {
        ...
        private PaletteContent GetPaletteContentCalendarDay(KiwiPaletteCalendarDay button, PaletteState state)
        {
            // Have to special case states that do not derive from PaletteTriple
            switch (state)
            {
        ...
        private PaletteTriple GetPaletteCalendarDay(KiwiPaletteCalendarDay button, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private PaletteTriple GetPaletteInputControl(KiwiPaletteInputControl inputControl, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private IPaletteBack GetPaletteBackTab(KiwiPaletteTabButton button, PaletteState state)
        {
            // Have to special case states that do not derive from PaletteTriple
            switch (state)
            {
        ...
        private PaletteBorder GetPaletteBorderTab(KiwiPaletteTabButton button, PaletteState state)
        {
            // Have to special case states that do not derive from PaletteTriple
            switch (state)
            {
        ...
        private PaletteContent GetPaletteContentTab(KiwiPaletteTabButton button, PaletteState state)
        {
            // Have to special case states that do not derive from PaletteTriple
            switch (state)
            {
        ...
        private PaletteTabTriple GetPaletteTab(KiwiPaletteTabButton button, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private PaletteBack GetPaletteBackSeparator(KiwiPaletteSeparator separator, PaletteState state)
        {
        ...
        private PaletteBorder GetPaletteBorderSeparator(KiwiPaletteSeparator separator, PaletteState state)
        {
            PaletteSeparatorPadding separatorState = GetPaletteSeparator(separator, state);
        ...
        private PaletteSeparatorPadding GetPaletteSeparator(KiwiPaletteSeparator separator, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private PaletteBack GetPaletteBackControl(KiwiPaletteControl control, PaletteState state)
        {
        ...
        private PaletteBorder GetPaletteBorderControl(KiwiPaletteControl control, PaletteState state)
        {
            PaletteDouble controlState = GetPaletteControl(control, state);
        ...
        private PaletteDouble GetPaletteControl(KiwiPaletteControl control, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private PaletteBack GetPaletteBackForm(KiwiPaletteForm form, PaletteState state)
        {
        ...
        private PaletteBack GetPaletteBackGridBackground(KiwiPaletteGrid grid, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private PaletteBack GetPaletteBackGridHeaderColumn(KiwiPaletteGrid grid, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private PaletteBack GetPaletteBackGridHeaderRow(KiwiPaletteGrid grid, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private PaletteBack GetPaletteBackGridDataCell(KiwiPaletteGrid grid, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private PaletteBorder GetPaletteBorderGridHeaderColumn(KiwiPaletteGrid grid, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private PaletteBorder GetPaletteBorderGridHeaderRow(KiwiPaletteGrid grid, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private PaletteBorder GetPaletteBorderGridDataCell(KiwiPaletteGrid grid, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private IPaletteContent GetPaletteContentGridHeaderColumn(KiwiPaletteGrid grid, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private IPaletteContent GetPaletteContentGridHeaderRow(KiwiPaletteGrid grid, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private IPaletteContent GetPaletteContentGridDataCell(KiwiPaletteGrid grid, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private PaletteBorder GetPaletteBorderForm(KiwiPaletteForm form, PaletteState state)
        {
            PaletteDouble controlState = GetPaletteForm(form, state);
        ...
        private PaletteDouble GetPaletteForm(KiwiPaletteForm form, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private PaletteBack GetPaletteBackHeader(KiwiPaletteHeader header, PaletteState state)
        {
        ...
        private PaletteBorder GetPaletteBorderHeader(KiwiPaletteHeader header, PaletteState state)
        {
            PaletteTriple headerState = GetPaletteHeader(header, state);
        ...
        private PaletteContent GetPaletteContentHeader(KiwiPaletteHeader header, PaletteState state)
        {
            PaletteTriple headerState = GetPaletteHeader(header, state);
        ...
        private PaletteTriple GetPaletteHeader(KiwiPaletteHeader header, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private PaletteBack GetPalettePanel(KiwiPalettePanel panel, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private PaletteContent GetPaletteLabel(KiwiPaletteLabel label, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private void OnNeedPaint(object sender, NeedLayoutEventArgs e)
        {
            ...
            if (_suspendCount == 0)
            {
                // Changing the kiwi control colors does not effect the menu/tool/status areas
