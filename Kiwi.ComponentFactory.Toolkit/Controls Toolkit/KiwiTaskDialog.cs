...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    //
    [ToolboxBitmap(typeof(KiwiTaskDialog), "ToolboxBitmaps.KiwiTaskDialog.bmp")]
    public class KiwiTaskDialog : Component, INotifyPropertyChanged
    {
        ...
        #region Identity
        /// <summary>
        ///  Initialize a new instance of the KiwiTaskDialog class.
        /// </summary>
        public KiwiTaskDialog()
        {
            _radioButtons = new KiwiTaskDialogCommandCollection();
            _commandButtons = new KiwiTaskDialogCommandCollection();
        ...
        [Browsable(true)]
        public KiwiTaskDialogCommandCollection RadioButtons
        {
        ...
        [RefreshProperties(RefreshProperties.All)]
        [Browsable(true)]
        public KiwiTaskDialogCommandCollection CommandButtons
        {
        ...
        public KiwiTaskDialogCommand DefaultRadioButton
        {
                                        ...
                                        TaskDialogButtons commonButtons)
        {
            ...
            using (KiwiTaskDialog taskDialog = new KiwiTaskDialog())
            {
