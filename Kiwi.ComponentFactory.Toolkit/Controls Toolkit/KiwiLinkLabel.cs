...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiLinkLabelDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [DesignerCategory("code")]
    [Description("Displays descriptive information as a hyperlink.")]
    //
    [ToolboxBitmap(typeof(KiwiLinkLabel), "ToolboxBitmaps.KiwiLinkLabel.bmp")]
    public class KiwiLinkLabel : KiwiLabel
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiLinkLabel class.
        /// </summary>
        public KiwiLinkLabel()
        {
            ...
            _inheritBehavior = new LinkLabelBehaviorInherit(StateNormal, KiwiLinkBehavior.AlwaysUnderline);
        ...
        {
            LinkBehavior = KiwiLinkBehavior.AlwaysUnderline;
        }

        private bool ShouldSerializeLinkBehavior()
        {
            return (LinkBehavior != KiwiLinkBehavior.AlwaysUnderline);
        }
