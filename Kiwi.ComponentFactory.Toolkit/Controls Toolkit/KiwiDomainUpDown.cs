...
{
    /// <summary>
    /// Provide a DomainUpDown with Kiwi styling applied.
	/// </summary>
    ...
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiDomainUpDownDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [DesignerCategory("code")]
    [Description("Represents a Windows spin box (also known as an up-down control) that displays string values.")]
    //
    [ToolboxBitmap(typeof(KiwiDomainUpDown), "ToolboxBitmaps.KiwiDomainUpDown.bmp")]
    public class KiwiDomainUpDown : VisualControlBase,
                                       IContainedInputControl
    {
        ...
        private class InternalDomainUpDown : DomainUpDown
        {
            ...
            private KiwiDomainUpDown _kiwiDomainUpDown;
            ...
            /// </summary>
            /// <param name="kiwiDomainUpDown">Reference to owning control.</param>
            public InternalDomainUpDown(KiwiDomainUpDown kiwiDomainUpDown)
            {
                _kiwiDomainUpDown = kiwiDomainUpDown;
            ...
            protected override void WndProc(ref Message m)
            {
                switch (m.Msg)
                {
                    case PI.WM_NCHITTEST:
                        if (_kiwiDomainUpDown.InTransparentDesignMode)
                    ...
                    case PI.WM_MOUSELEAVE:
                        ...
                        MouseOver = false;
                        _kiwiDomainUpDown.PerformNeedPaint(true);
                        Invalidate();
                        base.WndProc(ref m);
                        break;
                    ...
                    case PI.WM_PAINT:
                        {
                            ...
                            using (Graphics g = Graphics.FromHdc(hdc))
                            {
                                ...
                                else
                                {
                                    ...
                                    g.TextRenderingHint = CommonHelper.PaletteTextHintToRenderingHint(_kiwiDomainUpDown.StateDisabled.PaletteContent.GetContentShortTextHint(PaletteState.Disabled));
                                    ...
                                    switch (_kiwiDomainUpDown.TextAlign)
                                    {
                                    ...
                                    {
                                        using (SolidBrush foreBrush = new SolidBrush(ForeColor))
                                            g.DrawString(Text, _kiwiDomainUpDown.GetTripleState().PaletteContent.GetContentShortTextFont(PaletteState.Disabled), foreBrush,
                                                         new RectangleF(rect.left, rect.top, rect.right - rect.left, rect.bottom - rect.top),
                                                         stringFormat);
                                    }
                                }
                    ...
                    case PI.WM_CONTEXTMENU:
                        ...
                        if (_kiwiDomainUpDown.KiwiContextMenu != null)
                        {
                            ...
                            _kiwiDomainUpDown.KiwiContextMenu.Show(_kiwiDomainUpDown, mousePt);
        ...
        private class SubclassEdit : NativeWindow
        {
            ...
            /// </summary>
            protected KiwiDomainUpDown DomainUpDown
            {
                get { return _kiwiDomainUpDown; }
            }
            ...
            protected override void WndProc(ref Message m)
            {
                switch (m.Msg)
                {
                    ...
                    case PI.WM_PAINT:
                        {
                            ...
                            using (Graphics g = Graphics.FromHdc(hdc))
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        case HorizontalAlignment.Left:
                                            if (_kiwiDomainUpDown.RightToLeft == RightToLeft.Yes)
                                                stringFormat.Alignment = StringAlignment.Far;
                                            else
                                                stringFormat.Alignment = StringAlignment.Near;
                                            break;
                                    ...
                                    {
                                        using (SolidBrush foreBrush = new SolidBrush(_internalDomainUpDown.ForeColor))
                                            g.DrawString(_internalDomainUpDown.Text, _kiwiDomainUpDown.GetTripleState().PaletteContent.GetContentShortTextFont(PaletteState.Disabled), foreBrush,
                                                         new RectangleF(rect.left, rect.top, rect.right - rect.left, rect.bottom - rect.top),
                                                         stringFormat);
                                    }
                                }
                    ...
                    case PI.WM_CONTEXTMENU:
                        // Only interested in overriding the behavior when we have a kiwi context menu...
                        if (DomainUpDown.KiwiContextMenu != null)
                        {
                            // Extract the screen mouse position (if might not actually be provided)
                            Point mousePt = new Point(PI.LOWORD(m.LParam), PI.HIWORD(m.LParam));
                            ...
                            // Show the context menu
                            DomainUpDown.KiwiContextMenu.Show(DomainUpDown, mousePt);
        ...
        private class SubclassButtons : SubclassEdit, IContentValues, IDisposable
        {
            ...
            public SubclassButtons(IntPtr buttonsPtr,
                                   KiwiDomainUpDown kiwiDomainUpDown,
                                   InternalDomainUpDown internalDomainUpDown)
                : base(buttonsPtr, kiwiDomainUpDown, internalDomainUpDown)
            {
            ...
            private void DrawUpDownButtons(Graphics g, Rectangle clientRect)
            {
                ...
                if (_viewButton == null)
                {
                    // Create helper object to get all values from the KiwiDomainUpDown redirector
        ...
        public class DomainUpDownButtonSpecCollection : ButtonSpecCollection<ButtonSpecAny>
        {
            ...
            public DomainUpDownButtonSpecCollection(KiwiDomainUpDown owner)
                : base(owner)
            {
            }
            #endregion
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiDomainUpDown class.
		/// </summary>
        public KiwiDomainUpDown()
        {
            ...
            ((KiwiReadOnlyControls)Controls).AddInternal(_domainUpDown);
        }
