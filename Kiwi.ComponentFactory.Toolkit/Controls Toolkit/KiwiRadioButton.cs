...
{
    /// <summary>
    /// Display radio button with text and images with the styling features of the Kiwi Toolkit
	/// </summary>
    ...
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiRadioButtonDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [DesignerCategory("code")]
    [Description("Allow user to set or clear the associated option.")]
    //
    [ToolboxBitmap(typeof(KiwiRadioButton), "ToolboxBitmaps.KiwiRadioButton.bmp")]
    public class KiwiRadioButton : VisualSimpleBase
    {
            ...
            if (AutoCheck && Checked)
            {
                ...
                if (parent != null)
                {
                    ...
                    foreach (Control c in parent.Controls)
                    {
                        ...
                        if ((c != this) && (c is KiwiRadioButton))
                        {
                            // Cast to correct type
                            KiwiRadioButton rb = (KiwiRadioButton)c;
