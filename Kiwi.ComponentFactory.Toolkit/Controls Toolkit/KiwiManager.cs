...
{
    /// <summary>
    /// Exposes global settings that affect all the Kiwi controls.
    /// </summary>
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiManagerDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [ToolboxItem(true)]
    [DefaultProperty("GlobalPaletteMode")]
    //
    [ToolboxBitmap(typeof(KiwiManager), "ToolboxBitmaps.KiwiManager.bmp")]
    [Description("Access global Kiwi settings.")]
    public sealed class KiwiManager : Component
    {
        ...
        /// <summary>
        /// Initialize a new instance of the KiwiManager class.
        /// </summary>
        public KiwiManager()
        {
        }
        ...
        public KiwiManager(IContainer container)
            : this()
        {
        ...
        {
            get { return KiwiManager.ApplyToolstrips; }
            set { KiwiManager.ApplyToolstrips = value; }
        }
        ...
        /// <summary>
        /// Gets or sets a value indicating if KiwiForm instances are allowed to show custom chrome.
        /// </summary>
        [Category("Visuals")]
        [Description("Should KiwiForm instances be allowed to show custom chrome.")]
        [DefaultValue(true)]
        public bool GlobalAllowFormChrome
        {
            get { return KiwiManager.AllowFormChrome; }
            set { KiwiManager.AllowFormChrome = value; }
        }
        ...
        /// <summary>
        /// Gets a set of global strings used by Kiwi that can be localized.
        /// </summary>
        [Category("Visuals")]
        ...
        internal static bool HasCircularReference()
        {
            ...
            if (KiwiManager.InternalGlobalPaletteMode == PaletteModeManager.Custom)
