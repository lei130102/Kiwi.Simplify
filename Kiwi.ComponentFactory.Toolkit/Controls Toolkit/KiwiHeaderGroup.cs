...
{
    /// <summary>
    /// Combines the benefits of the KiwiHeader and the KiwiGroup into one.
    /// </summary>
    ...
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiHeaderGroupDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    //
    [ToolboxBitmap(typeof(KiwiHeaderGroup), "ToolboxBitmaps.KiwiHeaderGroup.bmp")]
    [DesignerCategory("code")]
    [Description("Group a collection of controls with a descriptive caption.")]
    [Docking(DockingBehavior.Ask)]
    public class KiwiHeaderGroup : VisualControlContainment
    {
        ...
        public class HeaderGroupButtonSpecCollection : ButtonSpecCollection<ButtonSpecHeaderGroup>
        {
            ...
            public HeaderGroupButtonSpecCollection(KiwiHeaderGroup owner)
                : base(owner)
            {
            }
            #endregion
        ...
        #region Identity
        /// <summary>
		/// Initialize a new instance of the KiwiHeaderGroup class.
		/// </summary>
		public KiwiHeaderGroup()
        {
            // Set default values
            ...
            _panel = new KiwiGroupPanel(this, _stateCommon, _stateDisabled, _stateNormal, new NeedPaintHandler(OnGroupPanelPaint));
            ...
            ((KiwiReadOnlyControls)Controls).AddInternal(_panel);
        ...
        /// <summary>
        /// Creates a new instance of the control collection for the KiwiHeaderGroup.
        /// </summary>
