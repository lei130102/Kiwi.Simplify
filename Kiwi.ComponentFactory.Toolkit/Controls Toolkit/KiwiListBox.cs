...
{
    /// <summary>
    /// Provide a ListBox with Kiwi styling applied.
	/// </summary>
    ...
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiListBoxDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [DesignerCategory("code")]
    [Description("Represents a list box control that allows single or multiple item selection.")]
    //
    [ToolboxBitmap(typeof(KiwiListBox), "ToolboxBitmaps.KiwiListBox.bmp")]
    public class KiwiListBox : VisualControlBase,
                                  IContainedInputControl
    {
        ...
        private class InternalListBox : ListBox
        {
            ...
            private KiwiListBox _kiwiListBox;
            ...
            /// </summary>
            /// <param name="kiwiListBox">Reference to owning control.</param>
            public InternalListBox(KiwiListBox kiwiListBox)
            {
                SetStyle(ControlStyles.ResizeRedraw, true);

                _kiwiListBox = kiwiListBox;
                _mouseIndex = -1;
            ...
            protected override void OnLayout(LayoutEventArgs levent)
            {
                ...
                using (ViewLayoutContext context = new ViewLayoutContext(_viewManager, this, _kiwiListBox, _kiwiListBox.Renderer))
            ...
            protected override void WndProc(ref Message m)
            {
                switch (m.Msg)
                {
                    ...
                    case PI.WM_MOUSELEAVE:
                        ...
                        MouseOver = false;
                        _kiwiListBox.PerformNeedPaint(true);
                        Invalidate();
                        base.WndProc(ref m);
                        break;
                    ...
                    if (hBitmap != IntPtr.Zero)
                    {
                        try
                        {
                            ...
                            using (Graphics g = Graphics.FromHdc(_screenDC))
                            {
                                ...
                                using (ViewLayoutContext context = new ViewLayoutContext(this, _kiwiListBox.Renderer))
                                {
                                    context.DisplayRectangle = realRect;
                                    _drawPanel.Layout(context);
                                }

                                using (RenderContext context = new RenderContext(this, _kiwiListBox, g, realRect, _kiwiListBox.Renderer))
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiListBox class.
        /// </summary>
        public KiwiListBox()
        {
        ...
        /// <summary>
        /// Gets or sets the zero-based index of the currently selected item in a KiwiListBox.
        /// </summary>
        [Bindable(true)]
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        /// <summary>
        /// Gets a collection that contains the zero-based indexes of all currently selected items in the KiwiListBox.
        /// </summary>
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        /// <summary>
        /// Gets or sets the currently selected item in the KiwiListBox.
        /// </summary>
        [Bindable(true)]
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        /// <summary>
        /// Gets a collection containing the currently selected items in the KiwiListBox.
        /// </summary>
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        /// <summary>
        /// Gets or sets the index of the first visible item in the KiwiListBox.
        /// </summary>
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public int TopIndex
        ...
        /// <summary>
        /// Gets or sets the width by which the horizontal scroll bar of a KiwiListBox can scroll. 
        /// </summary>
        [Category("Behavior")]
        ...
        /// </summary>
        [Category("Behavior")]
        [Description("Indicates whether the KiwiListBox will display a horizontal scrollbar for items beyond the right edge of the KiwiListBox.")]
        [Localizable(true)]
        [DefaultValue(false)]
        ...
        /// <summary>
        /// Gets or sets the selection mode of the KiwiListBox control.
        /// </summary>
        [Category("Behavior")]
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the items in the KiwiListBox are sorted alphabetically.
        /// </summary>
        [Category("Behavior")]
        ...
        /// <summary>
        /// Gets the items of the KiwiListBox. 
        /// </summary>
        [Category("Data")]
        [Description("The items in the KiwiListBox.")]
        ...
        /// <summary>
        /// Unselects all items in the KiwiListBox.
        /// </summary>
        ...
        /// <summary>
        /// Returns the height of an item in the KiwiListBox.
        /// </summary>
        ...
        /// <summary>
        /// Returns the bounding rectangle for an item in the KiwiListBox.
        /// </summary>
        ...
        /// <returns>true if the specified item is currently selected in the KiwiListBox; otherwise, false.</returns>
        ...
        /// <summary>
        /// Selects or clears the selection for the specified item in a KiwiListBox. 
        /// </summary>
        /// <param name="index">The zero-based index of the item in a KiwiListBox to select or clear the selection for.</param>
        ...
        /// <summary>
        /// Creates a new instance of the control collection for the KiwiListBox.
        /// </summary>
