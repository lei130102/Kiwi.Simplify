...
{
    /// <summary>
    /// Combines button functionality with the styling features of the Kiwi Toolkit.
    /// </summary>
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    [DefaultEvent("Click")]
    [DefaultProperty("Text")]
    [Designer("Kiwi.ComponentFactory.Toolkit.KiwiButtonDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [ToolboxItem(true)]
    //其他
    [ToolboxBitmap(typeof(KiwiButton), "ToolboxBitmaps.KiwiButton.bmp")]
    [DesignerCategory("code")]
    [Description("Raises an event when the user clicks it.")]
    public class KiwiButton : VisualSimpleBase, IButtonControl, IContentValues
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiButton class.
		/// </summary>
        public KiwiButton()
        {
        ...
        [DefaultValue(null)]
        public virtual IKiwiCommand KiwiCommand
        {
            get { return _command; }
