...
{
	/// <summary>
	/// Special panel used in the KiwiSplitContainer.
	/// </summary>
	...
	[Designer("Kiwi.ComponentFactory.Toolkit.KiwiSplitterPanelDesigner, Kiwi.ComponentFactory.Toolkit, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
	[Description("Enables you to group collections of controls.")]
	//
	[Docking(DockingBehavior.Never)]
	//
	[ToolboxBitmap(typeof(KiwiSplitterPanel), "ToolboxBitmaps.KiwiGroupPanel.bmp")]
	public sealed class KiwiSplitterPanel : KiwiPanel
	{
		#region Instance Fields
		private bool _collapsed;
		private KiwiSplitContainer _container;
		#endregion
		...
		#region Identity
		/// <summary>
		/// Initialize a new instance of the KiwiSplitterPanel class.
		/// </summary>
		/// <param name="container">Reference to owning container.</param>
		public KiwiSplitterPanel(KiwiSplitContainer container)
		{
		...
		/// <summary>
		/// Gets or sets the height of the KiwiSplitterPanel. 
		/// </summary>
		[Browsable(false)]
		...
		public new int Height
		{
			...
			set
			{
				throw new NotSupportedException("Cannot set the Height of a KiwiSplitterPanel");
			}
		}
		...
		public new int Width
		{
			...
			set
			{
				throw new NotSupportedException("Cannot set the Width of a KiwiSplitterPanel");
			}
		}
		...
		#region Internal
		internal KiwiSplitContainer Owner
		{
