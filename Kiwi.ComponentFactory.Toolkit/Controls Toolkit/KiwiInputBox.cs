...
namespace Kiwi.ComponentFactory.Toolkit
{
    ...
    [ToolboxBitmap(typeof(KiwiInputBox), "ToolboxBitmaps.KiwiInputBox.bmp")]
    public class KiwiInputBox : KiwiForm
    {
        ...
        private KiwiWrapLabel _labelPrompt;
        private KiwiTextBox _textBoxResponse;
        private KiwiButton _buttonOK;
        private KiwiButton _buttonCancel;
        #endregion

        #region Identity
        private KiwiInputBox(string prompt,
                                string caption,
                                           ...
                                           string defaultResponse)
        {
            ...
            using (KiwiInputBox ib = new KiwiInputBox(prompt, caption, defaultResponse))
            {
                if (showOwner == null)
        ...
        private void InitializeComponent()
        {
            ...
            this._textBoxResponse = new Kiwi.ComponentFactory.Toolkit.KiwiTextBox();
            this._labelPrompt = new Kiwi.ComponentFactory.Toolkit.KiwiWrapLabel();
            this._buttonCancel = new Kiwi.ComponentFactory.Toolkit.KiwiButton();
            this._buttonOK = new Kiwi.ComponentFactory.Toolkit.KiwiButton();
            ...
            this._labelPrompt.LabelStyle = Kiwi.ComponentFactory.Toolkit.LabelStyle.NormalPanel;
