...
namespace KiwiColorButton_Examples
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            propertyGrid.SelectedObject = new KiwiColorButtonProxy(blueSplitter);
        }

        private void colorButtonEnter(object sender, EventArgs e)
        {
            // Setup the property grid to edit this color button
            propertyGrid.SelectedObject = new KiwiColorButtonProxy(sender as KiwiColorButton);
        }
    ...
    public class KiwiColorButtonProxy
    {
        private KiwiColorButton _colorButton;

        public KiwiColorButtonProxy(KiwiColorButton comboBox)
        {
