...
namespace KiwiDateTimePicker_Examples
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            propertyGrid.SelectedObject = new KiwiDateTimePickerProxy(dtpNormalLong);
        }

        private void dtp_Enter(object sender, EventArgs e)
        {
            // Setup the property grid to edit this date time picker control
            propertyGrid.SelectedObject = new KiwiDateTimePickerProxy(sender as KiwiDateTimePicker);
        }
        ...
        {
            kiwiPalette.BasePaletteMode = PaletteMode.Office2010Silver;
        }

        private void rbOffice2010Black_CheckedChanged(object sender, EventArgs e)
        {
            kiwiPalette.BasePaletteMode = PaletteMode.Office2010Black;
        }
        ...
        {
            kiwiPalette.BasePaletteMode = PaletteMode.SparkleOrange;
        }

        private void rbSparklePurple_CheckedChanged(object sender, EventArgs e)
        {
            kiwiPalette.BasePaletteMode = PaletteMode.SparklePurple;
        }
    ...
    public class KiwiDateTimePickerProxy
    {
        private KiwiDateTimePicker _dateTimePicker;

        public KiwiDateTimePickerProxy(KiwiDateTimePicker dateTimePicker)
        {
