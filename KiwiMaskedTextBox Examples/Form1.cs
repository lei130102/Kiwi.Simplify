...
namespace KiwiMaskedTextBox_Examples
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            propertyGrid.SelectedObject = new KiwiMaskedTextBoxProxy(maskedTextBox1Blue);
        }

        private void maskedTextBox1Blue_Enter(object sender, EventArgs e)
        {
            // Setup the property grid to edit this masked text box
            propertyGrid.SelectedObject = new KiwiMaskedTextBoxProxy(sender as KiwiMaskedTextBox);
        }
    ...
    public class KiwiMaskedTextBoxProxy
    {
        private KiwiMaskedTextBox _maskedTextBox;

        public KiwiMaskedTextBoxProxy(KiwiMaskedTextBox maskedTextBox)
        {
