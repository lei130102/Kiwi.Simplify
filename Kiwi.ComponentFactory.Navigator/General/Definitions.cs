...
namespace Kiwi.ComponentFactory.Navigator
{
    ...
    /// <summary>
    /// Collection for managing ButtonSpecAny instances for a KiwiPage.
    /// </summary>
    public class PageButtonSpecCollection : ButtonSpecCollection<ButtonSpecAny>
    {
        ...
        public PageButtonSpecCollection(KiwiPage owner)
            : base(owner)
        {
        }
        #endregion
    ...
    /// <summary>
    /// Collection for managing NavigatorButtonSpec instances for a KiwiNavigator.
    /// </summary>
    public class NavigatorButtonSpecCollection : ButtonSpecCollection<ButtonSpecNavigator>
    {
        ...
        /// </summary>
        /// <param name="owner">Reference to owning object.</param>
        public NavigatorButtonSpecCollection(KiwiNavigator owner)
            : base(owner)
        {
        }
        #endregion
    ...
    public class NavFixedButtonSpecCollection : ButtonSpecCollection<ButtonSpecNavFixed>
    {
        ...
        /// </summary>
        /// <param name="owner">Reference to owning object.</param>
        public NavFixedButtonSpecCollection(KiwiNavigator owner)
            : base(owner)
        {
        }
        #endregion
    ...
    #region Enum KiwiPageFlags
    /// <summary>
    /// Specifies flags that can be applied to a KiwiPage
    /// </summary>
    [Flags()]
    public enum KiwiPageFlags : int
    {
    ...
    public enum NavigatorMode
    {
        ...
        /// <summary>Specifies a KiwiHeaderGroup style of appearance.</summary>
        HeaderGroup,

        /// <summary>Specifies a KiwiHeaderGroup style of appearance combined with a set of tabs.</summary>
        HeaderGroupTab,

        /// <summary>Specifies a KiwiGroup style of appearance.</summary>
        Group,

        /// <summary>Specifies a KiwiPanel style of appearance.</summary>
        Panel,
    }
    #endregion

    #region Enum MapKiwiPageText
    /// <summary>
    /// Specifies the mapping from KiwiPage text property.
    /// </summary>
    [TypeConverter(typeof(MapKiwiPageTextConverter))]
    public enum MapKiwiPageText
    {
        /// <summary>
        ...
        /// <summary>
        /// Specifies use of the KiwiPage.Text property.
        /// </summary>
        Text,
        ...
        /// <summary>
        /// Specifies use of the KiwiPage.TextTitle property.
        /// </summary>
        Title,
        ...
        /// <summary>
        /// Specifies use of the KiwiPage.TextDescription property.
        /// </summary>
        Description,
        ...
        /// <summary>
        /// Specifies use of the KiwiPage.ToolTipTitle property.
        /// </summary>
        ToolTipTitle,

        /// <summary>
        /// Specifies use of the KiwiPage.ToolTipBody property.
        /// </summary>
        ToolTipBody,
    }
    #endregion

    #region Enum MapKiwiPageImage
    /// <summary>
    /// Specifies the mapping from KiwiPage image property.
    /// </summary>
    [TypeConverter(typeof(MapKiwiPageImageConverter))]
    public enum MapKiwiPageImage
    {
        /// <summary>
        /// Specifies no mapping take place.
        /// </summary>
        ...
        /// <summary>
        /// Specifies use of the KiwiPage.ImageSmall property.
        /// </summary>
        Small,
        ...
        /// <summary>
        /// Specifies use of the KiwiPage.ImageMedium property.
        /// </summary>
        Medium,
        ...
        /// <summary>
        /// Specifies use of the KiwiPage.ImageLarge property.
        /// </summary>
        Large,
        ...
        /// <summary>
        /// Specifies use of the KiwiPage.ToolTipImage property.
        /// </summary>
        ToolTip,
    }
    #endregion
    ...
    public interface IDragPageNotify
    {
        ...
        void PageDragStart(object sender, KiwiNavigator navigator, PageDragCancelEventArgs e);
    ...
    #region Delegates
    /// <summary>
    /// Signature of method that provides a KiwiPageFlags enumeration value.
    /// </summary>
    /// <param name="sender">Source of the call.</param>
    /// <param name="e">A KiwiPageFlagsEventArgs containing event information.</param>
    public delegate void KiwiPageFlagsEventHandler(object sender, KiwiPageFlagsEventArgs e);
    #endregion
}
