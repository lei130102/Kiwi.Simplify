...
namespace Kiwi.ComponentFactory.Navigator
{
	...
	public abstract class HeaderGroupMappingBase : HeaderValuesBase
    {
        ...
        private MapKiwiPageText _mapHeading;
        private MapKiwiPageText _mapDescription;
        ...
        public HeaderGroupMappingBase(KiwiNavigator navigator,
        ...
        protected abstract MapKiwiPageImage GetMapImageDefault();

        /// <summary>
        /// Gets the default heading mapping value.
        /// </summary>
        /// <returns>Text mapping enumeration.</returns>
        protected abstract MapKiwiPageText GetMapHeadingDefault();

        /// <summary>
        /// Gets the default description mapping value.
        /// </summary>
        /// <returns>Text mapping enumeration.</returns>
        protected abstract MapKiwiPageText GetMapDescriptionDefault();
        #endregion
        ...
        public override Image GetImage(PaletteState state)
        {
            ...
            if ((_navigator.SelectedPage == null) ||
                (MapImage == MapKiwiPageImage.None))
                return Image;
        ...
        public override string GetShortText()
        {
            ...
            if ((_navigator.SelectedPage == null) ||
                (MapHeading == MapKiwiPageText.None))
                return Heading;
        ...
        public override string GetLongText()
        {
            ...
            // mapping indicates to always use the static text
            if ((_navigator.SelectedPage == null) ||
                (MapDescription == MapKiwiPageText.None))
                return Description;
        ...
        [RefreshPropertiesAttribute(RefreshProperties.All)]
        public virtual MapKiwiPageText MapHeading
        {
        ...
        [RefreshPropertiesAttribute(RefreshProperties.All)]
        public virtual MapKiwiPageText MapDescription
        {
