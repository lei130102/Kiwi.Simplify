...
namespace Kiwi.ComponentFactory.Navigator
{
    ...
    [Designer("Kiwi.ComponentFactory.Navigator.KiwiNavigatorDesigner, Kiwi.ComponentFactory.Navigator, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [DesignerCategory("code")]
    [Description("Allows navigation between pages.")]
    //
    [Docking(DockingBehavior.Ask)]
    //
    [ToolboxBitmap(typeof(KiwiNavigator), "ToolboxBitmaps.KiwiNavigator.bmp")]
    public class KiwiNavigator : VisualSimple,
                                    IDragTargetProvider
    {
        ...
        private KiwiGroupPanel _childPanel;
        private ViewBuilderBase _viewBuilder;
        private KiwiPage _selectedPage;
        ...
        public event EventHandler<KiwiPageCancelEventArgs> Selecting;
        ...
        public event EventHandler<KiwiPageEventArgs> Selected;
        ...
        public event EventHandler<KiwiPageCancelEventArgs> Deselecting;
        ...
        public event EventHandler<KiwiPageEventArgs> Deselected;
        ...
        public event EventHandler<KiwiContextMenuEventArgs> OutlookDropDown;
        ...
        public event EventHandler<KiwiPageEventArgs> TabClicked;
        ...
        public event EventHandler<KiwiPageEventArgs> TabDoubleClicked;
        ...
        public event EventHandler<KiwiPageEventArgs> TabMouseHoverStart;
        ...
        /// <summary>
        /// Initialize a new instance of the KiwiNavigator class.
        /// </summary>
        public KiwiNavigator()
        {
        ...
        [Editor("Kiwi.ComponentFactory.Navigator.NavigatorPageCollectionEditor, Kiwi.ComponentFactory.Navigator, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704", typeof(UITypeEditor))]
                ...
                if (_selectedPage != value)
                {
                    ...
                    if (Pages.Contains(value))
                    {
                        ...
                        if (_selectedPage != null)
                        {
                            ...
                            KiwiPageCancelEventArgs e1 = new KiwiPageCancelEventArgs(_selectedPage, Pages.IndexOf(_selectedPage));
                        ...
                        // Create event information
                        KiwiPageCancelEventArgs e2 = new KiwiPageCancelEventArgs(value, Pages.IndexOf(value));
                        ...
                        KiwiPage oldSelected = _selectedPage;
                        ...
                        if (oldSelected != null)
                            OnDeselected(new KiwiPageEventArgs(oldSelected, Pages.IndexOf(oldSelected)));

                        // For the new selection, generate event to show it is selected
                        OnSelected(new KiwiPageEventArgs(_selectedPage, Pages.IndexOf(_selectedPage)));
            ...
            set
            {
                if (_allowTabSelect != value)
                {
                    ...
                    if (!_allowTabSelect && (SelectedPage != null))
                    {
                        ...
                        OnDeselected(new KiwiPageEventArgs(SelectedPage, SelectedIndex));
        ...
        /// <summary>
        /// Gets the KiwiPage associated with the provided point.
        ...
        /// <returns>KiwiPage or null.</returns>
        public KiwiPage PageFromPoint(Point pt)
        {
            if (ViewManager.Root != null)
            {
                ...
                while (view != null)
                {
                    ...
                    if ((view.Component != null) && (view.Component is KiwiPage))
                        return (KiwiPage)view.Component;
        ...
        /// <param name="wrap">Wrap around end of collection to the start.</param>
        /// <returns>True if a new page was selected; otherwise false.</returns>
        public bool SelectNextPage(KiwiPage page, bool wrap)
        {
            // Perform view specific page selection
        ...
        /// <param name="wrap">Wrap around end of collection to the start.</param>
        /// <returns>True if a new page was selected; otherwise false.</returns>
        public bool SelectPreviousPage(KiwiPage page, bool wrap)
        {
            // Perform view specific page selection
        ...
        /// <returns>Returns the action that was performed.</returns>
        public CloseButtonAction PerformCloseAction(KiwiPage page)
        {
        ...
        public KiwiGroupPanel ChildPanel
        {
        ...
        protected override bool ProcessCmdKey(ref Message msg, Keys keyData)
        {
            ...
            if (SelectedPage != null)
            {
                if (SelectedPage.KiwiContextMenu != null)
                    if (SelectedPage.KiwiContextMenu.ProcessShortcut(keyData))
                        return true;
        ...
        /// </summary>
        /// <param name="e">A KiwiPageCancelEventArgs containing event details.</param>
        protected virtual void OnDeselecting(KiwiPageCancelEventArgs e)
        {
            if (Deselecting != null)
                Deselecting(this, e);
        }
        ...
        /// </summary>
        /// <param name="e">A KiwiPageCancelEventArgs containing event details.</param>
        protected virtual void OnSelecting(KiwiPageCancelEventArgs e)
        {
            if (Selecting != null)
                Selecting(this, e);
        }
        ...
        /// </summary>
        /// <param name="e">A KiwiPageEventArgs containing event details.</param>
        protected virtual void OnDeselected(KiwiPageEventArgs e)
        {
            if (Deselected != null)
                Deselected(this, e);
        }
        ...
        /// </summary>
        /// <param name="e">A KiwiPageEventArgs containing event details.</param>
        protected virtual void OnSelected(KiwiPageEventArgs e)
        {
            if (Selected != null)
                Selected(this, e);
        }
        ...
        /// <returns>Returns the action that was performed.</returns>
        protected virtual CloseButtonAction OnCloseAction(KiwiPage page)
        {
        ...
        /// </summary>
        /// <param name="e">An KiwiPageEventArgs containing the event args.</param>
        internal protected virtual void OnTabClicked(KiwiPageEventArgs e)
        {
            if (TabClicked != null)
                TabClicked(this, e);
        }
        ...
        /// </summary>
        /// <param name="e">An KiwiPageEventArgs containing the event args.</param>
        internal protected virtual void OnTabDoubleClicked(KiwiPageEventArgs e)
        {
        ...
        internal protected virtual void OnOutlookDropDown(KiwiContextMenu kcm)
        {
            if (OutlookDropDown != null)
                OutlookDropDown(this, new KiwiContextMenuEventArgs(SelectedPage,
                                                                      SelectedIndex,
                                                                      kcm));
        }
        ...
        /// </summary>
        /// <param name="e">An KiwiPageEventArgs containing event details.</param>
        protected virtual void OnTabMouseHoverStart(KiwiPageEventArgs e)
        {
        ...
        internal KiwiPage FirstActionPage()
        {
        ...
        internal KiwiPage LastActionPage()
        {
        ...
        internal KiwiPage PreviousActionPage(KiwiPage page)
        {
        ...
        internal KiwiPage NextActionPage(KiwiPage page)
        {
            Debug.Assert(page != null);
        ...
        internal void ShowPopupPage(KiwiPage page,
                                    ViewBase relative,
        ...
        internal void BorrowChildPanel()
        {
            if (!IsChildPanelBorrowed)
            {
                ...
                ((KiwiReadOnlyControls)Controls).RemoveInternal(ChildPanel);
        ...
        internal void ReturnChildPanel()
        {
            if (IsChildPanelBorrowed)
            {
                ...
                ((KiwiReadOnlyControls)Controls).AddInternal(ChildPanel);
                _borrowedChildPanel = false;
            }
        }

        internal void InternalDragStart(DragStartEventCancelArgs e, KiwiPage page)
        {
            if (DesignMode)
                e.Cancel = true;
            else
            {
                ...
                foreach (KiwiPage p in _dragPages)
                    if (p.AreFlagsSet(KiwiPageFlags.AllowPageDrag))
                    {
                        allowPageDrag = true;
                        break;
                    }
                ...
                if (!de.Cancel)
                {
                    ...
                    List<KiwiPage> list = new List<KiwiPage>();
                    foreach (KiwiPage p in de.Pages)
                        list.Add(p);
                    _dragPages = list.ToArray();
        ...
        internal void InternalDragEnd(PointEventArgs e)
        {
            if (_pageDragging && (DragPageNotify != null))
            {
                if (DragPageNotify.PageDragEnd(this, e))
                {
                    ...
                    foreach (KiwiPage page in _dragPages)
                        if (Pages.Contains(page))
                            Pages.Remove(page);
                }
            }
        ...
        private void CreatePageCollection()
        {
            ...
            _pages.Inserted += new TypedHandler<KiwiPage>(OnPageInserted);
            _pages.Removing += new TypedHandler<KiwiPage>(OnPageRemoving);
            _pages.Removed += new TypedHandler<KiwiPage>(OnPageRemoved);
        ...
        private void CreateStorageObjects()
        {
            ...
            _button.ContextButton.KiwiContextMenu.Opening += new CancelEventHandler(OnOpeningContextMenu);
        }
        ...
        private void CreateChildControl()
        {
            ...
            _childPanel = new KiwiGroupPanel(this,
            ...
            ((KiwiReadOnlyControls)Controls).AddInternal(_childPanel);
        }
        ...
        private void OnPageInserted(object sender, TypedCollectionEventArgs<KiwiPage> e)
        {
            // Ignore call as view builder is already destructed
            if (!IsDisposed && (_viewBuilder != null))
            {
                ...
                e.Item.FlagsChanged += new KiwiPageFlagsEventHandler(OnPageFlagsChanged);
        ...
        private void OnPageRemoving(object sender, TypedCollectionEventArgs<KiwiPage> e)
        {
            // Ignore call as view builder is already destructed
            if (!IsDisposed && (_viewBuilder != null))
            {
        ...
        private void OnPageRemoved(object sender, TypedCollectionEventArgs<KiwiPage> e)
        {
            // Ignore call as view builder is already destructed
            if (!IsDisposed && (_viewBuilder != null))
            {
        ...
        private void OnPageClearing(object sender, EventArgs e)
        {
            ...
            foreach (KiwiPage page in Pages)
            {
                ...
                // Unhook from page events
                page.FlagsChanged -= new KiwiPageFlagsEventHandler(OnPageFlagsChanged);
        ...
        {
            KiwiPage newSelection = null;
            KiwiPage firstEnabled = null;
            KiwiPage firstDisabled = null;

            // Process all pages
            for (int i = 0; i < Pages.Count; i++)
            {
                // Get the page to examine
                KiwiPage next = Pages[i];
                ...
                if (next.LastVisibleSet)
                {
                    ...
                    // Create event information
                    KiwiPageCancelEventArgs args = new KiwiPageCancelEventArgs(next, Pages.IndexOf(next));
            ...
            if (SelectedPage != null)
            {
                ...
                OnSelected(new KiwiPageEventArgs(SelectedPage, SelectedIndex));
            }
        ...
        private void SelectNextAvailablePage(KiwiPage begin)
        {
            // Generate event to show it is now deselected
            OnDeselected(new KiwiPageEventArgs(begin, Pages.IndexOf(begin)));
        ...
        private void OnOpeningContextMenu(object sender, CancelEventArgs e)
        {
            ...
            if (!IsDisposed && (_viewBuilder != null))
            {
                ...
                else
                {
                    ...
                    KiwiContextMenuItems contextMenuItems = new KiwiContextMenuItems();
                    ...
                    foreach (KiwiPage page in Pages)
                    {
                        ...
                        if ((page == SelectedPage) || (page.LastVisibleSet && page.Enabled))
                        {
                            ...
                            {
                                KiwiContextMenuSeparator vertBreak = new KiwiContextMenuSeparator();
                                vertBreak.Horizontal = false;
                                contextMenuItems.Items.Add(vertBreak);
                            }

                            // Create a menu item for the page
                            KiwiContextMenuItem pageMenuItem = new KiwiContextMenuItem(page.GetTextMapping(Button.ContextMenuMapText),
        ...
        private void OnShowToolTip(object sender, ToolTipEventArgs e)
        {
            if (!IsDisposed && (_viewBuilder != null))
            {
                ...
                if (!DesignMode)
                {
                    ...
                    KiwiPage toolTipPage = _viewBuilder.PageFromView(e.Target);

                    // If the tooltip is for a kiwi page header
                    if (toolTipPage != null)
                    {
        ...
        private void OnStartHover(object sender, ToolTipEventArgs e)
        {
            if (!IsDisposed && (_viewBuilder != null))
            {
                ...
                if (!DesignMode)
                {
                    ...
                    KiwiPage hoverPage = _viewBuilder.PageFromView(e.Target);
                    if (hoverPage != null)
                    {
                        OnTabMouseHoverStart(new KiwiPageEventArgs(hoverPage, Pages.IndexOf(hoverPage)));
        ...
        {
            // If a kiwi page is being removed
            if (e.Control is KiwiPage)
            {
                // Cast to correct type
                KiwiPage page = (KiwiPage)e.Control;
                    ...
                    do
                    {
                        ...
                        else
                        {
                            ...
                            if ((next != this) || ((next == this) && _viewBuilder.CanFocus))
                            {
                                ...
                                // Cannot select a control if that control is on an unselected kiwi page
                                if (!NextOnUnselectedKiwiPage(next))
                                {
        ...
        private bool NextOnUnselectedKiwiPage(Control next)
        {
            do
            {
                // Is this control actually a KiwiPage?
                if (next is KiwiPage)
                {
                    // Cast to the correct type
                    KiwiPage page = (KiwiPage)next;

                    // If the page is inside a kiwi container that is a navigator instance
                    if ((page.KiwiParentContainer != null) && (page.KiwiParentContainer is KiwiNavigator))
                    {
                        // Cast to correct type
                        KiwiNavigator nav = (KiwiNavigator)page.KiwiParentContainer;
            ...
            // Did not find the control is on a KiwiPage, so definitely not on an unselected KiwiPage
            return false;
        }
        ...
        private void ResetCachedKiwiContextMenu()
        {
            // First time around we need to create the context menu
            if (_kcm == null)
                _kcm = new KiwiContextMenu();
