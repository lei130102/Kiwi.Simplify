...
namespace Kiwi.ComponentFactory.Navigator
{
    ...
    /// </summary>
    public class KiwiNavigatorActionList : DesignerActionList
    {
        #region Instance Fields
        private KiwiNavigator _navigator;
        private KiwiNavigatorDesigner _designer;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiNavigatorActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public KiwiNavigatorActionList(KiwiNavigatorDesigner owner)
            : base(owner.Component)
        {
            // Remember designer and actual component instance being designed
            _designer = owner;
            _navigator = (KiwiNavigator)owner.Component;
                                       ...
                                       bool includeHeaderBar)
        {
            ...
            if (includeHeaderBar)
            {
                ...
                actions.Add(new KiwiDesignerActionItem(_headerBarVisible, "Header"));
            }
            ...
            if (includeHeaderPrimary)
            {
                ...
                actions.Add(new KiwiDesignerActionItem(_headerPrimaryVisible, "Header"));
            }
            ...
            if (includeHeaderSecondary)
            {
                ...
                actions.Add(new KiwiDesignerActionItem(_headerSecondaryVisible, "Header"));
            }
        }
