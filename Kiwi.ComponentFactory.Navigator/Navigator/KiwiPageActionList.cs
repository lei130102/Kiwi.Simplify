...
{
    internal class KiwiPageActionList : DesignerActionList
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiPageActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public KiwiPageActionList(KiwiPageDesigner owner)
            : base(owner.Component)
        {
            // Remember designer and actual component instance being designed
            _page = (KiwiPage)owner.Component;
        ...
        {
            get { return _page.AreFlagsSet(KiwiPageFlags.PageInOverflowBarForOutlookMode); }

            set
            {
                _serviceComponentChange.OnComponentChanged(_page, null, _page.AreFlagsSet(KiwiPageFlags.PageInOverflowBarForOutlookMode), value);
