...
namespace Kiwi.ComponentFactory.Navigator
{
    ...
    /// </summary>
    public class KiwiNavigatorDesigner : ParentControlDesigner
    {
        ...
        public override void Initialize(IComponent component)
        {
            ...
            _navigator = (KiwiNavigator)component;
            ...
            foreach (KiwiPage page in _navigator.Pages)
            ...
            _navigator.Pages.Inserted += new TypedHandler<KiwiPage>(OnPageInserted);
            _navigator.Pages.Removed += new TypedHandler<KiwiPage>(OnPageRemoved);
        ...
        public override DesignerActionListCollection ActionLists
        {
            get
            {
                ...
                actionLists.Add(new KiwiNavigatorActionList(this));
        ...
        {
            // Only a KiwiPage can be added as a child
            if (control is KiwiPage)
            {
        ...
        protected virtual void OnComponentRemoving(object sender, ComponentEventArgs e)
        {
            ...
            if (e.Component == _navigator)
            {
                ...
                {
                    KiwiPage page = _navigator.Pages[i];
                    _changeService.OnComponentChanging(_navigator, null);
        ...
        private void OnAddPage(object sender, EventArgs e)
        {
            ...
            DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiNavigator AddPage");
            ...
            try
            {
                ...
                KiwiPage page = (KiwiPage)_designerHost.CreateComponent(typeof(KiwiPage));
        ...
        {
            // Use a transaction to support undo/redo actions
            DesignerTransaction transaction = _designerHost.CreateTransaction("KiwiNavigator RemovePage");
            ...
            try
            {
                ...
                KiwiPage removePage = _navigator.SelectedPage;
