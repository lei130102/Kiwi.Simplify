...
namespace Kiwi.ComponentFactory.Navigator
{
    ...
    [Designer("Kiwi.ComponentFactory.Navigator.KiwiPageDesigner, Kiwi.ComponentFactory.Navigator, Version=1.0.0.0, Culture=neutral, PublicKeyToken=360f304a9e10e704")]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    //
    [ToolboxBitmap(typeof(KiwiPage), "ToolboxBitmaps.KiwiPage.bmp")]
    public class KiwiPage : VisualPanel
    {
        ...
        public event KiwiPageFlagsEventHandler FlagsChanged;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the KiwiPage class.
        /// </summary>
        public KiwiPage()
            : this("Page", null)
        {
        ...
        public KiwiPage(string text, string uniqueName)
        ...
        /// <param name="uniqueName">Initial unique name.</param>
        public KiwiPage(string text, Image imageSmall, string uniqueName)
        {
            // Default properties
            Text = text;
            ...
            _flags.Flags = (int)(KiwiPageFlags.All);
            _flags.ClearFlags((int)KiwiPageFlags.PageInOverflowBarForOutlookMode);
        ...
        [DefaultValue(null)]
        public virtual KiwiContextMenu KiwiContextMenu
        {
            get { return _kcm; }
            ...
            set
            {
                ...
                {
                    if (_kcm != null)
                        _kcm.Disposed += new EventHandler(OnKiwiContextMenuDisposed);
        ...
        public virtual string GetTextMapping(MapKiwiPageText mapping)
        {
            ...
            switch (mapping)
            {
                case MapKiwiPageText.Text:
                case MapKiwiPageText.TextTitle:
                case MapKiwiPageText.TextTitleDescription:
                case MapKiwiPageText.TextDescription:
                    ret = Text;
                    break;
                case MapKiwiPageText.Title:
                case MapKiwiPageText.TitleDescription:
                case MapKiwiPageText.TitleText:
                    ret = TextTitle;
                    break;
                case MapKiwiPageText.Description:
                case MapKiwiPageText.DescriptionText:
                case MapKiwiPageText.DescriptionTitle:
                case MapKiwiPageText.DescriptionTitleText:
                    ret = TextDescription;
                    break;
                case MapKiwiPageText.ToolTipTitle:
                    ret = ToolTipTitle;
                    break;
                case MapKiwiPageText.ToolTipBody:
                    ret = ToolTipBody;
                    break;
            }
        ...
        public virtual Image GetImageMapping(MapKiwiPageImage mapping)
        {
            Image ret = null;
            ...
            switch (mapping)
            {
                case MapKiwiPageImage.Small:
                case MapKiwiPageImage.SmallMedium:
                case MapKiwiPageImage.SmallMediumLarge:
                    ret = ImageSmall;
                    break;
                case MapKiwiPageImage.Medium:
                case MapKiwiPageImage.MediumLarge:
                case MapKiwiPageImage.MediumSmall:
                    ret = ImageMedium;
                    break;
                case MapKiwiPageImage.Large:
                case MapKiwiPageImage.LargeMedium:
                case MapKiwiPageImage.LargeMediumSmall:
                    ret = ImageLarge;
                    break;
                case MapKiwiPageImage.ToolTip:
                    ret = ToolTipImage;
                    break;
            }
        ...
        /// <summary>
        /// Gets the Kiwi control that is acting as the parent.
        /// </summary>
        [Browsable(false)]
        [EditorBrowsable(EditorBrowsableState.Advanced)]
        public Control KiwiParentContainer
        {
            [System.Diagnostics.DebuggerStepThrough]
        ...
        public virtual int Flags
        {
            ...
            set
            {
                if (_flags.Flags != value)
                {
                    ...
                    _flags.Flags = value;
                    OnFlagsChanged((KiwiPageFlags)changed);
                }
            }
        }
        ...
        public virtual void SetFlags(KiwiPageFlags flags)
        {
        ...
        /// </summary>
        /// <param name="flags">Flags to set.</param>
        public virtual void ClearFlags(KiwiPageFlags flags)
        {
        ...
        public virtual bool AreFlagsSet(KiwiPageFlags flags)
        {
                ...
                if (KiwiContextMenu != null)
                {
                    ...
                    if (ClientRectangle.Contains(mousePt))
                    {
                        if (!DesignMode)
                        {
                            ...
                            KiwiContextMenu.Show(this, PointToScreen(mousePt));
        ...
        protected virtual void OnFlagsChanged(KiwiPageFlags changed)
        {
            if (FlagsChanged != null)
                FlagsChanged(this, new KiwiPageFlagsEventArgs(changed));
        }
        ...
        private void OnKiwiContextMenuDisposed(object sender, EventArgs e)
        {
            // When the current kiwi context menu is disposed, we should remove 
            // it to prevent it being used again, as that would just throw an exception 
            // because it has been disposed.
            KiwiContextMenu = null;
        }
        #endregion
    }
}
