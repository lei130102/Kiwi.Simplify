...
{
    /// <summary>
	/// Navigator view base element for drawing a check button for a kiwi page.
	/// </summary>
                                                         ...
                                                         IContentValues
    {
        ...
        public ViewDrawNavCheckButtonBase(KiwiNavigator navigator,
                                          KiwiPage page,
        ...
        protected virtual void OnClick(object sender, EventArgs e)
        {
            ...
            Navigator.OnTabClicked(new KiwiPageEventArgs(_page, Navigator.Pages.IndexOf(_page)));
            ...
            if ((now - _lastClick).TotalMilliseconds < SystemInformation.DoubleClickTime)
            {
                ...
                // Generate click event for the page header
                Navigator.OnTabDoubleClicked(new KiwiPageEventArgs(_page, Navigator.Pages.IndexOf(_page)));
        ...
        protected virtual void OnRightClick(object sender, MouseEventArgs e)
        {
            ...
            if (!scma.Cancel)
            {
                if (CommonHelper.ValidKiwiContextMenu(scma.KiwiContextMenu))
                    scma.KiwiContextMenu.Show(_navigator, _navigator.PointToScreen(new Point(e.X, e.Y)));
                else
                {
