...
namespace Kiwi.ComponentFactory.Navigator
{
	...
	internal abstract class ViewBuilderBase
    {
        ...
        protected class PageToNavCheckItem : Dictionary<KiwiPage, INavCheckItem> { };
        protected class PageToNavCheckButton : Dictionary<KiwiPage, ViewDrawNavCheckButtonBase> { };
        #endregion
        ...
        public virtual void Construct(KiwiNavigator navigator,
                                      ViewManager manager,
        ...
        public virtual void PageVisibleStateChanged(KiwiPage page)
        {
        }
        ...
        public virtual void PageEnabledStateChanged(KiwiPage page)
        {
        }
        ...
        public virtual void PageAppearanceChanged(KiwiPage page, string property)
        {
        }
        ...
        public virtual void PageFlagsChanged(KiwiPage page, KiwiPageFlags changed)
        {
        }
        ...
        public abstract KiwiPage PageFromView(ViewBase element);
        ...
        public virtual void PerformNextAction(DirectionButtonAction action, KiwiPage page)
        {
            // Process the requested action
            switch (action)
            {
        ...
        /// <param name="action">Requested action.</param>
        /// <param name="page">Selected page at time of action request.</param>
        public virtual void PerformPreviousAction(DirectionButtonAction action, KiwiPage page)
        {
            // Process the requested action
            switch (action)
            {
        ...
        /// <returns>True if new page selected; otherwise false.</returns>
        public virtual bool SelectNextPage(KiwiPage page,
                                           bool wrap,
                                           bool ctrlTab)
        {
            // There must be at least one page and allowed to select a page
        ...
        /// <param name="ctrlTab">Associated with a Ctrl+Tab action.</param>
        /// <returns>True if new page selected; otherwise false.</returns>
        public virtual bool SelectPreviousPage(KiwiPage page,
                                               bool wrap,
                                               bool ctrlTab)
        {
            // There must be at least one page and allowed to select a page
