...
namespace Kiwi.ComponentFactory.Navigator
{
    ...
    internal abstract class ViewBuilderItemBase : ViewBuilderBase
    {
        ...
        public override KiwiPage PageFromView(ViewBase element)
        {
            if (_pageLookup != null)
            {
                foreach (KeyValuePair<KiwiPage, INavCheckItem> pair in _pageLookup)
        ...
        protected virtual INavCheckItem CreateCheckItem(KiwiPage page,
        ...
        private void CreateNavCheckItems()
        {
            ...
            Navigator.Pages.Inserted += new TypedHandler<KiwiPage>(OnItemPageInserted);
            Navigator.Pages.Removed += new TypedHandler<KiwiPage>(OnItemPageRemoved);
        ...
        private void UpdateCheckItemStyle()
        {
            ...
            if (PageLookup != null)
                foreach (KeyValuePair<KiwiPage, INavCheckItem> pair in PageLookup)
                {
        ...
        private void BringPageIntoView(KiwiPage page)
        {
        ...
        private void OnItemPageRemoved(object sender, TypedCollectionEventArgs<KiwiPage> e)
        {
            if (!Navigator.IsDisposed && (_events > 0))
            {
        ...
        private void OnItemPageInserted(object sender, TypedCollectionEventArgs<KiwiPage> e)
        {
            if (!Navigator.IsDisposed && (_events > 0))
            {
