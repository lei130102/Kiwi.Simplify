...
namespace Kiwi.ComponentFactory.Navigator
{
    ...
    internal class ViewBuilderOutlookMini : ViewBuilderOutlookBase
    {
        ...
        protected override void ReorderCheckButtonsOverflow(KiwiPage page,
        ...
        protected override bool AreMoreButtons()
        {
            ...
            foreach (KiwiPage page in Navigator.Pages)
                if (page.LastVisibleSet && page.AreFlagsSet(KiwiPageFlags.PageInOverflowBarForOutlookMode))
                    return true;
