...
namespace Kiwi.ComponentFactory.Navigator
{
                               ...
                               IDisposable
    {
        ...
        public virtual void PageDragStart(object sender, KiwiNavigator navigator, PageDragCancelEventArgs e)
        {
        ...
        private void ResolvePaletteRenderer()
        {
            ...
            switch (_paletteMode)
            {
                case PaletteMode.Custom:
                    ...
                    break;
                default:
                    _dragPalette = KiwiManager.GetPaletteForMode(_paletteMode);
                    break;
            }
