...
namespace Navigator_Modes
{
    public partial class Form1 : Form
    {
        ...
        private void UpdateModeFromRadioButtons()
        {
            ...
            kiwiNavigator1.NavigatorMode = mode;
            ...
            switch (mode)
            {
                ...
                case NavigatorMode.OutlookMini:
                    kiwiNavigator1.AutoSize = true;
                    break;
                default:
                    kiwiNavigator1.AutoSize = false;
                    break;
            }
            ...
            kiwiNavigator1.Dock = (mode == NavigatorMode.OutlookMini ? DockStyle.Left : DockStyle.Top);
        ...
        private void UpdateRadioButtonsFromMode()
        {
            ...
            NavigatorMode mode = kiwiNavigator1.NavigatorMode;
