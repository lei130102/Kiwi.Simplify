...
namespace KiwiSplitContainer_Examples
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            propertyGrid.SelectedObject = new KiwiSplitContainerProxy(splitContainer1Office);
        }

        private void splitContainer_MouseDown(object sender, MouseEventArgs e)
        {
            // Setup the property grid to edit this split container
            propertyGrid.SelectedObject = new KiwiSplitContainerProxy(sender as KiwiSplitContainer);
        }

        private void splitContainerPanel_MouseDown(object sender, MouseEventArgs e)
        {
            KiwiPanel panel = (KiwiPanel)sender;

            // Setup the property grid to edit this panels parent split container
            propertyGrid.SelectedObject = new KiwiSplitContainerProxy(panel.Parent as KiwiSplitContainer);
        }

        private void splitContainerLabel_MouseDown(object sender, MouseEventArgs e)
        {
            KiwiLabel label = (KiwiLabel)sender;
            KiwiPanel panel = (KiwiPanel)label.Parent;
        ...
        private void splitContainerGroupLabel_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            // Setup the property grid to edit this panels parent split container
            propertyGrid.SelectedObject = new KiwiSplitContainerProxy(panel.Parent.Parent.Parent as KiwiSplitContainer);
        }
    ...
    public class KiwiSplitContainerProxy
    {
        private KiwiSplitContainer _splitContainer;

        public KiwiSplitContainerProxy(KiwiSplitContainer splitContainer)
        {
