...
namespace External_Drag_To_Docking
{
    ...
    public class DraggableTreeView : TreeView
    {
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            {
                KiwiPage dragPage = null;

                // Create the correct type of kiwi page for the selected node
                ...
                if (dragPage != null)
                {
                    ...
                    KiwiDockingFloatingWindow fw = Form1.DockingManager.AddFloatingWindow("Floating",
                                                                                             new KiwiPage[] { dragPage },
                    ...
                    Form1.DockingManager.DoDragDropEnd += new EventHandler(kiwiDockingManager_DoDragDropFinished);
                    Form1.DockingManager.DoDragDropQuit += new EventHandler(kiwiDockingManager_DoDragDropFinished);
        ...
        private void kiwiDockingManager_DoDragDropFinished(object sender, EventArgs e)
        {
