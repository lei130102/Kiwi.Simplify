...
namespace OneNote_Tabs
{
    public partial class Form1 : Form
    {
        ...
        private void buttonAdd_Click(object sender, EventArgs e)
        {
            ...
            // Select the new page
            kiwiNavigator1.SelectedIndex = kiwiNavigator1.Pages.Count - 1;
        ...
        private void buttonRemove_Click(object sender, EventArgs e)
        {
            ...
            // Update button states
            buttonRemove.Enabled = (kiwiNavigator1.SelectedPage != null);
            buttonClear.Enabled = (kiwiNavigator1.SelectedPage != null);
        }
        ...
        {
            // Create a new kiwi page to be added
            ...
            kiwiNavigator1.Pages.Add(page);

            // Bump the page index to use next
            _count++;
        }

        private void AddEmbeddedNavigator(KiwiPage page)
        {
            // Create a navigator to embed inside the page
            KiwiNavigator nav = new KiwiNavigator();
        ...
        private KiwiPage NewEmbeddedPage(string title)
        {
            KiwiPage page = new KiwiPage();
            page.Text = title;
            page.ImageSmall = null;
