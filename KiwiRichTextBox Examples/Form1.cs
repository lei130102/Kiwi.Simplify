...
namespace KiwiRichTextBox_Examples
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            kiwiRichTextBox3Blue.Rtf = Properties.Resources.Document;
            kiwiRichTextBox6System.Rtf = Properties.Resources.Document;

            // Setup the property grid to edit this rich text box
            propertyGrid.SelectedObject = new KiwiRichTextBoxProxy(kiwiRichTextBox1Blue);
        }

        private void kiwiRichTextBox1Blue_Enter(object sender, EventArgs e)
        {
            // Setup the property grid to edit this rich text box
            propertyGrid.SelectedObject = new KiwiRichTextBoxProxy(sender as KiwiRichTextBox);
        }

        private void buttonSpecAny1_Click(object sender, EventArgs e)
        {
            kiwiRichTextBox2Blue.Text = string.Empty;
        }

        private void buttonSpecAny3_Click(object sender, EventArgs e)
        {
            kiwiRichTextBox5System.Text = string.Empty;
        }

        private void fixedText1_Click(object sender, EventArgs e)
        {
            kiwiRichTextBox9Custom.Text = "Fixed Text 1";
            kiwiRichTextBox9Custom.RichTextBox.Focus();
        }

        private void fixedText2_Click(object sender, EventArgs e)
        {
            kiwiRichTextBox9Custom.Text = "Fixed Text 2";
            kiwiRichTextBox9Custom.RichTextBox.Focus();
        }

        private void clear_Click(object sender, EventArgs e)
        {
            kiwiRichTextBox9Custom.Clear();
            kiwiRichTextBox9Custom.RichTextBox.Focus();
        }
    ...
    public class KiwiRichTextBoxProxy
    {
        private KiwiRichTextBox _richTextBox;

        public KiwiRichTextBoxProxy(KiwiRichTextBox textBox)
        {
